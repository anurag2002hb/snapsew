...
if (function (e, t) {
      ...
      f = function () {
        ...
        return i.close = function (e) {
          ...
          return this.each((function () {
            var n = t(this),
              o = n.data(c);
            o || (o = new e(this), n.data(c, o)), "close" === i && o[i](this)
          }))
    ...
    t(document).on(h.CLICK_DATA_API, '[data-dismiss="alert"]', f._handleDismiss(new f)), t.fn[l] = f._jQueryInterface, t.fn[l].Constructor = f, t.fn[l].noConflict = function () {
      return t.fn[l] = u, f._jQueryInterface
    };
    var p = "button",
      m = "bs.button",
      g = "." + m,
      ...
      x = function () {
        ...
        return i.toggle = function () {
          ...
          i && this._element.setAttribute("aria-pressed", !this._element.classList.contains(_)), e && t(this._element).toggleClass(_)
        }, i.dispose = function () {
    ...
    t(document).on(k.CLICK_DATA_API, b, (function (e) {
      e.preventDefault();
      var i = e.target;
      t(i).hasClass("btn") || (i = t(i).closest(w)), x._jQueryInterface.call(t(i), "toggle")
    })).on(k.FOCUS_BLUR_DATA_API, b, (function (e) {
      var i = t(e.target).closest(w)[0];
      ...
      F = function () {
        ...
        return i.next = function () {
          ...
          if (!(e > this._items.length - 1 || e < 0))
            if (this._isSliding) t(this._element).one(A.SLID, (function () {
              return i.to(e)
            }));
            else {
          ...
          t(this._element).off(C), t.removeData(this._element, S), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
        }, i._getConfig = function (e) {
          return e = s({}, E, e), a.typeCheckConfig(T, e, j), e
          ...
          if (this._touchSupported) {
            ...
            t(this._element.querySelectorAll(".carousel-item img")).on(A.DRAG_START, (function (e) {
              return e.preventDefault()
            })), this._pointerEvent ? (t(this._element).on(A.POINTERDOWN, (function (e) {
              return i(e)
            })), t(this._element).on(A.POINTERUP, (function (e) {
              return n(e)
            })), this._element.classList.add("pointer-event")) : (t(this._element).on(A.TOUCHSTART, (function (e) {
              return i(e)
            })), t(this._element).on(A.TOUCHMOVE, (function (t) {
              var i;
            ...
            })), t(this._element).on(A.TOUCHEND, (function (e) {
              return n(e)
            })))
          }
          ...
          if (s = e === I ? (n = "carousel-item-left", o = "carousel-item-next", "left") : (n = "carousel-item-right", o = "carousel-item-prev", "right"), d && t(d).hasClass(M)) this._isSliding = !1;
            ...
            if (t(this._element).hasClass("slide")) {
              t(d).addClass(o), a.reflow(d), t(l).addClass(n), t(d).addClass(n);
              ...
              t(l).one(a.TRANSITION_END, (function () {
                t(d).removeClass(n + " " + o).addClass(M), t(l).removeClass(M + " " + o + " " + n), r._isSliding = !1, setTimeout((function () {
                  return t(r._element).trigger(f)
                }), 0)
              })).emulateTransitionEnd(m)
            } else t(l).removeClass(M), t(d).addClass(M), this._isSliding = !1, t(this._element).trigger(f);
            h && this.cycle()
          }
        }, e._jQueryInterface = function (i) {
          return this.each((function () {
            ...
            if (n || (n = new e(this, o), t(this).data(S, n)), "number" == typeof i) n.to(i);
          ...
          if (n) {
            ...
            if (o && t(o).hasClass("carousel")) {
              ...
              l && (r.interval = !1), e._jQueryInterface.call(t(o), r), l && t(o).data(S).to(l), i.preventDefault()
            }
          }
        }, o(e, null, [{
          key: "VERSION",
    ...
    t(document).on(A.CLICK_DATA_API, "[data-slide], [data-slide-to]", F._dataApiClickHandler), t(window).on(A.LOAD_DATA_API, (function () {
      for (var e = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), i = 0, n = e.length; i < n; i++) {
        var o = t(e[i]);
        F._jQueryInterface.call(o, o.data())
      }
    })), t.fn[T] = F._jQueryInterface, t.fn[T].Constructor = F, t.fn[T].noConflict = function () {
      return t.fn[T] = O, F._jQueryInterface
    };
    var W = "collapse",
      R = "bs.collapse",
      q = "." + R,
      ...
      V = function () {
        ...
        return i.toggle = function () {
          ...
          if (!(this._isTransitioning || t(this._element).hasClass(Y) || (this._parent && 0 === (i = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter((function (e) {
              return "string" == typeof o._config.parent ? e.getAttribute("data-parent") === o._config.parent : e.classList.contains(U)
            }))).length && (i = null), i && (n = t(i).not(this._selector).data(R)) && n._isTransitioning))) {
            var s = t.Event(B.SHOW);
            if (t(this._element).trigger(s), !s.isDefaultPrevented()) {
              i && (e._jQueryInterface.call(t(i).not(this._selector), "hide"), n || t(i).data(R, null));
              var r = this._getDimension();
              t(this._element).removeClass(U).addClass(G), this._element.style[r] = 0, this._triggerArray.length && t(this._triggerArray).removeClass(X).attr("aria-expanded", !0), this.setTransitioning(!0);
              var l = "scroll" + (r[0].toUpperCase() + r.slice(1)),
                c = a.getTransitionDurationFromElement(this._element);
              t(this._element).one(a.TRANSITION_END, (function () {
                t(o._element).removeClass(G).addClass(U).addClass(Y), o._element.style[r] = "", o.setTransitioning(!1), t(o._element).trigger(B.SHOWN)
          ...
          if (!this._isTransitioning && t(this._element).hasClass(Y)) {
            var i = t.Event(B.HIDE);
            if (t(this._element).trigger(i), !i.isDefaultPrevented()) {
              var n = this._getDimension();
              this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", a.reflow(this._element), t(this._element).addClass(G).removeClass(U).removeClass(Y);
              var o = this._triggerArray.length;
              if (0 < o)
                for (var s = 0; s < o; s++) {
                  var r = this._triggerArray[s],
                    l = a.getSelectorFromElement(r);
                  null !== l && (t([].slice.call(document.querySelectorAll(l))).hasClass(Y) || t(r).addClass(X).attr("aria-expanded", !1))
                }
              this.setTransitioning(!0), this._element.style[n] = "";
              var c = a.getTransitionDurationFromElement(this._element);
              t(this._element).one(a.TRANSITION_END, (function () {
                e.setTransitioning(!1), t(e._element).removeClass(G).addClass(U).trigger(B.HIDDEN)
          ...
          return (e = s({}, N, e)).toggle = Boolean(e.toggle), a.typeCheckConfig(W, e, H), e
          ...
          i.length && t(i).toggleClass(X, !n).attr("aria-expanded", n)
          ...
          return this.each((function () {
            var n = t(this),
              o = n.data(R),
              r = s({}, N, n.data(), "object" == typeof i && i ? i : {});
            if (!o && r.toggle && /show|hide/.test(i) && (r.toggle = !1), o || (o = new e(this, r), n.data(R, o)), "string" == typeof i) {
    ...
    t(document).on(B.CLICK_DATA_API, J, (function (e) {
      ...
      return t.fn[W] = $, V._jQueryInterface
    };
    var K = "dropdown",
      Z = "bs.dropdown",
      ee = "." + Z,
      ...
      he = function () {
        ...
        return n.toggle = function () {
          ...
          return e = s({}, this.constructor.Default, t(this._element).data(), e), a.typeCheckConfig(K, e, this.constructor.DefaultType), e
            ...
            for (var n = [].slice.call(document.querySelectorAll(le)), o = 0, s = n.length; o < s; o++) {
              ...
              if (i && "click" === i.type && (l.clickEvent = i), a) {
                ...
                if (t(r).hasClass(re) && !(i && ("click" === i.type && /input|textarea/i.test(i.target.tagName) || "keyup" === i.type && 9 === i.which) && t.contains(r, i.target))) {
                  ...
                  t(r).trigger(d), d.isDefaultPrevented() || ("ontouchstart" in document.documentElement && t(document.body).children().off("mouseover", null, t.noop), n[o].setAttribute("aria-expanded", "false"), t(c).removeClass(re), t(r).removeClass(re).trigger(t.Event(oe.HIDDEN, l)))
                }
              }
            }
    ...
    t(document).on(oe.KEYDOWN_DATA_API, le, he._dataApiKeydownHandler).on(oe.KEYDOWN_DATA_API, ce, he._dataApiKeydownHandler).on(oe.CLICK_DATA_API + " " + oe.KEYUP_DATA_API, he._clearMenus).on(oe.CLICK_DATA_API, le, (function (e) {
      ...
      e.stopPropagation()
    })), t.fn[K] = he._jQueryInterface, t.fn[K].Constructor = he, t.fn[K].noConflict = function () {
      return t.fn[K] = ie, he._jQueryInterface
    };
    var fe = "modal",
      pe = "bs.modal",
      me = "." + pe,
      ...
      Se = function () {
        ...
        return i.toggle = function (e) {
          ...
          if (!this._isShown && !this._isTransitioning) {
            ...
            var n = t.Event(_e.SHOW, {
              relatedTarget: e
            });
            t(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(_e.CLICK_DISMISS, '[data-dismiss="modal"]', (function (e) {
              return i.hide(e)
            })), t(this._dialog).on(_e.MOUSEDOWN_DISMISS, (function () {
              t(i._element).one(_e.MOUSEUP_DISMISS, (function (e) {
          ...
          if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
            var n = t.Event(_e.HIDE);
            if (t(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
              this._isShown = !1;
              var o = t(this._element).hasClass(we);
              if (o && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), t(document).off(_e.FOCUSIN), t(this._element).removeClass(ke), t(this._element).off(_e.CLICK_DISMISS), t(this._dialog).off(_e.MOUSEDOWN_DISMISS), o) {
          ...
          return e = s({}, ve, e), a.typeCheckConfig(fe, e, ye), e
        }, i._showElement = function (e) {
          var i = this,
            n = t(this._element).hasClass(we);
          this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), t(this._dialog).hasClass("modal-dialog-scrollable") ? this._dialog.querySelector(".modal-body").scrollTop = 0 : this._element.scrollTop = 0, n && a.reflow(this._element), t(this._element).addClass(ke), this._config.focus && this._enforceFocus();
          ...
          var e = this;
          t(document).off(_e.FOCUSIN).on(_e.FOCUSIN, (function (i) {
          ...
          if (this._isShown && this._config.backdrop) {
            if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", n && this._backdrop.classList.add(n), t(this._backdrop).appendTo(document.body), t(this._element).on(_e.CLICK_DISMISS, (function (e) {
              ...
              })), n && a.reflow(this._backdrop), t(this._backdrop).addClass(ke), !e) return;
            if (!n) return void e();
            var o = a.getTransitionDurationFromElement(this._backdrop);
            t(this._backdrop).one(a.TRANSITION_END, e).emulateTransitionEnd(o)
          } else if (!this._isShown && this._backdrop) {
            t(this._backdrop).removeClass(ke);
            var s = function () {
          ...
          return this.each((function () {
            ...
            if (o || (o = new e(this, r), t(this).data(pe, o)), "string" == typeof i) {
              if (void 0 === o[i]) throw new TypeError('No method named "' + i + '"');
              o[i](n)
    ...
    t(document).on(_e.CLICK_DATA_API, '[data-toggle="modal"]', (function (e) {
      ...
      var r = t(i).data(pe) ? "toggle" : s({}, t(i).data(), t(this).data());
      "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
      var l = t(i).one(_e.SHOW, (function (e) {
        e.isDefaultPrevented() || l.one(_e.HIDDEN, (function () {
          t(n).is(":visible") && n.focus()
        }))
      }));
      Se._jQueryInterface.call(t(i), r, this)
    })), t.fn[fe] = Se._jQueryInterface, t.fn[fe].Constructor = Se, t.fn[fe].noConflict = function () {
      return t.fn[fe] = ge, Se._jQueryInterface
    };
      ...
      for (var n = (new window.DOMParser).parseFromString(e, "text/html"), o = Object.keys(t), s = [].slice.call(n.body.querySelectorAll("*")), r = function (e, i) {
          ...
          a.forEach((function (e) {
            (function (e, t) {
              ...
              if (-1 !== t.indexOf(i)) return -1 === Ce.indexOf(i) || Boolean(e.nodeValue.match(De) || e.nodeValue.match(Oe));
      ...
      Ge = function () {
        ...
        return n.enable = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            r.setAttribute("id", l), this.element.setAttribute("aria-describedby", l), this.setContent(), this.config.animation && t(r).addClass(He);
            ...
            var h = function () {
              ...
              var i = e._hoverState;
              e._hoverState = null, t(e.element).trigger(e.constructor.Event.SHOWN), i === $e && e._leave(null, e)
            };
            if (t(this.tip).hasClass(He)) {
          ...
          var i = this,
            ...
            s = function () {
              i._hoverState !== qe && n.parentNode && n.parentNode.removeChild(n), i._cleanTipClass(), i.element.removeAttribute("aria-describedby"), t(i.element).trigger(i.constructor.Event.HIDDEN), null !== i._popper && i._popper.destroy(), e && e()
            };
          if (t(this.element).trigger(o), !o.isDefaultPrevented()) {
            if (t(n).removeClass(Be), "ontouchstart" in document.documentElement && t(document.body).children().off("mouseover", null, t.noop), this._activeTrigger.click = !1, this._activeTrigger[Ue] = !1, this._activeTrigger[Ye] = !1, t(this.tip).hasClass(He)) {
          ...
          this.setElementContent(t(e.querySelectorAll(".tooltip-inner")), this.getTitle()), t(e).removeClass(He + " " + Be)
        }, n.setElementContent = function (e, i) {
          "object" != typeof i || !i.nodeType && !i.jquery ? this.config.html ? (this.config.sanitize && (i = Ee(i, this.config.whiteList, this.config.sanitizeFn)), e.html(i)) : e.text(i) : this.config.html ? t(i).parent().is(e) || e.empty().append(i) : e.text(t(i).text())
        }, n.getTitle = function () {
          ...
          (i = i || t(e.currentTarget).data(n)) || (i = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(n, i)), e && (i._activeTrigger["focusin" === e.type ? Ue : Ye] = !0), t(i.getTipElement()).hasClass(Be) || i._hoverState === qe ? i._hoverState = qe : (clearTimeout(i._timeout), i._hoverState = qe, i.config.delay && i.config.delay.show ? i._timeout = setTimeout((function () {
            i._hoverState === qe && i.show()
          }), i.config.delay.show) : i.show())
        }, n._leave = function (e, i) {
          var n = this.constructor.DATA_KEY;
          (i = i || t(e.currentTarget).data(n)) || (i = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(n, i)), e && (i._activeTrigger["focusout" === e.type ? Ue : Ye] = !1), i._isWithActiveTrigger() || (clearTimeout(i._timeout), i._hoverState = $e, i.config.delay && i.config.delay.hide ? i._timeout = setTimeout((function () {
            i._hoverState === $e && i.hide()
          ...
          return Object.keys(i).forEach((function (e) {
            -1 !== Le.indexOf(e) && delete i[e]
          })), "number" == typeof (e = s({}, this.constructor.Default, i, "object" == typeof e && e ? e : {})).delay && (e.delay = {
            show: e.delay,
            hide: e.delay
          }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), a.typeCheckConfig(je, e, this.constructor.DefaultType), e.sanitize && (e.template = Ee(e.template, e.whiteList, e.sanitizeFn)), e
          ...
          null === e.getAttribute("x-placement") && (t(e).removeClass(He), this.config.animation = !1, this.hide(), this.show(), this.config.animation = i)
        }, e._jQueryInterface = function (i) {
          return this.each((function () {
            var n = t(this).data(Ie),
              o = "object" == typeof i && i;
            if ((n || !/dispose|hide/.test(i)) && (n || (n = new e(this, o), t(this).data(Ie, n)), "string" == typeof i)) {
              if (void 0 === n[i]) throw new TypeError('No method named "' + i + '"');
              n[i]()
            }
          }))
    ...
    t.fn[je] = Ge._jQueryInterface, t.fn[je].Constructor = Ge, t.fn[je].noConflict = function () {
      return t.fn[je] = Ae, Ge._jQueryInterface
    };
    var Xe = "popover",
      Qe = "bs.popover",
      Je = "." + Qe,
      ...
      nt = function (e) {
        ...
        return r.isWithContent = function () {
          ...
          return this.each((function () {
            ...
            if ((i || !/dispose|hide/.test(e)) && (i || (i = new s(this, n), t(this).data(Qe, i)), "string" == typeof e)) {
    ...
    t.fn[Xe] = nt._jQueryInterface, t.fn[Xe].Constructor = nt, t.fn[Xe].noConflict = function () {
      return t.fn[Xe] = Ve, nt._jQueryInterface
    };
    var ot = "scrollspy",
      st = "bs.scrollspy",
      rt = "." + st,
      ...
      gt = function () {
        function e(e, i) {
          var n = this;
          this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(i), this._selector = this._config.target + " " + ft + "," + this._config.target + " " + pt + "," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, t(this._scrollElement).on(dt.SCROLL, (function (e) {
            return n._process(e)
        ...
        return i.refresh = function () {
          var e = this,
            i = this._scrollElement === this._scrollElement.window ? "offset" : mt,
            n = "auto" === this._config.method ? i : this._config.method,
            o = n === mt ? this._getScrollTop() : 0;
          ...
          n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(ut), n.addClass(ut)) : (n.addClass(ut), n.parents(ht).prev(ft + ", " + pt).addClass(ut), n.parents(ht).prev(".nav-item").children(ft).addClass(ut)), t(this._scrollElement).trigger(dt.ACTIVATE, {
            relatedTarget: e
          })
        }, i._clear = function () {
    ...
    })), t.fn[ot] = gt._jQueryInterface, t.fn[ot].Constructor = gt, t.fn[ot].noConflict = function () {
      return t.fn[ot] = at, gt._jQueryInterface
    };
    var vt = "bs.tab",
      yt = "." + vt,
      _t = t.fn.tab,
      ...
      Ct = function () {
        ...
        return i.show = function () {
          var e = this;
          if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(wt) || t(this._element).hasClass("disabled"))) {
            var i, n, o = t(this._element).closest(".nav, .list-group")[0],
              s = a.getSelectorFromElement(this._element);
            if (o) {
              var r = "UL" === o.nodeName || "OL" === o.nodeName ? St : Tt;
              n = (n = t.makeArray(t(o).find(r)))[n.length - 1]
            }
            var l = t.Event(bt.HIDE, {
                relatedTarget: this._element
              }),
              c = t.Event(bt.SHOW, {
                relatedTarget: n
          ...
          var o = this,
            s = (!i || "UL" !== i.nodeName && "OL" !== i.nodeName ? t(i).children(Tt) : t(i).find(St))[0],
            r = n && s && t(s).hasClass(kt),
            l = function () {
              return o._transitionComplete(e, s, n)
            };
          if (s && r) {
            var c = a.getTransitionDurationFromElement(s);
            t(s).removeClass(xt).one(a.TRANSITION_END, l).emulateTransitionEnd(c)
          } else l()
          ...
          if (t(e).addClass(wt), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), a.reflow(e), e.classList.contains(kt) && e.classList.add(xt), e.parentNode && t(e.parentNode).hasClass("dropdown-menu")) {
          ...
          return this.each((function () {
            var n = t(this),
              o = n.data(vt);
            if (o || (o = new e(this), n.data(vt, o)), "string" == typeof i) {
              if (void 0 === o[i]) throw new TypeError('No method named "' + i + '"');
              o[i]()
            }
          }))
    ...
    t(document).on(bt.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', (function (e) {
    ...
    var Dt = "toast",
      ...
      Ft = function () {
        ...
        return i.show = function () {
          ...
          var i = function () {
            e._element.classList.remove(Mt), e._element.classList.add(At), t(e._element).trigger(It.SHOWN), e._config.autohide && e.hide()
          };
          if (this._element.classList.remove(Pt), this._element.classList.add(Mt), this._config.animation) {
            var n = a.getTransitionDurationFromElement(this._element);
            t(this._element).one(a.TRANSITION_END, i).emulateTransitionEnd(n)
          } else i()
        }, i.hide = function (e) {
          var i = this;
          this._element.classList.contains(At) && (t(this._element).trigger(It.HIDE), e ? this._close() : this._timeout = setTimeout((function () {
            i._close()
          }), this._config.delay))
        }, i.dispose = function () {
          clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(At) && this._element.classList.remove(At), t(this._element).off(It.CLICK_DISMISS), t.removeData(this._element, Ot), this._element = null, this._config = null
        }, i._getConfig = function (e) {
          return e = s({}, Lt, t(this._element).data(), "object" == typeof e && e ? e : {}), a.typeCheckConfig(Dt, e, this.constructor.DefaultType), e
          ...
          var e = this,
            i = function () {
              e._element.classList.add(Pt), t(e._element).trigger(It.HIDDEN)
            };
          ...
          return this.each((function () {
            var n = t(this),
              o = n.data(Ot);
            if (o || (o = new e(this, "object" == typeof i && i), n.data(Ot, o)), "string" == typeof i) {
              if (void 0 === o[i]) throw new TypeError('No method named "' + i + '"');
              o[i](this)
            }
          }))
    ...
    t.fn[Dt] = Ft._jQueryInterface, t.fn[Dt].Constructor = Ft, t.fn[Dt].noConflict = function () {
        return t.fn[Dt] = jt, Ft._jQueryInterface
      },
      function () {
        if (void 0 === t) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
        var e = t.fn.jquery.split(" ")[0].split(".");
        if (e[0] < 2 && e[1] < 9 || 1 === e[0] && 9 === e[1] && e[2] < 1 || 4 <= e[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
      }(), e.Util = a, e.Alert = f, e.Button = x, e.Carousel = F, e.Collapse = V, e.Dropdown = he, e.Modal = Se, e.Popover = nt, e.Scrollspy = gt, e.Tab = Ct, e.Toast = Ft, e.Tooltip = Ge, Object.defineProperty(e, "__esModule", {
        value: !0
      })
  })), "object" == typeof LS_Meta && LS_Meta.fixGSAP) {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push((function () {
    "use strict";
    var e, t, i, n, o, s, r, a, l, c, d, u, h, f, p, m;
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], (function (e, t, i) {
        var n = function (e) {
          ...
          s = function (e) {
            ...
            return function (e, c, d) {
              var u, h, f, p, m, g, v, y, _, b = (d || t).length,
                w = s[b];
              if (!w) {
                if (!(_ = "auto" === t.grid ? 0 : (t.grid || [1 / 0])[0])) {
                  for (v = -1 / 0; v < (v = d[_++].getBoundingClientRect().left) && b > _;);
                  _--
                }
                for (w = s[b] = [], u = r ? Math.min(_, b) * l - .5 : n % _, h = r ? b * l / _ - .5 : n / _ | 0, v = 0, y = 1 / 0, g = 0; b > g; g++) f = g % _ - u, p = h - (g / _ | 0), w[g] = m = a ? Math.abs("y" === a ? p : f) : Math.sqrt(f * f + p * p), m > v && (v = m), y > m && (y = m);
                w.max = v - y, w.min = y, w.v = b = t.amount || t.each * (_ > b ? b - 1 : a ? "y" === a ? b / _ : _ : Math.max(_, b / _)) || 0, w.b = 0 > b ? o - b : o
              }
        ...
        r.version = "2.1.3", u.constructor = r, u.kill()._gc = !1, r.killTweensOf = r.killDelayedCallsTo = i.killTweensOf, r.getTweensOf = i.getTweensOf, r.lagSmoothing = i.lagSmoothing, r.ticker = i.ticker, r.render = i.render, r.distribute = s, u.invalidate = function () {
          ...
          if (o._initted || r)
            ...
            else if (o._gc && o._enabled(!0, !1), o._notifyPluginsOfEnabled && o._firstPT && i._onPluginEvent("_onDisable", o), o._time / o._duration > .998) {
            var a = o._totalTime;
            o.render(0, !0, !1), o._initted = !1, o.render(a, !0, !1)
          } else if (o._initted = !1, o._init(), o._time > 0 || r)
            for (var l, c = 1 / (1 - s), d = o._firstPT; d;) l = d.s + d.c, d.c *= c, d.s = l - d.c, d = d._next;
          return o
        }, u.render = function (e, t, n) {
          this._initted || 0 === this._duration && this.vars.repeat && this.invalidate();
          var o, s, r, c, d, u, h, f, p, m = this,
            ...
            b = m._duration,
            w = m._rawPrevTime;
          if (e >= g - a && e >= 0 ? (m._totalTime = g, m._cycle = m._repeat, m._yoyo && 0 != (1 & m._cycle) ? (m._time = 0, m.ratio = m._ease._calcEnd ? m._ease.getRatio(0) : 0) : (m._time = b, m.ratio = m._ease._calcEnd ? m._ease.getRatio(1) : 1), m._reversed || (o = !0, s = "onComplete", n = n || m._timeline.autoRemoveChildren), 0 === b && (m._initted || !m.vars.lazy || n) && (m._startTime === m._timeline._duration && (e = 0), (0 > w || 0 >= e && e >= -a || w === a && "isPause" !== m.data) && w !== e && (n = !0, w > a && (s = "onReverseComplete")), m._rawPrevTime = f = !t || e || w === e ? e : a)) : a > e ? (m._totalTime = m._time = m._cycle = 0, m.ratio = m._ease._calcEnd ? m._ease.getRatio(0) : 0, (0 !== y || 0 === b && w > 0) && (s = "onReverseComplete", o = m._reversed), e > -a ? e = 0 : 0 > e && (m._active = !1, 0 === b && (m._initted || !m.vars.lazy || n) && (w >= 0 && (n = !0), m._rawPrevTime = f = !t || e || w === e ? e : a)), m._initted || (n = !0)) : (m._totalTime = m._time = e, 0 !== m._repeat && (c = b + m._repeatDelay, m._cycle = m._totalTime / c >> 0, 0 !== m._cycle && m._cycle === m._totalTime / c && e >= y && m._cycle--, m._time = m._totalTime - m._cycle * c, m._yoyo && 0 != (1 & m._cycle) && (m._time = b - m._time, (p = m._yoyoEase || m.vars.yoyoEase) && (m._yoyoEase || (!0 !== p || m._initted ? m._yoyoEase = p = !0 === p ? m._ease : p instanceof Ease ? p : Ease.map[p] : (p = m.vars.ease, m._yoyoEase = p = p ? p instanceof Ease ? p : "function" == typeof p ? new Ease(p, m.vars.easeParams) : Ease.map[p] || i.defaultEase : i.defaultEase)), m.ratio = p ? 1 - p.getRatio((b - m._time) / b) : 0)), m._time > b ? m._time = b : m._time < 0 && (m._time = 0)), m._easeType && !p ? (d = m._time / b, (1 === (u = m._easeType) || 3 === u && d >= .5) && (d = 1 - d), 3 === u && (d *= 2), 1 === (h = m._easePower) ? d *= d : 2 === h ? d *= d * d : 3 === h ? d *= d * d * d : 4 === h && (d *= d * d * d * d), m.ratio = 1 === u ? 1 - d : 2 === u ? d : m._time / b < .5 ? d / 2 : 1 - d / 2) : p || (m.ratio = m._ease.getRatio(m._time / b))), v !== m._time || n || _ !== m._cycle) {
            if (!m._initted) {
              if (m._init(), !m._initted || m._gc) return;
              if (!n && m._firstPT && (!1 !== m.vars.lazy && m._duration || m.vars.lazy && !m._duration)) return m._time = v, m._totalTime = y, m._rawPrevTime = w, m._cycle = _, l.lazyTweens.push(m), void(m._lazy = [e, t]);
              !m._time || o || p ? o && this._ease._calcEnd && !p && (m.ratio = m._ease.getRatio(0 === m._time ? 0 : 1)) : m.ratio = m._ease.getRatio(m._time / b)
            }
            for (!1 !== m._lazy && (m._lazy = !1), m._active || !m._paused && m._time !== v && e >= 0 && (m._active = !0), 0 === y && (2 === m._initted && e > 0 && m._init(), m._startAt && (e >= 0 ? m._startAt.render(e, !0, n) : s || (s = "_dummyGS")), m.vars.onStart && (0 !== m._totalTime || 0 === b) && (t || m._callback("onStart"))), r = m._firstPT; r;) r.f ? r.t[r.p](r.c * m.ratio + r.s) : r.t[r.p] = r.c * m.ratio + r.s, r = r._next;
            m._onUpdate && (0 > e && m._startAt && m._startTime && m._startAt.render(e, !0, n), t || (m._totalTime !== y || s) && m._callback("onUpdate")), m._cycle !== _ && (t || m._gc || m.vars.onRepeat && m._callback("onRepeat")), s && (!m._gc || n) && (0 > e && m._startAt && !m._onUpdate && m._startTime && m._startAt.render(e, !0, n), o && (m._timeline.autoRemoveChildren && m._enabled(!1, !1), m._active = !1), !t && m.vars[s] && m._callback(s), 0 === b && m._rawPrevTime === a && f !== a && (m._rawPrevTime = 0))
        ...
        }, r.staggerTo = r.allTo = function (e, t, a, l, u, f, p) {
          var m, g, v, y, _ = [],
            b = s(a.stagger || l),
            w = a.cycle,
            k = (a.startAt || h).cycle;
          for (d(e) || ("string" == typeof e && (e = i.selector(e) || e), c(e) && (e = n(e))), m = (e = e || []).length - 1, v = 0; m >= v; v++) {
            for (y in g = {}, a) g[y] = a[y];
            if (w && (o(g, e, v), null != g.duration && (t = g.duration, delete g.duration)), k) {
              for (y in k = g.startAt = {}, a.startAt) k[y] = a.startAt[y];
              o(g.startAt, e, v)
            }
            g.delay = b(v, e[v], e) + (g.delay || 0), v === m && u && (g.onComplete = function () {
              a.onComplete && a.onComplete.apply(a.onCompleteScope || this, arguments), u.apply(p || a.callbackScope || this, f || h)
            }), _[v] = new r(e[v], t, g)
          }
          return _
        ...
        var f = function (e, t) {
            for (var n = [], o = 0, s = e._first; s;) s instanceof i ? n[o++] = s : (t && (n[o++] = s), o = (n = n.concat(f(s, t))).length), s = s._next;
            return n
          },
        ...
        r.killAll = function (e, i, n, o) {
          ...
          if (null != e) {
            var o, s, a, u, h, f = l.tweenLookup;
            if ("string" == typeof e && (e = i.selector(e) || e), c(e) && (e = n(e)), d(e))
              for (u = e.length; --u > -1;) r.killChildTweensOf(e[u], t);
            else {
              for (a in o = [], f)
                for (s = f[a].target.parentNode; s;) s === e && (o = o.concat(f[a].tweens)), s = s.parentNode;
              for (h = o.length, u = 0; h > u; u++) t && o[u].totalTime(o[u].totalDuration()), o[u]._enabled(!1, !1)
            }
          }
        };
        var m = function (e, i, n, o) {
          i = !1 !== i, n = !1 !== n;
          for (var s, r, a = p(o = !1 !== o), l = i && n && o, c = a.length; --c > -1;) r = a[c], (l || r instanceof t || (s = r.target === r.vars.onComplete) && n || i && !s) && r.paused(e)
        };
        return r.pauseAll = function (e, t, i) {
          ...
          return e > i && (e = i), this.totalTime(this._yoyo && 1 & n ? i - e + o : this._repeat ? e + o : e, t)
        ...
        var n = function (e) {
            ...
            var i, n, o = this,
              s = o.vars;
            for (n in o._labels = {}, o.autoRemoveChildren = !!s.autoRemoveChildren, o.smoothChildTiming = !!s.smoothChildTiming, o._sortChildren = !0, o._onUpdate = s.onUpdate, s) i = s[n], l(i) && -1 !== i.join("").indexOf("{self}") && (s[n] = o._swapSelfInParams(i));
            l(s.tweens) && o.add(s.tweens, 0, s.align, s.stagger)
          },
          o = 1e-8,
          s = i._internals,
          r = n._internals = {},
          ...
          v = n.prototype = new t;
        return n.version = "2.1.3", n.distribute = g, v.constructor = n, v.kill()._gc = v._forcingPlayhead = v._hasPause = !1, v.to = function (e, t, n, o) {
          var s = n.repeat && u.TweenMax || i;
          return t ? this.add(new s(e, t, n), o) : this.set(e, n, o)
        }, v.from = function (e, t, n, o) {
          return this.add((n.repeat && u.TweenMax || i).from(e, t, m(0, n)), o)
        }, v.fromTo = function (e, t, n, o, s) {
          var r = o.repeat && u.TweenMax || i;
          return o = m(0, o, n), t ? this.add(r.fromTo(e, t, n, o), s) : this.set(e, o, s)
        }, v.staggerTo = function (e, t, o, s, r, l, c, d) {
          var u, p, m = new n({
              onComplete: l,
              onCompleteParams: c,
              callbackScope: d,
            ...
            y = o.startAt,
            _ = o.cycle;
          for ("string" == typeof e && (e = i.selector(e) || e), a(e = e || []) && (e = function (e) {
              var t, i = [],
                n = e.length;
              for (t = 0; t !== n; i.push(e[t++]));
              return i
            }(e)), p = 0; p < e.length; p++) u = h(o), y && (u.startAt = h(y), y.cycle && f(u.startAt, e, p)), _ && (f(u, e, p), null != u.duration && (t = u.duration, delete u.duration)), m.to(e[p], t, u, v(p, e[p], e));
          return this.add(m, r)
        }, v.staggerFrom = function (e, t, i, n, o, s, r, a) {
          return i.runBackwards = !0, this.staggerTo(e, t, m(0, i), n, o, s, r, a)
        }, v.staggerFromTo = function (e, t, i, n, o, s, r, a, l) {
          return n.startAt = i, this.staggerTo(e, t, m(0, n, i), o, s, r, a, l)
          ...
          var o, s, r, a, l = new n(e),
            c = l._timeline;
          for (null == t && (t = !0), c._remove(l, !0), l._startTime = 0, l._rawPrevTime = l._time = l._totalTime = c._time, r = c._first; r;) a = r._next, t && r instanceof i && r.target === r.vars.onComplete || (0 > (s = r._startTime - r._delay) && (o = 1), l.add(r, s)), r = a;
          return c.add(l, 0), o && l.totalDuration(), l
        }, v.add = function (o, s, r, a) {
          var c, d, u, h, f, p, m = this;
          if ("number" != typeof s && (s = m._parseTimeOrLabel(s, 0, !0, o)), !(o instanceof e)) {
            if (o instanceof Array || o && o.push && l(o)) {
              for (r = r || "normal", a = a || 0, c = s, d = o.length, u = 0; d > u; u++) l(h = o[u]) && (h = new n({
                tweens: h
              })), m.add(h, c), "string" != typeof h && "function" != typeof h && ("sequence" === r ? c = h._startTime + h.totalDuration() / h._timeScale : "start" === r && (h._startTime -= h.delay())), c += a;
              return m._uncache(!0)
            }
          ...
          if (t.prototype.add.call(m, o, s), (o._time || !o._duration && o._initted) && (c = (m.rawTime() - o._startTime) * o._timeScale, (!o._duration || Math.abs(Math.max(0, Math.min(o.totalDuration(), c))) - o._totalTime > 1e-5) && o.render(c, !1, !1)), (m._gc || m._time === m._duration) && !m._paused && m._duration < m.duration())
            for (p = (f = m).rawTime() > o._startTime; f._timeline;) p && f._timeline.smoothChildTiming ? f.totalTime(f._totalTime, !0) : f._gc && f._enabled(!0, !1), f = f._timeline;
          return m
        }, v.remove = function (t) {
          if (t instanceof e) {
            this._remove(t, !1);
          ...
          var s = i.delayedCall(0, p, n, o || this);
          ...
          if (m !== p._time && (e += p._time - m), p._hasPause && !p._forcingPlayhead && !t) {
            if (e > m)
              for (n = p._first; n && n._startTime <= e && !u;) n._duration || "isPause" !== n.data || n.ratio || 0 === n._startTime && 0 === p._rawPrevTime || (u = n), n = n._next;
            else
              for (n = p._last; n && n._startTime >= e && !u;) n._duration || "isPause" === n.data && n._rawPrevTime > 0 && (u = n), n = n._prev;
            u && (p._time = p._totalTime = e = u._startTime, f = p._startTime + (p._reversed ? p._duration - e : e) / p._timeScale)
          }
          if (e >= g - o && e >= 0) p._totalTime = p._time = g, p._reversed || p._hasPausedChild() || (s = !0, a = "onComplete", l = !!p._timeline.autoRemoveChildren, 0 === p._duration && (0 >= e && e >= -o || p._rawPrevTime < 0 || p._rawPrevTime === o) && p._rawPrevTime !== e && p._first && (l = !0, p._rawPrevTime > o && (a = "onReverseComplete"))), p._rawPrevTime = p._duration || !t || e || p._rawPrevTime === e ? e : o, e = g + 1e-4;
          else if (o > e)
            if (p._totalTime = p._time = 0, e > -o && (e = 0), (0 !== m || 0 === p._duration && p._rawPrevTime !== o && (p._rawPrevTime > 0 || 0 > e && p._rawPrevTime >= 0)) && (a = "onReverseComplete", s = p._reversed), 0 > e) p._active = !1, p._timeline.autoRemoveChildren && p._reversed ? (l = s = !0, a = "onReverseComplete") : p._rawPrevTime >= 0 && p._first && (l = !0), p._rawPrevTime = e;
            else {
              if (p._rawPrevTime = p._duration || !t || e || p._rawPrevTime === e ? e : o, 0 === e && s)
                for (n = p._first; n && 0 === n._startTime;) n._duration || (s = !1), n = n._next;
              e = 0, p._initted || (l = !0)
            }
          ...
          if (p._time !== m && p._first || i || l || u) {
            if (p._initted || (p._initted = !0), p._active || !p._paused && p._time !== m && e > 0 && (p._active = !0), 0 === m && p.vars.onStart && (0 === p._time && p._duration || t || p._callback("onStart")), (h = p._time) >= m)
              for (n = p._first; n && (r = n._next, h === p._time && (!p._paused || _));)(n._active || n._startTime <= h && !n._paused && !n._gc) && (u === n && (p.pause(), p._pauseTime = f), n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)), n = r;
            else
              for (n = p._last; n && (r = n._prev, h === p._time && (!p._paused || _));) {
                if (n._active || n._startTime <= m && !n._paused && !n._gc) {
                  if (u === n) {
                    for (u = n._prev; u && u.endTime() > p._time;) u.render(u._reversed ? u.totalDuration() - (e - u._startTime) * u._timeScale : (e - u._startTime) * u._timeScale, t, i), u = u._prev;
                    u = null, p.pause(), p._pauseTime = f
                  }
                  n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)
                }
                n = r
              }
            p._onUpdate && (t || (c.length && d(), p._callback("onUpdate"))), a && (p._gc || (v === p._startTime || y !== p._timeScale) && (0 === p._time || g >= p.totalDuration()) && (s && (c.length && d(), p._timeline.autoRemoveChildren && p._enabled(!1, !1), p._active = !1), !t && p.vars[a] && p._callback(a)))
          }
          ...
          var n, o, s = this._gc,
            r = [],
            a = 0;
          for (s && this._enabled(!0, !0), o = (n = i.getTweensOf(e)).length; --o > -1;)(n[o].timeline === this || t && this._contains(n[o])) && (r[a++] = n[o]);
        ...
        return d.constructor = n, d.kill()._gc = !1, n.version = "2.1.3", d.invalidate = function () {
          ...
          var n, s, l, c, d, u, h, f, p, m = this,
            ...
            x = m._paused,
            T = m._cycle;
          if (g !== m._time && (e += m._time - g), e >= v - o && e >= 0) m._locked || (m._totalTime = v, m._cycle = m._repeat), m._reversed || m._hasPausedChild() || (s = !0, c = "onComplete", d = !!m._timeline.autoRemoveChildren, 0 === m._duration && (0 >= e && e >= -o || 0 > k || k === o) && k !== e && m._first && (d = !0, k > o && (c = "onReverseComplete"))), m._rawPrevTime = m._duration || !t || e || m._rawPrevTime === e ? e : o, m._yoyo && 1 & m._cycle ? m._time = e = 0 : (m._time = y, e = y + 1e-4);
          else if (o > e)
            if (m._locked || (m._totalTime = m._cycle = 0), m._time = 0, e > -o && (e = 0), (0 !== g || 0 === y && k !== o && (k > 0 || 0 > e && k >= 0) && !m._locked) && (c = "onReverseComplete", s = m._reversed), 0 > e) m._active = !1, m._timeline.autoRemoveChildren && m._reversed ? (d = s = !0, c = "onReverseComplete") : k >= 0 && m._first && (d = !0), m._rawPrevTime = e;
            else {
              if (m._rawPrevTime = y || !t || e || m._rawPrevTime === e ? e : o, 0 === e && s)
                for (n = m._first; n && 0 === n._startTime;) n._duration || (s = !1), n = n._next;
              e = 0, m._initted || (d = !0)
            }
          else 0 === y && 0 > k && (d = !0), m._time = m._rawPrevTime = e, m._locked || (m._totalTime = e, 0 !== m._repeat && (u = y + m._repeatDelay, m._cycle = m._totalTime / u >> 0, m._cycle && m._cycle === m._totalTime / u && e >= _ && m._cycle--, m._time = m._totalTime - m._cycle * u, m._yoyo && 1 & m._cycle && (m._time = y - m._time), m._time > y ? (m._time = y, e = y + 1e-4) : m._time < 0 ? m._time = e = 0 : e = m._time));
          if (m._hasPause && !m._forcingPlayhead && !t) {
            if ((e = m._time) > g || m._repeat && T !== m._cycle)
            ...
            h && (p = m._startTime + (m._reversed ? m._duration - h._startTime : h._startTime) / m._timeScale, h._startTime < y && (m._time = m._rawPrevTime = e = h._startTime, m._totalTime = e + m._cycle * (m._totalDuration + m._repeatDelay)))
          }
          if (m._cycle !== T && !m._locked) {
            var S = m._yoyo && 0 != (1 & T),
              ...
              E = m._rawPrevTime,
              j = m._time;
            if (m._totalTime = T * y, m._cycle < T ? S = !S : m._totalTime += y, m._time = g, m._rawPrevTime = 0 === y ? k - 1e-4 : k, m._cycle = T, m._locked = !0, g = S ? 0 : y, m.render(g, t, 0 === y), t || m._gc || m.vars.onRepeat && (m._cycle = O, m._locked = !1, m._callback("onRepeat")), g !== m._time) return;
            if (C && (m._cycle = T, m._locked = !0, g = S ? y + 1e-4 : -1e-4, m.render(g, !0, !1)), m._locked = !1, m._paused && !x) return;
            m._time = j, m._totalTime = D, m._cycle = O, m._rawPrevTime = E
          }
          if (m._time !== g && m._first || i || d || h) {
            if (m._initted || (m._initted = !0), m._active || !m._paused && m._totalTime !== _ && e > 0 && (m._active = !0), 0 === _ && m.vars.onStart && (0 === m._totalTime && m._totalDuration || t || m._callback("onStart")), (f = m._time) >= g)
              for (n = m._first; n && (l = n._next, f === m._time && (!m._paused || x));)(n._active || n._startTime <= m._time && !n._paused && !n._gc) && (h === n && (m.pause(), m._pauseTime = p), n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)), n = l;
            else
              for (n = m._last; n && (l = n._prev, f === m._time && (!m._paused || x));) {
            ...
            m._onUpdate && (t || (r.length && a(), m._callback("onUpdate"))), c && (m._locked || m._gc || (b === m._startTime || w !== m._timeScale) && (0 === m._time || v >= m.totalDuration()) && (s && (r.length && a(), m._timeline.autoRemoveChildren && m._enabled(!1, !1), m._active = !1), !t && m.vars[c] && m._callback(c)))
      ...
      }), !0), e = 180 / Math.PI, t = [], i = [], n = [], o = {}, s = _gsScope._gsDefine.globals, r = function (e, t, i, n) {
        ...
        var o = {
          ...
          h = (c + d) / 2,
          f = (h - u) / 8;
        return o.b = l + (e - l) / 4, s.b = u + f, o.c = s.a = (o.b + s.b) / 2, s.c = r.a = (u + h) / 2, r.b = h - f, a.b = d + (n - d) / 4, r.c = a.a = (r.b + a.b) / 2, [o, s, r, a]
      }, l = function (e, o, s, r, l) {
        var c, d, u, h, f, p, m, g, v, y, _, b, w, k = e.length - 1,
          x = 0,
          T = e[0].a;
        for (c = 0; k > c; c++) d = (f = e[x]).a, u = f.d, h = e[x + 1].d, l ? (_ = t[c], w = ((b = i[c]) + _) * o * .25 / (r ? .5 : n[c] || .5), g = u - ((p = u - (u - d) * (r ? .5 * o : 0 !== _ ? w / _ : 0)) + (((m = u + (h - u) * (r ? .5 * o : 0 !== b ? w / b : 0)) - p) * (3 * _ / (_ + b) + .5) / 4 || 0))) : g = u - ((p = u - (u - d) * o * .5) + (m = u + (h - u) * o * .5)) / 2, p += g, m += g, f.c = v = p, f.b = 0 !== c ? T : T = f.a + .6 * (f.c - f.a), f.da = u - d, f.ca = v - d, f.ba = T - d, s ? (y = a(d, T, v, u), e.splice(x, 1, y[0], y[1], y[2], y[3]), x += 4) : x++, T = m;
        (f = e[x]).b = T, f.c = T + .4 * (f.d - T), f.da = f.d - f.a, f.ca = f.c - f.a, f.ba = T - f.a, s && (y = a(f.a, T, f.c, f.d), e.splice(x, 1, y[0], y[1], y[2], y[3]))
      }, c = function (e, n, o, s) {
        var a, l, c, d, u, h, f = [];
        if (s)
          for (l = (e = [s].concat(e)).length; --l > -1;) "string" == typeof (h = e[l][n]) && "=" === h.charAt(1) && (e[l][n] = s[n] + Number(h.charAt(0) + h.substr(2)));
        if (0 > (a = e.length - 2)) return f[0] = new r(e[0][n], 0, 0, e[0][n]), f;
        for (l = 0; a > l; l++) c = e[l][n], d = e[l + 1][n], f[l] = new r(c, 0, 0, d), o && (u = e[l + 2][n], t[l] = (t[l] || 0) + (d - c) * (d - c), i[l] = (i[l] || 0) + (u - d) * (u - d));
        return f[l] = new r(e[l][n], 0, 0, e[l + 1][n]), f
      }, d = function (e, s, r, a, d, u) {
        var h, f, p, m, g, v, y, _, b = {},
          w = [],
          k = u || e[0];
        for (f in d = "string" == typeof d ? "," + d + "," : ",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,paddingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPosition_y,", null == s && (s = 1), e[0]) w.push(f);
        if (e.length > 1) {
          for (_ = e[e.length - 1], y = !0, h = w.length; --h > -1;)
            if (f = w[h], Math.abs(k[f] - _[f]) > .05) {
              y = !1;
              break
            } y && (e = e.concat(), u && e.unshift(u), e.push(e[1]), u = e[e.length - 3])
        }
        for (t.length = i.length = n.length = 0, h = w.length; --h > -1;) f = w[h], o[f] = -1 !== d.indexOf("," + f + ","), b[f] = c(e, f, o[f], u);
        for (h = t.length; --h > -1;) t[h] = Math.sqrt(t[h]), i[h] = Math.sqrt(i[h]);
        if (!a) {
          for (h = w.length; --h > -1;)
            if (o[f])
              for (v = (p = b[w[h]]).length - 1, m = 0; v > m; m++) g = p[m + 1].da / i[m] + p[m].da / t[m] || 0, n[m] = (n[m] || 0) + g * g;
          for (h = n.length; --h > -1;) n[h] = Math.sqrt(n[h])
        }
        for (h = w.length, m = r ? 4 : 1; --h > -1;) p = b[f = w[h]], l(p, s, r, a, o[f]), y && (p.splice(0, m), p.splice(p.length - m, m));
        return b
      }, u = function (e, t, i) {
        var n, o, s, a, l, c, d, u, h, f, p, m = {},
        ...
        for (c = y.length; --c > -1;) {
          for (m[h = y[c]] = l = [], f = 0, u = e.length, d = 0; u > d; d++) n = null == i ? e[d][h] : "string" == typeof (p = e[d][h]) && "=" === p.charAt(1) ? i[h] + Number(p.charAt(0) + p.substr(2)) : Number(p), v && d > 1 && u - 1 > d && (l[f++] = (n + l[f - 2]) / 2), l[f++] = n;
          for (u = f - g + 1, f = 0, d = 0; u > d; d += g) n = l[d], o = l[d + 1], s = l[d + 2], a = 2 === g ? 0 : l[d + 3], l[f++] = p = 3 === g ? new r(n, o, s, a) : new r(n, (2 * o + n) / 3, (2 * o + s) / 3, s);
          l.length = f
        }
        return m
      }, h = function (e, t, i) {
        for (var n, o, s, r, a, l, c, d, u, h, f, p = 1 / i, m = e.length; --m > -1;)
          for (s = (h = e[m]).a, r = h.d - s, a = h.c - s, l = h.b - s, n = o = 0, d = 1; i >= d; d++) n = o - (o = ((c = p * d) * c * r + 3 * (u = 1 - c) * (c * a + u * l)) * c), t[f = m * i + d - 1] = (t[f] || 0) + n * n
      }, f = function (e, t) {
        var i, n, o, s, r = [],
          a = [],
          l = 0,
        ...
        for (o = r.length, n = 0; o > n; n++) l += Math.sqrt(r[n]), f[s = n % t] = l, s === d && (c += l, u[s = n / t >> 0] = f, a[s] = c, l = 0, f = []);
        return {
          length: c,
          lengths: a,
          segments: u
        ...
        init: function (e, t, i) {
          ...
          if (this._beziers = "cubic" !== t.type && "quadratic" !== t.type && "soft" !== t.type ? d(l, isNaN(t.curviness) ? 1 : t.curviness, !1, "thruBasic" === t.type, t.correlate, a) : u(l, t.type, c), this._segCount = this._beziers[n].length, this._timeRes) {
        ...
        set: function (t) {
          var i, n, o, s, r, a, l, c, d, u, h, f = this._segCount,
            p = this._func,
            m = this._target,
            g = t !== this._startRatio;
          if (this._timeRes) {
            if (d = this._lengths, u = this._curSeg, h = t * this._length, o = this._li, h > this._l2 && f - 1 > o) {
              for (c = f - 1; c > o && (this._l2 = d[++o]) <= h;);
              this._l1 = d[o - 1], this._li = o, this._curSeg = u = this._segments[o], this._s2 = u[this._s1 = this._si = 0]
            } else if (h < this._l1 && o > 0) {
              for (; o > 0 && (this._l1 = d[--o]) >= h;);
              0 === o && h < this._l1 ? this._l1 = 0 : o++, this._l2 = d[o], this._li = o, this._curSeg = u = this._segments[o], this._s1 = u[(this._si = u.length - 1) - 1] || 0, this._s2 = u[this._si]
            }
            if (i = o, h -= this._l1, o = this._si, h > this._s2 && o < u.length - 1) {
              for (c = u.length - 1; c > o && (this._s2 = u[++o]) <= h;);
              this._s1 = u[o - 1], this._si = o
            } else if (h < this._s1 && o > 0) {
              for (; o > 0 && (this._s1 = u[--o]) >= h;);
              0 === o && h < this._s1 ? this._s1 = 0 : o++, this._s2 = u[o], this._si = o
            }
            a = 1 === t ? 1 : (o + (h - this._s1) / (this._s2 - this._s1)) * this._prec || 0
          } else a = (t - (i = 0 > t ? 0 : t >= 1 ? f - 1 : f * t >> 0) * (1 / f)) * f;
          for (n = 1 - a, o = this._props.length; --o > -1;) s = this._props[o], l = (a * a * (r = this._beziers[s][i]).da + 3 * n * (a * r.ca + n * r.ba)) * a + r.a, this._mod[s] && (l = this._mod[s](l, m)), p[s] ? m[s](l) : m[s] = l;
          if (this._autoRotate) {
            var v, y, _, b, w, k, x, T = this._autoRotate;
            for (o = T.length; --o > -1;) s = T[o][2], k = T[o][3] || 0, x = !0 === T[o][4] ? 1 : e, r = this._beziers[T[o][0]], v = this._beziers[T[o][1]], r && v && (r = r[i], v = v[i], y = r.a + (r.b - r.a) * a, y += ((b = r.b + (r.c - r.b) * a) - y) * a, b += (r.c + (r.d - r.c) * a - b) * a, _ = v.a + (v.b - v.a) * a, _ += ((w = v.b + (v.c - v.b) * a) - _) * a, w += (v.c + (v.d - v.c) * a - w) * a, l = g ? Math.atan2(w - _, b - y) * x + k : this._initialRotations[o], this._mod[s] && (l = this._mod[s](l, m)), p[s] ? m[s](l) : m[s] = l)
          }
        }
      }), m = p.prototype, p.bezierThrough = d, p.cubicToQuadratic = a, p._autoCSS = !0, p.quadraticToCubic = function (e, t, i) {
          ...
          t._registerComplexSpecialProp("bezier", {
            parser: function (e, t, s, r, a, l) {
              ...
              var c, d, u, h = t.values,
                ...
                g = {};
              if (0 > f) return a;
              for (c = 0; f >= c; c++) u = i(e, h[c], r, a, l, f !== c), m[c] = u.end;
              for (d in t) g[d] = t[d];
              return g.values = m, (a = new o(e, "bezier", 0, 0, u.pt, 2)).data = u, a.plugin = l, a.setRatio = n, 0 === g.autoRotate && (g.autoRotate = !0), !g.autoRotate || g.autoRotate instanceof Array || (c = !0 === g.autoRotate ? 0 : Number(g.autoRotate), g.autoRotate = null != u.end.left ? [
        ...
        c.constructor = r, r.version = "2.1.3", r.API = 2, r.defaultTransformPerspective = 0, r.defaultSkewType = "compensated", r.defaultSmoothOrigin = !0, c = "px", r.suffixMap = {
          top: c,
          right: c,
          bottom: c,
          left: c,
        ...
        var d, u, h, f, p, m, g, v, y = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
          ...
          N = function (e, t) {
            var i = $.createElementNS ? $.createElementNS(t || "http://www.w3.org/1999/xhtml", e) : $.createElement(e);
            return i.style ? i : $.createElement(e)
          },
          H = N("div"),
          B = N("img"),
          Y = r._internals = {
          ...
          G = function () {
            var e = U.indexOf("Android"),
              t = N("a");
            return h = -1 !== U.indexOf("Safari") && -1 === U.indexOf("Chrome") && (-1 === e || parseFloat(U.substr(e + 8, 2)) > 3), p = h && parseFloat(U.substr(U.indexOf("Version/") + 8, 2)) < 6, f = -1 !== U.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(U) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(U)) && (m = parseFloat(RegExp.$1)), !!t && (t.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(t.style.opacity))
          }(),
          X = function (e) {
          ...
          V = "",
          K = function (e, t) {
            var i, n, o = (t = t || H).style;
            if (void 0 !== o[e]) return e;
            for (e = e.charAt(0).toUpperCase() + e.substr(1), i = ["O", "Moz", "ms", "Ms", "Webkit"], n = 5; --n > -1 && void 0 === o[i[n] + e];);
            return n >= 0 ? (J = "-" + (V = 3 === n ? "ms" : i[n]).toLowerCase() + "-", V + e) : null
          },
          Z = "undefined" != typeof window ? window : $.defaultView || {
            getComputedStyle: function () {}
          },
          ee = function (e) {
            return Z.getComputedStyle(e)
          },
          te = r.getStyle = function (e, t, i, n, o) {
            var s;
            return G || "opacity" !== t ? (!n && e.style[t] ? s = e.style[t] : (i = i || ee(e)) ? s = i[t] || i.getPropertyValue(t) || i.getPropertyValue(t.replace(O, "-$1").toLowerCase()) : e.currentStyle && (s = e.currentStyle[t]), null == o || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : o) : X(e)
          },
          ie = Y.convertToPixels = function (e, i, n, o, s) {
            if ("px" === o || !o && "lineHeight" !== i) return n;
            if ("auto" === o || !n) return 0;
            var a, l, c, d = P.test(i),
              u = e,
              h = H.style,
              f = 0 > n,
              p = 1 === n;
            if (f && (n = -n), p && (n *= 100), "lineHeight" !== i || o)
              if ("%" === o && -1 !== i.indexOf("border")) a = n / 100 * (d ? e.clientWidth : e.clientHeight);
              else {
                if (h.cssText = "border:0 solid red;position:" + te(e, "position") + ";line-height:0;", "%" !== o && u.appendChild && "v" !== o.charAt(0) && "rem" !== o) h[d ? "borderLeftWidth" : "borderTopWidth"] = n + o;
                else {
                  if (u = e.parentNode || $.body, -1 !== te(u, "display").indexOf("flex") && (h.position = "absolute"), l = u._gsCache, c = t.ticker.frame, l && d && l.time === c) return l.width * n / 100;
                  h[d ? "width" : "height"] = n + o
                }
                u.appendChild(H), a = parseFloat(H[d ? "offsetWidth" : "offsetHeight"]), u.removeChild(H), d && "%" === o && !1 !== r.cacheWidths && ((l = u._gsCache = u._gsCache || {}).time = c, l.width = a / n * 100), 0 !== a || s || (a = ie(e, i, n, o, !0))
              }
            else l = ee(e).lineHeight, e.style.lineHeight = n, a = parseFloat(ee(e).lineHeight), e.style.lineHeight = l;
          ...
          ne = Y.calculateOffset = function (e, t, i) {
            ...
            var n = "left" === t ? "Left" : "Top",
              o = te(e, "margin" + n, i);
            return e["offset" + n] - (ie(e, t, parseFloat(o), o.replace(x, "")) || 0)
          },
          oe = function (e, t) {
            var i, n, o, s = {};
            if (t = t || ee(e))
              if (i = t.length)
                for (; --i > -1;)(-1 === (o = t[i]).indexOf("-transform") || Ie === o) && (s[o.replace(E, I)] = t.getPropertyValue(o));
              else
                for (i in t)(-1 === i.indexOf("Transform") || je === i) && (s[i] = t[i]);
            else if (t = e.currentStyle || e.style)
              for (i in t) "string" == typeof i && void 0 === s[i] && (s[i.replace(E, I)] = t[i]);
            return G || (s.opacity = X(e)), n = Be(e, t, !1), s.rotation = n.rotation, s.skewX = n.skewX, s.scaleX = n.scaleX, s.scaleY = n.scaleY, s.x = n.x, s.y = n.y, Ae && (s.z = n.z, s.rotationX = n.rotationX, s.rotationY = n.rotationY, s.scaleZ = n.scaleZ), s.filters && delete s.filters, s
          },
          se = function (e, t, i, n, o) {
            var s, r, a, l = {},
              c = e.style;
            for (r in i) "cssText" !== r && "length" !== r && isNaN(r) && (t[r] !== (s = i[r]) || o && o[r]) && -1 === r.indexOf("Origin") && ("number" == typeof s || "string" == typeof s) && (l[r] = "auto" !== s || "left" !== r && "top" !== r ? "" !== s && "auto" !== s && "none" !== s || "string" != typeof t[r] || "" === t[r].replace(k, "") ? s : 0 : ne(e, r), void 0 !== c[r] && (a = new be(c, r, c[r], a)));
            if (n)
          ...
          le = function (e, t, i) {
            ...
            var n = parseFloat("width" === t ? e.offsetWidth : e.offsetHeight),
              o = re[t],
              s = o.length;
            for (i = i || ee(e); --s > -1;) n -= parseFloat(te(e, "padding" + o[s], i, !0)) || 0, n -= parseFloat(te(e, "border" + o[s] + "Width", i, !0)) || 0;
            return n
          },
          ce = function (e, t) {
            ...
            return null == s ? s = "center" === o ? "50%" : "0" : "center" === s && (s = "50%"), ("center" === o || isNaN(parseFloat(o)) && -1 === (o + "").indexOf("=")) && (o = "50%"), e = o + " " + s + (n.length > 2 ? " " + n[2] : ""), t && (t.oxp = -1 !== o.indexOf("%"), t.oyp = -1 !== s.indexOf("%"), t.oxr = "=" === o.charAt(1), t.oyr = "=" === s.charAt(1), t.ox = parseFloat(o.replace(k, "")), t.oy = parseFloat(s.replace(k, "")), t.v = e), t || e
          },
          de = function (e, t) {
          ...
          he = function (e, t, i, n) {
            ...
            return "function" == typeof e && (e = e(v, g)), null == e ? a = t : "number" == typeof e ? a = e : (o = 360, s = e.split("_"), r = ((l = "=" === e.charAt(1)) ? parseInt(e.charAt(0) + "1", 10) * parseFloat(s[0].substr(2)) : parseFloat(s[0])) * (-1 === e.indexOf("rad") ? 1 : W) - (l ? 0 : t), s.length && (n && (n[i] = t + r), -1 !== e.indexOf("short") && ((r %= o) !== r % 180 && (r = 0 > r ? r + o : r - o)), -1 !== e.indexOf("_cw") && 0 > r ? r = (r + 9999999999 * o) % o - (r / o | 0) * o : -1 !== e.indexOf("ccw") && r > 0 && (r = (r - 9999999999 * o) % o - (r / o | 0) * o)), a = t + r), c > a && a > -c && (a = 0), a
          },
          fe = {
            aqua: [0, 255, 255],
            lime: [0, 255, 0],
          ...
          me = r.parseColor = function (e, t) {
            var i, n, o, s, r, a, l, c, d, u, h;
            if (e)
              if ("number" == typeof e) i = [e >> 16, e >> 8 & 255, 255 & e];
              else {
                if ("," === e.charAt(e.length - 1) && (e = e.substr(0, e.length - 1)), fe[e]) i = fe[e];
                else if ("#" === e.charAt(0)) 4 === e.length && (n = e.charAt(1), o = e.charAt(2), s = e.charAt(3), e = "#" + n + n + o + o + s + s), i = [(e = parseInt(e.substr(1), 16)) >> 16, e >> 8 & 255, 255 & e];
                else if ("hsl" === e.substr(0, 3))
                  if (i = h = e.match(y), t) {
                    if (-1 !== e.indexOf("=")) return e.match(_)
                  } else r = Number(i[0]) % 360 / 360, a = Number(i[1]) / 100, n = 2 * (l = Number(i[2]) / 100) - (o = .5 >= l ? l * (a + 1) : l + a - l * a), i.length > 3 && (i[3] = Number(i[3])), i[0] = pe(r + 1 / 3, n, o), i[1] = pe(r, n, o), i[2] = pe(r - 1 / 3, n, o);
                else i = e.match(y) || fe.transparent;
                i[0] = Number(i[0]), i[1] = Number(i[1]), i[2] = Number(i[2]), i.length > 3 && (i[3] = Number(i[3]))
              }
            else i = fe.black;
            return t && !h && (n = i[0] / 255, o = i[1] / 255, s = i[2] / 255, l = ((c = Math.max(n, o, s)) + (d = Math.min(n, o, s))) / 2, c === d ? r = a = 0 : (u = c - d, a = l > .5 ? u / (2 - c - d) : u / (c + d), r = c === n ? (o - s) / u + (s > o ? 6 : 0) : c === o ? (s - n) / u + 2 : (n - o) / u + 4, r *= 60), i[0] = r + .5 | 0, i[1] = 100 * a + .5 | 0, i[2] = 100 * l + .5 | 0), i
          },
          ge = function (e, t) {
            ...
            for (i = 0; i < s.length; i++) n = s[i], r += (o = e.substr(r, e.indexOf(n, r) - r)).length + n.length, 3 === (n = me(n, t)).length && n.push(1), a += o + (t ? "hsla(" + n[0] + "," + n[1] + "%," + n[2] + "%," + n[3] : "rgba(" + n.join(",")) + ")";
            return a + e.substr(r)
          },
          ve = "(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3}){1,2}\\b";
        for (c in fe) ve += "|" + c + "\\b";
        ve = new RegExp(ve + ")", "gi"), r.colorStringFilter = function (e) {
          var t, i = e[0] + " " + e[1];
        ...
        var ye = function (e, t, i, n) {
            ...
            var o, s = t ? (e.match(ve) || [""])[0] : "",
              r = e.split(s).join("").match(b) || [],
            ...
            return d ? o = t ? function (e) {
              ...
              if ("number" == typeof e) e += u;
                ...
                for (p = e.replace(z, "|").split("|"), f = 0; f < p.length; f++) p[f] = o(p[f]);
                return p.join(",")
              }
              if (t = (e.match(ve) || [s])[0], f = (h = e.split(t).join("").match(b) || []).length, d > f--)
                for (; ++f < d;) h[f] = i ? h[(f - 1) / 2 | 0] : r[f];
              return a + h.join(c) + c + t + l + (-1 !== e.indexOf("inset") ? " inset" : "")
            } : function (e) {
              var t, s, h;
              if ("number" == typeof e) e += u;
              else if (n && z.test(e)) {
                for (s = e.replace(z, "|").split("|"), h = 0; h < s.length; h++) s[h] = o(s[h]);
                return s.join(",")
              }
              if (h = (t = e.match("," === c ? b : w) || []).length, d > h--)
          ...
          be = (Y._setPluginRatio = function (e) {
            ...
            for (var t, i, n, o, s, r = this.data, a = r.proxy, l = r.firstMPT, c = 1e-6; l;) t = a[l.v], l.r ? t = l.r(t) : c > t && t > -c && (t = 0), l.t[l.p] = t, l = l._next;
          ...
          we = (Y._parseToProxy = function (e, t, i, n, o, s) {
            var r, a, l, c, d, u = n,
              h = {},
              f = {},
              p = i._transform,
              m = R;
            for (i._transform = null, R = t, n = d = i.parse(e, t, n, o), R = m, s && (i._transform = p, u && (u._prev = null, u._prev && (u._prev._next = null))); n && n !== u;) {
              if (n.type <= 1 && (f[a = n.p] = n.s + n.c, h[a] = n.s, s || (c = new be(n, "s", a, c, n.r), n.c = 0), 1 === n.type))
                for (r = n.l; --r > 0;) l = "xn" + r, f[a = n.p + "_" + l] = n.data[l], h[a] = n[l], s || (c = new be(n, l, a, c, n.rxp[l]));
              n = n._next
            }
            return {
              proxy: h,
          ...
          }, Y.CSSPropTween = function (e, t, n, o, r, a, l, c, d, u, h) {
            this.t = e, this.p = t, this.s = n, this.c = o, this.n = l || t, e instanceof we || s.push(this.n), this.r = c ? "function" == typeof c ? c : Math.round : c, this.type = a || 0, d && (this.pr = d, i = !0), this.b = void 0 === u ? n : u, this.e = void 0 === h ? n + o : h, r && (this._next = r, r._prev = this)
          }),
          ke = function (e, t, i, n, o, s) {
            var r = new we(e, t, i, n - i, o, -1, s);
            return r.b = i, r.e = r.xs0 = n, r
          },
          xe = r.parseComplex = function (e, t, i, n, o, s, a, l, c, u) {
            i = i || s || "", "function" == typeof n && (n = n(v, g)), a = new we(e, t, 0, 0, a, u ? 2 : 1, null, !1, l, i, n), n += "", o && ve.test(n + i) && (n = [i, n], r.colorStringFilter(n), i = n[0], n = n[1]);
            var h, f, p, m, b, w, k, x, T, S, C, D, O, E = i.split(", ").join(",").split(" "),
              j = n.split(", ").join(",").split(" "),
              I = E.length,
              P = !1 !== d;
            for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (-1 !== (n + i).indexOf("rgb") || -1 !== (n + i).indexOf("hsl") ? (E = E.join(" ").replace(z, ", ").split(" "), j = j.join(" ").replace(z, ", ").split(" ")) : (E = E.join(" ").split(",").join(", ").split(" "), j = j.join(" ").split(",").join(", ").split(" ")), I = E.length), I !== j.length && (I = (E = (s || "").split(" ")).length), a.plugin = c, a.setRatio = u, ve.lastIndex = 0, h = 0; I > h; h++)
              if (m = E[h], b = j[h] + "", (x = parseFloat(m)) || 0 === x) a.appendXtra("", x, de(b, x), b.replace(_, ""), !(!P || -1 === b.indexOf("px")) && Math.round, !0);
              else if (o && ve.test(m)) D = ")" + ((D = b.indexOf(")") + 1) ? b.substr(D) : ""), O = -1 !== b.indexOf("hsl") && G, S = b, m = me(m, O), b = me(b, O), (T = m.length + b.length > 6) && !G && 0 === b[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent", a.e = a.e.split(j[h]).join("transparent")) : (G || (T = !1), O ? a.appendXtra(S.substr(0, S.indexOf("hsl")) + (T ? "hsla(" : "hsl("), m[0], de(b[0], m[0]), ",", !1, !0).appendXtra("", m[1], de(b[1], m[1]), "%,", !1).appendXtra("", m[2], de(b[2], m[2]), T ? "%," : "%" + D, !1) : a.appendXtra(S.substr(0, S.indexOf("rgb")) + (T ? "rgba(" : "rgb("), m[0], b[0] - m[0], ",", Math.round, !0).appendXtra("", m[1], b[1] - m[1], ",", Math.round).appendXtra("", m[2], b[2] - m[2], T ? "," : D, Math.round), T && (m = m.length < 4 ? 1 : m[3], a.appendXtra("", m, (b.length < 4 ? 1 : b[3]) - m, D, !1))), ve.lastIndex = 0;
            else if (w = m.match(y)) {
              if (!(k = b.match(_)) || k.length !== w.length) return a;
              for (p = 0, f = 0; f < w.length; f++) C = w[f], S = m.indexOf(C, p), a.appendXtra(m.substr(p, S - p), Number(C), de(k[f], C), "", !(!P || "px" !== m.substr(S + C.length, 2)) && Math.round, 0 === f), p = S + C.length;
              a["xs" + a.l] += m.substr(p)
          ...
          Te = 9;
        for ((c = we.prototype).l = c.pr = 0; --Te > 0;) c["xn" + Te] = 0, c["xs" + Te] = "";
        c.xs0 = "", c._next = c._prev = c.xfirst = c.data = c.plugin = c.setRatio = c.rxp = null, c.appendXtra = function (e, t, i, n, o, s) {
          var r = this,
            a = r.l;
          return r["xs" + a] += s && (a || r["xs" + a]) ? " " + e : e || "", i || 0 === a || r.plugin ? (r.l++, r.type = r.setRatio ? 2 : 1, r["xs" + r.l] = n || "", a > 0 ? (r.data["xn" + a] = t + i, r.rxp["xn" + a] = o, r["xn" + a] = t, r.plugin || (r.xfirst = new we(r, "xn" + a, t, i, r.xfirst || r, 0, r.n, o, r.pr), r.xfirst.xs0 = 0), r) : (r.data = {
            s: t + i
          }, r.rxp = {}, r.s = t, r.c = i, r.r = o, r)) : (r["xs" + a] += t + (n || ""), r)
        };
        var Se = function (e, t) {
            t = t || {}, this.p = t.prefix && K(e) || e, l[e] = l[this.p] = this, this.format = t.formatter || ye(t.defaultValue, t.color, t.collapsible, t.multi), t.parser && (this.parse = t.parser), this.clrs = t.color, this.multi = t.multi, this.keyword = t.keyword, this.dflt = t.defaultValue, this.allowFunc = t.allowFunc, this.pr = t.priority || 0
          },
          Ce = Y._registerComplexSpecialProp = function (e, t, i) {
            "object" != typeof t && (t = {
              parser: i
            });
            var n, o = e.split(","),
              s = t.defaultValue;
            for (i = i || [s], n = 0; n < o.length; n++) t.prefix = 0 === n && t.prefix, t.defaultValue = i[n] || s, new Se(o[n], t)
          },
          De = Y._registerPluginProp = function (e) {
            if (!l[e]) {
              var t = e.charAt(0).toUpperCase() + e.substr(1) + "Plugin";
              Ce(e, {
                parser: function (e, i, n, o, s, r, c) {
                  var d = a.com.greensock.plugins[t];
                  return d ? (d._cssRegister(), l[n].parse(e, i, n, o, s, r, c)) : (Q("Error: " + t + " js file not loaded."), s)
                }
              })
            }
          };
        (c = Se.prototype).parseComplex = function (e, t, i, n, o, s) {
          var r, a, l, c, d, u, h = this.keyword;
          if (this.multi && (z.test(i) || z.test(t) ? (a = t.replace(z, "|").split("|"), l = i.replace(z, "|").split("|")) : h && (a = [t], l = [i])), l) {
            for (c = l.length > a.length ? l.length : a.length, r = 0; c > r; r++) t = a[r] = a[r] || this.dflt, i = l[r] = l[r] || this.dflt, h && ((d = t.indexOf(h)) !== (u = i.indexOf(h)) && (-1 === u ? a[r] = a[r].split(h).join("") : -1 === d && (a[r] += " " + h)));
            t = a.join(", "), i = l.join(", ")
          }
          return xe(e, this.p, t, i, this.clrs, this.dflt, n, this.pr, o, s)
        }, c.parse = function (e, t, i, n, s, r, a) {
          return this.parseComplex(e.style, this.format(te(e, this.p, o, !1, this.dflt)), this.format(t), s, r)
        }, r.registerSpecialProp = function (e, t, i) {
          Ce(e, {
            parser: function (e, n, o, s, r, a, l) {
              var c = new we(e, o, 0, 0, r, 2, o, !1, i);
              return c.plugin = a, c.setRatio = t(e, n, s._tween, o), c
            },
            priority: i
          })
        }, r.useSVGTransformAttr = !0;
        var Oe, Ee = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
          je = K("transform"),
          Ie = J + "transform",
          Pe = K("transformOrigin"),
          Ae = null !== K("perspective"),
          Me = Y.Transform = function () {
            this.perspective = parseFloat(r.defaultTransformPerspective) || 0, this.force3D = !(!1 === r.defaultForce3D || !Ae) && (r.defaultForce3D || "auto")
          },
          ze = _gsScope.SVGElement,
          Le = function (e, t, i) {
            var n, o = $.createElementNS("http://www.w3.org/2000/svg", e),
              s = /([a-z])([A-Z])/g;
          ...
          We = function () {
            ...
            return $.createElementNS && Fe.appendChild && !n && (e = Le("svg", Fe), i = (t = Le("rect", e, {
              width: 100,
              height: 50,
              x: 100
            })).getBoundingClientRect().width, t.style[Pe] = "50% 50%", t.style[je] = "scaleX(0.5)", n = i === t.getBoundingClientRect().width && !(f && Ae), Fe.removeChild(e)), n
          }(),
          Re = function (e, t, i, n, o, s) {
            var a, l, c, d, u, h, f, p, m, g, v, y, _, b, w = e._gsTransform,
              k = He(e, !0);
            w && (_ = w.xOrigin, b = w.yOrigin), (!n || (a = n.split(" ")).length < 2) && (0 === (f = e.getBBox()).x && 0 === f.y && f.width + f.height === 0 && (f = {
              ...
              width: 0,
              height: 0
            }), a = [(-1 !== (t = ce(t).split(" "))[0].indexOf("%") ? parseFloat(t[0]) / 100 * f.width : parseFloat(t[0])) + f.x, (-1 !== t[1].indexOf("%") ? parseFloat(t[1]) / 100 * f.height : parseFloat(t[1])) + f.y]), i.xOrigin = d = parseFloat(a[0]), i.yOrigin = u = parseFloat(a[1]), n && k !== Ne && (h = k[0], f = k[1], p = k[2], m = k[3], g = k[4], v = k[5], (y = h * m - f * p) && (l = d * (m / y) + u * (-p / y) + (p * v - m * g) / y, c = d * (-f / y) + u * (h / y) - (h * v - f * g) / y, d = i.xOrigin = a[0] = l, u = i.yOrigin = a[1] = c)), w && (s && (i.xOffset = w.xOffset, i.yOffset = w.yOffset, w = i), o || !1 !== o && !1 !== r.defaultSmoothOrigin ? (l = d - _, c = u - b, w.xOffset += l * k[0] + c * k[2] - l, w.yOffset += l * k[1] + c * k[3] - c) : w.xOffset = w.yOffset = 0), s || e.setAttribute("data-svg-origin", a.join(" "))
          },
          qe = function (e) {
            ...
            return o ? n.insertBefore(this, o) : n.appendChild(this), Fe.removeChild(i), this.style.cssText = s, t
          },
          $e = function (e) {
          ...
          Ne = [1, 0, 0, 1, 0, 0],
          He = function (e, t) {
            var i, n, o, s, r, a, l, c = e._gsTransform || new Me,
              d = 1e5,
              u = e.style;
            if (je ? n = te(e, Ie, null, !0) : e.currentStyle && (n = (n = e.currentStyle.filter.match(A)) && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), c.x || 0, c.y || 0].join(",") : ""), i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, je && i && !e.offsetParent && e !== Fe && (s = u.display, u.display = "block", (l = e.parentNode) && e.offsetParent || (r = 1, a = e.nextSibling, Fe.appendChild(e)), i = !(n = te(e, Ie, null, !0)) || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, s ? u.display = s : Xe(u, "display"), r && (a ? l.insertBefore(e, a) : l ? l.appendChild(e) : Fe.removeChild(e))), (c.svg || e.getCTM && $e(e)) && (i && -1 !== (u[je] + "").indexOf("matrix") && (n = u[je], i = 0), o = e.getAttribute("transform"), i && o && (n = "matrix(" + (o = e.transform.baseVal.consolidate().matrix).a + "," + o.b + "," + o.c + "," + o.d + "," + o.e + "," + o.f + ")", i = 0)), i) return Ne;
            for (o = (n || "").match(y) || [], Te = o.length; --Te > -1;) s = Number(o[Te]), o[Te] = (r = s - (s |= 0)) ? (r * d + (0 > r ? -.5 : .5) | 0) / d + s : s;
            return t && o.length > 6 ? [o[0], o[1], o[4], o[5], o[12], o[13]] : o
          },
          Be = Y.getTransform = function (e, i, n, o) {
            if (e._gsTransform && n && !o) return e._gsTransform;
            var s, a, l, c, d, u, h = n && e._gsTransform || new Me,
              f = h.scaleX < 0,
              p = 2e-5,
              m = 1e5,
              g = Ae && (parseFloat(te(e, Pe, i, !1, "0 0 0").split(" ")[2]) || h.zOrigin) || 0,
              v = parseFloat(r.defaultTransformPerspective) || 0;
            if (h.svg = !(!e.getCTM || !$e(e)), h.svg && (Re(e, te(e, Pe, i, !1, "50% 50%") + "", h, e.getAttribute("data-svg-origin")), Oe = r.useSVGTransformAttr || We), (s = He(e)) !== Ne) {
              if (16 === s.length) {
                var y, _, b, w, k, x = s[0],
                  T = s[1],
                  S = s[2],
                  ...
                  F = s[11],
                  R = Math.atan2(E, A);
                h.zOrigin && (M = I * (L = -h.zOrigin) - s[12], z = P * L - s[13], L = A * L + h.zOrigin - s[14]), h.rotationX = R * W, R && (y = D * (w = Math.cos(-R)) + I * (k = Math.sin(-R)), _ = O * w + P * k, b = E * w + A * k, I = D * -k + I * w, P = O * -k + P * w, A = E * -k + A * w, F = j * -k + F * w, D = y, O = _, E = b), R = Math.atan2(-S, A), h.rotationY = R * W, R && (_ = T * (w = Math.cos(-R)) - P * (k = Math.sin(-R)), b = S * w - A * k, P = T * k + P * w, A = S * k + A * w, F = C * k + F * w, x = y = x * w - I * k, T = _, S = b), R = Math.atan2(T, x), h.rotation = R * W, R && (y = x * (w = Math.cos(R)) + T * (k = Math.sin(R)), _ = D * w + O * k, b = I * w + P * k, T = T * w - x * k, O = O * w - D * k, P = P * w - I * k, x = y, D = _, I = b), h.rotationX && Math.abs(h.rotationX) + Math.abs(h.rotation) > 359.9 && (h.rotationX = h.rotation = 0, h.rotationY = 180 - h.rotationY), R = Math.atan2(D, O), h.scaleX = (Math.sqrt(x * x + T * T + S * S) * m + .5 | 0) / m, h.scaleY = (Math.sqrt(O * O + E * E) * m + .5 | 0) / m, h.scaleZ = (Math.sqrt(I * I + P * P + A * A) * m + .5 | 0) / m, x /= h.scaleX, D /= h.scaleY, T /= h.scaleX, O /= h.scaleY, Math.abs(R) > p ? (h.skewX = R * W, D = 0, "simple" !== h.skewType && (h.scaleY *= 1 / Math.cos(R))) : h.skewX = 0, h.perspective = F ? 1 / (0 > F ? -F : F) : 0, h.x = M, h.y = z, h.z = L, h.svg && (h.x -= h.xOrigin - (h.xOrigin * x - h.yOrigin * D), h.y -= h.yOrigin - (h.yOrigin * T - h.xOrigin * O))
              } else if (!Ae || o || !s.length || h.x !== s[4] || h.y !== s[5] || !h.rotationX && !h.rotationY) {
                var q = s.length >= 6,
                  $ = q ? s[0] : 1,
                  N = s[1] || 0,
                  H = s[2] || 0,
                  B = q ? s[3] : 1;
                h.x = s[4] || 0, h.y = s[5] || 0, l = Math.sqrt($ * $ + N * N), c = Math.sqrt(B * B + H * H), d = $ || N ? Math.atan2(N, $) * W : h.rotation || 0, u = H || B ? Math.atan2(H, B) * W + d : h.skewX || 0, h.scaleX = l, h.scaleY = c, h.rotation = d, h.skewX = u, Ae && (h.rotationX = h.rotationY = h.z = 0, h.perspective = v, h.scaleZ = 1), h.svg && (h.x -= h.xOrigin - (h.xOrigin * $ + h.yOrigin * H), h.y -= h.yOrigin - (h.xOrigin * N + h.yOrigin * B))
              }
              for (a in Math.abs(h.skewX) > 90 && Math.abs(h.skewX) < 270 && (f ? (h.scaleX *= -1, h.skewX += h.rotation <= 0 ? 180 : -180, h.rotation += h.rotation <= 0 ? 180 : -180) : (h.scaleY *= -1, h.skewX += h.skewX <= 0 ? 180 : -180)), h.zOrigin = g, h) h[a] < p && h[a] > -p && (h[a] = 0)
            }
            return n && (e._gsTransform = h, h.svg && (Oe && e.style[je] ? t.delayedCall(.001, (function () {
              Xe(e.style, je)
          ...
          Ye = function (e) {
            ...
            if (h) {
              ...
              if (null != n.ox && (b += (f = (n.oxp ? g * n.ox * .01 : n.ox) - g / 2) - (f * a + (p = (n.oyp ? v * n.oy * .01 : n.oy) - v / 2) * l), w += p - (f * c + p * d)), y ? _ += ", Dx=" + ((f = g / 2) - (f * a + (p = v / 2) * l) + b) + ", Dy=" + (p - (f * c + p * d) + w) + ")" : _ += ", sizingMethod='auto expand')", -1 !== t.indexOf("DXImageTransform.Microsoft.Matrix(") ? u.filter = t.replace(M, _) : u.filter = _ + " " + t, (0 === e || 1 === e) && 1 === a && 0 === l && 0 === c && 1 === d && (y && -1 === _.indexOf("Dx=0, Dy=0") || T.test(t) && 100 !== parseFloat(RegExp.$1) || -1 === t.indexOf(t.indexOf("Alpha")) && u.removeAttribute("filter")), !y) {
                var k, S, C, D = 8 > m ? 1 : -1;
                for (f = n.ieOffsetX || 0, p = n.ieOffsetY || 0, n.ieOffsetX = Math.round((g - ((0 > a ? -a : a) * g + (0 > l ? -l : l) * v)) / 2 + b), n.ieOffsetY = Math.round((v - ((0 > d ? -d : d) * v + (0 > c ? -c : c) * g)) / 2 + w), Te = 0; 4 > Te; Te++) C = (i = -1 !== (k = h[S = ae[Te]]).indexOf("px") ? parseFloat(k) : ie(this.t, S, parseFloat(k), k.replace(x, "")) || 0) !== n[S] ? 2 > Te ? -n.ieOffsetX : -n.ieOffsetY : 2 > Te ? f - n.ieOffsetX : p - n.ieOffsetY, u[S] = (n[S] = Math.round(i - C * (0 === Te || 2 === Te ? 1 : D))) + "px"
              }
            }
          },
          Ue = Y.set3DTransformRatio = Y.setTransformRatio = function (e) {
            var t, i, n, o, s, r, a, l, c, d, u, h, p, m, g, v, y, _, b, w, k, x, T, S = this.data,
              C = this.t.style,
              D = S.rotation,
              O = S.rotationX,
              E = S.rotationY,
              ...
              q = S.skewY,
              $ = S.skewX;
            if (q && ($ += q, D += q), !((1 !== e && 0 !== e || "auto" !== R || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && R || z || W || E || O || 1 !== P) || Oe && L || !Ae) D || $ || L ? (D *= F, x = $ * F, T = 1e5, i = Math.cos(D) * j, s = Math.sin(D) * j, n = Math.sin(D - x) * -I, r = Math.cos(D - x) * I, x && "simple" === S.skewType && (t = Math.tan(x - q * F), n *= t = Math.sqrt(1 + t * t), r *= t, q && (t = Math.tan(q * F), i *= t = Math.sqrt(1 + t * t), s *= t)), L && (A += S.xOrigin - (S.xOrigin * i + S.yOrigin * n) + S.xOffset, M += S.yOrigin - (S.xOrigin * s + S.yOrigin * r) + S.yOffset, Oe && (S.xPercent || S.yPercent) && (g = this.t.getBBox(), A += .01 * S.xPercent * g.width, M += .01 * S.yPercent * g.height), (g = 1e-6) > A && A > -g && (A = 0), g > M && M > -g && (M = 0)), b = (i * T | 0) / T + "," + (s * T | 0) / T + "," + (n * T | 0) / T + "," + (r * T | 0) / T + "," + A + "," + M + ")", L && Oe ? this.t.setAttribute("transform", "matrix(" + b) : C[je] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + b) : C[je] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + j + ",0,0," + I + "," + A + "," + M + ")";
            else {
              if (f && ((g = 1e-4) > j && j > -g && (j = P = 2e-5), g > I && I > -g && (I = P = 2e-5), !W || S.z || S.rotationX || S.rotationY || (W = 0)), D || $) D *= F, v = i = Math.cos(D), y = s = Math.sin(D), $ && (D -= $ * F, v = Math.cos(D), y = Math.sin(D), "simple" === S.skewType && (t = Math.tan(($ - q) * F), v *= t = Math.sqrt(1 + t * t), y *= t, S.skewY && (t = Math.tan(q * F), i *= t = Math.sqrt(1 + t * t), s *= t))), n = -y, r = v;
              else {
                if (!(E || O || 1 !== P || W || L)) return void(C[je] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) translate3d(" : "translate3d(") + A + "px," + M + "px," + z + "px)" + (1 !== j || 1 !== I ? " scale(" + j + "," + I + ")" : ""));
                i = r = 1, n = s = 0
              }
              d = 1, o = a = l = c = u = h = 0, p = W ? -1 / W : 0, m = S.zOrigin, g = 1e-6, w = ",", k = "0", (D = E * F) && (v = Math.cos(D), l = -(y = Math.sin(D)), u = p * -y, o = i * y, a = s * y, d = v, p *= v, i *= v, s *= v), (D = O * F) && (t = n * (v = Math.cos(D)) + o * (y = Math.sin(D)), _ = r * v + a * y, c = d * y, h = p * y, o = n * -y + o * v, a = r * -y + a * v, d *= v, p *= v, n = t, r = _), 1 !== P && (o *= P, a *= P, d *= P, p *= P), 1 !== I && (n *= I, r *= I, c *= I, h *= I), 1 !== j && (i *= j, s *= j, l *= j, u *= j), (m || L) && (m && (A += o * -m, M += a * -m, z += d * -m + m), L && (A += S.xOrigin - (S.xOrigin * i + S.yOrigin * n) + S.xOffset, M += S.yOrigin - (S.xOrigin * s + S.yOrigin * r) + S.yOffset), g > A && A > -g && (A = k), g > M && M > -g && (M = k), g > z && z > -g && (z = 0)), b = S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix3d(" : "matrix3d(", b += (g > i && i > -g ? k : i) + w + (g > s && s > -g ? k : s) + w + (g > l && l > -g ? k : l), b += w + (g > u && u > -g ? k : u) + w + (g > n && n > -g ? k : n) + w + (g > r && r > -g ? k : r), O || E || 1 !== P ? (b += w + (g > c && c > -g ? k : c) + w + (g > h && h > -g ? k : h) + w + (g > o && o > -g ? k : o), b += w + (g > a && a > -g ? k : a) + w + (g > d && d > -g ? k : d) + w + (g > p && p > -g ? k : p) + w) : b += ",0,0,0,0,1,0,", b += A + w + M + w + z + w + (W ? 1 + -z / W : 1) + ")", C[je] = b
            }
          };
        (c = Me.prototype).x = c.y = c.z = c.skewX = c.skewY = c.rotation = c.rotationX = c.rotationY = c.zOrigin = c.xPercent = c.yPercent = c.xOffset = c.yOffset = 0, c.scaleX = c.scaleY = c.scaleZ = 1, Ce("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
          parser: function (e, t, i, n, s, a, l) {
            if (n._lastParsedTransform === l) return s;
            n._lastParsedTransform = l;
            var c = l.scale && "function" == typeof l.scale ? l.scale : 0;
            c && (l.scale = c(v, e));
            var d, u, h, f, p, m, y, _, b, w = e._gsTransform,
              k = e.style,
              x = 1e-6,
              T = Ee.length,
              S = l,
              C = {},
              D = "transformOrigin",
              O = Be(e, o, !0, S.parseTransform),
              E = S.transform && ("function" == typeof S.transform ? S.transform(v, g) : S.transform);
            if (O.skewType = S.skewType || O.skewType || r.defaultSkewType, n._transform = O, "rotationZ" in S && (S.rotation = S.rotationZ), E && "string" == typeof E && je)(u = H.style)[je] = E, u.display = "block", u.position = "absolute", -1 !== E.indexOf("%") && (u.width = te(e, "width"), u.height = te(e, "height")), $.body.appendChild(H), d = Be(H, null, !1), "simple" === O.skewType && (d.scaleY *= Math.cos(d.skewX * F)), O.svg && (m = O.xOrigin, y = O.yOrigin, d.x -= O.xOffset, d.y -= O.yOffset, (S.transformOrigin || S.svgOrigin) && (E = {}, Re(e, ce(S.transformOrigin), E, S.svgOrigin, S.smoothOrigin, !0), m = E.xOrigin, y = E.yOrigin, d.x -= E.xOffset - O.xOffset, d.y -= E.yOffset - O.yOffset), (m || y) && (_ = He(H, !0), d.x -= m - (m * _[0] + y * _[2]), d.y -= y - (m * _[1] + y * _[3]))), $.body.removeChild(H), d.perspective || (d.perspective = O.perspective), null != S.xPercent && (d.xPercent = ue(S.xPercent, O.xPercent)), null != S.yPercent && (d.yPercent = ue(S.yPercent, O.yPercent));
            else if ("object" == typeof S) {
              if (d = {
                  scaleX: ue(null != S.scaleX ? S.scaleX : S.scale, O.scaleX),
                  scaleY: ue(null != S.scaleY ? S.scaleY : S.scale, O.scaleY),
                  scaleZ: ue(S.scaleZ, O.scaleZ),
                  x: ue(S.x, O.x),
                  y: ue(S.y, O.y),
                  z: ue(S.z, O.z),
                  xPercent: ue(S.xPercent, O.xPercent),
                  yPercent: ue(S.yPercent, O.yPercent),
                  perspective: ue(S.transformPerspective, O.perspective)
                }, null != (p = S.directionalRotation))
                if ("object" == typeof p)
                  for (u in p) S[u] = p[u];
                else S.rotation = p;
              "string" == typeof S.x && -1 !== S.x.indexOf("%") && (d.x = 0, d.xPercent = ue(S.x, O.xPercent)), "string" == typeof S.y && -1 !== S.y.indexOf("%") && (d.y = 0, d.yPercent = ue(S.y, O.yPercent)), d.rotation = he("rotation" in S ? S.rotation : "shortRotation" in S ? S.shortRotation + "_short" : O.rotation, O.rotation, "rotation", C), Ae && (d.rotationX = he("rotationX" in S ? S.rotationX : "shortRotationX" in S ? S.shortRotationX + "_short" : O.rotationX || 0, O.rotationX, "rotationX", C), d.rotationY = he("rotationY" in S ? S.rotationY : "shortRotationY" in S ? S.shortRotationY + "_short" : O.rotationY || 0, O.rotationY, "rotationY", C)), d.skewX = he(S.skewX, O.skewX), d.skewY = he(S.skewY, O.skewY)
            }
            for (Ae && null != S.force3D && (O.force3D = S.force3D, f = !0), (h = O.force3D || O.z || O.rotationX || O.rotationY || d.z || d.rotationX || d.rotationY || d.perspective) || null == S.scale || (d.scaleZ = 1); --T > -1;)((E = d[b = Ee[T]] - O[b]) > x || -x > E || null != S[b] || null != R[b]) && (f = !0, s = new we(O, b, O[b], E, s), b in C && (s.e = C[b]), s.xs0 = 0, s.plugin = a, n._overwriteProps.push(s.n));
            return E = "function" == typeof S.transformOrigin ? S.transformOrigin(v, g) : S.transformOrigin, O.svg && (E || S.svgOrigin) && (m = O.xOffset, y = O.yOffset, Re(e, ce(E), d, S.svgOrigin, S.smoothOrigin), s = ke(O, "xOrigin", (w ? O : d).xOrigin, d.xOrigin, s, D), s = ke(O, "yOrigin", (w ? O : d).yOrigin, d.yOrigin, s, D), (m !== O.xOffset || y !== O.yOffset) && (s = ke(O, "xOffset", w ? m : O.xOffset, O.xOffset, s, D), s = ke(O, "yOffset", w ? y : O.yOffset, O.yOffset, s, D)), E = "0px 0px"), (E || Ae && h && O.zOrigin) && (je ? (f = !0, b = Pe, E || (E = (E = (te(e, b, o, !1, "50% 50%") + "").split(" "))[0] + " " + E[1] + " " + O.zOrigin + "px"), E += "", (s = new we(k, b, 0, 0, s, -1, D)).b = k[b], s.plugin = a, Ae ? (u = O.zOrigin, E = E.split(" "), O.zOrigin = (E.length > 2 ? parseFloat(E[2]) : u) || 0, s.xs0 = s.e = E[0] + " " + (E[1] || "50%") + " 0px", (s = new we(O, "zOrigin", 0, 0, s, -1, s.n)).b = u, s.xs0 = s.e = O.zOrigin) : s.xs0 = s.e = E) : ce(E + "", O)), f && (n._transformType = O.svg && Oe || !h && 3 !== this._transformType ? 2 : 3), c && (l.scale = c), s
          },
          allowFunc: !0,
          prefix: !0
        }), Ce("boxShadow", {
          ...
          parser: function (e, t, i, s, r, a) {
            t = this.format(t);
            var l, c, d, u, h, f, p, m, g, v, y, _, b, w, k, x, T = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
              S = e.style;
            for (g = parseFloat(e.offsetWidth), v = parseFloat(e.offsetHeight), l = t.split(" "), c = 0; c < T.length; c++) this.p.indexOf("border") && (T[c] = K(T[c])), -1 !== (h = u = te(e, T[c], o, !1, "0px")).indexOf(" ") && (u = h.split(" "), h = u[0], u = u[1]), f = d = l[c], p = parseFloat(h), _ = h.substr((p + "").length), (b = "=" === f.charAt(1)) ? (m = parseInt(f.charAt(0) + "1", 10), f = f.substr(2), m *= parseFloat(f), y = f.substr((m + "").length - (0 > m ? 1 : 0)) || "") : (m = parseFloat(f), y = f.substr((m + "").length)), "" === y && (y = n[i] || _), y !== _ && (w = ie(e, "borderLeft", p, _), k = ie(e, "borderTop", p, _), "%" === y ? (h = w / g * 100 + "%", u = k / v * 100 + "%") : "em" === y ? (h = w / (x = ie(e, "borderLeft", 1, "em")) + "em", u = k / x + "em") : (h = w + "px", u = k + "px"), b && (f = parseFloat(h) + m + y, d = parseFloat(u) + m + y)), r = xe(S, T[c], h + " " + u, f + " " + d, !1, "0px", r);
            return r
          },
          prefix: !0,
          ...
          parser: function (e, t, i, n, s, r) {
            return xe(e.style, i, this.format(te(e, i, o, !1, "0px 0px")), this.format(t), !1, "0px", s)
          },
          prefix: !0,
          ...
          defaultValue: "0 0",
          parser: function (e, t, i, n, s, r) {
            var a, l, c, d, u, h, f = "background-position",
              p = o || ee(e),
              ...
              v = this.format(t);
            if (-1 !== g.indexOf("%") != (-1 !== v.indexOf("%")) && v.split(",").length < 2 && ((h = te(e, "backgroundImage").replace(j, "")) && "none" !== h)) {
              for (a = g.split(" "), l = v.split(" "), B.setAttribute("src", h), c = 2; --c > -1;)(d = -1 !== (g = a[c]).indexOf("%")) !== (-1 !== l[c].indexOf("%")) && (u = 0 === c ? e.offsetWidth - B.width : e.offsetHeight - B.height, a[c] = d ? parseFloat(g) / 100 * u + "px" : parseFloat(g) / u * 100 + "%");
              g = a.join(" ")
            }
          ...
          parser: function (e, t, i, n, s, r) {
            var a, l, c;
            return 9 > m ? (l = e.currentStyle, c = 8 > m ? " " : ",", a = "rect(" + l.clipTop + c + l.clipRight + c + l.clipBottom + c + l.clipLeft + ")", t = this.format(t).split(",").join(c)) : (a = this.format(te(e, this.p, o, !1, this.dflt)), t = this.format(t)), this.parseComplex(e.style, a, t, s, r)
          }
        }), Ce("textShadow", {
          ...
          parser: function (e, t, i, n, s, r) {
            var a = te(e, "borderTopWidth", o, !1, "0px"),
              ...
              c = l[0].replace(x, "");
            return "px" !== c && (a = parseFloat(a) / ie(e, "borderTopWidth", 1, c) + c), this.parseComplex(e.style, this.format(a + " " + te(e, "borderTopStyle", o, !1, "solid") + " " + te(e, "borderTopColor", o, !1, "#000")), l.join(" "), s, r)
          },
          color: !0,
          formatter: function (e) {
            var t = e.split(" ");
          ...
          parser: function (e, t, i, n, o, s) {
            ...
            return new we(r, a, 0, 0, o, -1, i, !1, 0, r[a], t)
          }
        });
        var Ge = function (e) {
          var t, i = this.t,
            ...
            o = this.s + this.c * e | 0;
          100 === o && (-1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"), t = !te(this.data, "filter")) : (i.filter = n.replace(C, ""), t = !0)), t || (this.xn1 && (i.filter = n = n || "alpha(opacity=" + o + ")"), -1 === n.indexOf("pacity") ? 0 === o && this.xn1 || (i.filter = n + " alpha(opacity=" + o + ")") : i.filter = n.replace(T, "opacity=" + o))
        };
        Ce("opacity,alpha,autoAlpha", {
          ...
          parser: function (e, t, i, n, s, r) {
            var a = parseFloat(te(e, "opacity", o, !1, "1")),
              l = e.style,
              c = "autoAlpha" === i;
            return "string" == typeof t && "=" === t.charAt(1) && (t = ("-" === t.charAt(0) ? -1 : 1) * parseFloat(t.substr(2)) + a), c && 1 === a && "hidden" === te(e, "visibility", o) && 0 !== t && (a = 0), G ? s = new we(l, "opacity", a, t - a, s) : ((s = new we(l, "opacity", 100 * a, 100 * (t - a), s)).xn1 = c ? 1 : 0, l.zoom = 1, s.type = 2, s.b = "alpha(opacity=" + s.s + ")", s.e = "alpha(opacity=" + (s.s + s.c) + ")", s.data = e, s.plugin = r, s.setRatio = Ge), c && ((s = new we(l, "visibility", 0, 0, s, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === t ? "hidden" : "inherit")).xs0 = "inherit", n._overwriteProps.push(s.n), n._overwriteProps.push(i)), s
          }
        });
        var Xe = function (e, t) {
        ...
        Ce("className", {
          parser: function (e, t, n, s, r, a, l) {
            var c, d, u, h, f, p = e.getAttribute("class") || "",
              m = e.style.cssText;
            if ((r = s._classNamePT = new we(e, n, 0, 0, r, 2)).setRatio = Qe, r.pr = -11, i = !0, r.b = p, d = oe(e, o), u = e._gsClassPT) {
              for (h = {}, f = u.data; f;) h[f.p] = 1, f = f._next;
              u.setRatio(1)
            }
            return e._gsClassPT = r, r.e = "=" !== t.charAt(1) ? t : p.replace(new RegExp("(?:\\s|^)" + t.substr(2) + "(?![\\w-])"), "") + ("+" === t.charAt(0) ? " " + t.substr(2) : ""), e.setAttribute("class", r.e), c = se(e, d, oe(e), l, h), e.setAttribute("class", p), r.data = c.firstMPT, e.style.cssText !== m && (e.style.cssText = m), r.xfirst = s.parse(e, c.difs, r, a)
          }
        });
        var Je = function (e) {
          if ((1 === e || 0 === e) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
            ...
            if ("all" === this.e) r.cssText = "", o = !0;
              ...
              for (n = (t = this.e.split(" ").join("").split(",")).length; --n > -1;) i = t[n], l[i] && (l[i].parse === a ? o = !0 : i = "transformOrigin" === i ? Pe : l[i].p), Xe(r, i);
            o && (Xe(r, je), (s = this.t._gsTransform) && (s.svg && (this.t.removeAttribute("data-svg-origin"), this.t.removeAttribute("transform")), delete this.t._gsTransform))
          }
        };
        for (Ce("clearProps", {
            parser: function (e, t, n, o, s) {
              return (s = new we(e, n, 0, 0, s, 2)).setRatio = Je, s.e = t, s.pr = -10, s.data = o._tween, i = !0, s
            }
          }), c = "bezier,throwProps,physicsProps,physics2D".split(","), Te = c.length; Te--;) De(c[Te]);
        (c = r.prototype)._firstPT = c._lastParsedTransform = c._transform = null, c._onInitTween = function (e, t, a, c) {
          if (!e.nodeType) return !1;
          this._target = g = e, this._tween = a, this._vars = t, v = c, d = t.autoRound, i = !1, n = t.suffixMap || r.suffixMap, o = ee(e), s = this._overwriteProps;
          var f, m, y, _, b, w, k, x, T, C = e.style;
          if (u && "" === C.zIndex && (("auto" === (f = te(e, "zIndex", o)) || "" === f) && this._addLazySet(C, "zIndex", 0)), "string" == typeof t && (_ = C.cssText, f = oe(e, o), C.cssText = _ + ";" + t, f = se(e, f, oe(e)).difs, !G && S.test(t) && (f.opacity = parseFloat(RegExp.$1)), t = f, C.cssText = _), t.className ? this._firstPT = m = l.className.parse(e, t.className, "className", this, null, null, t) : this._firstPT = m = this.parse(e, t, null), this._transformType) {
            for (T = 3 === this._transformType, je ? h && (u = !0, "" === C.zIndex && (("auto" === (k = te(e, "zIndex", o)) || "" === k) && this._addLazySet(C, "zIndex", 0)), p && this._addLazySet(C, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (T ? "visible" : "hidden"))) : C.zoom = 1, y = m; y && y._next;) y = y._next;
            x = new we(e, "transform", 0, 0, null, 2), this._linkCSSP(x, null, y), x.setRatio = je ? Ue : Ye, x.data = this._transform || Be(e, o, !0), x.tween = a, x.pr = -1, s.pop()
          }
          if (i) {
            for (; m;) {
          ...
          var r, a, c, u, h, f, p, m, y, _, b = e.style;
          for (r in t) {
            if (f = t[r], a = l[r], "function" != typeof f || a && a.allowFunc || (f = f(v, g)), a) i = a.parse(e, f, r, this, i, s, t);
            else {
              if ("--" === r.substr(0, 2)) {
                this._tween._propLookup[r] = this._addTween.call(this._tween, e.style, "setProperty", ee(e).getPropertyValue(r) + "", f + "", r, !1, r);
                continue
              }
              h = te(e, r, o) + "", y = "string" == typeof f, "color" === r || "fill" === r || "stroke" === r || -1 !== r.indexOf("Color") || y && D.test(f) ? (y || (f = ((f = me(f)).length > 3 ? "rgba(" : "rgb(") + f.join(",") + ")"), i = xe(b, r, h, f, !0, "transparent", i, 0, s)) : y && L.test(f) ? i = xe(b, r, h, f, !0, null, i, 0, s) : (p = (c = parseFloat(h)) || 0 === c ? h.substr((c + "").length) : "", ("" === h || "auto" === h) && ("width" === r || "height" === r ? (c = le(e, r, o), p = "px") : "left" === r || "top" === r ? (c = ne(e, r, o), p = "px") : (c = "opacity" !== r ? 0 : 1, p = "")), (_ = y && "=" === f.charAt(1)) ? (u = parseInt(f.charAt(0) + "1", 10), f = f.substr(2), u *= parseFloat(f), m = f.replace(x, "")) : (u = parseFloat(f), m = y ? f.replace(x, "") : ""), "" === m && (m = r in n ? n[r] : p), f = u || 0 === u ? (_ ? u + c : u) + m : t[r], p !== m && ("" !== m || "lineHeight" === r) && (u || 0 === u) && c && (c = ie(e, r, c, p), "%" === m ? (c /= ie(e, r, 100, "%") / 100, !0 !== t.strictUnits && (h = c + "%")) : "em" === m || "rem" === m || "vw" === m || "vh" === m ? c /= ie(e, r, 1, m) : "px" !== m && (u = ie(e, r, u, m), m = "px"), _ && (u || 0 === u) && (f = u + c + m)), _ && (u += c), !c && 0 !== c || !u && 0 !== u ? void 0 !== b[r] && (f || f + "" != "NaN" && null != f) ? (i = new we(b, r, u || c || 0, 0, i, -1, r, !1, 0, h, f)).xs0 = "none" !== f || "display" !== r && -1 === r.indexOf("Style") ? f : h : Q("invalid " + r + " tween value: " + t[r]) : (i = new we(b, r, c, u - c, i, 0, r, !1 !== d && ("px" === m || "zIndex" === r), 0, h, f)).xs0 = m)
            }
          ...
          if (1 !== e || this._tween._time !== this._tween._duration && 0 !== this._tween._time)
            if (e || this._tween._time !== this._tween._duration && 0 !== this._tween._time || -1e-6 === this._tween._rawPrevTime)
              for (; o;) {
                if (t = o.c * e + o.s, o.r ? t = o.r(t) : s > t && t > -s && (t = 0), o.type)
                  if (1 === o.type)
          ...
          this._transform = this._transform || Be(this._target, o, !0), this._transformType = this._transform.svg && Oe || !e && 3 !== this._transformType ? 2 : 3
        };
        var Ve = function (e) {
        ...
        var Ke = function (e, t, i) {
          ...
          if (e.slice)
            ...
            for (o = (n = e.childNodes).length; --o > -1;) r = (s = n[o]).type, s.style && (t.push(oe(s)), i && i.push(s)), 1 !== r && 9 !== r && 11 !== r || !s.childNodes.length || Ke(s, t, i)
        };
        return r.cascadeTo = function (e, i, n) {
          ...
          for (e = l._targets || l.target, Ke(e, d, h), l.render(i, !0, !0), Ke(e, u), l.render(0, !0, !0), l._enabled(!0), o = h.length; --o > -1;)
            if ((s = se(h[o], d[o], u[o])).firstMPT) {
              for (r in s = s.difs, n) f[r] && (s[r] = n[r]);
      ...
      function () {
        ...
        n._onInitAllProps = function () {
          ...
          for (s in l)
            for (e = r._firstPT; e;) n = e._next, e.pg ? e.t._mod(l) : e.n === s && (2 === e.f && e.t ? i(e.t._firstPT, l[s]) : (this._add(e.t, s, e.s, e.c, l[s]), n && (n._prev = e._prev), e._prev ? e._prev._next = n : r._firstPT === e && (r._firstPT = n), e._next = e._prev = null, r._propLookup[s] = c)), e = n;
          return !1
        ...
        var t, i, n, o, s = _gsScope.GreenSockGlobals || _gsScope,
          r = s.com.greensock,
          a = 2 * Math.PI,
          l = Math.PI / 2,
          c = r._class,
        ...
        }, !0), u(s.SlowMo, "SlowMo", "ease,"), u(n, "RoughEase", "ease,"), u(t, "SteppedEase", "ease,"), m
      }), !0)
  ...
  function (e, t) {
    ...
    var r, a, l, c, d, u = function (e) {
      ...
      y = function (n, s, r, a) {
        ...
        this.check = function (c) {
          for (var d, h, f, p, m = s.length, g = m; --m > -1;)(d = v[s[m]] || new y(s[m], [])).gsClass ? (l[m] = d.gsClass, g--) : c && d.sc.push(this);
          if (0 === g && r) {
            if (f = (h = ("com.greensock." + n).split(".")).pop(), p = u(h.join("."))[f] = this.gsClass = r.apply(r, l), a)
              if (o[f] = i[f] = p, "undefined" != typeof module && module.exports)
                if (n === t)
    ...
    _.globals = o;
    var w = [0, 0, 1, 1],
      k = b("easing.Ease", (function (e, t, i, n) {
        this._func = e, this._type = i || 0, this._power = n || 0, this._params = t ? w.concat(t) : w
      }), !0),
      x = k.map = {},
      T = k.register = function (e, t, i, n) {
        for (var o, s, r, a, l = t.split(","), c = l.length, d = (i || "easeIn,easeOut,easeInOut").split(","); --c > -1;)
          for (s = l[c], o = n ? b("easing." + s, null, !0) : h.easing[s] || {}, r = d.length; --r > -1;) a = d[r], x[s + "." + a] = x[a + s] = o[a] = e.getRatio ? e : e[a] || new e
      };
    for ((l = k.prototype)._calcEnd = !1, l.getRatio = function (e) {
      ...
      }, a = (r = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length; --a > -1;) l = r[a] + ",Power" + a, T(new k(null, null, 1, a), l, "easeOut", !0), T(new k(null, null, 2, a), l, "easeIn" + (0 === a ? ",easeNone" : "")), T(new k(null, null, 3, a), l, "easeInOut");
    x.linear = h.easing.Linear.easeIn, x.swing = h.easing.Quad.easeInOut;
    var S = b("events.EventDispatcher", (function (e) {
      this._listeners = {}, this._eventTarget = e || this
    }));
    (l = S.prototype).addEventListener = function (e, t, i, n, o) {
      o = o || 0;
      var s, r, a = this._listeners[e],
        l = 0;
      for (this !== c || d || c.wake(), null == a && (this._listeners[e] = a = []), r = a.length; --r > -1;)(s = a[r]).c === t && s.s === i ? a.splice(r, 1) : 0 === l && s.pr < o && (l = r + 1);
      a.splice(l, 0, {
        c: t,
        s: i,
        up: n,
    ...
    var C = e.requestAnimationFrame,
      ...
      E = O();
    for (a = (r = ["ms", "moz", "webkit", "o"]).length; --a > -1 && !C;) C = e[r[a] + "RequestAnimationFrame"], D = e[r[a] + "CancelAnimationFrame"] || e[r[a] + "CancelRequestAnimationFrame"];
    b("Ticker", (function (e, t) {
      var i, o, s, r, a, l = this,
        ...
        v = function (e) {
          var t, n, c = O() - E;
          c > p && (u += c - g), E += c, l.time = (E - u) / 1e3, t = l.time - a, (!i || t > 0 || !0 === e) && (l.frame++, a += t + (t >= r ? .004 : r - t), n = !0), !0 !== e && (s = o(v)), n && l.dispatchEvent("tick")
        };
      S.call(l), l.time = l.frame = 0, l.tick = function () {
        v(!0)
      }, l.lagSmoothing = function (e, t) {
        return arguments.length ? (p = e || 1 / f, void(g = Math.min(t, p, 0))) : 1 / f > p
      }, l.sleep = function () {
        null != s && (h && D ? D(s) : clearTimeout(s), o = m, s = null, l === c && (d = !1))
      }, l.wake = function (e) {
        null !== s ? l.sleep() : e ? u += -E + (E = O()) : l.frame > 10 && (E = O() - p + 5), o = 0 === i ? m : h && C ? C : function (e) {
          return setTimeout(e, 1e3 * (a - l.time) + 1 | 0)
        }, l === c && (d = !0), v(2)
      }, l.fps = function (e) {
        return arguments.length ? (r = 1 / ((i = e) || 60), a = this.time + r, void l.wake()) : i
      }, l.useRAF = function (e) {
    ...
    var j = b("core.Animation", (function (e, t) {
    ...
    c = j.ticker = new h.Ticker, (l = j.prototype)._dirty = l._gc = l._initted = l._paused = !1, l._totalTime = l._time = 0, l._rawPrevTime = -1, l._next = l._last = l._onUpdate = l._timeline = l.timeline = null, l._paused = !1;
    var I = function () {
      d && O() - E > 2e3 && ("hidden" !== (n || {}).visibilityState || !c.lagSmoothing()) && c.wake();
      var e = setTimeout(I, 2e3);
      e.unref && e.unref()
    };
    I(), l.play = function (e, t) {
      ...
      if ("on" === (e || "").substr(0, 2)) {
        ...
        null == t ? delete o[e] : (o[e] = t, o[e + "Params"] = g(i) && -1 !== i.join("").indexOf("{self}") ? this._swapSelfInParams(i) : i, o[e + "Scope"] = n), "onUpdate" === e && (this._onUpdate = t)
      }
      return this
    }, l.delay = function (e) {
      ...
      if (this._timeline) {
        ...
        this._gc && this._enabled(!0, !1), (this._totalTime !== e || 0 === this._duration) && (z.length && K(), this.render(e, t, !1), z.length && K())
      }
      return this
      ...
      return e != this._paused && n && (d || e || c.wake(), i = (t = n.rawTime()) - this._pauseTime, !e && n.smoothChildTiming && (this._startTime += i, this._uncache(!1)), this._pauseTime = e ? t : null, this._paused = e, this._active = this.isActive(), !e && 0 !== i && this._initted && this.duration() && (t = n.smoothChildTiming ? this._totalTime : (t - this._startTime) / this._timeScale, this.render(t, t === this._totalTime, !0))), this._gc && !e && this._enabled(!0, !1), this
    };
    var P = b("core.SimpleTimeline", (function (e) {
      j.call(this, 0, e), this.autoRemoveChildren = this.smoothChildTiming = !0
    }));
    (l = P.prototype = new j).constructor = P, l.kill()._gc = !1, l._first = l._last = l._recent = null, l._sortChildren = !1, l.add = l.insert = function (e, t, i, n) {
      var o, s;
    ...
    var A = b("TweenLite", (function (t, i, n) {
        if (j.call(this, i, n), this.render = A.prototype.render, null == t) throw "Cannot tween a null target.";
        ...
        if (this._overwrite = l = null == l ? X[A.defaultOverwrite] : "number" == typeof l ? l >> 0 : X[l], (a || t instanceof Array || t.push && g(t)) && "number" != typeof t[0])
          for (this._targets = r = p(t), this._propLookup = [], this._siblings = [], o = 0; o < r.length; o++)(s = r[o]) ? "string" != typeof s ? s.length && s !== e && s[0] && (s[0] === e || s[0].nodeType && s[0].style && !s.nodeType) ? (r.splice(o--, 1), this._targets = r = r.concat(p(s))) : (this._siblings[o] = Z(s, this, !1), 1 === l && this._siblings[o].length > 1 && te(s, this, null, 1, this._siblings[o])) : "string" == typeof (s = r[o--] = A.selector(s)) && r.splice(o + 1, 1) : r.splice(o--, 1);
        else this._propLookup = {}, this._siblings = Z(t, this, !1), 1 === l && this._siblings.length > 1 && te(t, this, null, 1, this._siblings);
    ...
    (l = A.prototype = new j).constructor = A, l.kill()._gc = !1, l.ratio = 0, l._firstPT = l._targets = l._overwrittenProps = l._startAt = null, l._notifyPluginsOfEnabled = l._lazy = !1, A.version = "2.1.3", A.defaultEase = l._ease = new k(null, null, 1, 1), A.defaultOverwrite = "auto", A.ticker = c, A.autoSleep = 120, A.lagSmoothing = function (e, t) {
      c.lagSmoothing(e, t)
    ...
    var z = [],
      ...
      W = /[\+-]=-?[\.\d]/,
      R = function (e) {
        for (var t, i = this._firstPT, n = 1e-6; i;) t = i.blob ? 1 === e && null != this.end ? this.end : e ? this.join("") : this.start : i.c * e + i.s, i.m ? t = i.m.call(this._tween, t, this._target || i.t, this._tween) : n > t && t > -n && !i.blob && (t = 0), i.f ? i.fp ? i.t[i.p](i.fp, t) : i.t[i.p](t) : i.t[i.p] = t, i = i._next
      },
      q = function (e) {
        return (1e3 * e | 0) / 1e3 + ""
      },
      $ = function (e, t, i, n) {
        var o, s, r, a, l, c, d, u = [],
          ...
          f = "",
          p = 0;
        for (u.start = e, u.end = t, e = u[0] = e + "", t = u[1] = t + "", i && (i(u), e = u[0], t = u[1]), u.length = 0, o = e.match(F) || [], s = t.match(F) || [], n && (n._next = null, n.blob = 1, u._firstPT = u._applyPT = n), l = s.length, a = 0; l > a; a++) d = s[a], f += (c = t.substr(h, t.indexOf(d, h) - h)) || !a ? c : ",", h += c.length, p ? p = (p + 1) % 5 : "rgba(" === c.substr(-5) && (p = 1), d === o[a] || o.length <= a ? f += d : (f && (u.push(f), f = ""), r = parseFloat(o[a]), u.push(r), u._firstPT = {
          _next: u._firstPT,
          t: u,
          p: u.length - 1,
          s: r,
          ...
          f: 0,
          m: p && 4 > p ? Math.round : q
        }), h += d.length;
        return (f += t.substr(h)) && u.push(f), u.setRatio = R, W.test(t) && (u.end = null), u
      },
      N = function (e, t, i, n, o, s, r, a, l) {
        ...
        return ("number" != typeof u || "number" != typeof n && !h) && (r || isNaN(u) || !h && isNaN(n) || "boolean" == typeof u || "boolean" == typeof n ? (f.fp = r, f = {
          t: $(u, h ? parseFloat(f.s) + f.c + (f.s + "").replace(/[0-9\-\.]/g, "") : n, a || A.defaultStringFilter, f),
          p: "setRatio",
          s: 0,
          c: 1,
          f: 2,
          ...
          pr: 0,
          m: 0
        }) : (f.s = parseFloat(u), h || (f.c = parseFloat(n) - f.s || 0))), f.c ? ((f._next = this._firstPT) && (f._next._prev = f), this._firstPT = f, f) : void 0
      },
      H = A._internals = {
        isArray: g,
        isSelector: M,
      ...
      Q = j._rootFramesTimeline = new P,
      J = j._rootTimeline = new P,
      V = 30,
      K = H.lazyRender = function () {
        var e, t, i = z.length;
        for (L = {}, e = 0; i > e; e++)(t = z[e]) && !1 !== t._lazy && (t.render(t._lazy[0], t._lazy[1], !0), t._lazy = !1);
        z.length = 0
      };
    J._startTime = c.time, Q._startTime = c.frame, J._active = Q._active = !0, setTimeout(K, 1), j._updateRoot = A.render = function () {
      var e, t, i;
      if (z.length && K(), J.render((c.time - J._startTime) * J._timeScale, !1, !1), Q.render((c.frame - Q._startTime) * Q._timeScale, !1, !1), z.length && K(), c.frame >= V) {
        for (i in V = c.frame + (parseInt(A.autoSleep, 10) || 120), Y) {
          for (e = (t = Y[i].tweens).length; --e > -1;) t[e]._gc && t.splice(e, 1);
          0 === t.length && delete Y[i]
        }
        if ((!(i = J._first) || i._paused) && A.autoSleep && !Q._first && 1 === c._listeners.tick.length) {
          for (; i && i._paused;) i = i._next;
          i || c.sleep()
        }
      }
    }, c.addEventListener("tick", j._updateRoot);
    var Z = function (e, t, i) {
        var n, o, s = e._gsTweenID;
        if (Y[s || (e._gsTweenID = s = "t" + U++)] || (Y[s] = {
            target: e,
            tweens: []
      ...
      ee = function (e, t, i, n) {
        ...
        return r && (o = r(e, t, i, n)), (r = A.onOverwrite) && (s = r(e, t, i, n)), !1 !== o && !1 !== s
      },
      te = function (e, t, i, n, o) {
        ...
        var c, d = t._startTime + f,
          u = [],
          h = 0,
          p = 0 === t._duration;
        for (s = o.length; --s > -1;)(a = o[s]) === t || a._gc || a._paused || (a._timeline !== t._timeline ? (c = c || ie(t, 0, p), 0 === ie(a, c, p) && (u[h++] = a)) : a._startTime <= d && a._startTime + a.totalDuration() / a._timeScale > d && ((p || !a._initted) && d - a._startTime <= 2 * f || (u[h++] = a)));
        for (s = h; --s > -1;)
      ...
      ie = function (e, t, i) {
        ...
        return (s /= o) > t ? s - t : i && s === t || !e._initted && 2 * f > s - t ? f : (s += e.totalDuration() / e._timeScale / o) > t + f ? 0 : s - t - f
      };
    l._init = function () {
      ...
      if (r.startAt) {
        ...
        if (o.data = "isStart", o.overwrite = !1, o.immediateRender = !0, o.lazy = c && !1 !== r.lazy, o.startAt = o.delay = null, o.onUpdate = r.onUpdate, o.onUpdateParams = r.onUpdateParams, o.onUpdateScope = r.onUpdateScope || r.callbackScope || this, this._startAt = A.to(this.target || {}, 0, o), c)
        ...
        if (u) u.render(-1, !0), u.kill(), this._startAt = null;
          ...
          if (i.overwrite = 0, i.data = "isFromStart", i.lazy = c && !1 !== r.lazy, i.immediateRender = c, this._startAt = A.to(this.target, 0, i), c) {
            if (0 === this._time) return
          } else this._startAt._init(), this._startAt._enabled(!1), this.vars.immediateRender && (this._startAt = null)
        } if (this._ease = d = d ? d instanceof k ? d : "function" == typeof d ? new k(d, r.easeParams) : x[d] || A.defaultEase : A.defaultEase, r.easeParams instanceof Array && d.config && (this._ease = d.config.apply(d, r.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)
    ...
    }, l._initProps = function (t, i, n, o, s) {
      var r, a, l, c, d, u;
      if (null == t) return !1;
      for (r in L[t._gsTweenID] && K(), this.vars.css || t.style && t !== e && t.nodeType && B.css && !1 !== this.vars.autoCSS && function (e, t) {
          var i, n = {};
          for (i in e) G[i] || i in t && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!B[i] || B[i] && B[i]._autoCSS) || (n[i] = e[i], delete e[i]);
          e.css = n
        }(this.vars, t), this.vars)
        if (u = this.vars[r], G[r]) u && (u instanceof Array || u.push && g(u)) && -1 !== u.join("").indexOf("{self}") && (this.vars[r] = u = this._swapSelfInParams(u, this));
        else if (B[r] && (c = new B[r])._onInitTween(t, this.vars[r], this, s)) {
        for (this._firstPT = d = {
            _next: this._firstPT,
            t: c,
            p: "setRatio",
      ...
      } else i[r] = N.call(this, t, r, "get", u, r, 0, null, this.vars.stringFilter, s);
      return o && this._kill(o, t) ? this._initProps(t, i, n, o, s) : this._overwrite > 1 && this._firstPT && n.length > 1 && te(t, this, i, this._overwrite, n) ? (this._kill(i, t), this._initProps(t, i, n, o, s)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && (L[t._gsTweenID] = !0), l)
    }, l.render = function (e, t, i) {
      var n, o, s, r, a = this,
        l = a._time,
        c = a._duration,
        d = a._rawPrevTime;
      if (e >= c - f && e >= 0) a._totalTime = a._time = c, a.ratio = a._ease._calcEnd ? a._ease.getRatio(1) : 1, a._reversed || (n = !0, o = "onComplete", i = i || a._timeline.autoRemoveChildren), 0 === c && (a._initted || !a.vars.lazy || i) && (a._startTime === a._timeline._duration && (e = 0), (0 > d || 0 >= e && e >= -f || d === f && "isPause" !== a.data) && d !== e && (i = !0, d > f && (o = "onReverseComplete")), a._rawPrevTime = r = !t || e || d === e ? e : f);
      else if (f > e) a._totalTime = a._time = 0, a.ratio = a._ease._calcEnd ? a._ease.getRatio(0) : 0, (0 !== l || 0 === c && d > 0) && (o = "onReverseComplete", n = a._reversed), e > -f ? e = 0 : 0 > e && (a._active = !1, 0 === c && (a._initted || !a.vars.lazy || i) && (d >= 0 && (d !== f || "isPause" !== a.data) && (i = !0), a._rawPrevTime = r = !t || e || d === e ? e : f)), (!a._initted || a._startAt && a._startAt.progress()) && (i = !0);
      else if (a._totalTime = a._time = e, a._easeType) {
        var u = e / c,
          h = a._easeType,
          p = a._easePower;
        (1 === h || 3 === h && u >= .5) && (u = 1 - u), 3 === h && (u *= 2), 1 === p ? u *= u : 2 === p ? u *= u * u : 3 === p ? u *= u * u * u : 4 === p && (u *= u * u * u * u), a.ratio = 1 === h ? 1 - u : 2 === h ? u : .5 > e / c ? u / 2 : 1 - u / 2
      } else a.ratio = a._ease.getRatio(e / c);
      if (a._time !== l || i) {
        if (!a._initted) {
          if (a._init(), !a._initted || a._gc) return;
          if (!i && a._firstPT && (!1 !== a.vars.lazy && a._duration || a.vars.lazy && !a._duration)) return a._time = a._totalTime = l, a._rawPrevTime = d, z.push(a), void(a._lazy = [e, t]);
          a._time && !n ? a.ratio = a._ease.getRatio(a._time / c) : n && a._ease._calcEnd && (a.ratio = a._ease.getRatio(0 === a._time ? 0 : 1))
        }
        for (!1 !== a._lazy && (a._lazy = !1), a._active || !a._paused && a._time !== l && e >= 0 && (a._active = !0), 0 === l && (a._startAt && (e >= 0 ? a._startAt.render(e, !0, i) : o || (o = "_dummyGS")), a.vars.onStart && (0 !== a._time || 0 === c) && (t || a._callback("onStart"))), s = a._firstPT; s;) s.f ? s.t[s.p](s.c * a.ratio + s.s) : s.t[s.p] = s.c * a.ratio + s.s, s = s._next;
        a._onUpdate && (0 > e && a._startAt && -1e-4 !== e && a._startAt.render(e, !0, i), t || (a._time !== l || n || i) && a._callback("onUpdate")), o && (!a._gc || i) && (0 > e && a._startAt && !a._onUpdate && -1e-4 !== e && a._startAt.render(e, !0, i), n && (a._timeline.autoRemoveChildren && a._enabled(!1, !1), a._active = !1), !t && a.vars[o] && a._callback(o), 0 === c && a._rawPrevTime === f && r !== f && (a._rawPrevTime = 0))
      }
      ...
      if ((g(t) || M(t)) && "number" != typeof t[0])
        ...
        if (a) {
          if (c = e || a, d = e !== o && "all" !== o && e !== a && ("object" != typeof e || !e._tempKill), i && (A.onOverwrite || this.vars.onOverwrite)) {
      ...
      var e = this._time;
      return this._firstPT = this._overwrittenProps = this._startAt = this._onUpdate = null, this._notifyPluginsOfEnabled = this._active = this._lazy = !1, this._propLookup = this._targets ? {} : [], j.prototype.invalidate.call(this), this.vars.immediateRender && (this._time = -f, this.render(e, !1, !1 !== this.vars.lazy)), this
    }, l._enabled = function (e, t) {
      ...
      return j.prototype._enabled.call(this, e, t), !(!this._notifyPluginsOfEnabled || !this._firstPT) && A._onPluginEvent(e ? "_onEnable" : "_onDisable", this)
    }, A.to = function (e, t, i) {
      return new A(e, t, i)
      ...
      if (null == e) return [];
      var i, n, o, s;
      if (e = "string" != typeof e ? e : A.selector(e) || e, (g(e) || M(e)) && "number" != typeof e[0]) {
    ...
    if (l = ne.prototype, ne.version = "1.19.0", ne.API = 2, l._firstPT = null, l._addTween = N, l.setRatio = R, l._kill = function (e) {
        ...
        for (var t = e.length; --t > -1;) e[t].API === ne.API && (B[(new e[t])._propName] = e[t]);
        return !0
      }, _.plugin = function (e) {
        ...
        for (t in a.constructor = r, r.API = e.API, s) "function" == typeof e[t] && (a[s[t]] = e[t]);
  ...
  function (e, t) {
    ...
    window.SplitType = function (e, t, i) {
      function n(e) {
        return null !== e && "object" == typeof e
      }

      function o(e) {
        return n(e) && "number" == typeof e.length && e.length > 0
      }
      ...
      function r(e, t, i) {
        for (var s = Object(e), r = o(s) ? s : function (e) {
            return n(e) && "[object Object]" === Object.prototype.toString.call(e)
          }(s) ? _(s) : [s], a = parseInt(r.length) || 0, l = 0; l < a; l++) t.call(i, r[l], l, s)
      }

      function a(e, t) {
        return e = Object(e), t = Object(t), Object.getOwnPropertyNames(e).reduce((function (i, n) {
          return b(i, n, w(t, n) || w(e, n))
        }), {})
      }

      function l(e, t, o) {
        var s, r = {};
        return n(e) && (s = e[p] || (e[p] = ++g), r = m[s] || (m[s] = {})), o === i ? t === i ? r : r[t] : t !== i ? (r[t] = o, o) : void 0
      }

      function c(e) {
        var t = e && e[p];
        t && (delete e[t], delete m[t])
      }
      ...
      function u(e) {
        ...
        if (function (e) {
          ...
          }(e) && (i = e.trim(), e = "#" === i[0] && !/[^\w]/.test(n = i.slice(1)) ? t.getElementById(n) : t.querySelectorAll(i)), i || s(e)) return s(e) ? [e] : y.call(e);
        if (o(e))
      ...
      function h(t) {
        var i, n, o, s, a = this.settings,
          ...
          p = -1 !== h.indexOf("words"),
          m = -1 !== h.indexOf("chars"),
          g = "absolute" === a.position || !0 === a.absolute,
          _ = d("div"),
          b = [],
          w = [];
        if (o = f ? d("div") : k(), _.innerHTML = t.innerHTML.replace(/<br\s*\/?>/g, " " + u + " "), s = _.textContent.replace(/\s+/g, " ").trim().split(" ").map((function (e) {
            ...
            return p || f ? (n = d(c, {
              ...
              style: "display: inline-block; position:" + (p ? "relative" : "static;"),
              children: m ? t : null,
              textContent: m ? null : e
            }), o.appendChild(n)) : r(t, (function (e) {
              o.appendChild(e)
            })), o.appendChild(x(" ")), n
          }), this).filter((function (e) {
            return e
          })), t.innerHTML = "", t.appendChild(o), v.apply(this.words, s), v.apply(this.chars, w), g || f) {
          var T, S, C, D, O, E, j, I, P, A, M, z = [];
          j = l(t).nodes = t.getElementsByTagName(c), I = t.parentElement, P = t.nextElementSibling, A = e.getComputedStyle(t), M = A.textAlign, g && (D = {
            left: o.offsetLeft,
            top: o.offsetTop,
            width: o.offsetWidth
          }, E = t.offsetWidth, O = t.offsetHeight, l(t).cssWidth = t.style.width, l(t).cssHeight = t.style.height), r(j, (function (e) {
            if (e !== o) {
              var t, i = e.parentElement === o;
              f && i && ((t = l(e).top = e.offsetTop) !== S && (S = t, z.push(T = [])), T.push(e)), g && (l(e).top = t || e.offsetTop, l(e).left = e.offsetLeft, l(e).width = e.offsetWidth, l(e).height = C || (C = e.offsetHeight))
            }
          })), I.removeChild(t), f && (o = k(), b = z.map((function (e) {
            return o.appendChild(i = d(c, {
              class: a.lineClass + " " + a.splitClass,
              style: "display: block; text-align:" + M + "; width: 100%;"
            })), g && (l(i).type = "line", l(i).top = l(e[0]).top, l(i).height = C), r(e, (function (e) {
              p ? i.appendChild(e) : m ? y.call(e.children).forEach((function (e) {
                i.appendChild(e)
              })) : i.appendChild(x(e.textContent)), i.appendChild(x(" "))
            })), i
          })), t.replaceChild(o, t.firstChild), v.apply(this.lines, b)), g && (t.style.width = t.style.width || E + "px", t.style.height = O + "px", r(j, (function (e) {
            var t = "line" === l(e).type,
              i = !t && "line" === l(e.parentElement).type;
            e.style.top = i ? 0 : l(e).top + "px", e.style.left = t ? D.left + "px" : (i ? l(e).left - D.left : l(e).left) + "px", e.style.height = l(e).height + "px", e.style.width = t ? D.width + "px" : l(e).width + "px", e.style.position = "absolute"
          }))), P ? I.insertBefore(t, P) : I.appendChild(t)
        }
      }

      function f(e, t) {
        return this instanceof f ? (this.isSplit = !1, this.settings = a(T, t), this.elements = u(e), void(this.elements.length && (this.originals = this.elements.map((function (e) {
          return l(e).html = l(e).html || e.innerHTML
        })), this.split()))) : new f(e, t)
      }
      if (t.addEventListener && Function.prototype.bind) {
        var p = "splitType" + 1 * new Date,
          m = {},
          g = 0,
          v = Array.prototype.push,
          y = Array.prototype.slice,
          _ = Object.keys,
          b = (Object.prototype.hasOwnProperty, Object.defineProperty),
          w = (Object.defineProperties, Object.getOwnPropertyDescriptor),
          k = t.createDocumentFragment.bind(t),
          x = t.createTextNode.bind(t),
          T = {
            splitClass: "",
            lineClass: "line",
            wordClass: "word",
        ...
        return b(f, "defaults", {
          ...
          this.revert(), this.lines = [], this.words = [], this.chars = [], e !== i && (this.settings = a(this.settings, e)), r(this.elements, (function (e) {
            h.call(this, e), l(e).isSplit = !0
          }), this), this.isSplit = !0, r(this.elements, (function (e) {
            for (var t = l(e).nodes || [], i = 0, n = t.length; i < n; i++) c(t[i])
          }))
        }, f.prototype.revert = function () {
  ...
  function (e, t) {
    ...
    function i() {
      if (!l) {
        ...
        s.appendChild(i);
        var r = t(i);
        o = 200 == Math.round(e(r.width)), n.isBoxSizeOuter = o, s.removeChild(i)
      }
    }
    ...
    function n(n) {
      if (i(), "string" == typeof n && (n = document.querySelector(n)), n && "object" == typeof n && n.nodeType) {
        ...
        var k = e(s.height);
        return !1 !== k && (l.height = k + (b ? 0 : m + _)), l.innerWidth = l.width - (p + y), l.innerHeight = l.height - (m + _), l.outerWidth = l.width + g, l.outerHeight = l.height + v, l
      }
    }
    ...
    e.fn.counterUp = function (t) {
      ...
      return this.each((function () {
        ...
        t.waypoint((function () {
          ...
          o = o.replace(/,/g, "");
          /^[0-9]+$/.test(o);
          for (var r = /^[0-9]+\.[0-9]+$/.test(o), a = r ? (o.split(".")[1] || []).length : 0, l = i; l >= 1; l--) {
            var c = parseInt(o / i * l);
            if (r && (c = parseFloat(o / i * l).toFixed(a)), s)
              for (;
  ...
  function () {
    ...
    e = function (e, t) {
      ...
      parseDate: function (t, i) {
        var n, o, s, r, a, l, c, d, u, h, f = this,
          p = !1,
          m = !1,
          g = f.dateSettings,
          v = {
        ...
        for (o = t.replace(f.separators, "\0").split("\0"), s = 0; s < o.length; s++) switch (r = o[s], a = parseInt(r), n[s]) {
          case "y":
          case "Y":
            if (!a) return null;
          ...
          case "g":
          case "h":
            if (h = o[c = -1 < n.indexOf("a") ? n.indexOf("a") : -1 < n.indexOf("A") ? n.indexOf("A") : -1], -1 < c) d = e(h, g.meridiem[0]) ? 0 : e(h, g.meridiem[1]) ? 12 : -1, 1 <= a && a <= 12 && -1 < d ? v.hour = a + d - 1 : 0 <= a && a <= 23 && (v.hour = a);
            else {
        ...
        for (o = 0; o < l.length; o++) {
          ...
          switch (o) {
            ...
            case 1:
              ...
              break;
            case 2:
              if (n = d.getFullYear(), u = (i = r.length) < 4 ? i : 4, !(n = parseInt(i < 4 ? n.toString().substr(0, 4 - i) + r : r.substr(0, 4)))) return null;
              d.setFullYear(n);
              break;
            case 3:
              d.setHours(a);
      ...
      moment: {
        ...
        formatter: {
          parseDate: function (e, t) {
            if (c(t)) return n.parseDate(e, t);
            var i = moment(e, t);
            return !!i.isValid() && i.toDate()
          },
          formatDate: function (e, t) {
            return c(t) ? n.formatDate(e, t) : moment(e).format(t)
          },
  ...
  e.extend(e.datetimepicker, l), r(), window.getComputedStyle || (window.getComputedStyle = function (e) {
    ...
    return this.each((function () {
      ...
      "hide" !== i ? (e(this).hasClass("xdsoft_scroller_box") || (n = l.children().eq(0), o = l[0].clientHeight, s = n[0].offsetHeight, r = e('<div class="xdsoft_scrollbar"></div>'), a = e('<div class="xdsoft_scroller"></div>'), r.append(a), l.addClass("xdsoft_scroller_box").append(r), v = function (e) {
        var t = c(e).y - h + g;
        t < 0 && (t = 0), t + a[0].offsetHeight > p && (t = p - a[0].offsetHeight), l.trigger("scroll_element.xdsoft_scroller", [d ? t / d : 0])
      }, a.on("touchstart.xdsoft_scroller mousedown.xdsoft_scroller", (function (n) {
        o || l.trigger("resize_scroll.xdsoft_scroller", [i]), h = c(n).y, g = parseInt(a.css("margin-top"), 10), p = r[0].offsetHeight, "mousedown" === n.type || "touchstart" === n.type ? (t.ownerDocument && e(t.ownerDocument.body).addClass("xdsoft_noselect"), e([t.ownerDocument.body, t.contentWindow]).on("touchend mouseup.xdsoft_scroller", (function i() {
        ...
        o || l.trigger("resize_scroll.xdsoft_scroller", [t, !0]), t = 1 < t ? 1 : t < 0 || isNaN(t) ? 0 : t, a.css("margin-top", d * t), setTimeout((function () {
          n.css("marginTop", -parseInt((n[0].offsetHeight - o) * t, 10))
        }), 10)
      })).on("resize_scroll.xdsoft_scroller", (function (e, t, i) {
        var c, u;
        o = l[0].clientHeight, s = n[0].offsetHeight, u = (c = o / s) * r[0].offsetHeight, 1 < c ? a.hide() : (a.show(), a.css("height", parseInt(10 < u ? u : 10, 10)), d = r[0].offsetHeight - a[0].offsetHeight, !0 !== i && l.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(n.css("marginTop"), 10)) / (s - o)]))
        ...
        u = c(e), f = Math.abs(parseInt(n.css("marginTop"), 10))
      })), l.on("touchmove", (function (e) {
        if (u) {
          e.preventDefault();
          var t = c(e);
          l.trigger("scroll_element.xdsoft_scroller", [(f - (t.y - u.y)) / (s - o)])
        }
    ...
    var r, a, l = this,
      ...
      C = 0;
    return r = function (t) {
      var s, r, a, l, C, D, O = e('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
        E = e('<div class="xdsoft_copyright"><a   href="http://xdsoft.net/jqplugins/datetimepicker/">xdsoft.net</a></div>'),
        ...
        F = e('<div class="xdsoft_select xdsoft_monthselect"><div></div></div>'),
        W = e('<div class="xdsoft_select xdsoft_yearselect"><div></div></div>'),
        R = !1,
        q = 0;
      S.id && O.attr("id", S.id), S.style && O.attr("style", S.style), S.weeks && O.addClass("xdsoft_showweeks"), S.rtl && O.addClass("xdsoft_rtl"), O.addClass("xdsoft_" + S.theme), O.addClass(S.className), I.find(".xdsoft_month span").after(F), I.find(".xdsoft_year span").after(W), I.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", (function (t) {
        var i, n, o = e(this).find(".xdsoft_select").eq(0),
          s = 0,
          r = 0,
          a = o.is(":visible");
        for (I.find(".xdsoft_select").hide(), C.currentTime && (s = C.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()), o[a ? "hide" : "show"](), i = o.find("div.xdsoft_option"), n = 0; n < i.length && i.eq(n).data("value") !== s; n += 1) r += i[0].offsetHeight;
      ...
      function H(n) {
        ...
        n.mask && t.off("keydown.xdsoft"), !0 === n.mask && (i.formatMask ? n.mask = i.formatMask(n.format) : n.mask = n.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59")), "string" === e.type(n.mask) && (o(n.mask, t.val()) || (t.val(n.mask.replace(/[0-9]/g, "_")), s(t[0], 0)), t.on("paste.xdsoft", (function (i) {
          ...
          if (48 <= l && l <= 57 || 96 <= l && l <= 105 || 8 === l || 46 === l) {
            for (r = 8 === l || 46 === l ? "_" : String.fromCharCode(96 <= l && l <= 105 ? l - 48 : l), 8 === l && d && !C && (d -= 1);;) {
              var D = n.mask.substr(d, 1),
                O = d < n.mask.length,
                E = 0 < d;
              if (!(/[^0-9_]/.test(D) && O && E)) break;
              d += 8 !== l || C ? 1 : -1
            }
            if (i.metaKey && (C = !(d = 0)), C) {
              var j = S - d,
                I = n.mask.replace(/[0-9]/g, "_"),
                P = I.substr(d, j).substr(1);
              a = a.substr(0, d) + (r + P) + a.substr(d + j)
            } else a = a.substr(0, d) + r + a.substr(d + 1);
            if ("" === e.trim(a)) a = I;
            else if (d === n.mask.length) return i.preventDefault(), !1;
            for (d += 8 === l ? 0 : 1;
              /[^0-9_]/.test(n.mask.substr(d, 1)) && d < n.mask.length && 0 < d;) d += 8 === l ? 0 : 1;
            o(n.mask, a) ? (this.value = a, s(this, d)) : "" === e.trim(a) ? this.value = n.mask.replace(/[0-9]/g, "_") : t.trigger("error_input.xdsoft")
          } else if (-1 !== [_, b, w, k, x].indexOf(l) && T || -1 !== [h, p, g, f, m, y, c, v, u].indexOf(l)) return !0;
          return i.preventDefault(), !1
        })))
      }
      I.find(".xdsoft_select").xdsoftScroller(S).on("touchstart mousedown.xdsoft", (function (e) {
        var t = e.originalEvent;
        this.touchMoved = !1, this.touchStartPosition = t.touches ? t.touches[0] : t, e.stopPropagation(), e.preventDefault()
      })).on("touchmove", ".xdsoft_option", $).on("touchend mousedown.xdsoft", ".xdsoft_option", (function () {
        if (!this.touchMoved) {
          void 0 !== C.currentTime && null !== C.currentTime || (C.currentTime = C.now());
          var t = C.currentTime.getFullYear();
          C && C.currentTime && C.currentTime[e(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"](e(this).data("value")), e(this).parent().parent().hide(), O.trigger("xchange.xdsoft"), S.onChangeMonth && e.isFunction(S.onChangeMonth) && S.onChangeMonth.call(O, C.currentTime, O.data("input")), t !== C.currentTime.getFullYear() && e.isFunction(S.onChangeYear) && S.onChangeYear.call(O, C.currentTime, O.data("input"))
        }
      })), O.getValue = function () {
        ...
        S = e.extend(!0, {}, S, n), n.allowTimes && e.isArray(n.allowTimes) && n.allowTimes.length && (S.allowTimes = e.extend(!0, [], n.allowTimes)), n.weekends && e.isArray(n.weekends) && n.weekends.length && (S.weekends = e.extend(!0, [], n.weekends)), n.allowDates && e.isArray(n.allowDates) && n.allowDates.length && (S.allowDates = e.extend(!0, [], n.allowDates)), n.allowDateRe && "[object String]" === Object.prototype.toString.call(n.allowDateRe) && (S.allowDateRe = new RegExp(n.allowDateRe)), n.highlightedDates && e.isArray(n.highlightedDates) && n.highlightedDates.length && (e.each(n.highlightedDates, (function (t, n) {
          var s, r = e.map(n.split(","), e.trim),
            a = new d(i.parseDate(r[0], S.formatDate), r[1], r[2]),
          ...
          var s, r, a, l, c, u, h;
          if (e.isArray(n)) s = n[0], r = n[1], a = n[2], h = n[3];
          else {
            var f = e.map(n.split(","), e.trim);
            s = i.parseDate(f[0], S.formatDate), r = i.parseDate(f[1], S.formatDate), a = f[2], h = f[3]
          }
          for (; s <= r;) l = new d(s, a, h), c = i.formatDate(s, S.formatDate), s.setDate(s.getDate() + 1), void 0 !== o[c] ? (u = o[c].desc) && u.length && l.desc && l.desc.length && (o[c].desc = u + "\n" + l.desc) : o[c] = l
        })), S.highlightedDates = e.extend(!0, [], o)), n.disabledDates && e.isArray(n.disabledDates) && n.disabledDates.length && (S.disabledDates = e.extend(!0, [], n.disabledDates)), n.disabledWeekDays && e.isArray(n.disabledWeekDays) && n.disabledWeekDays.length && (S.disabledWeekDays = e.extend(!0, [], n.disabledWeekDays)), !S.open && !S.opened || S.inline || t.trigger("open.xdsoft"), S.inline && (R = !0, O.addClass("xdsoft_inline"), t.after(O).hide()), S.inverseButton && (S.next = "xdsoft_prev", S.prev = "xdsoft_next"), S.datepicker ? j.addClass("active") : j.removeClass("active"), S.timepicker ? A.addClass("active") : A.removeClass("active"), S.value && (C.setCurrentTime(S.value), t && t.val && t.val(C.str)), isNaN(S.dayOfWeekStart) ? S.dayOfWeekStart = 0 : S.dayOfWeekStart = parseInt(S.dayOfWeekStart, 10) % 7, S.timepickerScrollbar || M.xdsoftScroller(S, "hide"), S.minDate && /^[\+\-](.*)$/.test(S.minDate) && (S.minDate = i.formatDate(C.strToDateTime(S.minDate), S.formatDate)), S.maxDate && /^[\+\-](.*)$/.test(S.maxDate) && (S.maxDate = i.formatDate(C.strToDateTime(S.maxDate), S.formatDate)), S.minDateTime && /^\+(.*)$/.test(S.minDateTime) && (S.minDateTime = C.strToDateTime(S.minDateTime).dateFormat(S.formatDate)), S.maxDateTime && /^\+(.*)$/.test(S.maxDateTime) && (S.maxDateTime = C.strToDateTime(S.maxDateTime).dateFormat(S.formatDate)), L.toggle(S.showApplyButton), I.find(".xdsoft_today_button").css("visibility", S.todayButton ? "visible" : "hidden"), I.find("." + S.prev).css("visibility", S.prevButton ? "visible" : "hidden"), I.find("." + S.next).css("visibility", S.nextButton ? "visible" : "hidden"), H(S), S.validateOnBlur && t.off("blur.xdsoft").on("blur.xdsoft", (function () {
          if (S.allowBlank && (!e.trim(e(this).val()).length || "string" == typeof S.mask && e.trim(e(this).val()) === S.mask.replace(/[0-9]/g, "_"))) e(this).val(null), O.data("xdsoft_datetime").empty();
          else {
      ...
      }, O.data("options", S).on("touchstart mousedown.xdsoft", (function (e) {
        return e.stopPropagation(), e.preventDefault(), W.hide(), F.hide(), !1
      })), M.append(z), M.xdsoftScroller(S), O.on("afterOpen.xdsoft", (function () {
        M.xdsoftScroller(S)
      })), O.append(j).append(A), !0 !== S.withoutCopyright && O.append(E), j.append(I).append(P).append(L), S.insideParent ? e(t).parent().append(O) : e(S.parentID).append(O), C = new function () {
        var t = this;
        t.now = function (e) {
          var i, n, o = new Date;
          ...
          "string" == typeof e ? t.currentTime = t.strToDateTime(e) : t.isValidDate(e) ? t.currentTime = e : e || i || !S.allowBlank || S.inline ? t.currentTime = t.now() : t.currentTime = null, O.trigger("xchange.xdsoft")
        }, t.empty = function () {
          t.currentTime = null
          ...
          if (S.onGetWeekOfYear && e.isFunction(S.onGetWeekOfYear)) {
            var i = S.onGetWeekOfYear.call(O, t);
        ...
        e.preventDefault(), O.data("changed", !0), C.setCurrentTime(N()), t.val(C.str()), O.trigger("close.xdsoft")
        ...
        n = new Date(n.getFullYear(), n.getMonth(), n.getDate()), e = C.strToDate(S.minDate), n < (e = new Date(e.getFullYear(), e.getMonth(), e.getDate())) || (i = C.strToDate(S.maxDate), (i = new Date(i.getFullYear(), i.getMonth(), i.getDate())) < n || (t.val(C.str()), t.trigger("change"), O.trigger("close.xdsoft")))
        ...
        ! function e(s) {
          ...
          t.hasClass(S.next) && a - r - S.timeHeightInTimePicker >= l ? z.css("marginTop", "-" + (l + S.timeHeightInTimePicker) + "px") : t.hasClass(S.prev) && 0 <= l - S.timeHeightInTimePicker && z.css("marginTop", "-" + (l - S.timeHeightInTimePicker) + "px"), M.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(z[0].style.marginTop, 10) / (a - r))]), o = 10 < o ? 10 : o - 10, n || (i = setTimeout(e, s || o))
        }(500), e([S.ownerDocument.body, S.contentWindow]).on("touchend mouseup.xdsoft", (function t() {
          clearTimeout(i), n = !0, e([S.ownerDocument.body, S.contentWindow]).off("touchend mouseup.xdsoft", t)
        }))
        ...
        clearTimeout(s), s = setTimeout((function () {
          void 0 !== C.currentTime && null !== C.currentTime || (C.currentTime = C.now());
          for (var s, r, a, l, c, d, u, h, f, p, m = "", g = new Date(C.currentTime.getFullYear(), C.currentTime.getMonth(), 1, 12, 0, 0), v = 0, y = C.now(), _ = !1, b = !1, w = !1, k = !1, x = [], T = !0, D = ""; g.getDay() !== S.dayOfWeekStart;) g.setDate(g.getDate() - 1);
          for (m += "<table><thead><tr>", S.weeks && (m += "<th></th>"), s = 0; s < 7; s += 1) m += "<th>" + S.i18n[o].dayOfWeekShort[(s + S.dayOfWeekStart) % 7] + "</th>";
          for (m += "</tr></thead>", m += "<tbody>", !1 !== S.maxDate && (_ = C.strToDate(S.maxDate), _ = new Date(_.getFullYear(), _.getMonth(), _.getDate(), 23, 59, 59, 999)), !1 !== S.minDate && (b = C.strToDate(S.minDate), b = new Date(b.getFullYear(), b.getMonth(), b.getDate())), !1 !== S.minDateTime && (w = C.strToDate(S.minDateTime), w = new Date(w.getFullYear(), w.getMonth(), w.getDate(), w.getHours(), w.getMinutes(), w.getSeconds())), !1 !== S.maxDateTime && (k = C.strToDate(S.maxDateTime), k = new Date(k.getFullYear(), k.getMonth(), k.getDate(), k.getHours(), k.getMinutes(), k.getSeconds())), !1 !== k && (p = 31 * (12 * k.getFullYear() + k.getMonth()) + k.getDate()); v < C.currentTime.countDaysInMonth() || g.getDay() !== S.dayOfWeekStart || C.currentTime.getMonth() === g.getMonth();) {
            x = [], v += 1, a = g.getDay(), l = g.getDate(), c = g.getFullYear(), L = g.getMonth(), d = C.getWeekOfYear(g), f = "", x.push("xdsoft_date"), u = S.beforeShowDay && e.isFunction(S.beforeShowDay.call) ? S.beforeShowDay.call(O, g) : null, S.allowDateRe && "[object RegExp]" === Object.prototype.toString.call(S.allowDateRe) && (S.allowDateRe.test(i.formatDate(g, S.formatDate)) || x.push("xdsoft_disabled")), S.allowDates && 0 < S.allowDates.length && -1 === S.allowDates.indexOf(i.formatDate(g, S.formatDate)) && x.push("xdsoft_disabled");
            var E = 31 * (12 * g.getFullYear() + g.getMonth()) + g.getDate();
            (!1 !== _ && _ < g || !1 !== w && g < w || !1 !== b && g < b || !1 !== k && p < E || u && !1 === u[0]) && x.push("xdsoft_disabled"), -1 !== S.disabledDates.indexOf(i.formatDate(g, S.formatDate)) && x.push("xdsoft_disabled"), -1 !== S.disabledWeekDays.indexOf(a) && x.push("xdsoft_disabled"), t.is("[disabled]") && x.push("xdsoft_disabled"), u && "" !== u[1] && x.push(u[1]), C.currentTime.getMonth() !== L && x.push("xdsoft_other_month"), (S.defaultSelect || O.data("changed")) && i.formatDate(C.currentTime, S.formatDate) === i.formatDate(g, S.formatDate) && x.push("xdsoft_current"), i.formatDate(y, S.formatDate) === i.formatDate(g, S.formatDate) && x.push("xdsoft_today"), 0 !== g.getDay() && 6 !== g.getDay() && -1 === S.weekends.indexOf(i.formatDate(g, S.formatDate)) || x.push("xdsoft_weekend"), void 0 !== S.highlightedDates[i.formatDate(g, S.formatDate)] && (r = S.highlightedDates[i.formatDate(g, S.formatDate)], x.push(void 0 === r.style ? "xdsoft_highlighted_default" : r.style), f = void 0 === r.desc ? "" : r.desc), S.beforeShowDay && e.isFunction(S.beforeShowDay) && x.push(S.beforeShowDay(g)), T && (m += "<tr>", T = !1, S.weeks && (m += "<th>" + d + "</th>")), m += '<td data-date="' + l + '" data-month="' + L + '" data-year="' + c + '" class="xdsoft_date xdsoft_day_of_week' + g.getDay() + " " + x.join(" ") + '" title="' + f + '"><div>' + l + "</div></td>", g.getDay() === S.dayOfWeekStartPrev && (m += "</tr>", T = !0), g.setDate(l + 1)
          }
          m += "</tbody></table>", P.html(m), I.find(".xdsoft_label span").eq(0).text(S.i18n[o].months[C.currentTime.getMonth()]), I.find(".xdsoft_label span").eq(1).text(C.currentTime.getFullYear() + S.yearOffset), L = D = "";
          var j = 0;
          if (!1 !== S.minTime) {
            var A = C.strtotime(S.minTime);
            j = 60 * A.getHours() + A.getMinutes()
          }
          var M = 1440;
          if (!1 !== S.maxTime && (A = C.strtotime(S.maxTime), M = 60 * A.getHours() + A.getMinutes()), !1 !== S.minDateTime && (A = C.strToDateTime(S.minDateTime), i.formatDate(C.currentTime, S.formatDate) === i.formatDate(A, S.formatDate))) {
            var L = 60 * A.getHours() + A.getMinutes();
            j < L && (j = L)
          }
          if (!1 !== S.maxDateTime && (A = C.strToDateTime(S.maxDateTime), i.formatDate(C.currentTime, S.formatDate) === i.formatDate(A, S.formatDate) && (L = 60 * A.getHours() + A.getMinutes()) < M && (M = L)), h = function (n, o) {
              var s, r = C.now(),
                a = S.allowTimes && e.isArray(S.allowTimes) && S.allowTimes.length;
              r.setHours(n), n = parseInt(r.getHours(), 10), r.setMinutes(o), o = parseInt(r.getMinutes(), 10), x = [];
              var l = 60 * n + o;
              (t.is("[disabled]") || M <= l || l < j) && x.push("xdsoft_disabled"), (s = new Date(C.currentTime)).setHours(parseInt(C.currentTime.getHours(), 10)), a || s.setMinutes(Math[S.roundTime](C.currentTime.getMinutes() / S.step) * S.step), (S.initTime || S.defaultSelect || O.data("changed")) && s.getHours() === parseInt(n, 10) && (!a && 59 < S.step || s.getMinutes() === parseInt(o, 10)) && (S.defaultSelect || O.data("changed") ? x.push("xdsoft_current") : S.initTime && x.push("xdsoft_init_time")), parseInt(y.getHours(), 10) === parseInt(n, 10) && parseInt(y.getMinutes(), 10) === parseInt(o, 10) && x.push("xdsoft_today"), D += '<div class="xdsoft_time ' + x.join(" ") + '" data-hour="' + n + '" data-minute="' + o + '">' + i.formatDate(r, S.formatTime) + "</div>"
            }, S.allowTimes && e.isArray(S.allowTimes) && S.allowTimes.length)
            for (v = 0; v < S.allowTimes.length; v += 1) h(C.strtotime(S.allowTimes[v]).getHours(), L = C.strtotime(S.allowTimes[v]).getMinutes());
          else
            for (s = v = 0; v < (S.hours12 ? 12 : 24); v += 1)
              for (s = 0; s < 60; s += S.step) {
                var R = 60 * v + s;
                R < j || M <= R || h((v < 10 ? "0" : "") + v, L = (s < 10 ? "0" : "") + s)
              }
          ...
          for (W.children().eq(0).html(n), v = parseInt(S.monthStart, 10), n = ""; v <= parseInt(S.monthEnd, 10); v += 1) n += '<div class="xdsoft_option ' + (C.currentTime.getMonth() === v ? "xdsoft_current" : "") + '" data-value="' + v + '">' + S.i18n[o].months[v] + "</div>";
          F.children().eq(0).html(n), e(O).trigger("generate.xdsoft")
        }), 10), r.stopPropagation()
      })).on("afterOpen.xdsoft", (function () {
        var e, t, i, n;
        S.timepicker && (z.find(".xdsoft_current").length ? e = ".xdsoft_current" : z.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"), e ? (t = M[0].clientHeight, (i = z[0].offsetHeight) - t < (n = z.find(e).index() * S.timeHeightInTimePicker + 1) && (n = i - t), M.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (i - t)])) : M.trigger("scroll_element.xdsoft_scroller", [0]))
      })), r = 0, P.on("touchend click.xdsoft", "td", (function (i) {
        i.stopPropagation(), r += 1;
        var n = e(this),
          o = C.currentTime;
        if (null == o && (C.currentTime = C.now(), o = C.currentTime), n.hasClass("xdsoft_disabled")) return !1;
        o.setDate(1), o.setFullYear(n.data("year")), o.setMonth(n.data("month")), o.setDate(n.data("date")), O.trigger("select.xdsoft", [o]), t.val(C.str()), S.onSelectDate && e.isFunction(S.onSelectDate) && S.onSelectDate.call(O, C.currentTime, O.data("input"), i), O.data("changed", !0), O.trigger("xchange.xdsoft"), O.trigger("changedatetime.xdsoft"), (1 < r || !0 === S.closeOnDateSelect || !1 === S.closeOnDateSelect && !S.timepicker) && !S.inline && O.trigger("close.xdsoft"), setTimeout((function () {
          r = 0
        }), 200)
      })), z.on("touchstart", "div", (function (e) {
        this.touchMoved = !1
      })).on("touchmove", "div", $).on("touchend click.xdsoft", "div", (function (t) {
        if (!this.touchMoved) {
          t.stopPropagation();
          var i = e(this),
            n = C.currentTime;
          if (null == n && (C.currentTime = C.now(), n = C.currentTime), i.hasClass("xdsoft_disabled")) return !1;
          n.setHours(i.data("hour")), n.setMinutes(i.data("minute")), O.trigger("select.xdsoft", [n]), O.data("input").val(C.str()), S.onSelectTime && e.isFunction(S.onSelectTime) && S.onSelectTime.call(O, C.currentTime, O.data("input"), t), O.data("changed", !0), O.trigger("xchange.xdsoft"), O.trigger("changedatetime.xdsoft"), !0 !== S.inline && !0 === S.closeOnTimeSelect && O.trigger("close.xdsoft")
        }
        ...
        return !S.scrollInput || (!S.datepicker && S.timepicker ? (0 <= (a = z.find(".xdsoft_current").length ? z.find(".xdsoft_current").eq(0).index() : 0) + e.deltaY && a + e.deltaY < z.children().length && (a += e.deltaY), z.children().eq(a).length && z.children().eq(a).trigger("mousedown"), !1) : S.datepicker && !S.timepicker ? (j.trigger(e, [e.deltaY, e.deltaX, e.deltaY]), t.val && t.val(C.str()), O.trigger("changedatetime.xdsoft"), !1) : void 0)
      })), O.on("changedatetime.xdsoft", (function (t) {
        if (S.onChangeDateTime && e.isFunction(S.onChangeDateTime)) {
          var i = O.data("input");
          S.onChangeDateTime.call(O, C.currentTime, i, t), delete S.value, i.trigger("change")
        }
      })).on("generate.xdsoft", (function () {
        S.onGenerate && e.isFunction(S.onGenerate) && S.onGenerate.call(O, C.currentTime, O.data("input")), R && (O.trigger("afterOpen.xdsoft"), R = !1)
        ...
        var t, i, n, o, s, r, a, l, c, d, u, h, f;
        if (t = (l = O.data("input")).offset(), i = l[0], d = "top", n = t.top + i.offsetHeight - 1, o = t.left, s = "absolute", c = e(S.contentWindow).width(), h = e(S.contentWindow).height(), f = e(S.contentWindow).scrollTop(), S.ownerDocument.documentElement.clientWidth - t.left < j.parent().outerWidth(!0)) {
          var p = j.parent().outerWidth(!0) - i.offsetWidth;
          o -= p
        }
        "rtl" === l.parent().css("direction") && (o -= O.outerWidth() - l.outerWidth()), S.fixed ? (n -= f, o -= e(S.contentWindow).scrollLeft(), s = "fixed") : (a = !1, D(i, (function (e) {
          return null !== e && ("fixed" === S.contentWindow.getComputedStyle(e).getPropertyValue("position") ? !(a = !0) : void 0)
        })), a && !S.insideParent ? (s = "fixed", n + O.outerHeight() > h + f ? (d = "bottom", n = h + f - t.top) : n -= f) : n + O[0].offsetHeight > h + f && (n = t.top - O[0].offsetHeight + 1), n < 0 && (n = 0), o + i.offsetWidth > c && (o = c - i.offsetWidth)), r = O[0], D(r, (function (e) {
          ...
          top: "",
          bottom: ""
        }, S.insideParent ? u[d] = i.offsetTop + i.offsetHeight : u[d] = n, O.css(u)
      }, O.on("open.xdsoft", (function (t) {
        var i = !0;
        S.onShow && e.isFunction(S.onShow) && (i = S.onShow.call(O, C.currentTime, O.data("input"), t)), !1 !== i && (O.show(), l(), e(S.contentWindow).off("resize.xdsoft", l).on("resize.xdsoft", l), S.closeOnWithoutClick && e([S.ownerDocument.body, S.contentWindow]).on("touchstart mousedown.xdsoft", (function t() {
          O.trigger("close.xdsoft"), e([S.ownerDocument.body, S.contentWindow]).off("touchstart mousedown.xdsoft", t)
        })))
      })).on("close.xdsoft", (function (t) {
        var i = !0;
        I.find(".xdsoft_month,.xdsoft_year").find(".xdsoft_select").hide(), S.onClose && e.isFunction(S.onClose) && (i = S.onClose.call(O, C.currentTime, O.data("input"), t)), !1 === i || S.opened || S.inline || O.hide(), t.stopPropagation()
      })).on("toggle.xdsoft", (function () {
        O.is(":visible") ? O.trigger("close.xdsoft") : O.trigger("open.xdsoft")
      })).data("input", t), q = 0, O.data("xdsoft_datetime", C), O.setOptions(S), C.setCurrentTime(N()), t.data("xdsoft_datetimepicker", O).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", (function () {
        t.is(":disabled") || t.data("xdsoft_datetimepicker").is(":visible") && S.closeOnInputClick || S.openOnFocus && (clearTimeout(q), q = setTimeout((function () {
          t.is(":disabled") || (R = !0, C.setCurrentTime(N(), !0), S.mask && H(S), O.trigger("open.xdsoft"))
        }), 100))
      })).on("keydown.xdsoft", (function (t) {
        var i, n = t.which;
        return -1 !== [u].indexOf(n) && S.enterLikeTab ? (i = e("input:visible,textarea:visible,button:visible,a:visible"), O.trigger("close.xdsoft"), i.eq(i.index(this) + 1).focus(), !1) : -1 !== [v].indexOf(n) ? (O.trigger("close.xdsoft"), !0) : void 0
...
function (e) {
  ...
  function l(n) {
    var o, r = n || window.event,
      ...
      p = 0,
      m = 0;
    if ((n = e.event.fix(r)).type = "mousewheel", "detail" in r && (f = -1 * r.detail), "wheelDelta" in r && (f = r.wheelDelta), "wheelDeltaY" in r && (f = r.wheelDeltaY), "wheelDeltaX" in r && (h = -1 * r.wheelDeltaX), "axis" in r && r.axis === r.HORIZONTAL_AXIS && (h = -1 * f, f = 0), u = 0 === f ? h : f, "deltaY" in r && (u = f = -1 * r.deltaY), "deltaX" in r && (h = r.deltaX, 0 === f && (u = -1 * h)), 0 !== f || 0 !== h) {
      if (1 === r.deltaMode) {
      ...
      if (o = Math.max(Math.abs(f), Math.abs(h)), (!i || o < i) && d(r, i = o) && (i /= 40), d(r, o) && (u /= 40, h /= 40, f /= 40), u = Math[1 <= u ? "floor" : "ceil"](u / i), h = Math[1 <= h ? "floor" : "ceil"](h / i), f = Math[1 <= f ? "floor" : "ceil"](f / i), a.settings.normalizeOffset && this.getBoundingClientRect) {
        var y = this.getBoundingClientRect();
        p = n.clientX - y.left, m = n.clientY - y.top
      }
      return n.deltaX = h, n.deltaY = f, n.deltaFactor = i, n.offsetX = p, n.offsetY = m, n.deltaMode = 0, l.unshift(n, u, h, f), t && clearTimeout(t), t = setTimeout(c, 200), (e.event.dispatch || e.event.handle).apply(this, l)
    }
  }
...
function (e) {
  ...
  v.prototype = {
    ...
    open: function (i) {
      ...
      if (!t.isOpen) {
        ...
        }), 16), t.isOpen = !0, t.updateSize(h), k(d), i
      }
      t.updateItemHTML()
    },
    close: function () {
    ...
    updateItemHTML: function () {
      ...
      t.appendContent(r, n), i.preloaded = !0, k(u, i), o = i.type, t.container.prepend(t.contentContainer), k("AfterChange")
    },
    appendContent: function (e, i) {
      t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[i] ? t.content.find(".mfp-close").length || t.content.append(x()) : t.content = e : t.content = "", k("BeforeAppend"), t.container.addClass("mfp-" + i + "-holder"), t.contentContainer.append(t.content)
    },
    parseEl: function (i) {
      var n, o = t.items[i];
      if (o.tagName ? o = {
      ...
      getInline: function (i, n) {
        if (E(), i.src) {
          ...
          if (s.length) {
            ...
            r && r.tagName && (C || (S = o.hiddenClass, C = w(S), S = "mfp-" + S), D = s.after(C).detach().removeClass(S)), t.updateStatus("ready")
  ...
  e.magnificPopup.registerModule(I, {
    ...
    proto: {
      initAjax: function () {
        t.types.push(I), j = t.st.ajax.cursor, b(a + "." + I, A), b("BeforeChange." + I, A)
      },
      getAjax: function (i) {
        ...
        var n = e.extend({
          ...
          success: function (n, o, s) {
            ...
            k("ParseAjax", r), t.appendContent(e(r.data), I), i.finished = !0, P(), t._setFocus(), setTimeout((function () {
              t.wrap.addClass(p)
  ...
  e.magnificPopup.registerModule("image", {
    ...
    proto: {
      ...
      _onImageHasSize: function (e) {
        e.img && (e.hasSize = !0, M && clearInterval(M), e.isCheckingImgSize = !1, k("ImageHasSize", e), e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1))
      },
        ...
        var i = 0,
          ...
          o = function (s) {
            M && clearInterval(M), M = setInterval((function () {
              return n.naturalWidth > 0 ? void t._onImageHasSize(e) : (i > 200 && clearInterval(M), void(3 === ++i ? o(10) : 40 === i ? o(50) : 100 === i && o(500)))
            }), s)
          };
        o(1)
      },
      getImage: function (i, n) {
        ...
        }, i), t.resizeImage(), i.hasSize ? (M && clearInterval(M), i.loadError ? (n.addClass("mfp-loading"), t.updateStatus("error", a.tError.replace("%url%", i.src))) : (n.removeClass("mfp-loading"), t.updateStatus("ready")), n) : (t.updateStatus("loading"), i.loading = !0, i.hasSize || (i.imgHidden = !0, n.addClass("mfp-loading"), t.findImageSize(i)), n)
      }
    }
  });
  var L;
  ...
  e.magnificPopup.registerModule("gallery", {
    ...
    proto: {
      initGallery: function () {
        var i = t.st.gallery,
          o = ".mfp-gallery";
        return t.direction = !0, !(!i || !i.enabled) && (s += " mfp-gallery", b(d + o, (function () {
    ...
    proto: {
      initRetina: function () {
        if (window.devicePixelRatio > 1) {
          var e = t.st.retina,
            i = e.ratio;
          (i = isNaN(i) ? i() : i) > 1 && (b("ImageHasSize." + $, (function (e, t) {
            t.img.css({
              "max-width": t.img[0].naturalWidth / i,
              width: "100%"
            })
          })), b("ElementParse." + $, (function (t, n) {
...
function (e) {
  e.fn.niceSelect = function (t) {
    function i(t) {
      ...
      i.find(".current").html(o.data("display") || o.text()), n.each((function (t) {
        var n = e(this),
          o = n.data("display");
    ...
    if ("string" == typeof t) return "update" == t ? this.each((function () {
      var t = e(this),
        ...
        o = n.hasClass("open");
      n.length && (n.remove(), i(t), o && t.next().trigger("click"))
...
}(jQuery), eval(function (e, t, i, n, o, s) {
    if (o = function (e) {
  ...
  function () {
    ...
    ! function (e, t) {
      ...
      var o, s, r, a, l, c, d, u, h, f, p, m, g, v, y, _;
      return o = i(n), u = e.call(n, "ontouchstart") >= 0, a = {
        horizontal: {},
        vertical: {}
      }, l = 1, d = {}, c = "waypoints-context-id", p = "resize.waypoints", m = "scroll.waypoints", g = 1, v = "waypoints-waypoint-ids", y = "waypoint", _ = "waypoints", s = function () {
        function e(e) {
          var t = this;
          this.$element = e, this.element = e[0], this.didResize = !1, this.didScroll = !1, this.id = "context" + l++, this.oldScroll = {
            ...
            }, n.setTimeout(e, i[_].settings.scrollThrottle)
          })), e.bind(p, (function () {
            var e;
            if (!t.didResize) return t.didResize = !0, e = function () {
              return i[_]("refresh"), t.didResize = !1
            }, n.setTimeout(e, i[_].settings.resizeThrottle)
          }))
        }
        return e.prototype.doScroll = function () {
          ...
          }, !u || e.vertical.oldScroll && e.vertical.newScroll || i[_]("refresh"), i.each(e, (function (e, n) {
            var o, s, r;
            return r = [], s = n.newScroll > n.oldScroll, o = s ? n.forward : n.backward, i.each(t.waypoints[e], (function (e, t) {
              var i, o;
              return n.oldScroll < (i = t.offset) && i <= n.newScroll || n.newScroll < (o = t.offset) && o <= n.oldScroll ? r.push(t) : void 0
            })), r.sort((function (e, t) {
        ...
        function e(e, t, n) {
          ...
          "bottom-in-view" === (n = i.extend({}, i.fn[y].defaults, n)).offset && (n.offset = function () {
            var e;
            return e = i[_]("viewportHeight"), i.isWindow(t.element) || (e = t.$element.height()), e - i(this).outerHeight()
          }), this.$element = e, this.element = e[0], this.axis = n.horizontal ? "horizontal" : "vertical", this.callback = n.handler, this.context = t, this.enabled = n.enabled, this.id = "waypoints" + g++, this.offset = null, this.options = n, t.waypoints[this.axis][this.id] = this, a[this.axis][this.id] = this, (o = null != (s = e.data(v)) ? s : []).push(this.id), e.data(v, o)
        }
        ...
        init: function (e, t) {
          return null == t && (t = {}), null == t.handler && (t.handler = e), this.each((function () {
            var e, n, o, a;
            return e = i(this), o = null != (a = t.context) ? a : i.fn[y].defaults.context, i.isWindow(o) || (o = e.closest(o)), o = i(o), (n = d[o.data(c)]) || (n = new s(o)), new r(e, n, t)
          })), i[_]("refresh"), this
        },
        disable: function () {
        ...
        aggregate: function (e) {
          var t, n, o;
          return t = a, e && (t = null != (o = d[i(e).data(c)]) ? o.waypoints : void 0), t ? (n = {
            horizontal: [],
            vertical: []
        ...
        _filter: function (e, t, n) {
          var o, s;
          return (o = d[i(e).data(c)]) ? (s = [], i.each(o.waypoints[t], (function (e, t) {
