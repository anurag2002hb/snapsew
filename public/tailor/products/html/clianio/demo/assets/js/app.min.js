var LS_oldGS, LS_oldGSQueue, LS_oldGSDefine, LS_GSAP;
! function (e, t) {
    ...
    typeCheckConfig: function (e, t, i) {
      for (var n in i)
        if (Object.prototype.hasOwnProperty.call(i, n)) {
          var o = i[n],
            s = t[n],
            r = s && m.isElement(s) ? "element" : {}.toString.call(s).match(/\s([a-z]+)/i)[1].toLowerCase();
  ...
  var i, o = "alert",
    ...
    h = ((i = f.prototype).close = function (e) {
      var t = this._element;
      ...
      var t = m.getSelectorFromElement(e),
        i = !1;
      return t && (i = document.querySelector(t)), i = i || p(e).closest(".alert")[0]
    }, i._triggerCloseEvent = function (e) {
      var t = p.Event(c.CLOSE);
      return p(e).trigger(t), t
    }, i._removeElement = function (t) {
      var e, i = this;
      p(t).removeClass("show"), p(t).hasClass("fade") ? (e = m.getTransitionDurationFromElement(t), p(t).one(m.TRANSITION_END, function (e) {
      ...
      return this.each(function () {
        var e = p(this),
          t = e.data(a);
        t || (t = new f(this), e.data(a, t)), "close" === i && t[i](this)
      })
  ...
  p(document).on(c.CLICK_DATA_API, '[data-dismiss="alert"]', h._handleDismiss(new h)), p.fn[o] = h._jQueryInterface, p.fn[o].Constructor = h, p.fn[o].noConflict = function () {
    return p.fn[o] = d, h._jQueryInterface
  };
  var g, y = "button",
    v = "bs.button",
    _ = "." + v,
    ...
    C = ((g = D.prototype).toggle = function () {
      var e = !0,
        t = !0,
        i = p(this._element).closest('[data-toggle="buttons"]')[0];
      if (i) {
        var n, o = this._element.querySelector('input:not([type="hidden"])');
        if (o) {
          if ("radio" === o.type && (o.checked && this._element.classList.contains(k) ? e = !1 : (n = i.querySelector(".active")) && p(n).removeClass(k)), e) {
            if (o.hasAttribute("disabled") || i.hasAttribute("disabled") || o.classList.contains("disabled") || i.classList.contains("disabled")) return;
            o.checked = !this._element.classList.contains(k), p(o).trigger("change")
          }
          o.focus(), t = !1
        }
      }
      t && this._element.setAttribute("aria-pressed", !this._element.classList.contains(k)), e && p(this._element).toggleClass(k)
    }, g.dispose = function () {
      p.removeData(this._element, v), this._element = null
    }, D._jQueryInterface = function (t) {
      return this.each(function () {
        var e = p(this).data(v);
        e || (e = new D(this), p(this).data(v, e)), "toggle" === t && e[t]()
      })
    }, s(D, null, [{
      key: "VERSION",
      get: function () {
  ...
  p(document).on(S.CLICK_DATA_API, x, function (e) {
    e.preventDefault();
    var t = e.target;
    p(t).hasClass("btn") || (t = p(t).closest(T)), C._jQueryInterface.call(p(t), "toggle")
  }).on(S.FOCUS_BLUR_DATA_API, x, function (e) {
    var t = p(e.target).closest(T)[0];
    p(t).toggleClass("focus", /^focus(in)?$/.test(e.type))
  }), p.fn[y] = C._jQueryInterface, p.fn[y].Constructor = C, p.fn[y].noConflict = function () {
    return p.fn[y] = w, C._jQueryInterface
  };
  var O, E = "carousel",
    j = "bs.carousel",
    I = "." + j,
    ...
    W = {
      ...
      LOAD_DATA_API: "load" + I + P,
      CLICK_DATA_API: "click" + I + P
    },
    R = "active",
    ...
    $ = ((O = H.prototype).next = function () {
      ...
      p(this._element).off(I), p.removeData(this._element, j), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
    }, O._getConfig = function (e) {
      return e = r({}, M, e), m.typeCheckConfig(E, e, z), e
    }, O._handleSwipe = function () {
      var e, t = Math.abs(this.touchDeltaX);
      t <= 40 || (0 < (e = t / this.touchDeltaX) && this.prev(), e < 0 && this.next())
      ...
      }, p(this._element.querySelectorAll(".carousel-item img")).on(W.DRAG_START, function (e) {
        return e.preventDefault()
      }), this._pointerEvent ? (p(this._element).on(W.POINTERDOWN, e), p(this._element).on(W.POINTERUP, t), this._element.classList.add("pointer-event")) : (p(this._element).on(W.TOUCHSTART, e), p(this._element).on(W.TOUCHMOVE, function (e) {
        var t;
      ...
      }), p(this._element).on(W.TOUCHEND, t)))
      ...
      var r = (o + (e === F ? -1 : 1)) % this._items.length;
      return -1 == r ? this._items[this._items.length - 1] : this._items[r]
    }, O._triggerSlideEvent = function (e, t) {
      var i = this._getItemIndex(e),
        n = this._getItemIndex(this._element.querySelector(q)),
        o = p.Event(W.SLIDE, {
          relatedTarget: e,
          direction: t,
          from: n,
      ...
      var t, i;
      this._indicatorsElement && (t = [].slice.call(this._indicatorsElement.querySelectorAll(".active")), p(t).removeClass(R), (i = this._indicatorsElement.children[this._getItemIndex(e)]) && p(i).addClass(R))
      ...
      var i, n, o, s, r, a = this,
        ...
        f = e === L ? (i = "carousel-item-left", n = "carousel-item-next", "left") : (i = "carousel-item-right", n = "carousel-item-prev", "right");
      c && p(c).hasClass(R) ? this._isSliding = !1 : !this._triggerSlideEvent(c, f).isDefaultPrevented() && l && c && (this._isSliding = !0, h && this.pause(), this._setActiveIndicatorElement(c), o = p.Event(W.SLID, {
        relatedTarget: c,
        direction: f,
        from: d,
        to: u
      }), p(this._element).hasClass("slide") ? (p(c).addClass(n), m.reflow(c), p(l).addClass(i), p(c).addClass(i), s = parseInt(c.getAttribute("data-interval"), 10), this._config.interval = s ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval, s) : this._config.defaultInterval || this._config.interval, r = m.getTransitionDurationFromElement(l), p(l).one(m.TRANSITION_END, function () {
        p(c).removeClass(i + " " + n).addClass(R), p(l).removeClass(R + " " + n + " " + i), a._isSliding = !1, setTimeout(function () {
          return p(a._element).trigger(o)
        }, 0)
      }).emulateTransitionEnd(r)) : (p(l).removeClass(R), p(c).addClass(R), this._isSliding = !1, p(this._element).trigger(o)), h && this.cycle())
    }, H._jQueryInterface = function (n) {
      return this.each(function () {
        var e = p(this).data(j),
          t = r({}, M, p(this).data());
        "object" == typeof n && (t = r({}, t, n));
        var i = "string" == typeof n ? n : t.slide;
        if (e || (e = new H(this, t), p(this).data(j, e)), "number" == typeof n) e.to(n);
      ...
      var t, i, n, o = m.getSelectorFromElement(this);
      !o || (t = p(o)[0]) && p(t).hasClass("carousel") && (i = r({}, p(t).data(), p(this).data()), (n = this.getAttribute("data-slide-to")) && (i.interval = !1), H._jQueryInterface.call(p(t), i), n && p(t).data(j).to(n), e.preventDefault())
    }, s(H, null, [{
      key: "VERSION",
      get: function () {
        return "4.3.1"
  ...
  p(document).on(W.CLICK_DATA_API, "[data-slide], [data-slide-to]", $._dataApiClickHandler), p(window).on(W.LOAD_DATA_API, function () {
    for (var e = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), t = 0, i = e.length; t < i; t++) {
      var n = p(e[t]);
      $._jQueryInterface.call(n, n.data())
    }
  }), p.fn[E] = $._jQueryInterface, p.fn[E].Constructor = $, p.fn[E].noConflict = function () {
    return p.fn[E] = A, $._jQueryInterface
  };
  var B, Y = "collapse",
    U = "bs.collapse",
    G = "." + U,
    ...
    ne = ((B = oe.prototype).toggle = function () {
      p(this._element).hasClass(K) ? this.hide() : this.show()
    }, B.show = function () {
      var e, t, i, n, o, s, r = this;
      this._isTransitioning || p(this._element).hasClass(K) || (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function (e) {
        return "string" == typeof r._config.parent ? e.getAttribute("data-parent") === r._config.parent : e.classList.contains(Z)
      })).length && (e = null), e && (t = p(e).not(this._selector).data(U)) && t._isTransitioning) || (i = p.Event(V.SHOW), p(this._element).trigger(i), i.isDefaultPrevented() || (e && (oe._jQueryInterface.call(p(e).not(this._selector), "hide"), t || p(e).data(U, null)), n = this._getDimension(), p(this._element).removeClass(Z).addClass(ee), this._element.style[n] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(te).attr("aria-expanded", !0), this.setTransitioning(!0), o = "scroll" + (n[0].toUpperCase() + n.slice(1)), s = m.getTransitionDurationFromElement(this._element), p(this._element).one(m.TRANSITION_END, function () {
        p(r._element).removeClass(ee).addClass(Z).addClass(K), r._element.style[n] = "", r.setTransitioning(!1), p(r._element).trigger(V.SHOWN)
      }).emulateTransitionEnd(s), this._element.style[n] = this._element[o] + "px"))
    }, B.hide = function () {
      var e = this;
      if (!this._isTransitioning && p(this._element).hasClass(K)) {
        var t = p.Event(V.HIDE);
        if (p(this._element).trigger(t), !t.isDefaultPrevented()) {
          var i = this._getDimension();
          this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", m.reflow(this._element), p(this._element).addClass(ee).removeClass(Z).removeClass(K);
          var n = this._triggerArray.length;
          if (0 < n)
            for (var o = 0; o < n; o++) {
              var s = this._triggerArray[o],
                r = m.getSelectorFromElement(s);
              null !== r && (p([].slice.call(document.querySelectorAll(r))).hasClass(K) || p(s).addClass(te).attr("aria-expanded", !1))
            }
          this.setTransitioning(!0), this._element.style[i] = "";
          var a = m.getTransitionDurationFromElement(this._element);
          p(this._element).one(m.TRANSITION_END, function () {
            e.setTransitioning(!1), p(e._element).removeClass(ee).addClass(Z).trigger(V.HIDDEN)
      ...
      p.removeData(this._element, U), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
    }, B._getConfig = function (e) {
      return (e = r({}, Q, e)).toggle = Boolean(e.toggle), m.typeCheckConfig(Y, e, J), e
      ...
      return p(n).each(function (e, t) {
        i._addAriaAndCollapsedClass(oe._getTargetFromElement(t), [t])
      }), e
    }, B._addAriaAndCollapsedClass = function (e, t) {
      var i = p(e).hasClass(K);
      t.length && p(t).toggleClass(te, !i).attr("aria-expanded", i)
    }, oe._getTargetFromElement = function (e) {
      var t = m.getSelectorFromElement(e);
      return t ? document.querySelector(t) : null
    }, oe._jQueryInterface = function (n) {
      return this.each(function () {
        var e = p(this),
          t = e.data(U),
          i = r({}, Q, e.data(), "object" == typeof n && n ? n : {});
        if (!t && i.toggle && /show|hide/.test(n) && (i.toggle = !1), t || (t = new oe(this, i), e.data(U, t)), "string" == typeof n) {
  ...
  function oe(t, e) {
    ...
    for (var i = [].slice.call(document.querySelectorAll(ie)), n = 0, o = i.length; n < o; n++) {
      var s = i[n],
        r = m.getSelectorFromElement(s),
  ...
  p(document).on(V.CLICK_DATA_API, ie, function (e) {
  ...
  }), p.fn[Y] = ne._jQueryInterface, p.fn[Y].Constructor = ne, p.fn[Y].noConflict = function () {
    return p.fn[Y] = X, ne._jQueryInterface
  };
  var se, re = "dropdown",
    ae = "bs.dropdown",
    le = "." + ae,
    ...
    be = ((se = we.prototype).toggle = function () {
      if (!this._element.disabled && !p(this._element).hasClass(fe)) {
        var e = we._getParentFromElement(this._element),
          t = p(this._menu).hasClass(pe);
        if (we._clearMenus(), !t) {
          var i = {
              relatedTarget: this._element
            },
            n = p.Event(he.SHOW, i);
          if (p(e).trigger(n), !n.isDefaultPrevented()) {
            if (!this._inNavbar) {
            ...
            "ontouchstart" in document.documentElement && 0 === p(e).closest(".navbar-nav").length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(pe), p(e).toggleClass(pe).trigger(p.Event(he.SHOWN, i))
          }
        }
      }
    }, se.show = function () {
      var e, t, i;
      this._element.disabled || p(this._element).hasClass(fe) || p(this._menu).hasClass(pe) || (e = {
        relatedTarget: this._element
      }, t = p.Event(he.SHOW, e), i = we._getParentFromElement(this._element), p(i).trigger(t), t.isDefaultPrevented() || (p(this._menu).toggleClass(pe), p(i).toggleClass(pe).trigger(p.Event(he.SHOWN, e))))
    }, se.hide = function () {
      var e, t, i;
      this._element.disabled || p(this._element).hasClass(fe) || !p(this._menu).hasClass(pe) || (e = {
        relatedTarget: this._element
      }, t = p.Event(he.HIDE, e), i = we._getParentFromElement(this._element), p(i).trigger(t), t.isDefaultPrevented() || (p(this._menu).toggleClass(pe), p(i).toggleClass(pe).trigger(p.Event(he.HIDDEN, e))))
    }, se.dispose = function () {
      p.removeData(this._element, ae), p(this._element).off(le), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
    }, se.update = function () {
      ...
      return e = r({}, this.constructor.Default, p(this._element).data(), e), m.typeCheckConfig(re, e, this.constructor.DefaultType), e
    }, se._getMenuElement = function () {
      var e;
      return this._menu || (e = we._getParentFromElement(this._element)) && (this._menu = e.querySelector(ye)), this._menu
      ...
      return this.each(function () {
        ...
        if (e || (e = new we(this, "object" == typeof t ? t : null), p(this).data(ae, e)), "string" == typeof t) {
      ...
      if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
        for (var t = [].slice.call(document.querySelectorAll(ge)), i = 0, n = t.length; i < n; i++) {
          var o, s, r = we._getParentFromElement(t[i]),
            a = p(t[i]).data(ae),
            l = {
              relatedTarget: t[i]
            };
          e && "click" === e.type && (l.clickEvent = e), a && (o = a._menu, !p(r).hasClass(pe) || e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(r, e.target) || (s = p.Event(he.HIDE, l), p(r).trigger(s), s.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), t[i].setAttribute("aria-expanded", "false"), p(o).removeClass(pe), p(r).removeClass(pe).trigger(p.Event(he.HIDDEN, l)))))
        }
      ...
      var t, i, n, o, s;
      (/input|textarea/i.test(e.target.tagName) ? 32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(ye).length) : !ue.test(e.which)) || (e.preventDefault(), e.stopPropagation(), this.disabled || p(this).hasClass(fe)) || (t = we._getParentFromElement(this), (i = p(t).hasClass(pe)) && (!i || 27 !== e.which && 32 !== e.which) ? 0 !== (n = [].slice.call(t.querySelectorAll(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)"))).length && (o = n.indexOf(e.target), 38 === e.which && 0 < o && o--, 40 === e.which && o < n.length - 1 && o++, o < 0 && (o = 0), n[o].focus()) : (27 === e.which && (s = t.querySelector(ge), p(s).trigger("focus")), p(this).trigger("click")))
    }, s(we, null, [{
      key: "VERSION",
      get: function () {
        return "4.3.1"
  ...
  p(document).on(he.KEYDOWN_DATA_API, ge, be._dataApiKeydownHandler).on(he.KEYDOWN_DATA_API, ye, be._dataApiKeydownHandler).on(he.CLICK_DATA_API + " " + he.KEYUP_DATA_API, be._clearMenus).on(he.CLICK_DATA_API, ge, function (e) {
    e.preventDefault(), e.stopPropagation(), be._jQueryInterface.call(p(this), "toggle")
  }).on(he.CLICK_DATA_API, ".dropdown form", function (e) {
    e.stopPropagation()
  }), p.fn[re] = be._jQueryInterface, p.fn[re].Constructor = be, p.fn[re].noConflict = function () {
    return p.fn[re] = ce, be._jQueryInterface
  };
  var ke, xe = "modal",
    Te = "bs.modal",
    Se = "." + Te,
    ...
    Me = ".sticky-top",
    ze = ((ke = Le.prototype).toggle = function (e) {
      return this._isShown ? this.hide() : this.show(e)
    }, ke.show = function (e) {
      var t, i = this;
      this._isShown || this._isTransitioning || (p(this._element).hasClass(Ie) && (this._isTransitioning = !0), t = p.Event(Ee.SHOW, {
        relatedTarget: e
      }), p(this._element).trigger(t), this._isShown || t.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(Ee.CLICK_DISMISS, '[data-dismiss="modal"]', function (e) {
        return i.hide(e)
      }), p(this._dialog).on(Ee.MOUSEDOWN_DISMISS, function () {
        p(i._element).one(Ee.MOUSEUP_DISMISS, function (e) {
          p(e.target).is(i._element) && (i._ignoreBackdropClick = !0)
        })
      ...
      var t, i, n, o = this;
      e && e.preventDefault(), this._isShown && !this._isTransitioning && (t = p.Event(Ee.HIDE), p(this._element).trigger(t), this._isShown && !t.isDefaultPrevented() && (this._isShown = !1, (i = p(this._element).hasClass(Ie)) && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off(Ee.FOCUSIN), p(this._element).removeClass(Pe), p(this._element).off(Ee.CLICK_DISMISS), p(this._dialog).off(Ee.MOUSEDOWN_DISMISS), i ? (n = m.getTransitionDurationFromElement(this._element), p(this._element).one(m.TRANSITION_END, function (e) {
        return o._hideModal(e)
      }).emulateTransitionEnd(n)) : this._hideModal()))
    }, ke.dispose = function () {
      [window, this._element, this._dialog].forEach(function (e) {
        return p(e).off(Se)
      }), p(document).off(Ee.FOCUSIN), p.removeData(this._element, Te), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
    }, ke.handleUpdate = function () {
      this._adjustDialog()
    }, ke._getConfig = function (e) {
      return e = r({}, De, e), m.typeCheckConfig(xe, e, Oe), e
    }, ke._showElement = function (e) {
      var t = this,
        i = p(this._element).hasClass(Ie);
      this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass("modal-dialog-scrollable") ? this._dialog.querySelector(".modal-body").scrollTop = 0 : this._element.scrollTop = 0, i && m.reflow(this._element), p(this._element).addClass(Pe), this._config.focus && this._enforceFocus();

      function n() {
        t._config.focus && t._element.focus(), t._isTransitioning = !1, p(t._element).trigger(s)
      }
      var o, s = p.Event(Ee.SHOWN, {
        relatedTarget: e
      });
      i ? (o = m.getTransitionDurationFromElement(this._dialog), p(this._dialog).one(m.TRANSITION_END, n).emulateTransitionEnd(o)) : n()
    }, ke._enforceFocus = function () {
      var t = this;
      p(document).off(Ee.FOCUSIN).on(Ee.FOCUSIN, function (e) {
        document !== e.target && t._element !== e.target && 0 === p(t._element).has(e.target).length && t._element.focus()
      })
    }, ke._setEscapeEvent = function () {
      var t = this;
      this._isShown && this._config.keyboard ? p(this._element).on(Ee.KEYDOWN_DISMISS, function (e) {
        27 === e.which && (e.preventDefault(), t.hide())
      }) : this._isShown || p(this._element).off(Ee.KEYDOWN_DISMISS)
    }, ke._setResizeEvent = function () {
      var t = this;
      this._isShown ? p(window).on(Ee.RESIZE, function (e) {
        return t.handleUpdate(e)
      }) : p(window).off(Ee.RESIZE)
    }, ke._hideModal = function () {
      var e = this;
      this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function () {
        p(document.body).removeClass(je), e._resetAdjustments(), e._resetScrollbar(), p(e._element).trigger(Ee.HIDDEN)
      })
    }, ke._removeBackdrop = function () {
      this._backdrop && (p(this._backdrop).remove(), this._backdrop = null)
    }, ke._showBackdrop = function (e) {
      var t, i, n = this,
        o = p(this._element).hasClass(Ie) ? Ie : "";
      if (this._isShown && this._config.backdrop) {
        if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", o && this._backdrop.classList.add(o), p(this._backdrop).appendTo(document.body), p(this._element).on(Ee.CLICK_DISMISS, function (e) {
            n._ignoreBackdropClick ? n._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === n._config.backdrop ? n._element.focus() : n.hide())
          }), o && m.reflow(this._backdrop), p(this._backdrop).addClass(Pe), !e) return;
        if (!o) return void e();
        var s = m.getTransitionDurationFromElement(this._backdrop);
        p(this._backdrop).one(m.TRANSITION_END, e).emulateTransitionEnd(s)
      } else {
        !this._isShown && this._backdrop ? (p(this._backdrop).removeClass(Pe), t = function () {
          n._removeBackdrop(), e && e()
        }, p(this._element).hasClass(Ie) ? (i = m.getTransitionDurationFromElement(this._backdrop), p(this._backdrop).one(m.TRANSITION_END, t).emulateTransitionEnd(i)) : t()) : e && e()
      }
      ...
      var e, t, i, n, o = this;
      this._isBodyOverflowing && (e = [].slice.call(document.querySelectorAll(Ae)), t = [].slice.call(document.querySelectorAll(Me)), p(e).each(function (e, t) {
        var i = t.style.paddingRight,
          n = p(t).css("padding-right");
        p(t).data("padding-right", i).css("padding-right", parseFloat(n) + o._scrollbarWidth + "px")
      }), p(t).each(function (e, t) {
        var i = t.style.marginRight,
          n = p(t).css("margin-right");
        p(t).data("margin-right", i).css("margin-right", parseFloat(n) - o._scrollbarWidth + "px")
      }), i = document.body.style.paddingRight, n = p(document.body).css("padding-right"), p(document.body).data("padding-right", i).css("padding-right", parseFloat(n) + this._scrollbarWidth + "px")), p(document.body).addClass(je)
    ...
    }, Le._jQueryInterface = function (i, n) {
      return this.each(function () {
        var e = p(this).data(Te),
          t = r({}, De, p(this).data(), "object" == typeof i && i ? i : {});
        if (e || (e = new Le(this, t), p(this).data(Te, e)), "string" == typeof i) {
          if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
          e[i](n)
  ...
  p(document).on(Ee.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
    var t, i = this,
      n = m.getSelectorFromElement(this);
    n && (t = document.querySelector(n));
    var o = p(t).data(Te) ? "toggle" : r({}, p(t).data(), p(this).data());
    "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
    var s = p(t).one(Ee.SHOW, function (e) {
      e.isDefaultPrevented() || s.one(Ee.HIDDEN, function () {
        p(i).is(":visible") && i.focus()
      })
    });
    ze._jQueryInterface.call(p(t), o, this)
  }), p.fn[xe] = ze._jQueryInterface, p.fn[xe].Constructor = ze, p.fn[xe].noConflict = function () {
    return p.fn[xe] = Ce, ze._jQueryInterface
  };
  ...
  function qe(e, s, t) {
    ...
    for (var i = (new window.DOMParser).parseFromString(e, "text/html"), r = Object.keys(s), a = [].slice.call(i.body.querySelectorAll("*")), n = 0, o = a.length; n < o; n++) ! function (e) {
      var t = a[e],
      ...
      n.forEach(function (e) {
        ! function (e, t) {
          ...
          if (-1 !== t.indexOf(i)) return -1 === Fe.indexOf(i) || Boolean(e.nodeValue.match(We) || e.nodeValue.match(Re));
  ...
  var Ne, $e = "tooltip",
    ...
    it = "hover",
    nt = "focus",
    ot = ((Ne = st.prototype).enable = function () {
      this._isEnabled = !0
    }, Ne.disable = function () {
      this._isEnabled = !1
    }, Ne.toggleEnabled = function () {
      this._isEnabled = !this._isEnabled
    }, Ne.toggle = function (e) {
      if (this._isEnabled)
        if (e) {
          ...
          if (p(this.getTipElement()).hasClass(tt)) return void this._leave(null, this);
      ...
      if (this.isWithContent() && this._isEnabled) {
        ...
        o.setAttribute("id", s), this.element.setAttribute("aria-describedby", s), this.setContent(), this.config.animation && p(o).addClass(et);
        ...
        }), p(o).addClass(tt), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
        var d, c = function () {
          t.config.animation && t._fixTransition();
          var e = t._hoverState;
          t._hoverState = null, p(t.element).trigger(t.constructor.Event.SHOWN), "out" === e && t._leave(null, t)
        };
        p(this.tip).hasClass(et) ? (d = m.getTransitionDurationFromElement(this.tip), p(this.tip).one(m.TRANSITION_END, c).emulateTransitionEnd(d)) : c()
      }
    }, Ne.hide = function (e) {
      function t() {
        n._hoverState !== Ke && o.parentNode && o.parentNode.removeChild(o), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), p(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), e && e()
      }
      var i, n = this,
        o = this.getTipElement(),
        s = p.Event(this.constructor.Event.HIDE);
      p(this.element).trigger(s), s.isDefaultPrevented() || (p(o).removeClass(tt), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger.click = !1, this._activeTrigger[nt] = !1, this._activeTrigger[it] = !1, p(this.tip).hasClass(et) ? (i = m.getTransitionDurationFromElement(o), p(o).one(m.TRANSITION_END, t).emulateTransitionEnd(i)) : t(), this._hoverState = "")
    }, Ne.update = function () {
      null !== this._popper && this._popper.scheduleUpdate()
    }, Ne.isWithContent = function () {
      return Boolean(this.getTitle())
    }, Ne.addAttachmentClass = function (e) {
      p(this.getTipElement()).addClass(Ue + "-" + e)
    }, Ne.getTipElement = function () {
      return this.tip = this.tip || p(this.config.template)[0], this.tip
    }, Ne.setContent = function () {
      var e = this.getTipElement();
      this.setElementContent(p(e.querySelectorAll(".tooltip-inner")), this.getTitle()), p(e).removeClass(et + " " + tt)
    }, Ne.setElementContent = function (e, t) {
      "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = qe(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t)) : e.text(t) : this.config.html ? p(t).parent().is(e) || e.empty().append(t) : e.text(p(t).text())
    ...
    }, Ne._getAttachment = function (e) {
      return Je[e.toUpperCase()]
    }, Ne._setListeners = function () {
      var n = this;
      this.config.trigger.split(" ").forEach(function (e) {
        var t, i;
        "click" === e ? p(n.element).on(n.constructor.Event.CLICK, n.config.selector, function (e) {
          return n.toggle(e)
        }) : "manual" !== e && (t = e === it ? n.constructor.Event.MOUSEENTER : n.constructor.Event.FOCUSIN, i = e === it ? n.constructor.Event.MOUSELEAVE : n.constructor.Event.FOCUSOUT, p(n.element).on(t, n.config.selector, function (e) {
          return n._enter(e)
    ...
    }, Ne._enter = function (e, t) {
      var i = this.constructor.DATA_KEY;
      (t = t || p(e.currentTarget).data(i)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(i, t)), e && (t._activeTrigger["focusin" === e.type ? nt : it] = !0), p(t.getTipElement()).hasClass(tt) || t._hoverState === Ke ? t._hoverState = Ke : (clearTimeout(t._timeout), t._hoverState = Ke, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function () {
        t._hoverState === Ke && t.show()
      }, t.config.delay.show) : t.show())
    }, Ne._leave = function (e, t) {
      var i = this.constructor.DATA_KEY;
      (t = t || p(e.currentTarget).data(i)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(i, t)), e && (t._activeTrigger["focusout" === e.type ? nt : it] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = "out", t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function () {
      ...
      return Object.keys(t).forEach(function (e) {
        ...
        show: e.delay,
        hide: e.delay
      }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), m.typeCheckConfig($e, e, this.constructor.DefaultType), e.sanitize && (e.template = qe(e.template, e.whiteList, e.sanitizeFn)), e
    ...
    }, Ne._handlePopperPlacementChange = function (e) {
      var t = e.instance;
      this.tip = t.popper, this._cleanTipClass(), this.addAttachmentClass(this._getAttachment(e.placement))
    }, Ne._fixTransition = function () {
      var e = this.getTipElement(),
        t = this.config.animation;
      null === e.getAttribute("x-placement") && (p(e).removeClass(et), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
    }, st._jQueryInterface = function (i) {
      return this.each(function () {
        var e = p(this).data(He),
          t = "object" == typeof i && i;
        if ((e || !/dispose|hide/.test(i)) && (e || (e = new st(this, t), p(this).data(He, e)), "string" == typeof i)) {
          if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
          e[i]()
        }
      })
  ...
  p.fn[$e] = ot._jQueryInterface, p.fn[$e].Constructor = ot, p.fn[$e].noConflict = function () {
    return p.fn[$e] = Ye, ot._jQueryInterface
  };
  var rt = "popover",
    at = "bs.popover",
    lt = "." + at,
    ...
    mt = function (e) {
      ...
      return o.isWithContent = function () {
        ...
        return this.each(function () {
          ...
          if ((e || !/dispose|hide/.test(i)) && (e || (e = new n(this, t), p(this).data(at, e)), "string" == typeof i)) {
            if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
            e[i]()
          }
        })
  ...
  p.fn[rt] = mt._jQueryInterface, p.fn[rt].Constructor = mt, p.fn[rt].noConflict = function () {
    return p.fn[rt] = dt, mt._jQueryInterface
  };
  var gt, yt = "scrollspy",
    vt = "bs.scrollspy",
    _t = "." + vt,
    ...
    Dt = ".list-group-item",
    Ot = "position",
    Et = ((gt = jt.prototype).refresh = function () {
      var t = this,
        e = this._scrollElement === this._scrollElement.window ? "offset" : Ot,
        o = "auto" === this._config.method ? e : this._config.method,
        s = o === Ot ? this._getScrollTop() : 0;
      this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map(function (e) {
        var t, i = m.getSelectorFromElement(e);
        if (i && (t = document.querySelector(i)), t) {
          var n = t.getBoundingClientRect();
          if (n.width || n.height) return [p(t)[o]().top + s, i]
        }
        return null
      }).filter(function (e) {
        return e
      ...
      p.removeData(this._element, vt), p(this._scrollElement).off(_t), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
    }, gt._getConfig = function (e) {
      var t;
      return "string" != typeof (e = r({}, wt, "object" == typeof e && e ? e : {})).target && ((t = p(e.target).attr("id")) || (t = m.getUID(yt), p(e.target).attr("id", t)), e.target = "#" + t), m.typeCheckConfig(yt, e, kt), e
      ...
      i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(Tt), i.addClass(Tt)) : (i.addClass(Tt), i.parents(St).prev(Ct + ", " + Dt).addClass(Tt), i.parents(St).prev(".nav-item").children(Ct).addClass(Tt)), p(this._scrollElement).trigger(xt.ACTIVATE, {
        relatedTarget: t
      })
    }, gt._clear = function () {
    ...
    }, jt._jQueryInterface = function (t) {
      return this.each(function () {
        var e = p(this).data(vt);
        if (e || (e = new jt(this, "object" == typeof t && t), p(this).data(vt, e)), "string" == typeof t) {
          if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
          e[t]()
        }
      })
  ...
  function jt(e, t) {
    var i = this;
    this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(t), this._selector = this._config.target + " " + Ct + "," + this._config.target + " " + Dt + "," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(xt.SCROLL, function (e) {
      return i._process(e)
  ...
  }), p.fn[yt] = Et._jQueryInterface, p.fn[yt].Constructor = Et, p.fn[yt].noConflict = function () {
    return p.fn[yt] = bt, Et._jQueryInterface
  };
  var It, Pt = "bs.tab",
    At = "." + Pt,
    Mt = p.fn.tab,
    ...
    Ft = ".active",
    Wt = "> li > .active",
    Rt = ((It = qt.prototype).show = function () {
      var e, t, i, n, o, s, r, a, l = this;
      this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Lt) || p(this._element).hasClass("disabled") || (t = p(this._element).closest(".nav, .list-group")[0], i = m.getSelectorFromElement(this._element), t && (n = "UL" === t.nodeName || "OL" === t.nodeName ? Wt : Ft, o = (o = p.makeArray(p(t).find(n)))[o.length - 1]), s = p.Event(zt.HIDE, {
        relatedTarget: this._element
      }), r = p.Event(zt.SHOW, {
        relatedTarget: o
      }), o && p(o).trigger(s), p(this._element).trigger(r), r.isDefaultPrevented() || s.isDefaultPrevented() || (i && (e = document.querySelector(i)), this._activate(this._element, t), a = function () {
        var e = p.Event(zt.HIDDEN, {
            relatedTarget: l._element
          }),
          t = p.Event(zt.SHOWN, {
            relatedTarget: o
          });
        p(o).trigger(e), p(l._element).trigger(t)
      }, e ? this._activate(e, e.parentNode, a) : a()))
    }, It.dispose = function () {
      p.removeData(this._element, Pt), this._element = null
    }, It._activate = function (e, t, i) {
      function n() {
        return s._transitionComplete(e, r, i)
      }
      var o, s = this,
        r = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children(Ft) : p(t).find(Wt))[0],
        a = i && r && p(r).hasClass("fade");
      r && a ? (o = m.getTransitionDurationFromElement(r), p(r).removeClass("show").one(m.TRANSITION_END, n).emulateTransitionEnd(o)) : n()
    }, It._transitionComplete = function (e, t, i) {
      var n, o, s;
      t && (p(t).removeClass(Lt), (n = p(t.parentNode).find("> .dropdown-menu .active")[0]) && p(n).removeClass(Lt), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)), p(e).addClass(Lt), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), m.reflow(e), e.classList.contains("fade") && e.classList.add("show"), e.parentNode && p(e.parentNode).hasClass("dropdown-menu") && ((o = p(e).closest(".dropdown")[0]) && (s = [].slice.call(o.querySelectorAll(".dropdown-toggle")), p(s).addClass(Lt)), e.setAttribute("aria-expanded", !0)), i && i()
    }, qt._jQueryInterface = function (i) {
      return this.each(function () {
        var e = p(this),
          t = e.data(Pt);
        if (t || (t = new qt(this), e.data(Pt, t)), "string" == typeof i) {
  ...
  p(document).on(zt.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function (e) {
    ...
    return p.fn.tab = Mt, Rt._jQueryInterface
  };
  var Nt, $t = "toast",
    Ht = "bs.toast",
    Bt = "." + Ht,
    ...
    Vt = ((Nt = Kt.prototype).show = function () {
      var e = this;
      p(this._element).trigger(Ut.SHOW), this._config.animation && this._element.classList.add("fade");

      function t() {
        e._element.classList.remove(Xt), e._element.classList.add(Gt), p(e._element).trigger(Ut.SHOWN), e._config.autohide && e.hide()
      }
      var i;
      this._element.classList.remove("hide"), this._element.classList.add(Xt), this._config.animation ? (i = m.getTransitionDurationFromElement(this._element), p(this._element).one(m.TRANSITION_END, t).emulateTransitionEnd(i)) : t()
    }, Nt.hide = function (e) {
      var t = this;
      this._element.classList.contains(Gt) && (p(this._element).trigger(Ut.HIDE), e ? this._close() : this._timeout = setTimeout(function () {
        t._close()
      }, this._config.delay))
    }, Nt.dispose = function () {
      clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Gt) && this._element.classList.remove(Gt), p(this._element).off(Ut.CLICK_DISMISS), p.removeData(this._element, Ht), this._element = null, this._config = null
    }, Nt._getConfig = function (e) {
      return e = r({}, Jt, p(this._element).data(), "object" == typeof e && e ? e : {}), m.typeCheckConfig($t, e, this.constructor.DefaultType), e
    }, Nt._setListeners = function () {
      var e = this;
      p(this._element).on(Ut.CLICK_DISMISS, '[data-dismiss="toast"]', function () {
        return e.hide(!0)
      })
    }, Nt._close = function () {
      function e() {
        i._element.classList.add("hide"), p(i._element).trigger(Ut.HIDDEN)
      }
      var t, i = this;
      this._element.classList.remove(Gt), this._config.animation ? (t = m.getTransitionDurationFromElement(this._element), p(this._element).one(m.TRANSITION_END, e).emulateTransitionEnd(t)) : e()
    }, Kt._jQueryInterface = function (i) {
      return this.each(function () {
        var e = p(this),
          t = e.data(Ht);
        if (t || (t = new Kt(this, "object" == typeof i && i), e.data(Ht, t)), "string" == typeof i) {
          if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
          t[i](this)
        }
      })
  ...
  p.fn[$t] = Vt._jQueryInterface, p.fn[$t].Constructor = Vt, p.fn[$t].noConflict = function () {
      return p.fn[$t] = Yt, Vt._jQueryInterface
    },
    function () {
      if (void 0 === p) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
      var e = p.fn.jquery.split(" ")[0].split(".");
      if (e[0] < 2 && e[1] < 9 || 1 === e[0] && 9 === e[1] && e[2] < 1 || 4 <= e[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
    }(), e.Util = m, e.Alert = h, e.Button = C, e.Carousel = $, e.Collapse = ne, e.Dropdown = be, e.Modal = ze, e.Popover = mt, e.Scrollspy = Et, e.Tab = Rt, e.Toast = Vt, e.Tooltip = ot, Object.defineProperty(e, "__esModule", {
      value: !0
    })
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    function S(e, t, i, n) {
      var o = {
        ...
        h = (d + c) / 2,
        f = (h - u) / 8;
      return o.b = l + (e - l) / 4, s.b = u + f, o.c = s.a = (o.b + s.b) / 2, s.c = r.a = (u + h) / 2, r.b = h - f, a.b = c + (n - c) / 4, r.c = a.a = (r.b + a.b) / 2, [o, s, r, a]
    }

    function f(e, t, i, n, o, s) {
      var r, a, l, d, c, u, h, f, p = {},
        m = [],
        g = s || e[0];
      ...
      if (1 < e.length) {
        for (f = e[e.length - 1], h = !0, r = m.length; - 1 < --r;)
          if (a = m[r], .05 < Math.abs(g[a] - f[a])) {
            h = !1;
            break
          } h && (e = e.concat(), s && e.unshift(s), e.push(e[1]), s = e[e.length - 3])
      }
      for (w.length = k.length = x.length = 0, r = m.length; - 1 < --r;) a = m[r], y[a] = -1 !== o.indexOf("," + a + ","), p[a] = function (e, t, i, n) {
        var o, s, r, a, l, d, c = [];
        if (n)
          for (s = (e = [n].concat(e)).length; - 1 < --s;) "string" == typeof (d = e[s][t]) && "=" === d.charAt(1) && (e[s][t] = n[t] + Number(d.charAt(0) + d.substr(2)));
        if ((o = e.length - 2) < 0) return c[0] = new v(e[0][t], 0, 0, e[0][t]), c;
        for (s = 0; s < o; s++) r = e[s][t], a = e[s + 1][t], c[s] = new v(r, 0, 0, a), i && (l = e[s + 2][t], w[s] = (w[s] || 0) + (a - r) * (a - r), k[s] = (k[s] || 0) + (l - a) * (l - a));
        return c[s] = new v(e[s][t], 0, 0, e[s + 1][t]), c
      }(e, a, y[a], s);
      for (r = w.length; - 1 < --r;) w[r] = Math.sqrt(w[r]), k[r] = Math.sqrt(k[r]);
      if (!n) {
        for (r = m.length; - 1 < --r;)
          if (y[a])
            for (u = (l = p[m[r]]).length - 1, d = 0; d < u; d++) c = l[d + 1].da / k[d] + l[d].da / w[d] || 0, x[d] = (x[d] || 0) + c * c;
        for (r = x.length; - 1 < --r;) x[r] = Math.sqrt(x[r])
      }
      for (r = m.length, d = i ? 4 : 1; - 1 < --r;)(function (e, t, i, n, o) {
        for (var s, r, a, l, d, c, u, h, f, p, m, g, y = e.length - 1, v = 0, _ = e[0].a, b = 0; b < y; b++) s = (l = e[v]).a, r = l.d, a = e[v + 1].d, u = o ? (p = w[b], g = ((m = k[b]) + p) * t * .25 / (!n && x[b] || .5), r - ((d = r - (r - s) * (n ? .5 * t : 0 !== p ? g / p : 0)) + (((c = r + (a - r) * (n ? .5 * t : 0 !== m ? g / m : 0)) - d) * (3 * p / (p + m) + .5) / 4 || 0))) : r - ((d = r - (r - s) * t * .5) + (c = r + (a - r) * t * .5)) / 2, d += u, c += u, l.c = h = d, l.b = 0 !== b ? _ : _ = l.a + .6 * (l.c - l.a), l.da = r - s, l.ca = h - s, l.ba = _ - s, i ? (f = S(s, _, h, r), e.splice(v, 1, f[0], f[1], f[2], f[3]), v += 4) : v++, _ = c;
        (l = e[v]).b = _, l.c = _ + .4 * (l.d - _), l.da = l.d - l.a, l.ca = l.c - l.a, l.ba = _ - l.a, i && (f = S(l.a, _, l.c, l.d), e.splice(v, 1, f[0], f[1], f[2], f[3]))
      })(l = p[a = m[r]], t, i, n, y[a]), h && (l.splice(0, d), l.splice(l.length - d, d));
      return p
    }
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (n, c, _) {
      ...
      function y(e) {
        ...
        return function (e, t, i) {
          var n, o, s, r, a, l, d, c, u, h = (i || p).length,
            f = v[h];
          if (!f) {
            if (!(u = "auto" === p.grid ? 0 : (p.grid || [1 / 0])[0])) {
              for (d = -1 / 0; d < (d = i[u++].getBoundingClientRect().left) && u < h;);
              u--
            }
            for (f = v[h] = [], n = _ ? Math.min(u, h) * w - .5 : g % u, o = _ ? h * w / u - .5 : g / u | 0, c = 1 / (d = 0), l = 0; l < h; l++) s = l % u - n, r = o - (l / u | 0), f[l] = a = b ? Math.abs("y" === b ? r : s) : Math.sqrt(s * s + r * r), d < a && (d = a), a < c && (c = a);
            f.max = d - c, f.min = c, f.v = h = p.amount || p.each * (h < u ? h - 1 : b ? "y" === b ? h / u : u : Math.max(u, h / u)) || 0, f.b = h < 0 ? y - h : y
          }
          return h = (f[e] - f.min) / f.max, f.b + (m ? m.getRatio(h) : h) * f.v
        }
      }
      var v = function (e, t, i) {
          _.call(this, e, t, i), this._cycle = 0, this._yoyo = !0 === this.vars.yoyo || !!this.vars.yoyoEase, this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._repeat && this._uncache(!0), this.render = v.prototype.render
        },
        b = 1e-8,
        w = _._internals,
        k = w.isSelector,
        ...
        T = [];
      v.version = "2.1.3", e.constructor = v, e.kill()._gc = !1, v.killTweensOf = v.killDelayedCallsTo = _.killTweensOf, v.getTweensOf = _.getTweensOf, v.lagSmoothing = _.lagSmoothing, v.ticker = _.ticker, v.render = _.render, v.distribute = y, e.invalidate = function () {
        ...
        var i, n = this,
          o = n.ratio,
          s = n.vars.immediateRender || e.immediateRender;
        ...
        if (n._initted || s)
          if (t) n._initted = !1, s && n.render(0, !0, !0);
          ...
          for (var a, l = 1 / (1 - o), d = n._firstPT; d;) a = d.s + d.c, d.c *= l, d.s = a - d.c, d = d._next;
        return n
      }, e.render = function (e, t, i) {
        this._initted || 0 === this._duration && this.vars.repeat && this.invalidate();
        var n, o, s, r, a, l, d, c, u, h = this,
          ...
          y = h._duration,
          v = h._rawPrevTime;
        if (f - b <= e && 0 <= e ? (h._totalTime = f, h._cycle = h._repeat, h._yoyo && 0 != (1 & h._cycle) ? (h._time = 0, h.ratio = h._ease._calcEnd ? h._ease.getRatio(0) : 0) : (h._time = y, h.ratio = h._ease._calcEnd ? h._ease.getRatio(1) : 1), h._reversed || (n = !0, o = "onComplete", i = i || h._timeline.autoRemoveChildren), 0 !== y || !h._initted && h.vars.lazy && !i || (h._startTime === h._timeline._duration && (e = 0), (v < 0 || e <= 0 && -b <= e || v === b && "isPause" !== h.data) && v !== e && (i = !0, b < v && (o = "onReverseComplete")), h._rawPrevTime = c = !t || e || v === e ? e : b)) : e < b ? (h._totalTime = h._time = h._cycle = 0, h.ratio = h._ease._calcEnd ? h._ease.getRatio(0) : 0, (0 !== m || 0 === y && 0 < v) && (o = "onReverseComplete", n = h._reversed), -b < e ? e = 0 : e < 0 && (h._active = !1, 0 !== y || !h._initted && h.vars.lazy && !i || (0 <= v && (i = !0), h._rawPrevTime = c = !t || e || v === e ? e : b)), h._initted || (i = !0)) : (h._totalTime = h._time = e, 0 !== h._repeat && (r = y + h._repeatDelay, h._cycle = h._totalTime / r >> 0, 0 !== h._cycle && h._cycle === h._totalTime / r && m <= e && h._cycle--, h._time = h._totalTime - h._cycle * r, h._yoyo && 0 != (1 & h._cycle) && (h._time = y - h._time, (u = h._yoyoEase || h.vars.yoyoEase) && (h._yoyoEase || (!0 !== u || h._initted ? h._yoyoEase = u = !0 === u ? h._ease : u instanceof Ease ? u : Ease.map[u] : (u = h.vars.ease, h._yoyoEase = u = u ? u instanceof Ease ? u : "function" == typeof u ? new Ease(u, h.vars.easeParams) : Ease.map[u] || _.defaultEase : _.defaultEase)), h.ratio = u ? 1 - u.getRatio((y - h._time) / y) : 0)), h._time > y ? h._time = y : h._time < 0 && (h._time = 0)), h._easeType && !u ? (a = h._time / y, (1 === (l = h._easeType) || 3 === l && .5 <= a) && (a = 1 - a), 3 === l && (a *= 2), 1 === (d = h._easePower) ? a *= a : 2 === d ? a *= a * a : 3 === d ? a *= a * a * a : 4 === d && (a *= a * a * a * a), h.ratio = 1 === l ? 1 - a : 2 === l ? a : h._time / y < .5 ? a / 2 : 1 - a / 2) : u || (h.ratio = h._ease.getRatio(h._time / y))), p !== h._time || i || g !== h._cycle) {
          if (!h._initted) {
            if (h._init(), !h._initted || h._gc) return;
            if (!i && h._firstPT && (!1 !== h.vars.lazy && h._duration || h.vars.lazy && !h._duration)) return h._time = p, h._totalTime = m, h._rawPrevTime = v, h._cycle = g, w.lazyTweens.push(h), void(h._lazy = [e, t]);
            !h._time || n || u ? n && this._ease._calcEnd && !u && (h.ratio = h._ease.getRatio(0 === h._time ? 0 : 1)) : h.ratio = h._ease.getRatio(h._time / y)
          }
          for (!1 !== h._lazy && (h._lazy = !1), h._active || !h._paused && h._time !== p && 0 <= e && (h._active = !0), 0 === m && (2 === h._initted && 0 < e && h._init(), h._startAt && (0 <= e ? h._startAt.render(e, !0, i) : o = o || "_dummyGS"), !h.vars.onStart || 0 === h._totalTime && 0 !== y || (t || h._callback("onStart"))), s = h._firstPT; s;) s.f ? s.t[s.p](s.c * h.ratio + s.s) : s.t[s.p] = s.c * h.ratio + s.s, s = s._next;
          h._onUpdate && (e < 0 && h._startAt && h._startTime && h._startAt.render(e, !0, i), t || h._totalTime === m && !o || h._callback("onUpdate")), h._cycle !== g && (t || h._gc || h.vars.onRepeat && h._callback("onRepeat")), !o || h._gc && !i || (e < 0 && h._startAt && !h._onUpdate && h._startTime && h._startAt.render(e, !0, i), n && (h._timeline.autoRemoveChildren && h._enabled(!1, !1), h._active = !1), !t && h.vars[o] && h._callback(o), 0 === y && h._rawPrevTime === b && c !== b && (h._rawPrevTime = 0))
      ...
      }, v.staggerTo = v.allTo = function (e, t, i, n, o, s, r) {
        var a, l, d, c, u = [],
          h = y(i.stagger || n),
          f = i.cycle,
          p = (i.startAt || T).cycle;
        for (x(e) || ("string" == typeof e && (e = _.selector(e) || e), k(e) && (e = m(e))), a = (e = e || []).length - 1, d = 0; d <= a; d++) {
          for (c in l = {}, i) l[c] = i[c];
          if (f && (g(l, e, d), null != l.duration && (t = l.duration, delete l.duration)), p) {
            for (c in p = l.startAt = {}, i.startAt) p[c] = i.startAt[c];
            g(l.startAt, e, d)
          }
          l.delay = h(d, e[d], e) + (l.delay || 0), d === a && o && (l.onComplete = function () {
            i.onComplete && i.onComplete.apply(i.onCompleteScope || this, arguments), o.apply(r || i.callbackScope || this, s || T)
          }), u[d] = new v(e[d], t, l)
        }
        return u
      }, v.staggerFrom = v.allFrom = function (e, t, i, n, o, s, r) {
        return i.runBackwards = !0, i.immediateRender = 0 != i.immediateRender, v.staggerTo(e, t, i, n, o, s, r)
      }, v.staggerFromTo = v.allFromTo = function (e, t, i, n, o, s, r, a) {
        return n.startAt = i, n.immediateRender = 0 != n.immediateRender && 0 != i.immediateRender, v.staggerTo(e, t, n, o, s, r, a)
      }, v.delayedCall = function (e, t, i, n, o) {
        return new v(t, 0, {
          delay: e,
          onComplete: t,
          onCompleteParams: i,
      ...
      var s = function (e, t) {
          for (var i = [], n = 0, o = e._first; o;) o instanceof _ ? i[n++] = o : (t && (i[n++] = o), n = (i = i.concat(s(o, t))).length), o = o._next;
          return i
        },
        u = v.getAllTweens = function (e) {
          return s(n._rootTimeline, e).concat(s(n._rootFramesTimeline, e))
        };
      v.killAll = function (e, t, i, n) {
        null == t && (t = !0), null == i && (i = !0);
        for (var o, s, r = u(0 != n), a = r.length, l = t && i && n, d = 0; d < a; d++) s = r[d], (l || s instanceof c || (o = s.target === s.vars.onComplete) && i || t && !o) && (e ? s.totalTime(s._reversed ? 0 : s.totalDuration()) : s._enabled(!1, !1))
      }, v.killChildTweensOf = function (e, t) {
        if (null != e) {
          var i, n, o, s, r, a = w.tweenLookup;
          if ("string" == typeof e && (e = _.selector(e) || e), k(e) && (e = m(e)), x(e))
            for (s = e.length; - 1 < --s;) v.killChildTweensOf(e[s], t);
          else {
            for (o in i = [], a)
              for (n = a[o].target.parentNode; n;) n === e && (i = i.concat(a[o].tweens)), n = n.parentNode;
            for (r = i.length, s = 0; s < r; s++) t && i[s].totalTime(i[s].totalDuration()), i[s]._enabled(!1, !1)
          }
        }
      };
      ...
      function o(e, t, i, n) {
        t = !1 !== t, i = !1 !== i;
        for (var o, s, r = u(n = !1 !== n), a = t && i && n, l = r.length; - 1 < --l;) s = r[l], (a || s instanceof c || (o = s.target === s.vars.onComplete) && i || t && !o) && s.paused(e)
      }
      return v.pauseAll = function (e, t, i) {
        ...
        var t = n._rootTimeline,
          i = _.ticker.time;
        return arguments.length ? (e = e || b, t._startTime = i - (i - t._startTime) * t._timeScale / e, t = n._rootFramesTimeline, i = _.ticker.frame, t._startTime = i - (i - t._startTime) * t._timeScale / e, t._timeScale = n._rootTimeline._timeScale = e) : t._timeScale
    ...
    }, !0), _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (u, h, p) {
      function m(e) {
        h.call(this, e);
        var t, i, n = this,
          o = n.vars;
        for (i in n._labels = {}, n.autoRemoveChildren = !!o.autoRemoveChildren, n.smoothChildTiming = !!o.smoothChildTiming, n._sortChildren = !0, n._onUpdate = o.onUpdate, o) t = o[i], f(t) && -1 !== t.join("").indexOf("{self}") && (o[i] = n._swapSelfInParams(t));
        f(o.tweens) && n.add(o.tweens, 0, o.align, o.stagger)
      }
      ...
      var _ = 1e-8,
        ...
        i = m.prototype = new h;
      return m.version = "2.1.3", m.distribute = v, i.constructor = m, i.kill()._gc = i._forcingPlayhead = i._hasPause = !1, i.to = function (e, t, i, n) {
        var o = i.repeat && r.TweenMax || p;
        return t ? this.add(new o(e, t, i), n) : this.set(e, i, n)
      }, i.from = function (e, t, i, n) {
        return this.add((i.repeat && r.TweenMax || p).from(e, t, d(0, i)), n)
      }, i.fromTo = function (e, t, i, n, o) {
        var s = n.repeat && r.TweenMax || p;
        return n = d(0, n, i), t ? this.add(s.fromTo(e, t, i, n), o) : this.set(e, n, o)
      }, i.staggerTo = function (e, t, i, n, o, s, r, a) {
        var l, d, c = new m({
            onComplete: s,
            onCompleteParams: r,
            callbackScope: a,
          ...
          h = i.startAt,
          f = i.cycle;
        for ("string" == typeof e && (e = p.selector(e) || e), b(e = e || []) && (e = function (e) {
            for (var t = [], i = e.length, n = 0; n !== i; t.push(e[n++]));
            return t
          }(e)), d = 0; d < e.length; d++) l = g(i), h && (l.startAt = g(h), h.cycle && y(l.startAt, e, d)), f && (y(l, e, d), null != l.duration && (t = l.duration, delete l.duration)), c.to(e[d], t, l, u(d, e[d], e));
        return this.add(c, o)
      }, i.staggerFrom = function (e, t, i, n, o, s, r, a) {
        return i.runBackwards = !0, this.staggerTo(e, t, d(0, i), n, o, s, r, a)
      }, i.staggerFromTo = function (e, t, i, n, o, s, r, a, l) {
        return n.startAt = i, this.staggerTo(e, t, d(0, n, i), o, s, r, a, l)
      }, i.call = function (e, t, i, n) {
        return this.add(p.delayedCall(0, e, t, i), n)
      }, i.set = function (e, t, i) {
        return this.add(new p(e, 0, d(0, t, null, !0)), i)
      }, m.exportRoot = function (e, t) {
        null == (e = e || {}).smoothChildTiming && (e.smoothChildTiming = !0);
        var i, n, o, s, r = new m(e),
          a = r._timeline;
        for (null == t && (t = !0), a._remove(r, !0), r._startTime = 0, r._rawPrevTime = r._time = r._totalTime = a._time, o = a._first; o;) s = o._next, t && o instanceof p && o.target === o.vars.onComplete || ((n = o._startTime - o._delay) < 0 && (i = 1), r.add(o, n)), o = s;
        return a.add(r, 0), i && r.totalDuration(), r
      }, i.add = function (e, t, i, n) {
        var o, s, r, a, l, d, c = this;
        if ("number" != typeof t && (t = c._parseTimeOrLabel(t, 0, !0, e)), !(e instanceof u)) {
          if (e instanceof Array || e && e.push && f(e)) {
            for (i = i || "normal", n = n || 0, o = t, s = e.length, r = 0; r < s; r++) f(a = e[r]) && (a = new m({
              tweens: a
            })), c.add(a, o), "string" != typeof a && "function" != typeof a && ("sequence" === i ? o = a._startTime + a.totalDuration() / a._timeScale : "start" === i && (a._startTime -= a.delay())), o += n;
            return c._uncache(!0)
          }
        ...
        if (h.prototype.add.call(c, e, t), (e._time || !e._duration && e._initted) && (o = (c.rawTime() - e._startTime) * e._timeScale, (!e._duration || 1e-5 < Math.abs(Math.max(0, Math.min(e.totalDuration(), o))) - e._totalTime) && e.render(o, !1, !1)), (c._gc || c._time === c._duration) && !c._paused && c._duration < c.duration())
          for (d = (l = c).rawTime() > e._startTime; l._timeline;) d && l._timeline.smoothChildTiming ? l.totalTime(l._totalTime, !0) : l._gc && l._enabled(!0, !1), l = l._timeline;
        return c
      }, i.remove = function (e) {
        if (e instanceof u) {
          this._remove(e, !1);
        ...
        var o = p.delayedCall(0, s, i, n || this);
        ...
        if (t = t || 0, "string" != typeof e || !isNaN(e) && null == this._labels[e]) null == e && (e = o);
          ...
          if (-1 === (s = e.indexOf("="))) return null == this._labels[e] ? i ? this._labels[e] = o + t : t : this._labels[e] + t;
          t = parseInt(e.charAt(s - 1) + "1", 10) * Number(e.substr(s + 1)), e = 1 < s ? this._parseTimeOrLabel(e.substr(0, s - 1), 0, i) : o
        }
        return Number(e) + t
      }, i.seek = function (e, t) {
        ...
        var n, o, s, r, a, l, d, c, u = this,
          h = u._time,
          f = u._dirty ? u.totalDuration() : u._totalDuration,
          p = u._startTime,
          m = u._timeScale,
          g = u._paused;
        if (h !== u._time && (e += u._time - h), u._hasPause && !u._forcingPlayhead && !t) {
          if (h < e)
          ...
          l && (u._time = u._totalTime = e = l._startTime, c = u._startTime + (u._reversed ? u._duration - e : e) / u._timeScale)
        }
        if (f - _ <= e && 0 <= e) u._totalTime = u._time = f, u._reversed || u._hasPausedChild() || (o = !0, r = "onComplete", a = !!u._timeline.autoRemoveChildren, 0 === u._duration && (e <= 0 && -_ <= e || u._rawPrevTime < 0 || u._rawPrevTime === _) && u._rawPrevTime !== e && u._first && (a = !0, u._rawPrevTime > _ && (r = "onReverseComplete"))), u._rawPrevTime = u._duration || !t || e || u._rawPrevTime === e ? e : _, e = f + 1e-4;
        else if (e < _)
          if (u._totalTime = u._time = 0, -_ < e && (e = 0), (0 !== h || 0 === u._duration && u._rawPrevTime !== _ && (0 < u._rawPrevTime || e < 0 && 0 <= u._rawPrevTime)) && (r = "onReverseComplete", o = u._reversed), e < 0) u._active = !1, u._timeline.autoRemoveChildren && u._reversed ? (a = o = !0, r = "onReverseComplete") : 0 <= u._rawPrevTime && u._first && (a = !0), u._rawPrevTime = e;
          else {
            if (u._rawPrevTime = u._duration || !t || e || u._rawPrevTime === e ? e : _, 0 === e && o)
              for (n = u._first; n && 0 === n._startTime;) n._duration || (o = !1), n = n._next;
            e = 0, u._initted || (a = !0)
          }
        else u._totalTime = u._time = u._rawPrevTime = e;
        if (u._time !== h && u._first || i || a || l) {
          if (u._initted || (u._initted = !0), u._active || !u._paused && u._time !== h && 0 < e && (u._active = !0), 0 === h && u.vars.onStart && (0 === u._time && u._duration || t || u._callback("onStart")), h <= (d = u._time))
            for (n = u._first; n && (s = n._next, d === u._time && (!u._paused || g));)(n._active || n._startTime <= d && !n._paused && !n._gc) && (l === n && (u.pause(), u._pauseTime = c), n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)), n = s;
          else
            for (n = u._last; n && (s = n._prev, d === u._time && (!u._paused || g));) {
              if (n._active || n._startTime <= h && !n._paused && !n._gc) {
                if (l === n) {
                  for (l = n._prev; l && l.endTime() > u._time;) l.render(l._reversed ? l.totalDuration() - (e - l._startTime) * l._timeScale : (e - l._startTime) * l._timeScale, t, i), l = l._prev;
                  l = null, u.pause(), u._pauseTime = c
                }
                n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)
              }
              n = s
            }
          u._onUpdate && (t || (w.length && k(), u._callback("onUpdate"))), r && (u._gc || p !== u._startTime && m === u._timeScale || !(0 === u._time || f >= u.totalDuration()) || (o && (w.length && k(), u._timeline.autoRemoveChildren && u._enabled(!1, !1), u._active = !1), !t && u.vars[r] && u._callback(r)))
        }
        ...
        n = n || -9999999999;
        for (var o = [], s = this._first, r = 0; s;) s._startTime < n || (s instanceof p ? !1 !== t && (o[r++] = s) : (!1 !== i && (o[r++] = s), !1 !== e && (r = (o = o.concat(s.getChildren(!0, t, i))).length))), s = s._next;
        return o
      }, i.getTweensOf = function (e, t) {
        var i, n, o = this._gc,
          s = [],
          r = 0;
        for (o && this._enabled(!0, !0), n = (i = p.getTweensOf(e)).length; - 1 < --n;)(i[n].timeline === this || t && this._contains(i[n])) && (s[r++] = i[n]);
      ...
      var O = 1e-8,
        ...
        o = i.prototype = new t;
      return o.constructor = i, o.kill()._gc = !1, i.version = "2.1.3", o.invalidate = function () {
        ...
        var n, o, s, r, a, l, d, c, u, h = this,
          ...
          b = h._paused,
          w = h._cycle;
        if (f !== h._time && (e += h._time - f), p - O <= e && 0 <= e) h._locked || (h._totalTime = p, h._cycle = h._repeat), h._reversed || h._hasPausedChild() || (o = !0, r = "onComplete", a = !!h._timeline.autoRemoveChildren, 0 === h._duration && (e <= 0 && -O <= e || _ < 0 || _ === O) && _ !== e && h._first && (a = !0, O < _ && (r = "onReverseComplete"))), h._rawPrevTime = h._duration || !t || e || h._rawPrevTime === e ? e : O, h._yoyo && 1 & h._cycle ? h._time = e = 0 : e = (h._time = m) + 1e-4;
        else if (e < O)
          if (h._locked || (h._totalTime = h._cycle = 0), h._time = 0, -O < e && (e = 0), (0 !== f || 0 === m && _ !== O && (0 < _ || e < 0 && 0 <= _) && !h._locked) && (r = "onReverseComplete", o = h._reversed), e < 0) h._active = !1, h._timeline.autoRemoveChildren && h._reversed ? (a = o = !0, r = "onReverseComplete") : 0 <= _ && h._first && (a = !0), h._rawPrevTime = e;
          else {
            if (h._rawPrevTime = m || !t || e || h._rawPrevTime === e ? e : O, 0 === e && o)
              for (n = h._first; n && 0 === n._startTime;) n._duration || (o = !1), n = n._next;
            e = 0, h._initted || (a = !0)
          }
        else 0 === m && _ < 0 && (a = !0), h._time = h._rawPrevTime = e, h._locked || (h._totalTime = e, 0 !== h._repeat && (l = m + h._repeatDelay, h._cycle = h._totalTime / l >> 0, h._cycle && h._cycle === h._totalTime / l && g <= e && h._cycle--, h._time = h._totalTime - h._cycle * l, h._yoyo && 1 & h._cycle && (h._time = m - h._time), h._time > m ? e = (h._time = m) + 1e-4 : h._time < 0 ? h._time = e = 0 : e = h._time));
        if (h._hasPause && !h._forcingPlayhead && !t) {
          if (f < (e = h._time) || h._repeat && w !== h._cycle)
            for (n = h._first; n && n._startTime <= e && !d;) n._duration || "isPause" !== n.data || n.ratio || 0 === n._startTime && 0 === h._rawPrevTime || (d = n), n = n._next;
          else
            for (n = h._last; n && n._startTime >= e && !d;) n._duration || "isPause" === n.data && 0 < n._rawPrevTime && (d = n), n = n._prev;
          d && (u = h._startTime + (h._reversed ? h._duration - d._startTime : d._startTime) / h._timeScale, d._startTime < m && (h._time = h._rawPrevTime = e = d._startTime, h._totalTime = e + h._cycle * (h._totalDuration + h._repeatDelay)))
        }
        if (h._cycle !== w && !h._locked) {
          var k = h._yoyo && 0 != (1 & w),
            x = k === (h._yoyo && 0 != (1 & h._cycle)),
            T = h._totalTime,
            S = h._cycle,
            C = h._rawPrevTime,
            D = h._time;
          if (h._totalTime = w * m, h._cycle < w ? k = !k : h._totalTime += m, h._time = f, h._rawPrevTime = 0 === m ? _ - 1e-4 : _, h._cycle = w, h._locked = !0, f = k ? 0 : m, h.render(f, t, 0 === m), t || h._gc || h.vars.onRepeat && (h._cycle = S, h._locked = !1, h._callback("onRepeat")), f !== h._time) return;
          if (x && (h._cycle = w, h._locked = !0, f = k ? m + 1e-4 : -1e-4, h.render(f, !0, !1)), h._locked = !1, h._paused && !b) return;
          h._time = D, h._totalTime = T, h._cycle = S, h._rawPrevTime = C
        }
        if (h._time !== f && h._first || i || a || d) {
          if (h._initted || (h._initted = !0), h._active || !h._paused && h._totalTime !== g && 0 < e && (h._active = !0), 0 === g && h.vars.onStart && (0 === h._totalTime && h._totalDuration || t || h._callback("onStart")), f <= (c = h._time))
            for (n = h._first; n && (s = n._next, c === h._time && (!h._paused || b));)(n._active || n._startTime <= h._time && !n._paused && !n._gc) && (d === n && (h.pause(), h._pauseTime = u), n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)), n = s;
          else
            for (n = h._last; n && (s = n._prev, c === h._time && (!h._paused || b));) {
              if (n._active || n._startTime <= f && !n._paused && !n._gc) {
                if (d === n) {
                  for (d = n._prev; d && d.endTime() > h._time;) d.render(d._reversed ? d.totalDuration() - (e - d._startTime) * d._timeScale : (e - d._startTime) * d._timeScale, t, i), d = d._prev;
                  d = null, h.pause(), h._pauseTime = u
                }
                n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)
              }
              n = s
            }
          h._onUpdate && (t || (E.length && j(), h._callback("onUpdate"))), r && (h._locked || h._gc || y !== h._startTime && v === h._timeScale || !(0 === h._time || p >= h.totalDuration()) || (o && (E.length && j(), h._timeline.autoRemoveChildren && h._enabled(!1, !1), h._active = !1), !t && h.vars[r] && h._callback(r)))
        } else g !== h._totalTime && h._onUpdate && (t || h._callback("onUpdate"))
      }, o.getActive = function (e, t, i) {
        for (var n, o = [], s = this.getChildren(e || null == e, t || null == e, !!i), r = 0, a = s.length, l = 0; l < a; l++)(n = s[l]).isActive() && (o[r++] = n);
        return o
      }, o.getLabelAfter = function (e) {
        e || 0 !== e && (e = this._time);
        for (var t = this.getLabelsArray(), i = t.length, n = 0; n < i; n++)
    ...
    }, !0), T = 180 / Math.PI, w = [], k = [], x = [], y = {}, i = _gsScope._gsDefine.globals, g = _gsScope._gsDefine.plugin({
      propName: "bezier",
      priority: -1,
      version: "1.3.9",
      API: 2,
      ...
      init: function (e, t, i) {
        ...
        for (s = this._props.length; - 1 < --s;) n = this._props[s], this._overwriteProps.push(n), o = this._func[n] = "function" == typeof e[n], c[n] = o ? e[n.indexOf("set") || "function" != typeof e["get" + n.substr(3)] ? n : "get" + n.substr(3)]() : parseFloat(e[n]), a || c[n] !== d[0][n] && (a = c);
        if (this._beziers = "cubic" !== t.type && "quadratic" !== t.type && "soft" !== t.type ? f(d, isNaN(t.curviness) ? 1 : t.curviness, !1, "thruBasic" === t.type, t.correlate, a) : function (e, t, i) {
            var n, o, s, r, a, l, d, c, u, h, f, p = {},
            ...
            for (l = y.length; - 1 < --l;) {
              for (p[u = y[l]] = a = [], h = 0, c = e.length, d = 0; d < c; d++) n = null == i ? e[d][u] : "string" == typeof (f = e[d][u]) && "=" === f.charAt(1) ? i[u] + Number(f.charAt(0) + f.substr(2)) : Number(f), g && 1 < d && d < c - 1 && (a[h++] = (n + a[h - 2]) / 2), a[h++] = n;
              for (c = h - m + 1, d = h = 0; d < c; d += m) n = a[d], o = a[d + 1], s = a[d + 2], r = 2 == m ? 0 : a[d + 3], a[h++] = f = 3 == m ? new v(n, o, s, r) : new v(n, (2 * o + n) / 3, (2 * o + s) / 3, s);
              a.length = h
            }
            return p
          }(d, t.type, c), this._segCount = this._beziers[n].length, this._timeRes && (l = function (e, t) {
            var i, n, o, s, r = [],
              a = [],
              l = 0,
              d = 0,
              ...
              u = [],
              h = [];
            for (i in e) ! function (e, t, i) {
              for (var n, o, s, r, a, l, d, c, u, h, f, p = 1 / i, m = e.length; - 1 < --m;)
                for (s = (h = e[m]).a, r = h.d - s, a = h.c - s, l = h.b - s, o = 0, c = 1; c <= i; c++) n = o - (o = ((d = p * c) * d * r + 3 * (u = 1 - d) * (d * a + u * l)) * d), t[f = m * i + c - 1] = (t[f] || 0) + n * n
            }(e[i], r, t);
            for (o = r.length, n = 0; n < o; n++) l += Math.sqrt(r[n]), h[s = n % t] = l, s == c && (d += l, u[s = n / t >> 0] = h, a[s] = d, l = 0, h = []);
            return {
              length: d,
              lengths: a,
              segments: u
            }
          }(this._beziers, this._timeRes), this._length = l.length, this._lengths = l.lengths, this._segments = l.segments, this._l1 = this._li = this._s1 = this._si = 0, this._l2 = this._lengths[0], this._curSeg = this._segments[0], this._s2 = this._curSeg[0], this._prec = 1 / this._curSeg.length), h = this._autoRotate)
          for (this._initialRotations = [], h[0] instanceof Array || (this._autoRotate = h = [h]), s = h.length; - 1 < --s;) {
            for (r = 0; r < 3; r++) n = h[s][r], this._func[n] = "function" == typeof e[n] && e[n.indexOf("set") || "function" != typeof e["get" + n.substr(3)] ? n : "get" + n.substr(3)];
      ...
      set: function (e) {
        var t, i, n, o, s, r, a, l, d, c, u = this._segCount,
          h = this._func,
          f = this._target,
          p = e !== this._startRatio;
        if (this._timeRes) {
          if (l = this._lengths, d = this._curSeg, c = e * this._length, x = this._li, c > this._l2 && x < u - 1) {
            for (a = u - 1; x < a && (this._l2 = l[++x]) <= c;);
            this._l1 = l[x - 1], this._li = x, this._curSeg = d = this._segments[x], this._s2 = d[this._s1 = this._si = 0]
          } else if (c < this._l1 && 0 < x) {
            for (; 0 < x && (this._l1 = l[--x]) >= c;);
            0 === x && c < this._l1 ? this._l1 = 0 : x++, this._l2 = l[x], this._li = x, this._curSeg = d = this._segments[x], this._s1 = d[(this._si = d.length - 1) - 1] || 0, this._s2 = d[this._si]
          }
          if (t = x, c -= this._l1, x = this._si, c > this._s2 && x < d.length - 1) {
            for (a = d.length - 1; x < a && (this._s2 = d[++x]) <= c;);
            this._s1 = d[x - 1], this._si = x
          } else if (c < this._s1 && 0 < x) {
            for (; 0 < x && (this._s1 = d[--x]) >= c;);
            0 === x && c < this._s1 ? this._s1 = 0 : x++, this._s2 = d[x], this._si = x
          }
          s = 1 === e ? 1 : (x + (c - this._s1) / (this._s2 - this._s1)) * this._prec || 0
        } else s = (e - (t = e < 0 ? 0 : 1 <= e ? u - 1 : u * e >> 0) * (1 / u)) * u;
        for (i = 1 - s, x = this._props.length; - 1 < --x;) n = this._props[x], r = (s * s * (o = this._beziers[n][t]).da + 3 * i * (s * o.ca + i * o.ba)) * s + o.a, this._mod[n] && (r = this._mod[n](r, f)), h[n] ? f[n](r) : f[n] = r;
        if (this._autoRotate)
          for (var m, g, y, v, _, b, w, k = this._autoRotate, x = k.length; - 1 < --x;) n = k[x][2], b = k[x][3] || 0, w = !0 === k[x][4] ? 1 : T, o = this._beziers[k[x][0]], m = this._beziers[k[x][1]], o && m && (o = o[t], m = m[t], g = o.a + (o.b - o.a) * s, g += ((v = o.b + (o.c - o.b) * s) - g) * s, v += (o.c + (o.d - o.c) * s - v) * s, y = m.a + (m.b - m.a) * s, y += ((_ = m.b + (m.c - m.b) * s) - y) * s, _ += (m.c + (m.d - m.c) * s - _) * s, r = p ? Math.atan2(_ - y, v - g) * w + b : this._initialRotations[x], this._mod[n] && (r = this._mod[n](r, f)), h[n] ? f[n](r) : f[n] = r)
      }
    }), n = g.prototype, g.bezierThrough = f, g.cubicToQuadratic = S, g._autoCSS = !0, g.quadraticToCubic = function (e, t, i) {
      return new v(e, (2 * t + e) / 3, (2 * t + i) / 3, i)
    }, g._cssRegister = function () {
      var e, f, p, m, t = i.CSSPlugin;
      t && (e = t._internals, f = e._parseToProxy, p = e._setPluginRatio, m = e.CSSPropTween, e._registerComplexSpecialProp("bezier", {
        parser: function (e, t, i, n, o, s) {
          t instanceof Array && (t = {
            values: t
          }), s = new g;
          var r, a, l, d = t.values,
            c = d.length - 1,
            u = [],
            h = {};
          if (c < 0) return o;
          for (r = 0; r <= c; r++) l = f(e, d[r], n, o, s, c !== r), u[r] = l.end;
          for (a in t) h[a] = t[a];
          return h.values = u, (o = new m(e, "bezier", 0, 0, l.pt, 2)).data = l, o.plugin = s, o.setRatio = p, 0 === h.autoRotate && (h.autoRotate = !0), !h.autoRotate || h.autoRotate instanceof Array || (r = !0 === h.autoRotate ? 0 : Number(h.autoRotate), h.autoRotate = null != l.end.left ? [
    ...
    }, _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function (s, q) {
      var p, T, S, m, N = function () {
          s.call(this, "css"), this._overwriteProps.length = 0, this.setRatio = N.prototype.setRatio
        },
        d = _gsScope._gsDefine.globals,
        g = {},
        e = N.prototype = new s("css");
      (e.constructor = N).version = "2.1.3", N.API = 2, N.defaultTransformPerspective = 0, N.defaultSkewType = "compensated", N.defaultSmoothOrigin = !0, e = "px", N.suffixMap = {
        top: e,
        right: e,
        bottom: e,
        left: e,
      ...
      function a(e, t) {
        var i = te.createElementNS ? te.createElementNS(t || "http://www.w3.org/1999/xhtml", e) : te.createElement(e);
        return i.style ? i : te.createElement(e)
      }
      ...
      function _(e, t) {
        ...
        if (t = t || v(e))
          if (i = t.length)
            for (; - 1 < --i;) - 1 !== (o = t[i]).indexOf("-transform") && Re !== o || (s[o.replace(B, r)] = t.getPropertyValue(o));
          else
            for (i in t) - 1 !== i.indexOf("Transform") && We !== i || (s[i] = t[i]);
        else if (t = e.currentStyle || e.style)
          for (i in t) "string" == typeof i && void 0 === s[i] && (s[i.replace(B, r)] = t[i]);
        return re || (s.opacity = l(e)), n = Je(e, t, !1), s.rotation = n.rotation, s.skewX = n.skewX, s.scaleX = n.scaleX, s.scaleY = n.scaleY, s.x = n.x, s.y = n.y, Ne && (s.z = n.z, s.rotationX = n.rotationX, s.rotationY = n.rotationY, s.scaleZ = n.scaleZ), s.filters && delete s.filters, s
      }

      function b(e, t, i, n, o) {
        var s, r, a, l = {},
          d = e.style;
        for (r in i) "cssText" !== r && "length" !== r && isNaN(r) && (t[r] !== (s = i[r]) || o && o[r]) && -1 === r.indexOf("Origin") && ("number" == typeof s || "string" == typeof s) && (l[r] = "auto" !== s || "left" !== r && "top" !== r ? "" !== s && "auto" !== s && "none" !== s || "string" != typeof t[r] || "" === t[r].replace(c, "") ? s : 0 : he(e, r), void 0 !== d[r] && (a = new ke(d, r, d[r], a)));
        if (n)
      ...
      function E(e, t, i, n) {
        var o, s, r, a, l;
        return "function" == typeof e && (e = e(A, P)), (a = null == e ? t : "number" == typeof e ? e : (o = 360, s = e.split("_"), r = ((l = "=" === e.charAt(1)) ? parseInt(e.charAt(0) + "1", 10) * parseFloat(s[0].substr(2)) : parseFloat(s[0])) * (-1 === e.indexOf("rad") ? 1 : K) - (l ? 0 : t), s.length && (n && (n[i] = t + r), -1 !== e.indexOf("short") && ((r %= o) !== r % 180 && (r = r < 0 ? r + o : r - o)), -1 !== e.indexOf("_cw") && r < 0 ? r = (r + 3599999999640) % o - (r / o | 0) * o : -1 !== e.indexOf("ccw") && 0 < r && (r = (r - 3599999999640) % o - (r / o | 0) * o)), t + r)) < 1e-6 && -1e-6 < a && (a = 0), a
      }
      ...
      var j, w, k, $, x, I, P, A, t, i, M = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
        z = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g,
        ...
        se = (_gsScope.navigator || {}).userAgent || "",
        re = (t = se.indexOf("Android"), i = a("a"), k = -1 !== se.indexOf("Safari") && -1 === se.indexOf("Chrome") && (-1 === t || 3 < parseFloat(se.substr(t + 8, 2))), x = k && parseFloat(se.substr(se.indexOf("Version/") + 8, 2)) < 6, $ = -1 !== se.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(se) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(se)) && (I = parseFloat(RegExp.$1)), !!i && (i.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(i.style.opacity))),
        ae = "",
        le = "",
        de = "undefined" != typeof window ? window : te.defaultView || {
          getComputedStyle: function () {}
        },
        ce = N.getStyle = function (e, t, i, n, o) {
          var s;
          return re || "opacity" !== t ? (!n && e.style[t] ? s = e.style[t] : (i = i || v(e)) ? s = i[t] || i.getPropertyValue(t) || i.getPropertyValue(t.replace(h, "-$1").toLowerCase()) : e.currentStyle && (s = e.currentStyle[t]), null == o || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : o) : l(e)
        },
        ue = oe.convertToPixels = function (e, t, i, n, o) {
          if ("px" === n || !n && "lineHeight" !== t) return i;
          if ("auto" === n || !i) return 0;
          var s, r, a, l = U.test(t),
            d = e,
            c = ie.style,
            u = i < 0,
            h = 1 === i;
          if (u && (i = -i), h && (i *= 100), "lineHeight" !== t || n)
            if ("%" === n && -1 !== t.indexOf("border")) s = i / 100 * (l ? e.clientWidth : e.clientHeight);
            else {
              if (c.cssText = "border:0 solid red;position:" + ce(e, "position") + ";line-height:0;", "%" !== n && d.appendChild && "v" !== n.charAt(0) && "rem" !== n) c[l ? "borderLeftWidth" : "borderTopWidth"] = i + n;
              else {
                if (d = e.parentNode || te.body, -1 !== ce(d, "display").indexOf("flex") && (c.position = "absolute"), r = d._gsCache, a = q.ticker.frame, r && l && r.time === a) return r.width * i / 100;
                c[l ? "width" : "height"] = i + n
              }
              d.appendChild(ie), s = parseFloat(ie[l ? "offsetWidth" : "offsetHeight"]), d.removeChild(ie), l && "%" === n && !1 !== N.cacheWidths && ((r = d._gsCache = d._gsCache || {}).time = a, r.width = s / i * 100), 0 !== s || o || (s = ue(e, t, i, n, !0))
            }
          else r = v(e).lineHeight, e.style.lineHeight = i, s = parseFloat(v(e).lineHeight), e.style.lineHeight = r;
          return h && (s /= 100), u ? -s : s
        },
        he = oe.calculateOffset = function (e, t, i) {
          if ("absolute" !== ce(e, "position", i)) return 0;
          var n = "left" === t ? "Left" : "Top",
            o = ce(e, "margin" + n, i);
          return e["offset" + n] - (ue(e, t, parseFloat(o), o.replace(F, "")) || 0)
        },
        fe = {
          width: ["Left", "Right"],
          height: ["Top", "Bottom"]
        ...
        me = function (e, t) {
          ...
          if (3 < n.length && !t) {
            for (n = e.split(", ").join(",").split(","), e = [], i = 0; i < n.length; i++) e.push(me(n[i]));
            return e.join(",")
          }
          return null == s ? s = "center" === o ? "50%" : "0" : "center" === s && (s = "50%"), ("center" === o || isNaN(parseFloat(o)) && -1 === (o + "").indexOf("=")) && (o = "50%"), e = o + " " + s + (2 < n.length ? " " + n[2] : ""), t && (t.oxp = -1 !== o.indexOf("%"), t.oyp = -1 !== s.indexOf("%"), t.oxr = "=" === o.charAt(1), t.oyr = "=" === s.charAt(1), t.ox = parseFloat(o.replace(c, "")), t.oy = parseFloat(s.replace(c, "")), t.v = e), t || e
        },
        ge = {
          aqua: [0, 255, 255],
          lime: [0, 255, 0],
        ...
        ye = N.parseColor = function (e, t) {
          var i, n, o, s, r, a, l, d, c, u, h;
          if (e)
            if ("number" == typeof e) i = [e >> 16, e >> 8 & 255, 255 & e];
            else {
              if ("," === e.charAt(e.length - 1) && (e = e.substr(0, e.length - 1)), ge[e]) i = ge[e];
                ...
                if (i = h = e.match(M), t) {
                  if (-1 !== e.indexOf("=")) return e.match(z)
                } else r = Number(i[0]) % 360 / 360, a = Number(i[1]) / 100, n = 2 * (l = Number(i[2]) / 100) - (o = l <= .5 ? l * (a + 1) : l + a - l * a), 3 < i.length && (i[3] = Number(i[3])), i[0] = f(r + 1 / 3, n, o), i[1] = f(r, n, o), i[2] = f(r - 1 / 3, n, o);
              else i = e.match(M) || ge.transparent;
              i[0] = Number(i[0]), i[1] = Number(i[1]), i[2] = Number(i[2]), 3 < i.length && (i[3] = Number(i[3]))
            }
          else i = ge.black;
          return t && !h && (n = i[0] / 255, o = i[1] / 255, s = i[2] / 255, l = ((d = Math.max(n, o, s)) + (c = Math.min(n, o, s))) / 2, d === c ? r = a = 0 : (u = d - c, a = .5 < l ? u / (2 - d - c) : u / (d + c), r = d === n ? (o - s) / u + (o < s ? 6 : 0) : d === o ? (s - n) / u + 2 : (n - o) / u + 4, r *= 60), i[0] = r + .5 | 0, i[1] = 100 * a + .5 | 0, i[2] = 100 * l + .5 | 0), i
        },
        ve = "(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3}){1,2}\\b";
      for (e in ge) ve += "|" + e + "\\b";
      ve = new RegExp(ve + ")", "gi"), N.colorStringFilter = function (e) {
        var t, i = e[0] + " " + e[1];
        ve.test(i) && (t = -1 !== i.indexOf("hsl(") || -1 !== i.indexOf("hsla("), e[0] = n(e[0], t), e[1] = n(e[1], t)), ve.lastIndex = 0
      }, q.defaultStringFilter || (q.defaultStringFilter = N.colorStringFilter);
      ...
      function _e(e, t, s, r) {
        ...
        return f ? a = t ? function (e) {
          ...
          if ("number" == typeof e) e += p;
            ...
            for (o = e.replace(Q, "|").split("|"), n = 0; n < o.length; n++) o[n] = a(o[n]);
            return o.join(",")
          }
          if (t = (e.match(ve) || [l])[0], n = (i = e.split(t).join("").match(L) || []).length, f > n--)
            for (; ++n < f;) i[n] = s ? i[(n - 1) / 2 | 0] : d[n];
          return c + i.join(h) + h + t + u + (-1 !== e.indexOf("inset") ? " inset" : "")
        } : function (e) {
          var t, i, n;
          if ("number" == typeof e) e += p;
          else if (r && Q.test(e)) {
            for (i = e.replace(Q, "|").split("|"), n = 0; n < i.length; n++) i[n] = a(i[n]);
            return i.join(",")
          }
          if (n = (t = e.match("," == h ? L : o) || []).length, f > n--)
            for (; ++n < f;) t[n] = s ? t[(n - 1) / 2 | 0] : d[n];
          return (c && "none" !== e && e.substr(0, e.indexOf(t[0])) || c) + t.join(h) + u
        } : function (e) {
          return e
        }
      }
      ...
      function we(e, t, i, n, o, s) {
        var r = new xe(e, t, i, n - i, o, -1, s);
        return r.b = i, r.e = r.xs0 = n, r
      }
      var ke = (oe._setPluginRatio = function (e) {
        ...
        xe = (oe._parseToProxy = function (e, t, i, n, o, s) {
          var r, a, l, d, c, u = n,
            h = {},
            f = {},
            p = i._transform,
            m = Z;
          for (i._transform = null, Z = t, n = c = i.parse(e, t, n, o), Z = m, s && (i._transform = p, u && (u._prev = null, u._prev && (u._prev._next = null))); n && n !== u;) {
            if (n.type <= 1 && (f[a = n.p] = n.s + n.c, h[a] = n.s, s || (d = new ke(n, "s", a, d, n.r), n.c = 0), 1 === n.type))
              for (r = n.l; 0 < --r;) l = "xn" + r, f[a = n.p + "_" + l] = n.data[l], h[a] = n[l], s || (d = new ke(n, l, a, d, n.rxp[l]));
            n = n._next
          }
          return {
            proxy: h,
        ...
        }, oe.CSSPropTween = function (e, t, i, n, o, s, r, a, l, d, c) {
          this.t = e, this.p = t, this.s = i, this.c = n, this.n = r || t, e instanceof xe || m.push(this.n), this.r = !a || "function" == typeof a ? a : Math.round, this.type = s || 0, l && (this.pr = l, p = !0), this.b = void 0 === d ? i : d, this.e = void 0 === c ? i + n : c, o && ((this._next = o)._prev = this)
        }),
        Te = N.parseComplex = function (e, t, i, n, o, s, r, a, l, d) {
          i = i || s || "", "function" == typeof n && (n = n(A, P)), r = new xe(e, t, 0, 0, r, d ? 2 : 1, null, !1, a, i, n), n += "", o && ve.test(n + i) && (n = [i, n], N.colorStringFilter(n), i = n[0], n = n[1]);
          var c, u, h, f, p, m, g, y, v, _, b, w, k, x = i.split(", ").join(",").split(" "),
            T = n.split(", ").join(",").split(" "),
            S = x.length,
            C = !1 !== j;
          for (-1 === n.indexOf(",") && -1 === i.indexOf(",") || (T = -1 !== (n + i).indexOf("rgb") || -1 !== (n + i).indexOf("hsl") ? (x = x.join(" ").replace(Q, ", ").split(" "), T.join(" ").replace(Q, ", ").split(" ")) : (x = x.join(" ").split(",").join(", ").split(" "), T.join(" ").split(",").join(", ").split(" ")), S = x.length), S !== T.length && (S = (x = (s || "").split(" ")).length), r.plugin = l, r.setRatio = d, c = ve.lastIndex = 0; c < S; c++)
            if (f = x[c], p = T[c] + "", (y = parseFloat(f)) || 0 === y) r.appendXtra("", y, D(p, y), p.replace(z, ""), C && -1 !== p.indexOf("px") && Math.round, !0);
            else if (o && ve.test(f)) w = ")" + ((w = p.indexOf(")") + 1) ? p.substr(w) : ""), k = -1 !== p.indexOf("hsl") && re, _ = p, f = ye(f, k), p = ye(p, k), (v = 6 < f.length + p.length) && !re && 0 === p[3] ? (r["xs" + r.l] += r.l ? " transparent" : "transparent", r.e = r.e.split(T[c]).join("transparent")) : (re || (v = !1), k ? r.appendXtra(_.substr(0, _.indexOf("hsl")) + (v ? "hsla(" : "hsl("), f[0], D(p[0], f[0]), ",", !1, !0).appendXtra("", f[1], D(p[1], f[1]), "%,", !1).appendXtra("", f[2], D(p[2], f[2]), v ? "%," : "%" + w, !1) : r.appendXtra(_.substr(0, _.indexOf("rgb")) + (v ? "rgba(" : "rgb("), f[0], p[0] - f[0], ",", Math.round, !0).appendXtra("", f[1], p[1] - f[1], ",", Math.round).appendXtra("", f[2], p[2] - f[2], v ? "," : w, Math.round), v && (f = f.length < 4 ? 1 : f[3], r.appendXtra("", f, (p.length < 4 ? 1 : p[3]) - f, w, !1))), ve.lastIndex = 0;
          else if (m = f.match(M)) {
            if (!(g = p.match(z)) || g.length !== m.length) return r;
            for (u = h = 0; u < m.length; u++) b = m[u], _ = f.indexOf(b, h), r.appendXtra(f.substr(h, _ - h), Number(b), D(g[u], b), "", C && "px" === f.substr(_ + b.length, 2) && Math.round, 0 === u), h = _ + b.length;
            r["xs" + r.l] += f.substr(h)
          } else r["xs" + r.l] += r.l || r["xs" + r.l] ? " " + p : p;
          if (-1 !== n.indexOf("=") && r.data) {
            for (w = r.xs0 + r.data.s, c = 1; c < r.l; c++) w += r["xs" + c] + r.data["xn" + c];
            r.e = w + r["xs" + c]
          }
      ...
      e.xs0 = "", e._next = e._prev = e.xfirst = e.data = e.plugin = e.setRatio = e.rxp = null, e.appendXtra = function (e, t, i, n, o, s) {
        var r = this,
          a = r.l;
        return r["xs" + a] += s && (a || r["xs" + a]) ? " " + e : e || "", i || 0 === a || r.plugin ? (r.l++, r.type = r.setRatio ? 2 : 1, r["xs" + r.l] = n || "", 0 < a ? (r.data["xn" + a] = t + i, r.rxp["xn" + a] = o, r["xn" + a] = t, r.plugin || (r.xfirst = new xe(r, "xn" + a, t, i, r.xfirst || r, 0, r.n, o, r.pr), r.xfirst.xs0 = 0)) : (r.data = {
          s: t + i
        }, r.rxp = {}, r.s = t, r.c = i, r.r = o)) : r["xs" + a] += t + (n || ""), r
      };

      function Ce(e, t) {
        t = t || {}, this.p = t.prefix && C(e) || e, (g[e] = g[this.p] = this).format = t.formatter || _e(t.defaultValue, t.color, t.collapsible, t.multi), t.parser && (this.parse = t.parser), this.clrs = t.color, this.multi = t.multi, this.keyword = t.keyword, this.dflt = t.defaultValue, this.allowFunc = t.allowFunc, this.pr = t.priority || 0
      }
      var De = oe._registerComplexSpecialProp = function (e, t, i) {
          "object" != typeof t && (t = {
            parser: i
          });
          var n, o = e.split(","),
            s = t.defaultValue;
          for (i = i || [s], n = 0; n < o.length; n++) t.prefix = 0 === n && t.prefix, t.defaultValue = i[n] || s, new Ce(o[n], t)
        },
        Oe = oe._registerPluginProp = function (e) {
          var l;
          g[e] || (l = e.charAt(0).toUpperCase() + e.substr(1) + "Plugin", De(e, {
            parser: function (e, t, i, n, o, s, r) {
              var a = d.com.greensock.plugins[l];
              return a ? (a._cssRegister(), g[i].parse(e, t, i, n, o, s, r)) : (y("Error: " + l + " js file not loaded."), o)
            }
          }))
        };
      (e = Ce.prototype).parseComplex = function (e, t, i, n, o, s) {
        var r, a, l, d, c, u, h = this.keyword;
        if (this.multi && (Q.test(i) || Q.test(t) ? (a = t.replace(Q, "|").split("|"), l = i.replace(Q, "|").split("|")) : h && (a = [t], l = [i])), l) {
          for (d = l.length > a.length ? l.length : a.length, r = 0; r < d; r++) t = a[r] = a[r] || this.dflt, i = l[r] = l[r] || this.dflt, h && ((c = t.indexOf(h)) !== (u = i.indexOf(h)) && (-1 === u ? a[r] = a[r].split(h).join("") : -1 === c && (a[r] += " " + h)));
          t = a.join(", "), i = l.join(", ")
        }
        return Te(e, this.p, t, i, this.clrs, this.dflt, n, this.pr, o, s)
      }, e.parse = function (e, t, i, n, o, s, r) {
        return this.parseComplex(e.style, this.format(ce(e, this.p, S, !1, this.dflt)), this.format(t), o, s)
      }, N.registerSpecialProp = function (e, l, d) {
        De(e, {
          parser: function (e, t, i, n, o, s, r) {
            var a = new xe(e, i, 0, 0, o, 2, i, !1, d);
      ...
      function Ee(e, t, i) {
        var n, o = te.createElementNS("http://www.w3.org/2000/svg", e),
          s = /([a-z])([A-Z])/g;
      ...
      function je(e, t, i, n, o, s) {
        var r, a, l, d, c, u, h, f, p, m, g, y, v, _, b = e._gsTransform,
          w = Qe(e, !0);
        b && (v = b.xOrigin, _ = b.yOrigin), (!n || (r = n.split(" ")).length < 2) && (0 === (h = e.getBBox()).x && 0 === h.y && h.width + h.height === 0 && (h = {
          x: parseFloat(e.hasAttribute("x") ? e.getAttribute("x") : e.hasAttribute("cx") ? e.getAttribute("cx") : 0) || 0,
          y: parseFloat(e.hasAttribute("y") ? e.getAttribute("y") : e.hasAttribute("cy") ? e.getAttribute("cy") : 0) || 0,
          width: 0,
          height: 0
        }), r = [(-1 !== (t = me(t).split(" "))[0].indexOf("%") ? parseFloat(t[0]) / 100 * h.width : parseFloat(t[0])) + h.x, (-1 !== t[1].indexOf("%") ? parseFloat(t[1]) / 100 * h.height : parseFloat(t[1])) + h.y]), i.xOrigin = d = parseFloat(r[0]), i.yOrigin = c = parseFloat(r[1]), n && w !== Xe && (u = w[0], h = w[1], f = w[2], p = w[3], m = w[4], g = w[5], (y = u * p - h * f) && (a = d * (p / y) + c * (-f / y) + (f * g - p * m) / y, l = d * (-h / y) + c * (u / y) - (u * g - h * m) / y, d = i.xOrigin = r[0] = a, c = i.yOrigin = r[1] = l)), b && (s && (i.xOffset = b.xOffset, i.yOffset = b.yOffset, b = i), o || !1 !== o && !1 !== N.defaultSmoothOrigin ? (a = d - v, l = c - _, b.xOffset += a * w[0] + l * w[2] - a, b.yOffset += a * w[1] + l * w[3] - l) : b.xOffset = b.yOffset = 0), s || e.setAttribute("data-svg-origin", r.join(" "))
      }
      ...
      function Ie(e) {
        ...
        if (h) {
          ...
          var f = this.t.offsetWidth,
            ...
            g = "progid:DXImageTransform.Microsoft.Matrix(M11=" + a + ", M12=" + l + ", M21=" + d + ", M22=" + c,
            y = n.x + f * n.xPercent / 100,
            v = n.y + p * n.yPercent / 100;
          if (null != n.ox && (y += (x = (n.oxp ? f * n.ox * .01 : n.ox) - f / 2) - (x * a + (T = (n.oyp ? p * n.oy * .01 : n.oy) - p / 2) * l), v += T - (x * d + T * c)), m ? g += ", Dx=" + ((x = f / 2) - (x * a + (T = p / 2) * l) + y) + ", Dy=" + (T - (x * d + T * c) + v) + ")" : g += ", sizingMethod='auto expand')", -1 !== t.indexOf("DXImageTransform.Microsoft.Matrix(") ? u.filter = t.replace(X, g) : u.filter = g + " " + t, 0 !== e && 1 !== e || 1 != a || 0 != l || 0 != d || 1 != c || (m && -1 === g.indexOf("Dx=0, Dy=0") || W.test(t) && 100 !== parseFloat(RegExp.$1) || -1 === t.indexOf(t.indexOf("Alpha")) && u.removeAttribute("filter")), !m) {
            var _, b, w, k = I < 8 ? 1 : -1,
              x = n.ieOffsetX || 0,
              T = n.ieOffsetY || 0;
            for (n.ieOffsetX = Math.round((f - ((a < 0 ? -a : a) * f + (l < 0 ? -l : l) * p)) / 2 + y), n.ieOffsetY = Math.round((p - ((c < 0 ? -c : c) * p + (d < 0 ? -d : d) * f)) / 2 + v), Se = 0; Se < 4; Se++) w = (i = -1 !== (_ = h[b = pe[Se]]).indexOf("px") ? parseFloat(_) : ue(this.t, b, parseFloat(_), _.replace(F, "")) || 0) !== n[b] ? Se < 2 ? -n.ieOffsetX : -n.ieOffsetY : Se < 2 ? x - n.ieOffsetX : T - n.ieOffsetY, u[b] = (n[b] = Math.round(i - w * (0 === Se || 2 === Se ? 1 : k))) + "px"
          }
        }
      }
      var Pe, Ae, Me, ze, Le, Fe = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
        We = C("transform"),
        Re = ae + "transform",
        qe = C("transformOrigin"),
        Ne = null !== C("perspective"),
        $e = oe.Transform = function () {
          this.perspective = parseFloat(N.defaultTransformPerspective) || 0, this.force3D = !(!1 === N.defaultForce3D || !Ne) && (N.defaultForce3D || "auto")
        },
        He = _gsScope.SVGElement,
        Be = te.documentElement || {},
        Ye = (Le = I || /Android/i.test(se) && !_gsScope.chrome, te.createElementNS && Be.appendChild && !Le && (Ae = Ee("svg", Be), ze = (Me = Ee("rect", Ae, {
          width: 100,
          height: 50,
          x: 100
        })).getBoundingClientRect().width, Me.style[qe] = "50% 50%", Me.style[We] = "scaleX(0.5)", Le = ze === Me.getBoundingClientRect().width && !($ && Ne), Be.removeChild(Ae)), Le),
        Ue = function (e) {
          var t, i = a("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"),
            n = this.parentNode,
            o = this.nextSibling,
          ...
          return o ? n.insertBefore(this, o) : n.appendChild(this), Be.removeChild(i), this.style.cssText = s, t
        },
        Ge = function (e) {
        ...
        Xe = [1, 0, 0, 1, 0, 0],
        Qe = function (e, t) {
          var i, n, o, s, r, a, l, d = e._gsTransform || new $e,
            c = e.style;
          if (We ? n = ce(e, Re, null, !0) : e.currentStyle && (n = (n = e.currentStyle.filter.match(G)) && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), d.x || 0, d.y || 0].join(",") : ""), i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, We && i && !e.offsetParent && e !== Be && (s = c.display, c.display = "block", (l = e.parentNode) && e.offsetParent || (r = 1, a = e.nextSibling, Be.appendChild(e)), i = !(n = ce(e, Re, null, !0)) || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, s ? c.display = s : et(c, "display"), r && (a ? l.insertBefore(e, a) : l ? l.appendChild(e) : Be.removeChild(e))), (d.svg || e.getCTM && Ge(e)) && (i && -1 !== (c[We] + "").indexOf("matrix") && (n = c[We], i = 0), o = e.getAttribute("transform"), i && o && (n = "matrix(" + (o = e.transform.baseVal.consolidate().matrix).a + "," + o.b + "," + o.c + "," + o.d + "," + o.e + "," + o.f + ")", i = 0)), i) return Xe;
          for (o = (n || "").match(M) || [], Se = o.length; - 1 < --Se;) s = Number(o[Se]), o[Se] = (r = s - (s |= 0)) ? (1e5 * r + (r < 0 ? -.5 : .5) | 0) / 1e5 + s : s;
          return t && 6 < o.length ? [o[0], o[1], o[4], o[5], o[12], o[13]] : o
        },
        Je = oe.getTransform = function (e, t, i, n) {
          if (e._gsTransform && i && !n) return e._gsTransform;
          var o, s, r, a, l, d, c, u, h, f, p, m, g, y, v, _, b, w, k, x, T, S, C, D, O, E, j, I, P, A, M, z, L = i && e._gsTransform || new $e,
            F = L.scaleX < 0,
            W = Ne && (parseFloat(ce(e, qe, t, !1, "0 0 0").split(" ")[2]) || L.zOrigin) || 0,
            R = parseFloat(N.defaultTransformPerspective) || 0;
          if (L.svg = !(!e.getCTM || !Ge(e)), L.svg && (je(e, ce(e, qe, t, !1, "50% 50%") + "", L, e.getAttribute("data-svg-origin")), Pe = N.useSVGTransformAttr || Ye), (o = Qe(e)) !== Xe)
            for (s in 16 === o.length ? (m = o[0], g = o[1], y = o[2], v = o[3], _ = o[4], b = o[5], w = o[6], k = o[7], x = o[8], T = o[9], S = o[10], C = o[12], D = o[13], O = o[14], E = o[11], j = Math.atan2(w, S), L.zOrigin && (C = x * (O = -L.zOrigin) - o[12], D = T * O - o[13], O = S * O + L.zOrigin - o[14]), L.rotationX = j * K, j && (c = _ * (f = Math.cos(-j)) + x * (p = Math.sin(-j)), u = b * f + T * p, h = w * f + S * p, x = _ * -p + x * f, T = b * -p + T * f, S = w * -p + S * f, E = k * -p + E * f, _ = c, b = u, w = h), j = Math.atan2(-y, S), L.rotationY = j * K, j && (u = g * (f = Math.cos(-j)) - T * (p = Math.sin(-j)), h = y * f - S * p, T = g * p + T * f, S = y * p + S * f, E = v * p + E * f, m = c = m * f - x * p, g = u, y = h), j = Math.atan2(g, m), L.rotation = j * K, j && (c = m * (f = Math.cos(j)) + g * (p = Math.sin(j)), u = _ * f + b * p, h = x * f + T * p, g = g * f - m * p, b = b * f - _ * p, T = T * f - x * p, m = c, _ = u, x = h), L.rotationX && 359.9 < Math.abs(L.rotationX) + Math.abs(L.rotation) && (L.rotationX = L.rotation = 0, L.rotationY = 180 - L.rotationY), j = Math.atan2(_, b), L.scaleX = (1e5 * Math.sqrt(m * m + g * g + y * y) + .5 | 0) / 1e5, L.scaleY = (1e5 * Math.sqrt(b * b + w * w) + .5 | 0) / 1e5, L.scaleZ = (1e5 * Math.sqrt(x * x + T * T + S * S) + .5 | 0) / 1e5, m /= L.scaleX, _ /= L.scaleY, g /= L.scaleX, b /= L.scaleY, 2e-5 < Math.abs(j) ? (L.skewX = j * K, _ = 0, "simple" !== L.skewType && (L.scaleY *= 1 / Math.cos(j))) : L.skewX = 0, L.perspective = E ? 1 / (E < 0 ? -E : E) : 0, L.x = C, L.y = D, L.z = O, L.svg && (L.x -= L.xOrigin - (L.xOrigin * m - L.yOrigin * _), L.y -= L.yOrigin - (L.yOrigin * g - L.xOrigin * b))) : Ne && !n && o.length && L.x === o[4] && L.y === o[5] && (L.rotationX || L.rotationY) || (P = (I = 6 <= o.length) ? o[0] : 1, A = o[1] || 0, M = o[2] || 0, z = I ? o[3] : 1, L.x = o[4] || 0, L.y = o[5] || 0, r = Math.sqrt(P * P + A * A), a = Math.sqrt(z * z + M * M), l = P || A ? Math.atan2(A, P) * K : L.rotation || 0, d = M || z ? Math.atan2(M, z) * K + l : L.skewX || 0, L.scaleX = r, L.scaleY = a, L.rotation = l, L.skewX = d, Ne && (L.rotationX = L.rotationY = L.z = 0, L.perspective = R, L.scaleZ = 1), L.svg && (L.x -= L.xOrigin - (L.xOrigin * P + L.yOrigin * M), L.y -= L.yOrigin - (L.xOrigin * A + L.yOrigin * z))), 90 < Math.abs(L.skewX) && Math.abs(L.skewX) < 270 && (F ? (L.scaleX *= -1, L.skewX += L.rotation <= 0 ? 180 : -180, L.rotation += L.rotation <= 0 ? 180 : -180) : (L.scaleY *= -1, L.skewX += L.skewX <= 0 ? 180 : -180)), L.zOrigin = W, L) L[s] < 2e-5 && -2e-5 < L[s] && (L[s] = 0);
          return i && ((e._gsTransform = L).svg && (Pe && e.style[We] ? q.delayedCall(.001, function () {
            et(e.style, We)
          }) : !Pe && e.getAttribute("transform") && q.delayedCall(.001, function () {
            e.removeAttribute("transform")
          }))), L
        },
        Ve = oe.set3DTransformRatio = oe.setTransformRatio = function (e) {
          var t, i, n, o, s, r, a, l, d, c, u, h, f, p, m, g, y, v, _, b, w, k, x, T = this.data,
            S = this.t.style,
            C = T.rotation,
            D = T.rotationX,
            O = T.rotationY,
            ...
            W = T.skewY,
            R = T.skewX;
          if (W && (R += W, C += W), !((1 !== e && 0 !== e || "auto" !== F || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && F || M || L || O || D || 1 !== I) || Pe && z || !Ne) C || R || z ? (C *= V, k = R * V, x = 1e5, i = Math.cos(C) * E, s = Math.sin(C) * E, n = Math.sin(C - k) * -j, r = Math.cos(C - k) * j, k && "simple" === T.skewType && (t = Math.tan(k - W * V), n *= t = Math.sqrt(1 + t * t), r *= t, W && (t = Math.tan(W * V), i *= t = Math.sqrt(1 + t * t), s *= t)), z && (P += T.xOrigin - (T.xOrigin * i + T.yOrigin * n) + T.xOffset, A += T.yOrigin - (T.xOrigin * s + T.yOrigin * r) + T.yOffset, Pe && (T.xPercent || T.yPercent) && (m = this.t.getBBox(), P += .01 * T.xPercent * m.width, A += .01 * T.yPercent * m.height), P < (m = 1e-6) && -m < P && (P = 0), A < m && -m < A && (A = 0)), _ = (i * x | 0) / x + "," + (s * x | 0) / x + "," + (n * x | 0) / x + "," + (r * x | 0) / x + "," + P + "," + A + ")", z && Pe ? this.t.setAttribute("transform", "matrix(" + _) : S[We] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + _) : S[We] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + E + ",0,0," + j + "," + P + "," + A + ")";
          else {
            if ($ && (E < (m = 1e-4) && -m < E && (E = I = 2e-5), j < m && -m < j && (j = I = 2e-5), !L || T.z || T.rotationX || T.rotationY || (L = 0)), C || R) C *= V, g = i = Math.cos(C), y = s = Math.sin(C), R && (C -= R * V, g = Math.cos(C), y = Math.sin(C), "simple" === T.skewType && (t = Math.tan((R - W) * V), g *= t = Math.sqrt(1 + t * t), y *= t, T.skewY && (t = Math.tan(W * V), i *= t = Math.sqrt(1 + t * t), s *= t))), n = -y, r = g;
            else {
              if (!(O || D || 1 !== I || L || z)) return void(S[We] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) translate3d(" : "translate3d(") + P + "px," + A + "px," + M + "px)" + (1 !== E || 1 !== j ? " scale(" + E + "," + j + ")" : ""));
              i = r = 1, n = s = 0
            }
            c = 1, o = a = l = d = u = h = 0, f = L ? -1 / L : 0, p = T.zOrigin, m = 1e-6, b = ",", w = "0", (C = O * V) && (g = Math.cos(C), u = f * (l = -(y = Math.sin(C))), o = i * y, a = s * y, f *= c = g, i *= g, s *= g), (C = D * V) && (t = n * (g = Math.cos(C)) + o * (y = Math.sin(C)), v = r * g + a * y, d = c * y, h = f * y, o = n * -y + o * g, a = r * -y + a * g, c *= g, f *= g, n = t, r = v), 1 !== I && (o *= I, a *= I, c *= I, f *= I), 1 !== j && (n *= j, r *= j, d *= j, h *= j), 1 !== E && (i *= E, s *= E, l *= E, u *= E), (p || z) && (p && (P += o * -p, A += a * -p, M += c * -p + p), z && (P += T.xOrigin - (T.xOrigin * i + T.yOrigin * n) + T.xOffset, A += T.yOrigin - (T.xOrigin * s + T.yOrigin * r) + T.yOffset), P < m && -m < P && (P = w), A < m && -m < A && (A = w), M < m && -m < M && (M = 0)), _ = T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix3d(" : "matrix3d(", _ += (i < m && -m < i ? w : i) + b + (s < m && -m < s ? w : s) + b + (l < m && -m < l ? w : l), _ += b + (u < m && -m < u ? w : u) + b + (n < m && -m < n ? w : n) + b + (r < m && -m < r ? w : r), D || O || 1 !== I ? (_ += b + (d < m && -m < d ? w : d) + b + (h < m && -m < h ? w : h) + b + (o < m && -m < o ? w : o), _ += b + (a < m && -m < a ? w : a) + b + (c < m && -m < c ? w : c) + b + (f < m && -m < f ? w : f) + b) : _ += ",0,0,0,0,1,0,", _ += P + b + A + b + M + b + (L ? 1 + -M / L : 1) + ")", S[We] = _
          }
        };
      (e = $e.prototype).x = e.y = e.z = e.skewX = e.skewY = e.rotation = e.rotationX = e.rotationY = e.zOrigin = e.xPercent = e.yPercent = e.xOffset = e.yOffset = 0, e.scaleX = e.scaleY = e.scaleZ = 1, De("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
        parser: function (e, t, i, n, o, s, r) {
          ...
          a && (r.scale = a(A, e));
          var l, d, c, u, h, f, p, m, g, y = e._gsTransform,
            v = e.style,
            _ = Fe.length,
            b = r,
            w = {},
            k = "transformOrigin",
            x = Je(e, S, !0, b.parseTransform),
            T = b.transform && ("function" == typeof b.transform ? b.transform(A, P) : b.transform);
          if (x.skewType = b.skewType || x.skewType || N.defaultSkewType, n._transform = x, "rotationZ" in b && (b.rotation = b.rotationZ), T && "string" == typeof T && We)(d = ie.style)[We] = T, d.display = "block", d.position = "absolute", -1 !== T.indexOf("%") && (d.width = ce(e, "width"), d.height = ce(e, "height")), te.body.appendChild(ie), l = Je(ie, null, !1), "simple" === x.skewType && (l.scaleY *= Math.cos(l.skewX * V)), x.svg && (f = x.xOrigin, p = x.yOrigin, l.x -= x.xOffset, l.y -= x.yOffset, (b.transformOrigin || b.svgOrigin) && (T = {}, je(e, me(b.transformOrigin), T, b.svgOrigin, b.smoothOrigin, !0), f = T.xOrigin, p = T.yOrigin, l.x -= T.xOffset - x.xOffset, l.y -= T.yOffset - x.yOffset), (f || p) && (m = Qe(ie, !0), l.x -= f - (f * m[0] + p * m[2]), l.y -= p - (f * m[1] + p * m[3]))), te.body.removeChild(ie), l.perspective || (l.perspective = x.perspective), null != b.xPercent && (l.xPercent = O(b.xPercent, x.xPercent)), null != b.yPercent && (l.yPercent = O(b.yPercent, x.yPercent));
          else if ("object" == typeof b) {
            if (l = {
                scaleX: O(null != b.scaleX ? b.scaleX : b.scale, x.scaleX),
                scaleY: O(null != b.scaleY ? b.scaleY : b.scale, x.scaleY),
                scaleZ: O(b.scaleZ, x.scaleZ),
                x: O(b.x, x.x),
                y: O(b.y, x.y),
                z: O(b.z, x.z),
                xPercent: O(b.xPercent, x.xPercent),
                yPercent: O(b.yPercent, x.yPercent),
                perspective: O(b.transformPerspective, x.perspective)
              }, null != (h = b.directionalRotation))
              if ("object" == typeof h)
                for (d in h) b[d] = h[d];
              else b.rotation = h;
            "string" == typeof b.x && -1 !== b.x.indexOf("%") && (l.x = 0, l.xPercent = O(b.x, x.xPercent)), "string" == typeof b.y && -1 !== b.y.indexOf("%") && (l.y = 0, l.yPercent = O(b.y, x.yPercent)), l.rotation = E("rotation" in b ? b.rotation : "shortRotation" in b ? b.shortRotation + "_short" : x.rotation, x.rotation, "rotation", w), Ne && (l.rotationX = E("rotationX" in b ? b.rotationX : "shortRotationX" in b ? b.shortRotationX + "_short" : x.rotationX || 0, x.rotationX, "rotationX", w), l.rotationY = E("rotationY" in b ? b.rotationY : "shortRotationY" in b ? b.shortRotationY + "_short" : x.rotationY || 0, x.rotationY, "rotationY", w)), l.skewX = E(b.skewX, x.skewX), l.skewY = E(b.skewY, x.skewY)
          }
          for (Ne && null != b.force3D && (x.force3D = b.force3D, u = !0), (c = x.force3D || x.z || x.rotationX || x.rotationY || l.z || l.rotationX || l.rotationY || l.perspective) || null == b.scale || (l.scaleZ = 1); - 1 < --_;)(1e-6 < (T = l[g = Fe[_]] - x[g]) || T < -1e-6 || null != b[g] || null != Z[g]) && (u = !0, o = new xe(x, g, x[g], T, o), g in w && (o.e = w[g]), o.xs0 = 0, o.plugin = s, n._overwriteProps.push(o.n));
          return T = "function" == typeof b.transformOrigin ? b.transformOrigin(A, P) : b.transformOrigin, x.svg && (T || b.svgOrigin) && (f = x.xOffset, p = x.yOffset, je(e, me(T), l, b.svgOrigin, b.smoothOrigin), o = we(x, "xOrigin", (y ? x : l).xOrigin, l.xOrigin, o, k), o = we(x, "yOrigin", (y ? x : l).yOrigin, l.yOrigin, o, k), f === x.xOffset && p === x.yOffset || (o = we(x, "xOffset", y ? f : x.xOffset, x.xOffset, o, k), o = we(x, "yOffset", y ? p : x.yOffset, x.yOffset, o, k)), T = "0px 0px"), (T || Ne && c && x.zOrigin) && (We ? (u = !0, g = qe, T || (T = (T = (ce(e, g, S, !1, "50% 50%") + "").split(" "))[0] + " " + T[1] + " " + x.zOrigin + "px"), T += "", (o = new xe(v, g, 0, 0, o, -1, k)).b = v[g], o.plugin = s, Ne ? (d = x.zOrigin, T = T.split(" "), x.zOrigin = (2 < T.length ? parseFloat(T[2]) : d) || 0, o.xs0 = o.e = T[0] + " " + (T[1] || "50%") + " 0px", (o = new xe(x, "zOrigin", 0, 0, o, -1, o.n)).b = d, o.xs0 = o.e = x.zOrigin) : o.xs0 = o.e = T) : me(T + "", x)), u && (n._transformType = x.svg && Pe || !c && 3 !== this._transformType ? 2 : 3), a && (r.scale = a), o
        },
        allowFunc: !0,
        prefix: !0
      }), De("boxShadow", {
        ...
        parser: function (e, t, i, n, o, s) {
          t = this.format(t);
          for (var r, a, l, d, c, u, h, f, p, m, g, y, v = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], _ = e.style, b = parseFloat(e.offsetWidth), w = parseFloat(e.offsetHeight), k = t.split(" "), x = 0; x < v.length; x++) this.p.indexOf("border") && (v[x] = C(v[x])), -1 !== (l = a = ce(e, v[x], S, !1, "0px")).indexOf(" ") && (l = (a = l.split(" "))[0], a = a[1]), d = r = k[x], c = parseFloat(l), f = l.substr((c + "").length), "" === (h = (p = "=" === d.charAt(1)) ? (u = parseInt(d.charAt(0) + "1", 10), d = d.substr(2), u *= parseFloat(d), d.substr((u + "").length - (u < 0 ? 1 : 0)) || "") : (u = parseFloat(d), d.substr((u + "").length))) && (h = T[i] || f), h !== f && (m = ue(e, "borderLeft", c, f), g = ue(e, "borderTop", c, f), a = "%" === h ? (l = m / b * 100 + "%", g / w * 100 + "%") : "em" === h ? (l = m / (y = ue(e, "borderLeft", 1, "em")) + "em", g / y + "em") : (l = m + "px", g + "px"), p && (d = parseFloat(l) + u + h, r = parseFloat(a) + u + h)), o = Te(_, v[x], l + " " + a, d + " " + r, !1, "0px", o);
          return o
        },
        prefix: !0,
        ...
        defaultValue: "0px",
        parser: function (e, t, i, n, o, s) {
          return Te(e.style, i, this.format(ce(e, i, S, !1, "0px 0px")), this.format(t), !1, "0px", o)
        },
        prefix: !0,
        ...
        defaultValue: "0 0",
        parser: function (e, t, i, n, o, s) {
          var r, a, l, d, c, u, h = "background-position",
            f = S || v(e),
            p = this.format((f ? I ? f.getPropertyValue(h + "-x") + " " + f.getPropertyValue(h + "-y") : f.getPropertyValue(h) : e.currentStyle.backgroundPositionX + " " + e.currentStyle.backgroundPositionY) || "0 0"),
            m = this.format(t);
          if (-1 !== p.indexOf("%") != (-1 !== m.indexOf("%")) && m.split(",").length < 2 && ((u = ce(e, "backgroundImage").replace(Y, "")) && "none" !== u)) {
            for (r = p.split(" "), a = m.split(" "), ne.setAttribute("src", u), l = 2; - 1 < --l;)(d = -1 !== (p = r[l]).indexOf("%")) != (-1 !== a[l].indexOf("%")) && (c = 0 === l ? e.offsetWidth - ne.width : e.offsetHeight - ne.height, r[l] = d ? parseFloat(p) / 100 * c + "px" : parseFloat(p) / c * 100 + "%");
            p = r.join(" ")
          }
          return this.parseComplex(e.style, p, m, o, s)
        },
        formatter: me
      }), De("backgroundSize", {
        defaultValue: "0 0",
        formatter: function (e) {
          return "co" === (e += "").substr(0, 2) ? e : me(-1 === e.indexOf(" ") ? e + " " + e : e)
        }
      }), De("perspective", {
        defaultValue: "0px",
        prefix: !0
        ...
        parser: function (e, t, i, n, o, s) {
          var r, a, l;
          return t = I < 9 ? (a = e.currentStyle, l = I < 8 ? " " : ",", r = "rect(" + a.clipTop + l + a.clipRight + l + a.clipBottom + l + a.clipLeft + ")", this.format(t).split(",").join(l)) : (r = this.format(ce(e, this.p, S, !1, this.dflt)), this.format(t)), this.parseComplex(e.style, r, t, o, s)
        }
      }), De("textShadow", {
        ...
        parser: function (e, t, i, n, o, s) {
          var r = ce(e, "borderTopWidth", S, !1, "0px"),
            a = this.format(t).split(" "),
            l = a[0].replace(F, "");
          return "px" !== l && (r = parseFloat(r) / ue(e, "borderTopWidth", 1, l) + l), this.parseComplex(e.style, this.format(r + " " + ce(e, "borderTopStyle", S, !1, "solid") + " " + ce(e, "borderTopColor", S, !1, "#000")), a.join(" "), o, s)
        },
        color: !0,
        formatter: function (e) {
          var t = e.split(" ");
        ...
        parser: function (e, t, i, n, o, s) {
          ...
          return new xe(r, a, 0, 0, o, -1, i, !1, 0, r[a], t)
        }
      });
      ...
      function Ke(e) {
        var t, i = this.t,
          ...
          o = this.s + this.c * e | 0;
        100 == o && (t = -1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"), !ce(this.data, "filter")) : (i.filter = n.replace(u, ""), !0)), t || (this.xn1 && (i.filter = n = n || "alpha(opacity=" + o + ")"), -1 === n.indexOf("pacity") ? 0 == o && this.xn1 || (i.filter = n + " alpha(opacity=" + o + ")") : i.filter = n.replace(W, "opacity=" + o))
      }
      De("opacity,alpha,autoAlpha", {
        defaultValue: "1",
        parser: function (e, t, i, n, o, s) {
          var r = parseFloat(ce(e, "opacity", S, !1, "1")),
            a = e.style,
            l = "autoAlpha" === i;
          return "string" == typeof t && "=" === t.charAt(1) && (t = ("-" === t.charAt(0) ? -1 : 1) * parseFloat(t.substr(2)) + r), l && 1 === r && "hidden" === ce(e, "visibility", S) && 0 !== t && (r = 0), re ? o = new xe(a, "opacity", r, t - r, o) : ((o = new xe(a, "opacity", 100 * r, 100 * (t - r), o)).xn1 = l ? 1 : 0, a.zoom = 1, o.type = 2, o.b = "alpha(opacity=" + o.s + ")", o.e = "alpha(opacity=" + (o.s + o.c) + ")", o.data = e, o.plugin = s, o.setRatio = Ke), l && ((o = new xe(a, "visibility", 0, 0, o, -1, null, !1, 0, 0 !== r ? "inherit" : "hidden", 0 === t ? "hidden" : "inherit")).xs0 = "inherit", n._overwriteProps.push(o.n), n._overwriteProps.push(i)), o
        }
      });
      ...
      function Ze(e) {
        if (this.t._gsClassPT = this, 1 === e || 0 === e) {
          ...
          for (var t = this.data, i = this.t.style; t;) t.v ? i[t.p] = t.v : et(i, t.p), t = t._next;
      ...
      De("className", {
        parser: function (e, t, i, n, o, s, r) {
          var a, l, d, c, u, h = e.getAttribute("class") || "",
            f = e.style.cssText;
          if ((o = n._classNamePT = new xe(e, i, 0, 0, o, 2)).setRatio = Ze, o.pr = -11, p = !0, o.b = h, l = _(e, S), d = e._gsClassPT) {
            for (c = {}, u = d.data; u;) c[u.p] = 1, u = u._next;
            d.setRatio(1)
          }
          return (e._gsClassPT = o).e = "=" !== t.charAt(1) ? t : h.replace(new RegExp("(?:\\s|^)" + t.substr(2) + "(?![\\w-])"), "") + ("+" === t.charAt(0) ? " " + t.substr(2) : ""), e.setAttribute("class", o.e), a = b(e, l, _(e), r, c), e.setAttribute("class", h), o.data = a.firstMPT, e.style.cssText !== f && (e.style.cssText = f), o.xfirst = n.parse(e, a.difs, o, s)
        }
      });
      ...
      function tt(e) {
        if ((1 === e || 0 === e) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
          ...
          if ("all" === this.e) o = !(r.cssText = "");
            ...
            for (n = (t = this.e.split(" ").join("").split(",")).length; - 1 < --n;) i = t[n], g[i] && (g[i].parse === a ? o = !0 : i = "transformOrigin" === i ? qe : g[i].p), et(r, i);
          o && (et(r, We), (s = this.t._gsTransform) && (s.svg && (this.t.removeAttribute("data-svg-origin"), this.t.removeAttribute("transform")), delete this.t._gsTransform))
        }
      }
      for (De("clearProps", {
          parser: function (e, t, i, n, o) {
            return (o = new xe(e, i, 0, 0, o, 2)).setRatio = tt, o.e = t, o.pr = -10, o.data = n._tween, p = !0, o
          }
        }), e = "bezier,throwProps,physicsProps,physics2D".split(","), Se = e.length; Se--;) Oe(e[Se]);
      (e = N.prototype)._firstPT = e._lastParsedTransform = e._transform = null, e._onInitTween = function (e, t, i, n) {
        if (!e.nodeType) return !1;
        this._target = P = e, this._tween = i, this._vars = t, A = n, j = t.autoRound, p = !1, T = t.suffixMap || N.suffixMap, S = v(e), m = this._overwriteProps;
        var o, s, r, a, l, d, c, u, h, f = e.style;
        if (w && "" === f.zIndex && ("auto" !== (o = ce(e, "zIndex", S)) && "" !== o || this._addLazySet(f, "zIndex", 0)), "string" == typeof t && (a = f.cssText, o = _(e, S), f.cssText = a + ";" + t, o = b(e, o, _(e)).difs, !re && R.test(t) && (o.opacity = parseFloat(RegExp.$1)), t = o, f.cssText = a), t.className ? this._firstPT = s = g.className.parse(e, t.className, "className", this, null, null, t) : this._firstPT = s = this.parse(e, t, null), this._transformType) {
          for (h = 3 === this._transformType, We ? k && (w = !0, "" === f.zIndex && ("auto" !== (c = ce(e, "zIndex", S)) && "" !== c || this._addLazySet(f, "zIndex", 0)), x && this._addLazySet(f, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (h ? "visible" : "hidden"))) : f.zoom = 1, r = s; r && r._next;) r = r._next;
          u = new xe(e, "transform", 0, 0, null, 2), this._linkCSSP(u, null, r), u.setRatio = We ? Ve : Ie, u.data = this._transform || Je(e, S, !0), u.tween = i, u.pr = -1, m.pop()
        }
        if (p) {
          for (; s;) {
            for (d = s._next, r = a; r && r.pr > s.pr;) r = r._next;
            (s._prev = r ? r._prev : l) ? s._prev._next = s: a = s, (s._next = r) ? r._prev = s : l = s, s = d
          }
          this._firstPT = a
        }
        return !0
      }, e.parse = function (e, t, i, n) {
        var o, s, r, a, l, d, c, u, h, f, p = e.style;
        for (o in t) {
          if (d = t[o], s = g[o], "function" != typeof d || s && s.allowFunc || (d = d(A, P)), s) i = s.parse(e, d, o, this, i, n, t);
          else {
            if ("--" === o.substr(0, 2)) {
              this._tween._propLookup[o] = this._addTween.call(this._tween, e.style, "setProperty", v(e).getPropertyValue(o) + "", d + "", o, !1, o);
              continue
            }
            l = ce(e, o, S) + "", h = "string" == typeof d, "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || h && H.test(d) ? (h || (d = (3 < (d = ye(d)).length ? "rgba(" : "rgb(") + d.join(",") + ")"), i = Te(p, o, l, d, !0, "transparent", i, 0, n)) : h && J.test(d) ? i = Te(p, o, l, d, !0, null, i, 0, n) : (c = (r = parseFloat(l)) || 0 === r ? l.substr((r + "").length) : "", "" !== l && "auto" !== l || (c = "width" === o || "height" === o ? (r = function (e, t, i) {
              if ("svg" === (e.nodeName + "").toLowerCase()) return (i || v(e))[t] || 0;
              if (e.getCTM && Ge(e)) return e.getBBox()[t] || 0;
              var n = parseFloat("width" === t ? e.offsetWidth : e.offsetHeight),
                o = fe[t],
                s = o.length;
              for (i = i || v(e); - 1 < --s;) n -= parseFloat(ce(e, "padding" + o[s], i, !0)) || 0, n -= parseFloat(ce(e, "border" + o[s] + "Width", i, !0)) || 0;
              return n
            }(e, o, S), "px") : "left" === o || "top" === o ? (r = he(e, o, S), "px") : (r = "opacity" !== o ? 0 : 1, "")), "" === (u = (f = h && "=" === d.charAt(1)) ? (a = parseInt(d.charAt(0) + "1", 10), d = d.substr(2), a *= parseFloat(d), d.replace(F, "")) : (a = parseFloat(d), h ? d.replace(F, "") : "")) && (u = o in T ? T[o] : c), d = a || 0 === a ? (f ? a + r : a) + u : t[o], c === u || "" === u && "lineHeight" !== o || !a && 0 !== a || !r || (r = ue(e, o, r, c), "%" === u ? (r /= ue(e, o, 100, "%") / 100, !0 !== t.strictUnits && (l = r + "%")) : "em" === u || "rem" === u || "vw" === u || "vh" === u ? r /= ue(e, o, 1, u) : "px" !== u && (a = ue(e, o, a, u), u = "px"), f && (a || 0 === a) && (d = a + r + u)), f && (a += r), !r && 0 !== r || !a && 0 !== a ? void 0 !== p[o] && (d || d + "" != "NaN" && null != d) ? (i = new xe(p, o, a || r || 0, 0, i, -1, o, !1, 0, l, d)).xs0 = "none" !== d || "display" !== o && -1 === o.indexOf("Style") ? d : l : y("invalid " + o + " tween value: " + t[o]) : (i = new xe(p, o, r, a - r, i, 0, o, !1 !== j && ("px" === u || "zIndex" === o), 0, l, d)).xs0 = u)
          }
        ...
        this._transform = this._transform || Je(this._target, S, !0), this._transformType = this._transform.svg && Pe || !e && 3 !== this._transformType ? 2 : 3
      };
      ...
      var nt = function (e, t, i) {
        var n, o, s, r;
        if (e.slice)
          for (o = e.length; - 1 < --o;) nt(e[o], t, i);
        else
          for (o = (n = e.childNodes).length; - 1 < --o;) r = (s = n[o]).type, s.style && (t.push(_(s)), i && i.push(s)), 1 !== r && 9 !== r && 11 !== r || !s.childNodes.length || nt(s, t, i)
      };
      return N.cascadeTo = function (e, t, i) {
        var n, o, s, r, a = q.to(e, t, i),
          l = [a],
          d = [],
          c = [],
          u = [],
          h = q._internals.reservedProps;
        for (e = a._targets || a.target, nt(e, d, u), a.render(t, !0, !0), nt(e, c), a.render(0, !0, !0), a._enabled(!0), n = u.length; - 1 < --n;)
          if ((o = b(u[n], d[n], c[n])).firstMPT) {
            for (s in o = o.difs, i) h[s] && (o[s] = i[s]);
            for (s in r = {}, o) r[s] = d[n][s];
            l.push(q.fromTo(u[n], t, r, o))
          } return l
      }, s.activate([N]), N
      ...
      for (n in r)
        for (e = o._firstPT; e;) t = e._next, e.pg ? e.t._mod(r) : e.n === n && (2 === e.f && e.t ? function (e, t) {
          for (; e;) e.f || e.blob || (e.m = t || Math.round), e = e._next
        }(e.t._firstPT, r[n]) : (this._add(e.t, n, e.s, e.c, r[n]), t && (t._prev = e._prev), e._prev ? e._prev._next = t : o._firstPT === e && (o._firstPT = t), e._next = e._prev = null, o._propLookup[n] = a)), e = t;
      return !1
    }, t._add = function (e, t, i, n, o) {
      ...
      var n, o, s, r, a = _gsScope.GreenSockGlobals || _gsScope,
        ...
        p = u("easing.SlowMo", function (e, t, i) {
          t = t || 0 === t ? t : .7, null == e ? e = .7 : 1 < e && (e = 1), this._p = 1 !== e ? t : 0, this._p1 = (1 - e) / 2, this._p2 = e, this._p3 = this._p1 + this._p2, this._calcEnd = !0 === i
        }, !0),
        m = p.prototype = new g;
      return m.constructor = p, m.getRatio = function (e) {
        var t = e + (.5 - e) * this._p;
        return e < this._p1 ? this._calcEnd ? 1 - (e = 1 - e / this._p1) * e : t - (e = 1 - e / this._p1) * e * e * e * t : e > this._p3 ? this._calcEnd ? 1 === e ? 0 : 1 - (e = (e - this._p3) / this._p1) * e : t + (e - t) * (e = (e - this._p3) / this._p1) * e * e * e : this._calcEnd ? 1 : t
      }, p.ease = new p(.7, .7), m.config = p.config = function (e, t, i) {
        return new p(e, t, i)
      }, (m = (n = u("easing.SteppedEase", function (e, t) {
        ...
        return new n(e, t)
      }, (m = (o = u("easing.ExpoScaleEase", function (e, t, i) {
        this._p1 = Math.log(t / e), this._p2 = t - e, this._p3 = e, this._ease = i
      }, !0)).prototype = new g).constructor = o, m.getRatio = function (e) {
        return this._ease && (e = this._ease.getRatio(e)), (this._p3 * Math.exp(this._p1 * e) - this._p3) / this._p2
      }, m.config = o.config = function (e, t, i) {
        return new o(e, t, i)
      }, (m = (s = u("easing.RoughEase", function (e) {
        for (var t, i, n, o, s, r, a = (e = e || {}).taper || "none", l = [], d = 0, c = 0 | (e.points || 20), u = c, h = !1 !== e.randomize, f = !0 === e.clamp, p = e.template instanceof g ? e.template : null, m = "number" == typeof e.strength ? .4 * e.strength : .4; - 1 < --u;) t = h ? Math.random() : 1 / c * u, i = p ? p.getRatio(t) : t, n = "none" === a ? m : "out" === a ? (o = 1 - t) * o * m : "in" === a ? t * t * m : (o = t < .5 ? 2 * t : 2 * (1 - t)) * o * .5 * m, h ? i += Math.random() * n - .5 * n : u % 2 ? i += .5 * n : i -= .5 * n, f && (1 < i ? i = 1 : i < 0 && (i = 0)), l[d++] = {
          x: t,
          y: i
        };
        for (l.sort(function (e, t) {
            return e.x - t.x
          }), r = new y(1, 1, null), u = c; - 1 < --u;) s = l[u], r = new y(s.x, s.y, r);
        ...
        return new s(e)
      }, s.ease = new s, t("Bounce", e("BounceOut", function (e) {
      ...
      })), t("Elastic", (r = function (e, t, i) {
        var n = u("easing." + e, function (e, t) {
            this._p1 = 1 <= e ? e : 1, this._p2 = (t || i) / (e < 1 ? e : 1), this._p3 = this._p2 / d * (Math.asin(1 / this._p1) || 0), this._p2 = d / this._p2
          }, !0),
          o = n.prototype = new g;
      ...
      }, !0), h(a.SlowMo, "SlowMo", "ease,"), h(s, "RoughEase", "ease,"), h(n, "SteppedEase", "ease,"), f
    }, !0)
  ...
  function (h, f) {
    ...
    function g(e) {
      for (var t = e.split("."), i = m, n = 0; n < t.length; n++) i[t[n]] = i = i[t[n]] || {};
      return i
    }
    ...
    function y() {}
    var v, t, i, u = g("com.greensock"),
      _ = 1e-8,
      b = (t = Object.prototype.toString, i = t.call([]), function (e) {
      ...
      k = function (a, l, d, c) {
        ...
        this.check = function (e) {
          for (var t, i, n, o, s = l.length, r = s; - 1 < --s;)(t = w[l[s]] || new k(l[s], [])).gsClass ? (u[s] = t.gsClass, r--) : e && t.sc.push(this);
          if (0 === r && d) {
            if (n = (i = ("com.greensock." + a).split(".")).pop(), o = g(i.join("."))[n] = this.gsClass = d.apply(d, u), c)
              if (m[n] = p[n] = o, "undefined" != typeof module && module.exports)
                if (a === f)
                  for (s in module.exports = p[f] = o, p) o[s] = p[s];
                else p[f] && (p[f][n] = o);
    ...
    var s, r = [0, 0, 1, 1],
      T = x("easing.Ease", function (e, t, i, n) {
        this._func = e, this._type = i || 0, this._power = n || 0, this._params = t ? r.concat(t) : r
      }, !0),
      S = T.map = {},
      a = T.register = function (e, t, i, n) {
        for (var o, s, r, a, l = t.split(","), d = l.length, c = (i || "easeIn,easeOut,easeInOut").split(","); - 1 < --d;)
          for (s = l[d], o = n ? x("easing." + s, null, !0) : u.easing[s] || {}, r = c.length; - 1 < --r;) a = c[r], S[s + "." + a] = S[a + s] = o[a] = e.getRatio ? e : e[a] || new e
      };
    for ((s = T.prototype)._calcEnd = !1, s.getRatio = function (e) {
      ...
      }, c = (d = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length; - 1 < --c;) s = d[c] + ",Power" + c, a(new T(null, null, 1, c), s, "easeOut", !0), a(new T(null, null, 2, c), s, "easeIn" + (0 === c ? ",easeNone" : "")), a(new T(null, null, 3, c), s, "easeInOut");
    S.linear = u.easing.Linear.easeIn, S.swing = u.easing.Quad.easeInOut;
    var C = x("events.EventDispatcher", function (e) {
      this._listeners = {}, this._eventTarget = e || this
    });
    (s = C.prototype).addEventListener = function (e, t, i, n, o) {
      o = o || 0;
      var s, r, a = this._listeners[e],
        l = 0;
      for (this !== P || v || P.wake(), null == a && (this._listeners[e] = a = []), r = a.length; - 1 < --r;)(s = a[r]).c === t && s.s === i ? a.splice(r, 1) : 0 === l && s.pr < o && (l = r + 1);
      a.splice(l, 0, {
        c: t,
        s: i,
        up: n,
    ...
    for (var d, D = h.requestAnimationFrame, O = h.cancelAnimationFrame, E = Date.now || function () {
        return (new Date).getTime()
      }, j = E(), c = (d = ["ms", "moz", "webkit", "o"]).length; - 1 < --c && !D;) D = h[d[c] + "RequestAnimationFrame"], O = h[d[c] + "CancelAnimationFrame"] || h[d[c] + "CancelRequestAnimationFrame"];
    x("Ticker", function (e, t) {
      var o, s, r, a, l, d = this,
        ...
        f = function (e) {
          var t, i, n = E() - j;
          u < n && (c += n - h), j += n, d.time = (j - c) / 1e3, t = d.time - l, (!o || 0 < t || !0 === e) && (d.frame++, l += t + (a <= t ? .004 : a - t), i = !0), !0 !== e && (r = s(f)), i && d.dispatchEvent("tick")
        };
      C.call(d), d.time = d.frame = 0, d.tick = function () {
        f(!0)
      }, d.lagSmoothing = function (e, t) {
        return arguments.length ? (u = e || 1e8, void(h = Math.min(t, u, 0))) : u < 1e8
      }, d.sleep = function () {
        null != r && ((i && O ? O : clearTimeout)(r), s = y, r = null, d === P && (v = !1))
      }, d.wake = function (e) {
        null !== r ? d.sleep() : e ? c += -j + (j = E()) : 10 < d.frame && (j = E() - u + 5), s = 0 === o ? y : i && D ? D : function (e) {
          return setTimeout(e, 1e3 * (l - d.time) + 1 | 0)
        }, d === P && (v = !0), f(2)
      }, d.fps = function (e) {
        return arguments.length ? (a = 1 / ((o = e) || 60), l = this.time + a, void d.wake()) : o
      }, d.useRAF = function (e) {
        return arguments.length ? (d.sleep(), i = e, void d.fps(o)) : i
      }, d.fps(e), setTimeout(function () {
        "auto" === i && d.frame < 5 && "hidden" !== (n || {}).visibilityState && d.useRAF(!1)
      }, 1500)
    }), (s = u.Ticker.prototype = new u.events.EventDispatcher).constructor = u.Ticker;
    var I = x("core.Animation", function (e, t) {
        var i;
        this.vars = t = t || {}, this._duration = this._totalDuration = e || 0, this._delay = Number(t.delay) || 0, this._timeScale = 1, this._active = !!t.immediateRender, this.data = t.data, this._reversed = !!t.reversed, K && (v || P.wake(), (i = this.vars.useFrames ? V : K).add(this, i._time), this.vars.paused && this.paused(!0))
      }),
      P = I.ticker = new u.Ticker;
    (s = I.prototype)._dirty = s._gc = s._initted = s._paused = !1, s._totalTime = s._time = 0, s._rawPrevTime = -1, s._next = s._last = s._onUpdate = s._timeline = s.timeline = null, s._paused = !1;
    var A = function () {
      v && 2e3 < E() - j && ("hidden" !== (n || {}).visibilityState || !P.lagSmoothing()) && P.wake();
    ...
    A(), s.play = function (e, t) {
      ...
      return v || P.wake(), this._gc = !e, this._active = this.isActive(), !0 !== t && (e && !this.timeline ? this._timeline.add(this, this._startTime - this._delay) : !e && this.timeline && this._timeline._remove(this, !0)), !1
      ...
      if ("on" === (e || "").substr(0, 2)) {
        ...
        null == t ? delete o[e] : (o[e] = t, o[e + "Params"] = b(i) && -1 !== i.join("").indexOf("{self}") ? this._swapSelfInParams(i) : i, o[e + "Scope"] = n), "onUpdate" === e && (this._onUpdate = t)
      }
      return this
    }, s.delay = function (e) {
      ...
      if (v || P.wake(), !arguments.length) return this._totalTime;
      if (this._timeline) {
      ...
      return e != this._paused && n && (v || e || P.wake(), i = (t = n.rawTime()) - this._pauseTime, !e && n.smoothChildTiming && (this._startTime += i, this._uncache(!1)), this._pauseTime = e ? t : null, this._paused = e, this._active = this.isActive(), !e && 0 != i && this._initted && this.duration() && (t = n.smoothChildTiming ? this._totalTime : (t - this._startTime) / this._timeScale, this.render(t, t === this._totalTime, !0))), this._gc && !e && this._enabled(!0, !1), this
    };
    var M = x("core.SimpleTimeline", function (e) {
      I.call(this, 0, e), this.autoRemoveChildren = this.smoothChildTiming = !0
    });
    (s = M.prototype = new I).constructor = M, s.kill()._gc = !1, s._first = s._last = s._recent = null, s._sortChildren = !1, s.add = s.insert = function (e, t, i, n) {
      var o, s;
    ...
    var L = x("TweenLite", function (e, t, i) {
      ...
      var n, o, s, r = e.jquery || e.length && e !== h && e[0] && (e[0] === h || e[0].nodeType && e[0].style && !e.nodeType),
        a = this.vars.overwrite;
      if (this._overwrite = a = null == a ? J[L.defaultOverwrite] : "number" == typeof a ? a >> 0 : J[a], (r || e instanceof Array || e.push && b(e)) && "number" != typeof e[0])
        for (this._targets = s = l(e), this._propLookup = [], this._siblings = [], n = 0; n < s.length; n++)(o = s[n]) ? "string" != typeof o ? o.length && o !== h && o[0] && (o[0] === h || o[0].nodeType && o[0].style && !o.nodeType) ? (s.splice(n--, 1), this._targets = s = s.concat(l(o))) : (this._siblings[n] = ie(o, this, !1), 1 === a && 1 < this._siblings[n].length && ne(o, this, null, 1, this._siblings[n])) : "string" == typeof (o = s[n--] = L.selector(o)) && s.splice(n + 1, 1) : s.splice(n--, 1);
      else this._propLookup = {}, this._siblings = ie(e, this, !1), 1 === a && 1 < this._siblings.length && ne(e, this, null, 1, this._siblings);
      (this.vars.immediateRender || 0 === t && 0 === this._delay && !1 !== this.vars.immediateRender) && (this._time = -_, this.render(Math.min(0, -this._delay)))
    }, !0);
    (s = L.prototype = new I).constructor = L, s.kill()._gc = !1, s.ratio = 0, s._firstPT = s._targets = s._overwrittenProps = s._startAt = null, s._notifyPluginsOfEnabled = s._lazy = !1, L.version = "2.1.3", L.defaultEase = s._ease = new T(null, null, 1, 1), L.defaultOverwrite = "auto", L.ticker = P, L.autoSleep = 120, L.lagSmoothing = function (e, t) {
      P.lagSmoothing(e, t)
    }, L.selector = h.$ || h.jQuery || function (e) {
      var t = h.$ || h.jQuery;
      return t ? (L.selector = t)(e) : (n = n || h.document) ? n.querySelectorAll ? n.querySelectorAll(e) : n.getElementById("#" === e.charAt(0) ? e.substr(1) : e) : e
    };
    ...
    function R(e, t, i, n) {
      var o, s, r, a, l, d, c, u = [],
        ...
        f = "",
        p = 0;
      for (u.start = e, u.end = t, e = u[0] = e + "", t = u[1] = t + "", i && (i(u), e = u[0], t = u[1]), u.length = 0, o = e.match(H) || [], s = t.match(H) || [], n && (n._next = null, n.blob = 1, u._firstPT = u._applyPT = n), l = s.length, a = 0; a < l; a++) c = s[a], f += (d = t.substr(h, t.indexOf(c, h) - h)) || !a ? d : ",", h += d.length, p ? p = (p + 1) % 5 : "rgba(" === d.substr(-5) && (p = 1), c === o[a] || o.length <= a ? f += c : (f && (u.push(f), f = ""), r = parseFloat(o[a]), u.push(r), u._firstPT = {
        _next: u._firstPT,
        t: u,
        p: u.length - 1,
        s: r,
      ...
      return (f += t.substr(h)) && u.push(f), u.setRatio = F, B.test(t) && (u.end = null), u
    }
    ...
    function q(e, t, i, n, o, s, r, a, l) {
      ...
      return "number" == typeof u && ("number" == typeof n || h) || (r || isNaN(u) || !h && isNaN(n) || "boolean" == typeof u || "boolean" == typeof n ? (f.fp = r, f = {
        t: R(u, h ? parseFloat(f.s) + f.c + (f.s + "").replace(/[0-9\-\.]/g, "") : n, a || L.defaultStringFilter, f),
        p: "setRatio",
        s: 0,
        c: 1,
        f: 2,
        ...
        pr: 0,
        m: 0
      }) : (f.s = parseFloat(u), h || (f.c = parseFloat(n) - f.s || 0))), f.c ? ((f._next = this._firstPT) && (f._next._prev = f), this._firstPT = f) : void 0
    }
    var N = [],
      $ = {},
      H = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
      ...
      V = I._rootFramesTimeline = new M,
      K = I._rootTimeline = new M,
      Z = 30,
      ee = Y.lazyRender = function () {
        var e, t, i = N.length;
        for ($ = {}, e = 0; e < i; e++)(t = N[e]) && !1 !== t._lazy && (t.render(t._lazy[0], t._lazy[1], !0), t._lazy = !1);
        N.length = 0
      };
    K._startTime = P.time, V._startTime = P.frame, K._active = V._active = !0, setTimeout(ee, 1), I._updateRoot = L.render = function () {
      var e, t, i;
      if (N.length && ee(), K.render((P.time - K._startTime) * K._timeScale, !1, !1), V.render((P.frame - V._startTime) * V._timeScale, !1, !1), N.length && ee(), P.frame >= Z) {
        for (i in Z = P.frame + (parseInt(L.autoSleep, 10) || 120), G) {
          for (e = (t = G[i].tweens).length; - 1 < --e;) t[e]._gc && t.splice(e, 1);
          0 === t.length && delete G[i]
        }
        if ((!(i = K._first) || i._paused) && L.autoSleep && !V._first && 1 === P._listeners.tick.length) {
    ...
    var ie = function (e, t, i) {
        ...
        if (G[s || (e._gsTweenID = s = "t" + X++)] || (G[s] = {
            target: e,
            tweens: []
          }), t && ((n = G[s].tweens)[o = n.length] = t, i))
      ...
      ne = function (e, t, i, n, o) {
        var s, r, a;
        if (1 === n || 4 <= n) {
          for (a = o.length, f = 0; f < a; f++)
            if ((r = o[f]) !== t) r._gc || r._kill(null, e, t) && (s = !0);
            else if (5 === n) break;
          return s
        }
        for (var l, d = t._startTime + _, c = [], u = 0, h = 0 === t._duration, f = o.length; - 1 < --f;)(r = o[f]) === t || r._gc || r._paused || (r._timeline !== t._timeline ? (l = l || oe(t, 0, h), 0 === oe(r, l, h) && (c[u++] = r)) : r._startTime <= d && r._startTime + r.totalDuration() / r._timeScale > d && ((h || !r._initted) && d - r._startTime <= 2e-8 || (c[u++] = r)));
        for (f = u; - 1 < --f;)
          if (a = (r = c[f])._firstPT, 2 === n && r._kill(i, e, t) && (s = !0), 2 !== n || !r._firstPT && r._initted && a) {
            if (2 !== n && !te(r, t)) continue;
            r._enabled(!1, !1) && (s = !0)
          } return s
      },
      oe = function (e, t, i) {
        ...
        return t < (s /= o) ? s - t : i && s === t || !e._initted && s - t < 2e-8 ? _ : (s += e.totalDuration() / e._timeScale / o) > t + _ ? 0 : s - t - _
      };
    s._init = function () {
    ...
    }, s._initProps = function (e, t, i, n, o) {
      var s, r, a, l, d, c;
      if (null == e) return !1;
      for (s in $[e._gsTweenID] && ee(), this.vars.css || e.style && e !== h && e.nodeType && U.css && !1 !== this.vars.autoCSS && function (e, t) {
          var i, n = {};
        ...
        if (c = this.vars[s], Q[s]) c && (c instanceof Array || c.push && b(c)) && -1 !== c.join("").indexOf("{self}") && (this.vars[s] = c = this._swapSelfInParams(c, this));
        ...
        (l._priority || l._onInitAllProps) && (a = !0), (l._onDisable || l._onEnable) && (this._notifyPluginsOfEnabled = !0), d._next && (d._next._prev = d)
      } else t[s] = q.call(this, e, s, "get", c, s, 0, null, this.vars.stringFilter, o);
      return n && this._kill(n, e) ? this._initProps(e, t, i, n, o) : 1 < this._overwrite && this._firstPT && 1 < i.length && ne(e, this, t, this._overwrite, i) ? (this._kill(t, e), this._initProps(e, t, i, n, o)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && ($[e._gsTweenID] = !0), a)
    }, s.render = function (e, t, i) {
      var n, o, s, r, a, l, d, c = this,
        u = c._time,
        h = c._duration,
        f = c._rawPrevTime;
      if (h - _ <= e && 0 <= e ? (c._totalTime = c._time = h, c.ratio = c._ease._calcEnd ? c._ease.getRatio(1) : 1, c._reversed || (n = !0, o = "onComplete", i = i || c._timeline.autoRemoveChildren), 0 !== h || !c._initted && c.vars.lazy && !i || (c._startTime === c._timeline._duration && (e = 0), (f < 0 || e <= 0 && -_ <= e || f === _ && "isPause" !== c.data) && f !== e && (i = !0, _ < f && (o = "onReverseComplete")), c._rawPrevTime = r = !t || e || f === e ? e : _)) : e < _ ? (c._totalTime = c._time = 0, c.ratio = c._ease._calcEnd ? c._ease.getRatio(0) : 0, (0 !== u || 0 === h && 0 < f) && (o = "onReverseComplete", n = c._reversed), -_ < e ? e = 0 : e < 0 && (c._active = !1, 0 !== h || !c._initted && c.vars.lazy && !i || (0 <= f && (f !== _ || "isPause" !== c.data) && (i = !0), c._rawPrevTime = r = !t || e || f === e ? e : _)), (!c._initted || c._startAt && c._startAt.progress()) && (i = !0)) : (c._totalTime = c._time = e, c._easeType ? (a = e / h, (1 === (l = c._easeType) || 3 === l && .5 <= a) && (a = 1 - a), 3 === l && (a *= 2), 1 === (d = c._easePower) ? a *= a : 2 === d ? a *= a * a : 3 === d ? a *= a * a * a : 4 === d && (a *= a * a * a * a), c.ratio = 1 === l ? 1 - a : 2 === l ? a : e / h < .5 ? a / 2 : 1 - a / 2) : c.ratio = c._ease.getRatio(e / h)), c._time !== u || i) {
        if (!c._initted) {
          if (c._init(), !c._initted || c._gc) return;
          if (!i && c._firstPT && (!1 !== c.vars.lazy && c._duration || c.vars.lazy && !c._duration)) return c._time = c._totalTime = u, c._rawPrevTime = f, N.push(c), void(c._lazy = [e, t]);
          c._time && !n ? c.ratio = c._ease.getRatio(c._time / h) : n && c._ease._calcEnd && (c.ratio = c._ease.getRatio(0 === c._time ? 0 : 1))
        }
        for (!1 !== c._lazy && (c._lazy = !1), c._active || !c._paused && c._time !== u && 0 <= e && (c._active = !0), 0 === u && (c._startAt && (0 <= e ? c._startAt.render(e, !0, i) : o = o || "_dummyGS"), !c.vars.onStart || 0 === c._time && 0 !== h || (t || c._callback("onStart"))), s = c._firstPT; s;) s.f ? s.t[s.p](s.c * c.ratio + s.s) : s.t[s.p] = s.c * c.ratio + s.s, s = s._next;
        c._onUpdate && (e < 0 && c._startAt && -1e-4 !== e && c._startAt.render(e, !0, i), t || (c._time !== u || n || i) && c._callback("onUpdate")), !o || c._gc && !i || (e < 0 && c._startAt && !c._onUpdate && -1e-4 !== e && c._startAt.render(e, !0, i), n && (c._timeline.autoRemoveChildren && c._enabled(!1, !1), c._active = !1), !t && c.vars[o] && c._callback(o), 0 === h && c._rawPrevTime === _ && r !== _ && (c._rawPrevTime = 0))
      }
    }, s._kill = function (e, t, i) {
      if ("all" === e && (e = null), null == e && (null == t || t === this.target)) return this._lazy = !1, this._enabled(!1, !1);
      t = "string" != typeof t ? t || this._targets || this.target : L.selector(t) || t;
      var n, o, s, r, a, l, d, c, u, h = i && this._time && i._startTime === this._startTime && this._timeline === i._timeline,
        f = this._firstPT;
      if ((b(t) || z(t)) && "number" != typeof t[0])
        ...
        if (a) {
          ...
          for (s in d)(r = a[s]) && (h && (r.f ? r.t[r.p](r.s) : r.t[r.p] = r.s, l = !0), r.pg && r.t._kill(d) && (l = !0), r.pg && 0 !== r.t._overwriteProps.length || (r._prev ? r._prev._next = r._next : r === this._firstPT && (this._firstPT = r._next), r._next && (r._next._prev = r._prev), r._next = r._prev = null), delete a[s]), c && (o[s] = 1);
      ...
      var e = this._time;
      return this._firstPT = this._overwrittenProps = this._startAt = this._onUpdate = null, this._notifyPluginsOfEnabled = this._active = this._lazy = !1, this._propLookup = this._targets ? {} : [], I.prototype.invalidate.call(this), this.vars.immediateRender && (this._time = -_, this.render(e, !1, !1 !== this.vars.lazy)), this
    }, s._enabled = function (e, t) {
      if (v || P.wake(), e && this._gc) {
      ...
      if (null == e) return [];
      var i, n, o, s;
      if (e = "string" == typeof e && L.selector(e) || e, (b(e) || z(e)) && "number" != typeof e[0]) {
    ...
    if (s = se.prototype, se.version = "1.19.0", se.API = 2, s._firstPT = null, s._addTween = q, s.setRatio = F, s._kill = function (e) {
  ...
  function (e) {
    ...
    window.SplitType = function (D, l, s) {
      function d(e) {
        return null !== e && "object" == typeof e
      }

      function c(e) {
        return d(e) && "number" == typeof e.length && 0 < e.length
      }

      function u(e) {
        return d(e) && /^(1|3|11)$/.test(e.nodeType)
      }

      function O(e, t, i) {
        for (var n, o = Object(e), s = c(o) ? o : d(n = o) && "[object Object]" === Object.prototype.toString.call(n) ? f(o) : [o], r = parseInt(s.length) || 0, a = 0; a < r; a++) t.call(i, s[a], a, o)
      }

      function i(i, n) {
        return i = Object(i), n = Object(n), Object.getOwnPropertyNames(i).reduce(function (e, t) {
          return o(e, t, p(n, t) || p(i, t))
        }, {})
      }

      function E(e, t, i) {
        var n, o = {};
        return d(e) && (n = e[r] || (e[r] = ++h), o = a[n] || (a[n] = {})), i === s ? t === s ? o : o[t] : t !== s ? o[t] = i : void 0
      }

      function j(e, i) {
        var n = l.createElement(e);
        return i === s || O(i, function (e) {
          var t = i[e];
          if (null !== t) switch (e) {
            case "textContent":
              n.textContent = t;
      ...
      function n(e, t) {
        return this instanceof n ? (this.isSplit = !1, this.settings = i(m, t), this.elements = function (e) {
          var t, i, n, o, s, r, a = [];
          if ("string" == typeof e && (e = "#" === (t = e.trim())[0] && !/[^\w]/.test(i = t.slice(1)) ? l.getElementById(i) : l.querySelectorAll(t)), t || u(e)) return u(e) ? [e] : P.call(e);
          if (c(e))
            for (s = 0, n = e.length; s < n; s++)
              if (c(e[s]))
                for (r = 0, o = e[s].length; r < o; r++) u(e[s][r]) && a.push(e[s][r]);
              else u(e[s]) && a.push(e[s]);
          return a
        }(e), void(this.elements.length && (this.originals = this.elements.map(function (e) {
          return E(e).html = E(e).html || e.innerHTML
        }), this.split()))) : new n(e, t)
      }
      if (l.addEventListener && Function.prototype.bind) {
        var r = "splitType" + +new Date,
          ...
          f = Object.keys,
          o = (Object.prototype.hasOwnProperty, Object.defineProperty),
        ...
        return o(n, "defaults", {
          ...
          this.revert(), this.lines = [], this.words = [], this.chars = [], e !== s && (this.settings = i(this.settings, e)), O(this.elements, function (e) {
            (function (e) {
              var t, i, n, o, s, r, a, l, d, c, u, h, f, p, m, g = this.settings,
                y = g.tagName,
                v = "B" + +new Date + "R",
                _ = g.split,
                b = -1 !== _.indexOf("lines"),
                w = -1 !== _.indexOf("words"),
                k = -1 !== _.indexOf("chars"),
                x = "absolute" === g.position || !0 === g.absolute,
                T = j("div"),
                S = [],
                C = b ? j("div") : A();
              T.innerHTML = e.innerHTML.replace(/<br\s*\/?>/g, " " + v + " "), o = T.textContent.replace(/\s+/g, " ").trim().split(" ").map(function (e) {
                return e === v ? (C.appendChild(j("br")), null) : (k && (t = e.split("").map(function (e) {
                  return j(y, {
                    class: g.charClass + " " + g.splitClass,
                    style: "display: inline-block;",
                    textContent: e
                  })
                }), I.apply(S, t)), w || b ? (i = j(y, {
                  class: g.wordClass + " " + g.splitClass,
                  style: "display: inline-block; position:" + (w ? "relative" : "static;"),
                  children: k ? t : null,
                  textContent: k ? null : e
                }), C.appendChild(i)) : O(t, function (e) {
                  C.appendChild(e)
                }), C.appendChild(M(" ")), i);
                var t
              }, this).filter(function (e) {
                return e
              }), e.innerHTML = "", e.appendChild(C), I.apply(this.words, o), I.apply(this.chars, S), (x || b) && (u = [], h = E(e).nodes = e.getElementsByTagName(y), f = e.parentElement, p = e.nextElementSibling, m = D.getComputedStyle(e).textAlign, x && (l = {
                left: C.offsetLeft,
                top: C.offsetTop,
                width: C.offsetWidth
              }, c = e.offsetWidth, d = e.offsetHeight, E(e).cssWidth = e.style.width, E(e).cssHeight = e.style.height), O(h, function (e) {
                var t, i;
                e !== C && (i = e.parentElement === C, b && i && ((t = E(e).top = e.offsetTop) !== r && (r = t, u.push(s = [])), s.push(e)), x && (E(e).top = t || e.offsetTop, E(e).left = e.offsetLeft, E(e).width = e.offsetWidth, E(e).height = a = a || e.offsetHeight))
              }), f.removeChild(e), b && (C = A(), n = u.map(function (e) {
                return C.appendChild(t = j(y, {
                  class: g.lineClass + " " + g.splitClass,
                  style: "display: block; text-align:" + m + "; width: 100%;"
                })), x && (E(t).type = "line", E(t).top = E(e[0]).top, E(t).height = a), O(e, function (e) {
                  w ? t.appendChild(e) : k ? P.call(e.children).forEach(function (e) {
                    t.appendChild(e)
                  }) : t.appendChild(M(e.textContent)), t.appendChild(M(" "))
                }), t
              }), e.replaceChild(C, e.firstChild), I.apply(this.lines, n)), x && (e.style.width = e.style.width || c + "px", e.style.height = d + "px", O(h, function (e) {
                var t = "line" === E(e).type,
                  i = !t && "line" === E(e.parentElement).type;
                e.style.top = i ? 0 : E(e).top + "px", e.style.left = t ? l.left + "px" : (i ? E(e).left - l.left : E(e).left) + "px", e.style.height = E(e).height + "px", e.style.width = t ? l.width + "px" : E(e).width + "px", e.style.position = "absolute"
              })), p ? f.insertBefore(e, p) : f.appendChild(e))
            }).call(this, e), E(e).isSplit = !0
          }, this), this.isSplit = !0, O(this.elements, function (e) {
            for (var t, i, n = E(e).nodes || [], o = 0, s = n.length; o < s; o++) i = void 0, (i = (t = n[o]) && t[r]) && (delete t[i], delete a[i])
          })
        }, n.prototype.revert = function () {
          this.isSplit && (this.lines = this.words = this.chars = null), O(this.elements, function (e) {
            E(e).isSplit && E(e).html && (e.innerHTML = E(e).html, e.style.height = E(e).cssHeight || "", e.style.width = E(e).cssWidth || "", this.isSplit = !1)
          }, this)
        }, n
      }
    }(window, document)
  }), "object" == typeof LS_Meta && LS_Meta.fixGSAP && (window.GreenSockGlobals = null, window._gsQueue = null, window._gsDefine = null, delete window.GreenSockGlobals, delete window._gsQueue, delete window._gsDefine, window.GreenSockGlobals = LS_oldGS, window._gsQueue = LS_oldGSQueue, window._gsDefine = LS_oldGSDefine),
  function (e, t) {
  ...
  function (t, i) {
    ...
    function r(e, t, i) {
      ...
      var n, o = e;
      return "string" == typeof e && (o = document.querySelectorAll(e)), o ? (this.elements = (n = o, Array.isArray(n) ? n : "object" == typeof n && "number" == typeof n.length ? d.call(n) : [n]), this.options = s({}, this.options), "function" == typeof t ? i = t : s(this.options, t), i && this.on("always", i), this.getImages(), a && (this.jqDeferred = new a.Deferred), void setTimeout(this.check.bind(this))) : void l.error("Bad element for imagesLoaded " + (o || e))
    }
  ...
  function (t, i) {
    ...
    function i(d, o, c) {
      (c = c || t || e.jQuery) && (o.prototype.option || (o.prototype.option = function (e) {
        c.isPlainObject(e) && (this.options = c.extend(!0, this.options, e))
      }), c.fn[d] = function (e) {
        if ("string" != typeof e) return n = e, this.each(function (e, t) {
          var i = c.data(t, d);
          i ? (i.option(n), i._init()) : (i = new o(t, n), c.data(t, d, i))
        }), this;
        var t, s, r, a, l, n, i = u.call(arguments, 1);
        return r = i, l = "$()." + d + '("' + (s = e) + '")', (t = this).each(function (e, t) {
          var i, n, o = c.data(t, d);
          o ? (i = o[s]) && "_" != s.charAt(0) ? (n = i.apply(o, r), a = void 0 === a ? n : a) : h(l + " is not a valid method") : h(d + " not initialized. Cannot call methods, i.e. " + l)
        }), void 0 !== a ? a : t
      }, n(c))
    }
  ...
  function (e, t) {
    ...
    function k(e) {
      if (C || (C = !0, (y = document.createElement("div")).style.width = "200px", y.style.padding = "1px 2px 3px 4px", y.style.borderStyle = "solid", y.style.borderWidth = "1px 2px 3px 4px", y.style.boxSizing = "border-box", (v = document.body || document.documentElement).appendChild(y), _ = w(y), x = 200 == Math.round(b(_.width)), k.isBoxSizeOuter = x, v.removeChild(y)), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
        var t = w(e);
        ...
        for (var n = i.isBorderBox = "border-box" == t.boxSizing, o = 0; o < S; o++) {
          var s = T[o],
            r = t[s],
            a = parseFloat(r);
          i[s] = isNaN(a) ? 0 : a
        ...
        var g = b(t.height);
        return !1 !== g && (i.height = g + (p ? 0 : d + f)), i.innerWidth = i.width - (l + h), i.innerHeight = i.height - (d + f), i.outerWidth = i.width + c, i.outerHeight = i.height + u, i
      }
      var y, v, _
    }
  ...
  function (e, t) {
    ...
    l.constructor = i, l._create = function () {
      ...
      this.getPosition();
      var i, n, o, s = this.position.x,
        r = this.position.y,
        a = e == this.position.x && t == this.position.y;
      this.setPosition(e, t), !a || this.isTransitioning ? (i = e - s, n = t - r, (o = {}).transform = this.getTranslate(i, n), this.transition({
        to: o,
        onTransitionEnd: {
  ...
  function (o, s) {
    ...
    function r(e, t) {
      ...
      n ? (this.element = n, d && (this.$element = d(this.element)), this.options = s.extend({}, this.constructor.defaults), this.option(t), i = ++c, this.element.outlayerGUID = i, (u[i] = this)._create(), this._getOption("initLayout") && this.layout()) : l && l.error("Bad element for " + this.constructor.namespace + ": " + (n || e))
    }
    ...
    s.extend(h, t.prototype), h.option = function (e) {
      ...
      return null == e ? void(this.stagger = 0) : (this.stagger = function (e) {
        ...
        var t = e.match(/(^\d*\.?\d*)(\w*)/),
          i = t && t[1],
          n = t && t[2];
        return i.length ? parseFloat(i) * (f[n] || 1) : 0
      }(e), this.stagger)
      ...
      var n, o = t ? [t].concat(i) : i;
      this.emitEvent(e, o), d && (this.$element = this.$element || d(this.element), t ? ((n = d.Event(t)).type = e, this.$element.trigger(n, i)) : this.$element.trigger(e, i))
    }, h.ignore = function (e) {
  ...
  function (e, t) {
    ...
    return ["_resetLayout", "_getItemLayoutPosition", "_manageStamp", "_getContainerSize", "_getElementOffset", "needsResizeLayout", "_getOption"].forEach(function (e) {
      ...
      var i, n = e + t,
        o = "outer" + t;
      this._getMeasurement(n, o), this[n] || (i = this.getFirstItemSize(), this[n] = i && i[o] || this.isotope.size["inner" + t])
  ...
  function (e, t) {
    ...
    return i._resetLayout = function () {
      ...
      e.getSize();
      for (var t = e.size.outerWidth % this.columnWidth, i = Math[t && t < 1 ? "round" : "ceil"](e.size.outerWidth / this.columnWidth), i = Math.min(i, this.cols), n = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](i, e), o = {
  ...
  function (r, a) {
    ...
    l._create = function () {
      ...
      for (var t = (t = this.options.filter) || "*", i = [], n = [], o = [], s = this._getFilterTest(t), r = 0; r < e.length; r++) {
        var a, l = e[r];
    ...
    c.sortDataParsers = {
      ...
      var t = this.addItems(e);
      if (t.length) {
        for (var i, n = t.length, o = 0; o < n; o++) i = t[o], this.element.appendChild(i.element);
        var s = this._filter(t).matches;
        for (o = 0; o < n; o++) t[o].isLayoutInstant = !0;
        for (this.arrange(), o = 0; o < n; o++) delete t[o].isLayoutInstant;
        this.reveal(s)
      }
    };
    var h = l.remove;
    ...
    i.fn.counterUp = function (e) {
      ...
      return this.each(function () {
        var l = i(this),
          d = t;
        l.waypoint(function () {
          for (var e = [], t = d.time / d.delay, i = l.text(), n = /[0-9]+,[0-9]+/.test(i), i = i.replace(/,/g, ""), o = (/^[0-9]+$/.test(i), /^[0-9]+\.[0-9]+$/.test(i)), s = o ? (i.split(".")[1] || []).length : 0, r = t; 1 <= r; r--) {
            var a = parseInt(i / t * r);
            if (o && (a = parseFloat(i / t * r).toFixed(s)), n)
              for (;
          ...
          l.data("counterup-func", function () {
            l.text(l.data("counterup-nums").shift()), l.data("counterup-nums").length ? setTimeout(l.data("counterup-func"), d.delay) : (l.data("counterup-nums"), l.data("counterup-nums", null), l.data("counterup-func", null))
  ...
  function () {
    ...
    var g = function (e, t) {
      ...
      a = function (e, t, i) {
        var n = i || "0",
          o = e.toString();
        return o.length < t ? a(n + o, t) : o
      },
      o = function (e) {
        var t, i;
        for (e = e || {}, t = 1; t < arguments.length; t++)
          if (i = arguments[t])
            for (var n in i) i.hasOwnProperty(n) && ("object" == typeof i[n] ? o(e[n], i[n]) : e[n] = i[n]);
        return e
      },
      i = function (e, t) {
        for (var i = 0; i < t.length; i++)
    ...
    (DateFormatter = function (e) {
      ...
      parseDate: function (e, t) {
        ...
        for (n = e.replace(this.separators, "\0").split("\0"), o = 0; o < n.length; o++) switch (s = n[o], r = parseInt(s), i[o]) {
          case "y":
          case "Y":
            if (!r) return null;
            c = s.length, m.year = 2 === c ? parseInt((r < 70 ? "20" : "19") + s) : r, h = !0;
            break;
          case "m":
          case "n":
          case "M":
          case "F":
            if (isNaN(r)) {
              if (!(0 < (a = this.getMonth(s)))) return null;
              m.month = a
            } else {
              if (!(1 <= r && r <= 12)) return null;
              m.month = r
            }
            h = !0;
            break;
          case "d":
          case "j":
            if (!(1 <= r && r <= 31)) return null;
            m.day = r, h = !0;
            break;
          case "g":
          case "h":
            if (u = n[l = -1 < i.indexOf("a") ? i.indexOf("a") : -1 < i.indexOf("A") ? i.indexOf("A") : -1], -1 < l) d = g(u, p.meridiem[0]) ? 0 : g(u, p.meridiem[1]) ? 12 : -1, 1 <= r && r <= 12 && -1 < d ? m.hour = r + d - 1 : 0 <= r && r <= 23 && (m.hour = r);
            else {
              if (!(0 <= r && r <= 23)) return null;
              m.hour = r
            }
            f = !0;
            break;
        ...
        if (!0 === h && m.year && m.month && m.day) m.date = new Date(m.year, m.month - 1, m.day, m.hour, m.min, m.sec, 0);
        else {
          if (!0 !== f) return null;
      ...
      parseFormat: function (e, n) {
        ...
        var i = this,
          ...
          r = {
            ...
            c: function () {
              return "Y-m-d\\TH:i:sP".replace(s, t)
            },
            r: function () {
              return "D, d M Y H:i:s O".replace(s, t)
            },
            U: function () {
...
var datetimepickerFactory = function (N) {
  "use strict";
  ...
  function i() {
    var e = a.i18n[H],
      t = {
        ...
        months: e.months,
        monthsShort: N.map(e.months, function (e) {
          return e.substring(0, 3)
        })
      };
    "function" == typeof DateFormatter && ($ = n = new DateFormatter({
      dateSettings: N.extend({}, o, t)
    }))
  }
  var a = {
      i18n: {
    ...
    s = {
      moment: {
        ...
        formatter: {
          parseDate: function (e, t) {
            if (r(t)) return n.parseDate(e, t);
            var i = moment(e, t);
            return !!i.isValid() && i.toDate()
          },
          formatDate: function (e, t) {
            return r(t) ? n.formatDate(e, t) : moment(e).format(t)
          },
  ...
  N.datetimepicker = {
    ...
    setDateFormatter: function (e) {
      var t;
      $ = "string" == typeof e && s.hasOwnProperty(e) ? (t = s[e], N.extend(a, t.default_options), t.formatter) : e
    }
  };
  var t = {
  ...
  N.extend(N.datetimepicker, t), i(), window.getComputedStyle || (window.getComputedStyle = function (i) {
    ...
    for (var i = t || 0, n = this.length; i < n; i += 1)
      if (this[i] === e) return i;
    return -1
  }), Date.prototype.countDaysInMonth = function () {
    return new Date(this.getFullYear(), this.getMonth() + 1, 0).getDate()
  }, N.fn.xdsoftScroller = function (g, y) {
    return this.each(function () {
      function i(e) {
        var t, i = {
          x: 0,
      ...
      var s, r, a, l, d, t, c = N(this),
        ...
        p = !1,
        m = 0;
      "hide" !== y ? (N(this).hasClass("xdsoft_scroller_box") || (s = c.children().eq(0), r = c[0].clientHeight, a = s[0].offsetHeight, l = N('<div class="xdsoft_scrollbar"></div>'), d = N('<div class="xdsoft_scroller"></div>'), l.append(d), c.addClass("xdsoft_scroller_box").append(l), t = function (e) {
        var t = i(e).y - o + m;
        t < 0 && (t = 0), t + d[0].offsetHeight > f && (t = f - d[0].offsetHeight), c.trigger("scroll_element.xdsoft_scroller", [u ? t / u : 0])
      }, d.on("touchstart.xdsoft_scroller mousedown.xdsoft_scroller", function (e) {
        r || c.trigger("resize_scroll.xdsoft_scroller", [y]), o = i(e).y, m = parseInt(d.css("margin-top"), 10), f = l[0].offsetHeight, "mousedown" === e.type || "touchstart" === e.type ? (g.ownerDocument && N(g.ownerDocument.body).addClass("xdsoft_noselect"), N([g.ownerDocument.body, g.contentWindow]).on("touchend mouseup.xdsoft_scroller", function e() {
          N([g.ownerDocument.body, g.contentWindow]).off("touchend mouseup.xdsoft_scroller", e).off("mousemove.xdsoft_scroller", t).removeClass("xdsoft_noselect")
        }), N(g.ownerDocument.body).on("mousemove.xdsoft_scroller", t)) : (p = !0, e.stopPropagation(), e.preventDefault())
      }).on("touchmove", function (e) {
        p && (e.preventDefault(), t(e))
      }).on("touchend touchcancel", function () {
        p = !1, m = 0
      }), c.on("scroll_element.xdsoft_scroller", function (e, t) {
        r || c.trigger("resize_scroll.xdsoft_scroller", [t, !0]), t = 1 < t ? 1 : t < 0 || isNaN(t) ? 0 : t, d.css("margin-top", u * t), setTimeout(function () {
          s.css("marginTop", -parseInt((s[0].offsetHeight - r) * t, 10))
        }, 10)
      }).on("resize_scroll.xdsoft_scroller", function (e, t, i) {
        var n, o;
        r = c[0].clientHeight, a = s[0].offsetHeight, o = (n = r / a) * l[0].offsetHeight, 1 < n ? d.hide() : (d.show(), d.css("height", parseInt(10 < o ? o : 10, 10)), u = l[0].offsetHeight - d[0].offsetHeight, !0 !== i && c.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(s.css("marginTop"), 10)) / (a - r)]))
      }), c.on("mousewheel", function (e) {
        var t = Math.abs(parseInt(s.css("marginTop"), 10));
        return (t -= 20 * e.deltaY) < 0 && (t = 0), c.trigger("scroll_element.xdsoft_scroller", [t / (a - r)]), e.stopPropagation(), !1
      }), c.on("touchstart", function (e) {
        n = i(e), h = Math.abs(parseInt(s.css("marginTop"), 10))
      }), c.on("touchmove", function (e) {
        var t;
        n && (e.preventDefault(), t = i(e), c.trigger("scroll_element.xdsoft_scroller", [(h - (t.y - n.y)) / (a - r)]))
      }), c.on("touchend touchcancel", function () {
        n = !1, h = 0
      })), c.trigger("resize_scroll.xdsoft_scroller", [y])) : c.find(".xdsoft_scrollbar").hide()
    })
  }, N.fn.datetimepicker = function (z, i) {
    var n = this,
      g = 17,
      y = 13,
      v = 27,
      ...
      W = 89,
      R = !1,
      q = N.isPlainObject(z) || !z ? N.extend(!0, {}, a, z) : N.extend(!0, {}, a),
      o = 0,
      s = function (D) {
        var t, n, i, o, O, p, E = N('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
          e = N('<div class="xdsoft_copyright"><a target="_blank" href="http://xdsoft.net/jqplugins/datetimepicker/">xdsoft.net</a></div>'),
          m = N('<div class="xdsoft_datepicker active"></div>'),
          j = N('<div class="xdsoft_monthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><div class="xdsoft_label xdsoft_month"><span></span><i></i></div><div class="xdsoft_label xdsoft_year"><span></span><i></i></div><button type="button" class="xdsoft_next"></button></div>'),
          I = N('<div class="xdsoft_calendar"></div>'),
          s = N('<div class="xdsoft_timepicker active"><button type="button" class="xdsoft_prev"></button><div class="xdsoft_time_box"></div><button type="button" class="xdsoft_next"></button></div>'),
          d = s.find(".xdsoft_time_box").eq(0),
          P = N('<div class="xdsoft_time_variant"></div>'),
          r = N('<button type="button" class="xdsoft_save_selected blue-gradient-button">Save Selected</button>'),
          A = N('<div class="xdsoft_select xdsoft_monthselect"><div></div></div>'),
          M = N('<div class="xdsoft_select xdsoft_yearselect"><div></div></div>'),
          a = !1,
          l = 0;
        q.id && E.attr("id", q.id), q.style && E.attr("style", q.style), q.weeks && E.addClass("xdsoft_showweeks"), q.rtl && E.addClass("xdsoft_rtl"), E.addClass("xdsoft_" + q.theme), E.addClass(q.className), j.find(".xdsoft_month span").after(A), j.find(".xdsoft_year span").after(M), j.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", function (e) {
          var t, i, n = N(this).find(".xdsoft_select").eq(0),
            o = 0,
            s = 0,
            r = n.is(":visible");
          for (j.find(".xdsoft_select").hide(), O.currentTime && (o = O.currentTime[N(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()), n[r ? "hide" : "show"](), t = n.find("div.xdsoft_option"), i = 0; i < t.length && t.eq(i).data("value") !== o; i += 1) s += t[0].offsetHeight;
          return n.xdsoftScroller(q, s / (n.children()[0].offsetHeight - n[0].clientHeight)), e.stopPropagation(), !1
        });
        ...
        function c(e) {
          ...
          Math.sqrt(n * n + o * o) > q.touchMovedThreshold && (this.touchMoved = !0)
        }

        function u() {
          var e, t = !1;
          return q.startDate ? t = O.strToDate(q.startDate) : (t = q.value || (D && D.val && D.val() ? D.val() : "")) ? (t = O.strToDateTime(t), q.yearOffset && (t = new Date(t.getFullYear() - q.yearOffset, t.getMonth(), t.getDate(), t.getHours(), t.getMinutes(), t.getSeconds(), t.getMilliseconds()))) : q.defaultDate && (t = O.strToDateTime(q.defaultDate), q.defaultTime && (e = O.strtotime(q.defaultTime), t.setHours(e.getHours()), t.setMinutes(e.getMinutes()))), t && O.isValidDate(t) ? E.data("changed", !0) : t = "", t || 0
        }
        ...
        function h(f) {
          ...
          function m(e, t) {
            if (e = "string" == typeof e || e instanceof String ? f.ownerDocument.getElementById(e) : e) {
          ...
          f.mask && D.off("keydown.xdsoft"), !0 === f.mask && ($.formatMask ? f.mask = $.formatMask(f.format) : f.mask = f.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59")), "string" === N.type(f.mask) && (p(f.mask, D.val()) || (D.val(f.mask.replace(/[0-9]/g, "_")), m(D[0], 0)), D.on("paste.xdsoft", function (e) {
            var t = (e.clipboardData || e.originalEvent.clipboardData || window.clipboardData).getData("text"),
              i = this.value,
              n = this.selectionStart,
              i = i.substr(0, n) + t + i.substr(n + t.length);
            return n += t.length, p(f.mask, i) ? (this.value = i, m(this, n)) : "" === N.trim(i) ? this.value = f.mask.replace(/[0-9]/g, "_") : D.trigger("error_input.xdsoft"), e.preventDefault(), !1
          }), D.on("keydown.xdsoft", function (e) {
            var t, i, n, o, s = this.value,
              r = e.which,
              a = this.selectionStart,
              l = this.selectionEnd,
              d = a !== l;
            if (48 <= r && r <= 57 || 96 <= r && r <= 105 || 8 === r || 46 === r) {
              for (t = 8 === r || 46 === r ? "_" : String.fromCharCode(96 <= r && r <= 105 ? r - 48 : r), 8 === r && a && !d && --a;;) {
                var c = f.mask.substr(a, 1),
                  u = a < f.mask.length,
                  h = 0 < a;
                if (!(/[^0-9_]/.test(c) && u && h)) break;
                a += 8 !== r || d ? 1 : -1
              }
              if (e.metaKey && (d = !(a = 0)), s = d ? (i = l - a, o = (n = f.mask.replace(/[0-9]/g, "_")).substr(a, i).substr(1), s.substr(0, a) + (t + o) + s.substr(a + i)) : s.substr(0, a) + t + s.substr(a + 1), "" === N.trim(s)) s = n;
              else if (a === f.mask.length) return e.preventDefault(), !1;
              for (a += 8 === r ? 0 : 1;
                /[^0-9_]/.test(f.mask.substr(a, 1)) && a < f.mask.length && 0 < a;) a += 8 === r ? 0 : 1;
              p(f.mask, s) ? (this.value = s, m(this, a)) : "" === N.trim(s) ? this.value = f.mask.replace(/[0-9]/g, "_") : D.trigger("error_input.xdsoft")
            } else if (-1 !== [S, C, L, F, W].indexOf(r) && R || -1 !== [v, b, k, _, w, T, g, x, y].indexOf(r)) return !0;
            return e.preventDefault(), !1
          }))
        }
        j.find(".xdsoft_select").xdsoftScroller(q).on("touchstart mousedown.xdsoft", function (e) {
          var t = e.originalEvent;
          this.touchMoved = !1, this.touchStartPosition = t.touches ? t.touches[0] : t, e.stopPropagation(), e.preventDefault()
        }).on("touchmove", ".xdsoft_option", c).on("touchend mousedown.xdsoft", ".xdsoft_option", function () {
          var e;
          this.touchMoved || (void 0 !== O.currentTime && null !== O.currentTime || (O.currentTime = O.now()), e = O.currentTime.getFullYear(), O && O.currentTime && O.currentTime[N(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"](N(this).data("value")), N(this).parent().parent().hide(), E.trigger("xchange.xdsoft"), q.onChangeMonth && N.isFunction(q.onChangeMonth) && q.onChangeMonth.call(E, O.currentTime, E.data("input")), e !== O.currentTime.getFullYear() && N.isFunction(q.onChangeYear) && q.onChangeYear.call(E, O.currentTime, E.data("input")))
        }), E.getValue = function () {
          return O.getCurrentTime()
        }, E.setOptions = function (e) {
          var c = {};
          q = N.extend(!0, {}, q, e), e.allowTimes && N.isArray(e.allowTimes) && e.allowTimes.length && (q.allowTimes = N.extend(!0, [], e.allowTimes)), e.weekends && N.isArray(e.weekends) && e.weekends.length && (q.weekends = N.extend(!0, [], e.weekends)), e.allowDates && N.isArray(e.allowDates) && e.allowDates.length && (q.allowDates = N.extend(!0, [], e.allowDates)), e.allowDateRe && "[object String]" === Object.prototype.toString.call(e.allowDateRe) && (q.allowDateRe = new RegExp(e.allowDateRe)), e.highlightedDates && N.isArray(e.highlightedDates) && e.highlightedDates.length && (N.each(e.highlightedDates, function (e, t) {
            var i, n = N.map(t.split(","), N.trim),
              o = new f($.parseDate(n[0], q.formatDate), n[1], n[2]),
              s = $.formatDate(o.date, q.formatDate);
            void 0 !== c[s] ? (i = c[s].desc) && i.length && o.desc && o.desc.length && (c[s].desc = i + "\n" + o.desc) : c[s] = o
          }), q.highlightedDates = N.extend(!0, [], c)), e.highlightedPeriods && N.isArray(e.highlightedPeriods) && e.highlightedPeriods.length && (c = N.extend(!0, [], q.highlightedDates), N.each(e.highlightedPeriods, function (e, t) {
            var i, n, o, s, r, a, l, d;
            for (d = N.isArray(t) ? (r = t[0], a = t[1], l = t[2], t[3]) : (s = N.map(t.split(","), N.trim), r = $.parseDate(s[0], q.formatDate), a = $.parseDate(s[1], q.formatDate), l = s[2], s[3]); r <= a;) i = new f(r, l, d), n = $.formatDate(r, q.formatDate), r.setDate(r.getDate() + 1), void 0 !== c[n] ? (o = c[n].desc) && o.length && i.desc && i.desc.length && (c[n].desc = o + "\n" + i.desc) : c[n] = i
          }), q.highlightedDates = N.extend(!0, [], c)), e.disabledDates && N.isArray(e.disabledDates) && e.disabledDates.length && (q.disabledDates = N.extend(!0, [], e.disabledDates)), e.disabledWeekDays && N.isArray(e.disabledWeekDays) && e.disabledWeekDays.length && (q.disabledWeekDays = N.extend(!0, [], e.disabledWeekDays)), !q.open && !q.opened || q.inline || D.trigger("open.xdsoft"), q.inline && (a = !0, E.addClass("xdsoft_inline"), D.after(E).hide()), q.inverseButton && (q.next = "xdsoft_prev", q.prev = "xdsoft_next"), q.datepicker ? m.addClass("active") : m.removeClass("active"), q.timepicker ? s.addClass("active") : s.removeClass("active"), q.value && (O.setCurrentTime(q.value), D && D.val && D.val(O.str)), isNaN(q.dayOfWeekStart) ? q.dayOfWeekStart = 0 : q.dayOfWeekStart = parseInt(q.dayOfWeekStart, 10) % 7, q.timepickerScrollbar || d.xdsoftScroller(q, "hide"), q.minDate && /^[\+\-](.*)$/.test(q.minDate) && (q.minDate = $.formatDate(O.strToDateTime(q.minDate), q.formatDate)), q.maxDate && /^[\+\-](.*)$/.test(q.maxDate) && (q.maxDate = $.formatDate(O.strToDateTime(q.maxDate), q.formatDate)), q.minDateTime && /^\+(.*)$/.test(q.minDateTime) && (q.minDateTime = O.strToDateTime(q.minDateTime).dateFormat(q.formatDate)), q.maxDateTime && /^\+(.*)$/.test(q.maxDateTime) && (q.maxDateTime = O.strToDateTime(q.maxDateTime).dateFormat(q.formatDate)), r.toggle(q.showApplyButton), j.find(".xdsoft_today_button").css("visibility", q.todayButton ? "visible" : "hidden"), j.find("." + q.prev).css("visibility", q.prevButton ? "visible" : "hidden"), j.find("." + q.next).css("visibility", q.nextButton ? "visible" : "hidden"), h(q), q.validateOnBlur && D.off("blur.xdsoft").on("blur.xdsoft", function () {
            var e, t, i;
            q.allowBlank && (!N.trim(N(this).val()).length || "string" == typeof q.mask && N.trim(N(this).val()) === q.mask.replace(/[0-9]/g, "_")) ? (N(this).val(null), E.data("xdsoft_datetime").empty()) : ((e = $.parseDate(N(this).val(), q.format)) ? N(this).val($.formatDate(e, q.format)) : (t = +[N(this).val()[0], N(this).val()[1]].join(""), i = +[N(this).val()[2], N(this).val()[3]].join(""), !q.datepicker && q.timepicker && 0 <= t && t < 24 && 0 <= i && i < 60 ? N(this).val([t, i].map(function (e) {
              return 9 < e ? e : "0" + e
            }).join(":")) : N(this).val($.formatDate(O.now(), q.format))), E.data("xdsoft_datetime").setCurrentTime(N(this).val())), E.trigger("changedatetime.xdsoft"), E.trigger("close.xdsoft")
          }), q.dayOfWeekStartPrev = 0 === q.dayOfWeekStart ? 6 : q.dayOfWeekStart - 1, E.trigger("xchange.xdsoft").trigger("afterOpen.xdsoft")
        }, E.data("options", q).on("touchstart mousedown.xdsoft", function (e) {
          return e.stopPropagation(), e.preventDefault(), M.hide(), A.hide(), !1
        }), d.append(P), d.xdsoftScroller(q), E.on("afterOpen.xdsoft", function () {
          d.xdsoftScroller(q)
        }), E.append(m).append(s), !0 !== q.withoutCopyright && E.append(e), m.append(j).append(I).append(r), q.insideParent ? N(D).parent().append(E) : N(q.parentID).append(E), O = new function () {
          var o = this;
          o.now = function (e) {
            var t, i, n = new Date;
            return !e && q.defaultDate && (t = o.strToDateTime(q.defaultDate), n.setFullYear(t.getFullYear()), n.setMonth(t.getMonth()), n.setDate(t.getDate())), n.setFullYear(n.getFullYear()), !e && q.defaultTime && (i = o.strtotime(q.defaultTime), n.setHours(i.getHours()), n.setMinutes(i.getMinutes()), n.setSeconds(i.getSeconds()), n.setMilliseconds(i.getMilliseconds())), n
          }, o.isValidDate = function (e) {
            return "[object Date]" === Object.prototype.toString.call(e) && !isNaN(e.getTime())
          }, o.setCurrentTime = function (e, t) {
            "string" == typeof e ? o.currentTime = o.strToDateTime(e) : o.isValidDate(e) ? o.currentTime = e : e || t || !q.allowBlank || q.inline ? o.currentTime = o.now() : o.currentTime = null, E.trigger("xchange.xdsoft")
          }, o.empty = function () {
            o.currentTime = null
            ...
            var e, t = o.currentTime.getMonth() + 1;
            return 12 === t && (o.currentTime.setFullYear(o.currentTime.getFullYear() + 1), t = 0), e = o.currentTime.getFullYear(), o.currentTime.setDate(Math.min(new Date(o.currentTime.getFullYear(), t + 1, 0).getDate(), o.currentTime.getDate())), o.currentTime.setMonth(t), q.onChangeMonth && N.isFunction(q.onChangeMonth) && q.onChangeMonth.call(E, O.currentTime, E.data("input")), e !== o.currentTime.getFullYear() && N.isFunction(q.onChangeYear) && q.onChangeYear.call(E, O.currentTime, E.data("input")), E.trigger("xchange.xdsoft"), t
          }, o.prevMonth = function () {
            void 0 !== o.currentTime && null !== o.currentTime || (o.currentTime = o.now());
            var e = o.currentTime.getMonth() - 1;
            return -1 === e && (o.currentTime.setFullYear(o.currentTime.getFullYear() - 1), e = 11), o.currentTime.setDate(Math.min(new Date(o.currentTime.getFullYear(), e + 1, 0).getDate(), o.currentTime.getDate())), o.currentTime.setMonth(e), q.onChangeMonth && N.isFunction(q.onChangeMonth) && q.onChangeMonth.call(E, O.currentTime, E.data("input")), E.trigger("xchange.xdsoft"), e
          }, o.getWeekOfYear = function (e) {
            if (q.onGetWeekOfYear && N.isFunction(q.onGetWeekOfYear)) {
              var t = q.onGetWeekOfYear.call(E, e);
            ...
            var t, i, n = [];
            return e && e instanceof Date && o.isValidDate(e) ? e : ((n = /^([+-]{1})(.*)$/.exec(e)) && (n[2] = $.parseDate(n[2], q.formatDate)), i = n && n[2] ? (t = n[2].getTime() - 6e4 * n[2].getTimezoneOffset(), new Date(o.now(!0).getTime() + parseInt(n[1] + "1", 10) * t)) : e ? $.parseDate(e, q.format) : o.now(), o.isValidDate(i) || (i = o.now()), i)
          }, o.strToDate = function (e) {
            if (e && e instanceof Date && o.isValidDate(e)) return e;
            var t = e ? $.parseDate(e, q.formatDate) : o.now(!0);
            return o.isValidDate(t) || (t = o.now(!0)), t
          }, o.strtotime = function (e) {
            if (e && e instanceof Date && o.isValidDate(e)) return e;
            var t = e ? $.parseDate(e, q.formatTime) : o.now(!0);
            return o.isValidDate(t) || (t = o.now(!0)), t
          }, o.str = function () {
            var e = q.format;
            return q.yearOffset && (e = (e = e.replace("Y", o.currentTime.getFullYear() + q.yearOffset)).replace("y", String(o.currentTime.getFullYear() + q.yearOffset).substring(2, 4))), $.formatDate(o.currentTime, e)
          }, o.currentTime = this.now()
        }, r.on("touchend click", function (e) {
          e.preventDefault(), E.data("changed", !0), O.setCurrentTime(u()), D.val(O.str()), E.trigger("close.xdsoft")
        }), j.find(".xdsoft_today_button").on("touchend mousedown.xdsoft", function () {
          E.data("changed", !0), O.setCurrentTime(0, !0), E.trigger("afterOpen.xdsoft")
        }).on("dblclick.xdsoft", function () {
          var e, t = O.getCurrentTime(),
            t = new Date(t.getFullYear(), t.getMonth(), t.getDate()),
            i = O.strToDate(q.minDate);
          t < (i = new Date(i.getFullYear(), i.getMonth(), i.getDate())) || (e = O.strToDate(q.maxDate), (e = new Date(e.getFullYear(), e.getMonth(), e.getDate())) < t || (D.val(O.str()), D.trigger("change"), E.trigger("close.xdsoft")))
        }), j.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", function () {
          var i = N(this),
            n = 0,
            o = !1;
          ! function e(t) {
            i.hasClass(q.next) ? O.nextMonth() : i.hasClass(q.prev) && O.prevMonth(), q.monthChangeSpinner && (o || (n = setTimeout(e, t || 100)))
          }(500), N([q.ownerDocument.body, q.contentWindow]).on("touchend mouseup.xdsoft", function e() {
            clearTimeout(n), o = !0, N([q.ownerDocument.body, q.contentWindow]).off("touchend mouseup.xdsoft", e)
          })
          ...
          ! function e(t) {
            var i = d[0].clientHeight,
              n = P[0].offsetHeight,
              o = Math.abs(parseInt(P.css("marginTop"), 10));
            s.hasClass(q.next) && n - i - q.timeHeightInTimePicker >= o ? P.css("marginTop", "-" + (o + q.timeHeightInTimePicker) + "px") : s.hasClass(q.prev) && 0 <= o - q.timeHeightInTimePicker && P.css("marginTop", "-" + (o - q.timeHeightInTimePicker) + "px"), d.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(P[0].style.marginTop, 10) / (n - i))]), l = 10 < l ? 10 : l - 10, a || (r = setTimeout(e, t || l))
          }(500), N([q.ownerDocument.body, q.contentWindow]).on("touchend mouseup.xdsoft", function e() {
            clearTimeout(r), a = !0, N([q.ownerDocument.body, q.contentWindow]).off("touchend mouseup.xdsoft", e)
          })
        }), t = 0, E.on("xchange.xdsoft", function (e) {
          clearTimeout(t), t = setTimeout(function () {
            void 0 !== O.currentTime && null !== O.currentTime || (O.currentTime = O.now());
            for (var e, t, i, n, o, s, r, a, l, d, c = "", u = new Date(O.currentTime.getFullYear(), O.currentTime.getMonth(), 1, 12, 0, 0), h = 0, f = O.now(), p = !1, m = !1, g = !1, y = !1, v = [], _ = !0, b = ""; u.getDay() !== q.dayOfWeekStart;) u.setDate(u.getDate() - 1);
            for (c += "<table><thead><tr>", q.weeks && (c += "<th></th>"), e = 0; e < 7; e += 1) c += "<th>" + q.i18n[H].dayOfWeekShort[(e + q.dayOfWeekStart) % 7] + "</th>";
            for (c += "</tr></thead>", c += "<tbody>", !1 !== q.maxDate && (p = O.strToDate(q.maxDate), p = new Date(p.getFullYear(), p.getMonth(), p.getDate(), 23, 59, 59, 999)), !1 !== q.minDate && (m = O.strToDate(q.minDate), m = new Date(m.getFullYear(), m.getMonth(), m.getDate())), !1 !== q.minDateTime && (g = O.strToDate(q.minDateTime), g = new Date(g.getFullYear(), g.getMonth(), g.getDate(), g.getHours(), g.getMinutes(), g.getSeconds())), !1 !== q.maxDateTime && (y = O.strToDate(q.maxDateTime), y = new Date(y.getFullYear(), y.getMonth(), y.getDate(), y.getHours(), y.getMinutes(), y.getSeconds())), !1 !== y && (d = 31 * (12 * y.getFullYear() + y.getMonth()) + y.getDate()); h < O.currentTime.countDaysInMonth() || u.getDay() !== q.dayOfWeekStart || O.currentTime.getMonth() === u.getMonth();) {
              v = [], h += 1, i = u.getDay(), n = u.getDate(), o = u.getFullYear(), x = u.getMonth(), s = O.getWeekOfYear(u), l = "", v.push("xdsoft_date"), r = q.beforeShowDay && N.isFunction(q.beforeShowDay.call) ? q.beforeShowDay.call(E, u) : null, q.allowDateRe && "[object RegExp]" === Object.prototype.toString.call(q.allowDateRe) && (q.allowDateRe.test($.formatDate(u, q.formatDate)) || v.push("xdsoft_disabled")), q.allowDates && 0 < q.allowDates.length && -1 === q.allowDates.indexOf($.formatDate(u, q.formatDate)) && v.push("xdsoft_disabled");
              var w = 31 * (12 * u.getFullYear() + u.getMonth()) + u.getDate();
              (!1 !== p && p < u || !1 !== g && u < g || !1 !== m && u < m || !1 !== y && d < w || r && !1 === r[0]) && v.push("xdsoft_disabled"), -1 !== q.disabledDates.indexOf($.formatDate(u, q.formatDate)) && v.push("xdsoft_disabled"), -1 !== q.disabledWeekDays.indexOf(i) && v.push("xdsoft_disabled"), D.is("[disabled]") && v.push("xdsoft_disabled"), r && "" !== r[1] && v.push(r[1]), O.currentTime.getMonth() !== x && v.push("xdsoft_other_month"), (q.defaultSelect || E.data("changed")) && $.formatDate(O.currentTime, q.formatDate) === $.formatDate(u, q.formatDate) && v.push("xdsoft_current"), $.formatDate(f, q.formatDate) === $.formatDate(u, q.formatDate) && v.push("xdsoft_today"), 0 !== u.getDay() && 6 !== u.getDay() && -1 === q.weekends.indexOf($.formatDate(u, q.formatDate)) || v.push("xdsoft_weekend"), void 0 !== q.highlightedDates[$.formatDate(u, q.formatDate)] && (t = q.highlightedDates[$.formatDate(u, q.formatDate)], v.push(void 0 === t.style ? "xdsoft_highlighted_default" : t.style), l = void 0 === t.desc ? "" : t.desc), q.beforeShowDay && N.isFunction(q.beforeShowDay) && v.push(q.beforeShowDay(u)), _ && (c += "<tr>", _ = !1, q.weeks && (c += "<th>" + s + "</th>")), c += '<td data-date="' + n + '" data-month="' + x + '" data-year="' + o + '" class="xdsoft_date xdsoft_day_of_week' + u.getDay() + " " + v.join(" ") + '" title="' + l + '"><div>' + n + "</div></td>", u.getDay() === q.dayOfWeekStartPrev && (c += "</tr>", _ = !0), u.setDate(n + 1)
            }
            c += "</tbody></table>", I.html(c), j.find(".xdsoft_label span").eq(0).text(q.i18n[H].months[O.currentTime.getMonth()]), j.find(".xdsoft_label span").eq(1).text(O.currentTime.getFullYear() + q.yearOffset), x = b = "";
            var k = 0;
            !1 !== q.minTime && (T = O.strtotime(q.minTime), k = 60 * T.getHours() + T.getMinutes());
            var x, T, S = 1440;
            if (!1 !== q.maxTime && (T = O.strtotime(q.maxTime), S = 60 * T.getHours() + T.getMinutes()), !1 !== q.minDateTime && (T = O.strToDateTime(q.minDateTime), $.formatDate(O.currentTime, q.formatDate) === $.formatDate(T, q.formatDate) && (x = 60 * T.getHours() + T.getMinutes(), k < x && (k = x))), !1 !== q.maxDateTime && (T = O.strToDateTime(q.maxDateTime), $.formatDate(O.currentTime, q.formatDate) === $.formatDate(T, q.formatDate) && (x = 60 * T.getHours() + T.getMinutes()) < S && (S = x)), a = function (e, t) {
                var i, n = O.now(),
                  o = q.allowTimes && N.isArray(q.allowTimes) && q.allowTimes.length;
                n.setHours(e), e = parseInt(n.getHours(), 10), n.setMinutes(t), t = parseInt(n.getMinutes(), 10), v = [];
                var s = 60 * e + t;
                (D.is("[disabled]") || S <= s || s < k) && v.push("xdsoft_disabled"), (i = new Date(O.currentTime)).setHours(parseInt(O.currentTime.getHours(), 10)), o || i.setMinutes(Math[q.roundTime](O.currentTime.getMinutes() / q.step) * q.step), (q.initTime || q.defaultSelect || E.data("changed")) && i.getHours() === parseInt(e, 10) && (!o && 59 < q.step || i.getMinutes() === parseInt(t, 10)) && (q.defaultSelect || E.data("changed") ? v.push("xdsoft_current") : q.initTime && v.push("xdsoft_init_time")), parseInt(f.getHours(), 10) === parseInt(e, 10) && parseInt(f.getMinutes(), 10) === parseInt(t, 10) && v.push("xdsoft_today"), b += '<div class="xdsoft_time ' + v.join(" ") + '" data-hour="' + e + '" data-minute="' + t + '">' + $.formatDate(n, q.formatTime) + "</div>"
              }, q.allowTimes && N.isArray(q.allowTimes) && q.allowTimes.length)
              for (h = 0; h < q.allowTimes.length; h += 1) a(O.strtotime(q.allowTimes[h]).getHours(), x = O.strtotime(q.allowTimes[h]).getMinutes());
            else
              for (e = h = 0; h < (q.hours12 ? 12 : 24); h += 1)
                for (e = 0; e < 60; e += q.step) {
                  var C = 60 * h + e;
                  C < k || S <= C || a((h < 10 ? "0" : "") + h, x = (e < 10 ? "0" : "") + e)
                }
            for (P.html(b), z = "", h = parseInt(q.yearStart, 10); h <= parseInt(q.yearEnd, 10); h += 1) z += '<div class="xdsoft_option ' + (O.currentTime.getFullYear() === h ? "xdsoft_current" : "") + '" data-value="' + h + '">' + (h + q.yearOffset) + "</div>";
            for (M.children().eq(0).html(z), h = parseInt(q.monthStart, 10), z = ""; h <= parseInt(q.monthEnd, 10); h += 1) z += '<div class="xdsoft_option ' + (O.currentTime.getMonth() === h ? "xdsoft_current" : "") + '" data-value="' + h + '">' + q.i18n[H].months[h] + "</div>";
            A.children().eq(0).html(z), N(E).trigger("generate.xdsoft")
          }, 10), e.stopPropagation()
        }).on("afterOpen.xdsoft", function () {
          var e, t, i, n;
          q.timepicker && (P.find(".xdsoft_current").length ? e = ".xdsoft_current" : P.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"), e ? (t = d[0].clientHeight, (i = P[0].offsetHeight) - t < (n = P.find(e).index() * q.timeHeightInTimePicker + 1) && (n = i - t), d.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (i - t)])) : d.trigger("scroll_element.xdsoft_scroller", [0]))
        }), n = 0, I.on("touchend click.xdsoft", "td", function (e) {
          e.stopPropagation(), n += 1;
          var t = N(this),
            i = O.currentTime;
          if (null == i && (O.currentTime = O.now(), i = O.currentTime), t.hasClass("xdsoft_disabled")) return !1;
          i.setDate(1), i.setFullYear(t.data("year")), i.setMonth(t.data("month")), i.setDate(t.data("date")), E.trigger("select.xdsoft", [i]), D.val(O.str()), q.onSelectDate && N.isFunction(q.onSelectDate) && q.onSelectDate.call(E, O.currentTime, E.data("input"), e), E.data("changed", !0), E.trigger("xchange.xdsoft"), E.trigger("changedatetime.xdsoft"), (1 < n || !0 === q.closeOnDateSelect || !1 === q.closeOnDateSelect && !q.timepicker) && !q.inline && E.trigger("close.xdsoft"), setTimeout(function () {
            n = 0
          }, 200)
        }), P.on("touchstart", "div", function (e) {
          this.touchMoved = !1
        }).on("touchmove", "div", c).on("touchend click.xdsoft", "div", function (e) {
          if (!this.touchMoved) {
            e.stopPropagation();
            var t = N(this),
              i = O.currentTime;
            if (null == i && (O.currentTime = O.now(), i = O.currentTime), t.hasClass("xdsoft_disabled")) return !1;
            i.setHours(t.data("hour")), i.setMinutes(t.data("minute")), E.trigger("select.xdsoft", [i]), E.data("input").val(O.str()), q.onSelectTime && N.isFunction(q.onSelectTime) && q.onSelectTime.call(E, O.currentTime, E.data("input"), e), E.data("changed", !0), E.trigger("xchange.xdsoft"), E.trigger("changedatetime.xdsoft"), !0 !== q.inline && !0 === q.closeOnTimeSelect && E.trigger("close.xdsoft")
          }
        }), m.on("mousewheel.xdsoft", function (e) {
          return !q.scrollMonth || (e.deltaY < 0 ? O.nextMonth() : O.prevMonth(), !1)
        }), D.on("mousewheel.xdsoft", function (e) {
          return !q.scrollInput || (!q.datepicker && q.timepicker ? (0 <= (i = P.find(".xdsoft_current").length ? P.find(".xdsoft_current").eq(0).index() : 0) + e.deltaY && i + e.deltaY < P.children().length && (i += e.deltaY), P.children().eq(i).length && P.children().eq(i).trigger("mousedown"), !1) : q.datepicker && !q.timepicker ? (m.trigger(e, [e.deltaY, e.deltaX, e.deltaY]), D.val && D.val(O.str()), E.trigger("changedatetime.xdsoft"), !1) : void 0)
        }), E.on("changedatetime.xdsoft", function (e) {
          var t;
          q.onChangeDateTime && N.isFunction(q.onChangeDateTime) && (t = E.data("input"), q.onChangeDateTime.call(E, O.currentTime, t, e), delete q.value, t.trigger("change"))
        }).on("generate.xdsoft", function () {
          q.onGenerate && N.isFunction(q.onGenerate) && q.onGenerate.call(E, O.currentTime, E.data("input")), a && (E.trigger("afterOpen.xdsoft"), a = !1)
          ...
          var e, t, i, n, o, s = (i = E.data("input")).offset(),
            r = i[0],
            a = "top",
            l = s.top + r.offsetHeight - 1,
            d = s.left,
            c = "absolute",
            u = N(q.contentWindow).width(),
            h = N(q.contentWindow).height(),
            f = N(q.contentWindow).scrollTop();
          q.ownerDocument.documentElement.clientWidth - s.left < m.parent().outerWidth(!0) && (o = m.parent().outerWidth(!0) - r.offsetWidth, d -= o), "rtl" === i.parent().css("direction") && (d -= E.outerWidth() - i.outerWidth()), q.fixed ? (l -= f, d -= N(q.contentWindow).scrollLeft(), c = "fixed") : (t = !1, p(r, function (e) {
            return null !== e && ("fixed" === q.contentWindow.getComputedStyle(e).getPropertyValue("position") ? !(t = !0) : void 0)
          }), t && !q.insideParent ? (c = "fixed", l + E.outerHeight() > h + f ? (a = "bottom", l = h + f - s.top) : l -= f) : l + E[0].offsetHeight > h + f && (l = s.top - E[0].offsetHeight + 1), l < 0 && (l = 0), d + r.offsetWidth > u && (d = u - r.offsetWidth)), e = E[0], p(e, function (e) {
            if ("relative" === q.contentWindow.getComputedStyle(e).getPropertyValue("position") && u >= e.offsetWidth) return d -= (u - e.offsetWidth) / 2, !1
          }), n = {
            position: c,
            left: q.insideParent ? r.offsetLeft : d,
            top: "",
            bottom: ""
          }, q.insideParent ? n[a] = r.offsetTop + r.offsetHeight : n[a] = l, E.css(n)
        }, E.on("open.xdsoft", function (e) {
          var t = !0;
          q.onShow && N.isFunction(q.onShow) && (t = q.onShow.call(E, O.currentTime, E.data("input"), e)), !1 !== t && (E.show(), o(), N(q.contentWindow).off("resize.xdsoft", o).on("resize.xdsoft", o), q.closeOnWithoutClick && N([q.ownerDocument.body, q.contentWindow]).on("touchstart mousedown.xdsoft", function e() {
            E.trigger("close.xdsoft"), N([q.ownerDocument.body, q.contentWindow]).off("touchstart mousedown.xdsoft", e)
          }))
        }).on("close.xdsoft", function (e) {
          var t = !0;
          j.find(".xdsoft_month,.xdsoft_year").find(".xdsoft_select").hide(), q.onClose && N.isFunction(q.onClose) && (t = q.onClose.call(E, O.currentTime, E.data("input"), e)), !1 === t || q.opened || q.inline || E.hide(), e.stopPropagation()
        }).on("toggle.xdsoft", function () {
          E.is(":visible") ? E.trigger("close.xdsoft") : E.trigger("open.xdsoft")
        }).data("input", D), l = 0, E.data("xdsoft_datetime", O), E.setOptions(q), O.setCurrentTime(u()), D.data("xdsoft_datetimepicker", E).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function () {
          D.is(":disabled") || D.data("xdsoft_datetimepicker").is(":visible") && q.closeOnInputClick || q.openOnFocus && (clearTimeout(l), l = setTimeout(function () {
            D.is(":disabled") || (a = !0, O.setCurrentTime(u(), !0), q.mask && h(q), E.trigger("open.xdsoft"))
          }, 100))
        }).on("keydown.xdsoft", function (e) {
          var t, i = e.which;
          return -1 !== [y].indexOf(i) && q.enterLikeTab ? (t = N("input:visible,textarea:visible,button:visible,a:visible"), E.trigger("close.xdsoft"), t.eq(t.index(this) + 1).focus(), !1) : -1 !== [x].indexOf(i) ? (E.trigger("close.xdsoft"), !0) : void 0
      ...
      r = function (e) {
        ...
        t && (t.data("xdsoft_datetime", null), t.remove(), e.data("xdsoft_datetimepicker", null).off(".xdsoft"), N(q.contentWindow).off("resize.xdsoft"), N([q.contentWindow, q.ownerDocument.body]).off("mousedown.xdsoft touchstart"), e.unmousewheel && e.unmousewheel())
      };
    return N(q.ownerDocument).off("keydown.xdsoftctrl keyup.xdsoftctrl").off("keydown.xdsoftcmd keyup.xdsoftcmd").on("keydown.xdsoftctrl", function (e) {
      e.keyCode === g && (R = !0)
      ...
      var t, e = N(this).data("xdsoft_datetimepicker");
      if (e) {
        if ("string" === N.type(z)) switch (z) {
          case "show":
            N(this).select().focus(), e.trigger("open.xdsoft");
            break;
          case "hide":
            e.trigger("close.xdsoft");
            break;
          ...
          case "destroy":
            ...
            break;
          case "reset":
            this.value = this.defaultValue, this.value && e.data("xdsoft_datetime").isValidDate($.parseDate(this.value, q.format)) || e.data("changed", !1), e.data("xdsoft_datetime").setCurrentTime(this.value);
            break;
          case "validate":
            e.data("input").trigger("blur.xdsoft");
            break;
          default:
            e[z] && N.isFunction(e[z]) && (n = e[z](i))
        } else e.setOptions(z);
        return 0
      }
      "string" !== N.type(z) && (!q.lazyInit || q.open || q.inline ? s(N(this)) : (t = N(this)).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function e() {
        t.is(":disabled") || t.data("xdsoft_datetimepicker") || (clearTimeout(o), o = setTimeout(function () {
          t.data("xdsoft_datetimepicker") || s(t), t.off("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", e).trigger("open.xdsoft")
        }, 100))
      }))
    }), n
  }, N.fn.datetimepicker.defaults = a
};
! function (e) {
...
function (e) {
  ...
  var f, p, e = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"],
  ...
  function n(e) {
    var t, i, n = e || window.event,
      ...
      l = 0,
      d = 0;
    if ((e = h.event.fix(n)).type = "mousewheel", "detail" in n && (a = -1 * n.detail), "wheelDelta" in n && (a = n.wheelDelta), "wheelDeltaY" in n && (a = n.wheelDeltaY), "wheelDeltaX" in n && (r = -1 * n.wheelDeltaX), "axis" in n && n.axis === n.HORIZONTAL_AXIS && (r = -1 * a, a = 0), s = 0 === a ? r : a, "deltaY" in n && (s = a = -1 * n.deltaY), "deltaX" in n && (r = n.deltaX, 0 === a && (s = -1 * r)), 0 !== a || 0 !== r) {
      1 === n.deltaMode ? (s *= t = h.data(this, "mousewheel-line-height"), a *= t, r *= t) : 2 === n.deltaMode && (s *= i = h.data(this, "mousewheel-page-height"), a *= i, r *= i);
      var c, u = Math.max(Math.abs(a), Math.abs(r));
      return (!p || u < p) && v(n, p = u) && (p /= 40), v(n, u) && (s /= 40, r /= 40, a /= 40), s = Math[1 <= s ? "floor" : "ceil"](s / p), r = Math[1 <= r ? "floor" : "ceil"](r / p), a = Math[1 <= a ? "floor" : "ceil"](a / p), g.settings.normalizeOffset && this.getBoundingClientRect && (c = this.getBoundingClientRect(), l = e.clientX - c.left, d = e.clientY - c.top), e.deltaX = r, e.deltaY = a, e.deltaFactor = p, e.offsetX = l, e.offsetY = d, e.deltaMode = 0, o.unshift(e, s, r, a), f && clearTimeout(f), f = setTimeout(y, 200), (h.event.dispatch || h.event.handle).apply(this, o)
    }
  }
...
function (e) {
  ...
  e.prototype = {
    ...
    open: function (e) {
      ...
      if (!m.isOpen) {
        m.types = [], y = "", e.mainEl && e.mainEl.length ? m.ev = e.mainEl.eq(0) : m.ev = g, e.key ? (m.popupsCache[e.key] || (m.popupsCache[e.key] = {}), m.currTemplate = m.popupsCache[e.key]) : m.currTemplate = {}, m.st = c.extend(!0, {}, c.magnificPopup.defaults, e), m.fixedContentPos = "auto" === m.st.fixedContentPos ? !m.probablyMobile : m.st.fixedContentPos, m.st.modal && (m.st.closeOnContentClick = !1, m.st.closeOnBgClick = !1, m.st.showCloseBtn = !1, m.st.enableEscapeKey = !1), m.bgOverlay || (m.bgOverlay = h("bg").on("click.mfp", function () {
          m.close()
        }), m.wrap = h("wrap").attr("tabindex", -1).on("click.mfp", function (e) {
        ...
        f("BeforeOpen"), m.st.showCloseBtn && (m.st.closeBtnInside ? (u(v, function (e, t, i, n) {
          i.close_replaceWith = p(n.type)
        }), y += " mfp-close-btn-in") : m.wrap.append(p())), m.st.alignTop && (y += " mfp-align-top"), m.fixedContentPos ? m.wrap.css({
          ...
          height: g.height(),
          position: "absolute"
        }), m.st.enableEscapeKey && g.on("keyup.mfp", function (e) {
          27 === e.keyCode && m.close()
        }), w.on("resize.mfp", function () {
          m.updateSize()
        }), m.st.closeOnContentClick || (y += " mfp-auto-cursor"), y && m.wrap.addClass(y);
        var r, a = m.wH = w.height(),
          l = {};
        ...
        return m.isIE7 && (d += " mfp-ie7"), d && m._addClassToMFP(d), m.updateItemHTML(), f("BuildControls"), c("html").css(l), m.bgOverlay.add(m.wrap).prependTo(m.st.prependTo || c(document.body)), m._lastFocusedEl = document.activeElement, setTimeout(function () {
          m.content ? (m._addClassToMFP(_), m._setFocus()) : m.bgOverlay.addClass(_), g.on("focusin.mfp", m._onFocusIn)
        }, 16), m.isOpen = !0, m.updateSize(a), f("Open"), e
      }
      m.updateItemHTML()
    },
    close: function () {
      m.isOpen && (f(l), m.isOpen = !1, m.st.removalDelay && !m.isLowIE && m.supportsTransition ? (m._addClassToMFP(r), setTimeout(function () {
        m._close()
    ...
    _close: function () {
      f(a);
      var e, t = r + " " + _ + " ";
      m.bgOverlay.detach(), m.wrap.detach(), m.container.empty(), m.st.mainClass && (t += m.st.mainClass + " "), m._removeClassFromMFP(t), m.fixedContentPos && (e = {
        marginRight: ""
      }, m.isIE7 ? c("body, html").css("overflow", "") : e.overflow = "", c("html").css(e)), g.off("keyup.mfp focusin.mfp"), m.ev.off(i), m.wrap.attr("class", "mfp-wrap").removeAttr("style"), m.bgOverlay.attr("class", "mfp-bg"), m.container.attr("class", "mfp-container"), !m.st.showCloseBtn || m.st.closeBtnInside && !0 !== m.currTemplate[m.currItem.type] || m.currTemplate.closeBtn && m.currTemplate.closeBtn.detach(), m.st.autoFocusLast && m._lastFocusedEl && c(m._lastFocusedEl).focus(), m.currItem = null, m.content = null, m.currTemplate = null, m.prevHeight = 0, f("AfterClose")
    },
    updateSize: function (e) {
      var t, i;
      m.isIOS ? (t = document.documentElement.clientWidth / window.innerWidth, i = window.innerHeight * t, m.wrap.css("height", i), m.wH = i) : m.wH = e || w.height(), m.fixedContentPos || m.wrap.css("height", m.wH), f("Resize")
    },
    updateItemHTML: function () {
      var e = m.items[m.index];
      m.contentContainer.detach(), m.content && m.content.detach(), e.parsed || (e = m.parseEl(m.index));
      var t, i = e.type;
      f("BeforeChange", [m.currItem ? m.currItem.type : "", i]), m.currItem = e, m.currTemplate[i] || (t = !!m.st[i] && m.st[i].markup, f("FirstMarkupParse", t), m.currTemplate[i] = !t || c(t)), o && o !== e.type && m.container.removeClass("mfp-" + o + "-holder");
      var n = m["get" + i.charAt(0).toUpperCase() + i.slice(1)](e, m.currTemplate[i]);
      m.appendContent(n, i), e.preloaded = !0, f("Change", e), o = e.type, m.container.prepend(m.contentContainer), f("AfterChange")
    },
    appendContent: function (e, t) {
      (m.content = e) ? m.st.showCloseBtn && m.st.closeBtnInside && !0 === m.currTemplate[t] ? m.content.find(".mfp-close").length || m.content.append(p()) : m.content = e: m.content = "", f("BeforeAppend"), m.container.addClass("mfp-" + t + "-holder"), m.contentContainer.append(m.content)
    },
    parseEl: function (e) {
      var t, i = m.items[e];
      if ((i = i.tagName ? {
      ...
      return i.type = t || m.st.type || "inline", i.index = e, i.parsed = !0, m.items[e] = i, f("ElementParse", i), m.items[e]
    },
    ...
    updateStatus: function (e, t) {
      var i;
      m.preloader && (n !== e && m.container.removeClass("mfp-s-" + n), t || "loading" !== e || (t = m.st.tLoading), f("UpdateStatus", i = {
        status: e,
        text: t
      }), e = i.status, t = i.text, m.preloader.html(t), m.preloader.find("a").on("click", function (e) {
    ...
    _hasScrollBar: function (e) {
      return (m.isIE7 ? g.height() : document.body.scrollHeight) > (e || w.height())
    },
    _setFocus: function () {
    ...
    _parseMarkup: function (o, e, t) {
      var s;
      t.data && (e = c.extend(t.data, e)), f(v, [o, e, t]), c.each(e, function (e, t) {
        return void 0 === t || !1 === t || void(1 < (s = e.split("_")).length ? 0 < (i = o.find(".mfp-" + s[0])).length && ("replaceWith" === (n = s[1]) ? i[0] !== t[0] && i.replaceWith(t) : "img" === n ? i.is("img") ? i.attr("src", t) : i.replaceWith(c("<img>").attr("src", t).attr("class", i.attr("class"))) : i.attr(s[1], t)) : o.find(".mfp-" + e).html(t));
        var i, n
      })
    },
    ...
    s();
    var t, i, n, o = c(this);
    return "string" == typeof e ? "open" === e ? (t = b ? o.data("magnificPopup") : o[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, n = t.items ? t.items[i] : (n = o, t.delegate && (n = n.find(t.delegate)), n.eq(i)), m._openClick({
      mfpEl: n
    }, o, t)) : m.isOpen && m[e].apply(m, Array.prototype.slice.call(arguments, 1)) : (e = c.extend(!0, {}, e), b ? o.data("magnificPopup", e) : o[0].magnificPopup = e, m.addGroup(o, e)), o
  };
    ...
    proto: {
      ...
      getInline: function (e, t) {
        if (k(), e.src) {
          var i, n = m.st.inline,
            o = c(e.src);
          return o.length ? ((i = o[0].parentNode) && i.tagName && (T || (x = n.hiddenClass, T = h(x), x = "mfp-" + x), S = o.after(T).detach().removeClass(x)), m.updateStatus("ready")) : (m.updateStatus("error", n.tNotFound), o = c("<div>")), e.inlineElement = o
        }
  ...
  c.magnificPopup.registerModule(j, {
    ...
    proto: {
      initAjax: function () {
        m.types.push(j), E = m.st.ajax.cursor, u(a + "." + j, O), u("BeforeChange.ajax", O)
      },
      getAjax: function (o) {
        ...
        var e = c.extend({
          ...
          success: function (e, t, i) {
            ...
            f("ParseAjax", n), m.appendContent(c(n.data), j), o.finished = !0, D(), m._setFocus(), setTimeout(function () {
              m.wrap.addClass(_)
            }, 16), m.updateStatus("ready"), f("AjaxContentAdded")
          },
          error: function () {
            D(), o.finished = o.loadError = !0, m.updateStatus("error", m.st.ajax.tError.replace("%url%", o.src))
          }
        }, m.st.ajax.settings);
  ...
  c.magnificPopup.registerModule("image", {
    ...
    proto: {
      initImage: function () {
        var e = m.st.image,
          t = ".image";
        m.types.push("image"), u("Open" + t, function () {
      ...
      _onImageHasSize: function (e) {
        e.img && (e.hasSize = !0, I && clearInterval(I), e.isCheckingImgSize = !1, f("ImageHasSize", e), e.imgHidden && (m.content && m.content.removeClass("mfp-loading"), e.imgHidden = !1))
      },
        ...
        var i = 0,
          ...
          o = function (e) {
            I && clearInterval(I), I = setInterval(function () {
              return 0 < n.naturalWidth ? void m._onImageHasSize(t) : (200 < i && clearInterval(I), void(3 === ++i ? o(10) : 40 === i ? o(50) : 100 === i && o(500)))
            }, e)
          };
        o(1)
      },
      getImage: function (e, t) {
        var i, n = 0,
          o = function () {
            e && (e.img[0].complete ? (e.img.off(".mfploader"), e === m.currItem && (m._onImageHasSize(e), m.updateStatus("ready")), e.hasSize = !0, e.loaded = !0, f("ImageLoadComplete")) : ++n < 200 ? setTimeout(o, 100) : s())
          },
          s = function () {
            e && (e.img.off(".mfploader"), e === m.currItem && (m._onImageHasSize(e), m.updateStatus("error", r.tError.replace("%url%", e.src))), e.hasSize = !0, e.loaded = !0, e.loadError = !0)
          },
          r = m.st.image,
          a = t.find(".mfp-img");
        return a.length && ((i = document.createElement("img")).className = "mfp-img", e.el && e.el.find("img").length && (i.alt = e.el.find("img").attr("alt")), e.img = c(i).on("load.mfploader", o).on("error.mfploader", s), i.src = e.src, a.is("img") && (e.img = e.img.clone()), 0 < (i = e.img[0]).naturalWidth ? e.hasSize = !0 : i.width || (e.hasSize = !1)), m._parseMarkup(t, {
          title: function (e) {
        ...
        }, e), m.resizeImage(), e.hasSize ? (I && clearInterval(I), e.loadError ? (t.addClass("mfp-loading"), m.updateStatus("error", r.tError.replace("%url%", e.src))) : (t.removeClass("mfp-loading"), m.updateStatus("ready"))) : (m.updateStatus("loading"), e.loading = !0, e.hasSize || (e.imgHidden = !0, t.addClass("mfp-loading"), m.findImageSize(e))), t
      }
    }
  });
  var P;
  c.magnificPopup.registerModule("zoom", {
    ...
    proto: {
      initZoom: function () {
        var e, t, i, n, o, s, r = m.st.zoom;
        r.enabled && m.supportsTransition && (n = r.duration, o = function (e) {
          ...
          if (m._allowZoom()) {
            if (clearTimeout(t), m.content.css("visibility", "hidden"), !(e = m._getItemToZoom())) return void s();
            (i = o(e)).css(m._getOffset()), m.wrap.append(i), t = setTimeout(function () {
              i.css(m._getOffset(!0)), t = setTimeout(function () {
                s(), setTimeout(function () {
                  i.remove(), e = i = null, f("ZoomAnimationEnded")
                }, 16)
              }, n)
            }, 16)
          }
          ...
          if (m._allowZoom()) {
            if (clearTimeout(t), m.st.removalDelay = n, !e) {
          ...
          m._allowZoom() && (s(), i && i.remove(), e = null)
        }))
      },
      _allowZoom: function () {
      ...
      _getOffset: function (e) {
        ...
        var s = {
          width: t.width(),
          height: (b ? t.innerHeight() : t[0].offsetHeight) - o - n
        };
  ...
  function A(e) {
    var t;
    !m.currTemplate[M] || (t = m.currTemplate[M].find("iframe")).length && (e || (t[0].src = "//about:blank"), m.isIE8 && t.css("display", e ? "block" : "none"))
  }
  var M = "iframe";
  c.magnificPopup.registerModule(M, {
    ...
    proto: {
      initIframe: function () {
        m.types.push(M), u("BeforeChange", function (e, t, i) {
          t !== i && (t === M ? A() : i === M && A(!0))
        }), u(a + "." + M, function () {
          A()
        })
  ...
  c.magnificPopup.registerModule("gallery", {
    ...
    proto: {
      initGallery: function () {
        var s = m.st.gallery,
          e = ".mfp-gallery";
        return m.direction = !0, !(!s || !s.enabled) && (y += " mfp-gallery", u("Open" + e, function () {
          s.navigateByImgClick && m.wrap.on("click" + e, ".mfp-img", function () {
          ...
          i.counter = 1 < o ? L(s.tCounter, n.index, o) : ""
        }), u("BuildControls" + e, function () {
          var e, t, i;
          1 < m.items.length && s.arrows && !m.arrowLeft && (e = s.arrowMarkup, t = m.arrowLeft = c(e.replace(/%title%/gi, s.tPrev).replace(/%dir%/gi, "left")).addClass(d), i = m.arrowRight = c(e.replace(/%title%/gi, s.tNext).replace(/%dir%/gi, "right")).addClass(d), t.click(function () {
            m.prev()
          }), i.click(function () {
            m.next()
      ...
      preloadNearbyImages: function () {
        for (var e = m.st.gallery.preload, t = Math.min(e[0], m.items.length), i = Math.min(e[1], m.items.length), n = 1; n <= (m.direction ? i : t); n++) m._preloadItem(m.index + n);
        for (n = 1; n <= (m.direction ? t : i); n++) m._preloadItem(m.index - n)
      },
      _preloadItem: function (e) {
        var t;
        e = z(e), m.items[e].preloaded || ((t = m.items[e]).parsed || (t = m.parseEl(e)), f("LazyLoad", t), "image" === t.type && (t.img = c('<img class="mfp-img" />').on("load.mfploader", function () {
          t.hasSize = !0
  ...
  c.magnificPopup.registerModule(F, {
    ...
    proto: {
      initRetina: function () {
        var i, n;
        1 < window.devicePixelRatio && (i = m.st.retina, n = i.ratio, 1 < (n = isNaN(n) ? n() : n) && (u("ImageHasSize." + F, function (e, t) {
          t.img.css({
            "max-width": t.img[0].naturalWidth / n,
            width: "100%"
          })
        }), u("ElementParse." + F, function (e, t) {
...
function (s) {
  s.fn.niceSelect = function (e) {
    ...
    this.hide(), this.each(function () {
      ...
      var t, i, n = s(this),
        o = s(n.find(".focus") || n.find(".list .option.selected"));
      if (32 == e.keyCode || 13 == e.keyCode) return n.hasClass("open") ? o.trigger("click") : n.trigger("click"), !1;
      if (40 == e.keyCode) return n.hasClass("open") ? 0 < (t = o.nextAll(".option:not(.disabled)").first()).length && (n.find(".focus").removeClass("focus"), t.addClass("focus")) : n.trigger("click"), !1;
      if (38 == e.keyCode) return n.hasClass("open") ? 0 < (i = o.prevAll(".option:not(.disabled)").first()).length && (n.find(".focus").removeClass("focus"), i.addClass("focus")) : n.trigger("click"), !1;
...
}(jQuery), eval(function (e, t, i, n, o) {
    if (n = function (e) {
        return (e < 62 ? "" : n(parseInt(e / 62))) + (35 < (e %= 62) ? String.fromCharCode(e + 29) : e.toString(36))
      }, !"".replace(/^/, String)) {
      for (; t--;) o[n(t)] = i[t] || n(t);
      i = [function (e) {
        return o[e]
  ...
  function (e) {
    ...
    o = 0, (s = function (e, t) {
      ...
      if ("window" === s.respondTo ? o = l : "slider" === s.respondTo ? o = a : "min" === s.respondTo && (o = Math.min(l, a)), s.options.responsive && s.options.responsive.length && null !== s.options.responsive) {
        ...
        null !== n ? null !== s.activeBreakpoint && n === s.activeBreakpoint && !t || (s.activeBreakpoint = n, "unslick" === s.breakpointSettings[n] ? s.unslick(n) : (s.options = d.extend({}, s.originalSettings, s.breakpointSettings[n]), !0 === e && (s.currentSlide = s.options.initialSlide), s.refresh(e)), r = n) : null !== s.activeBreakpoint && (s.activeBreakpoint = null, s.options = s.originalSettings, !0 === e && (s.currentSlide = s.options.initialSlide), s.refresh(e), r = n), e || !1 === r || s.$slider.trigger("breakpoint", [s, r])
      }
      ...
      !i.options.infinite && i.currentSlide > n && (i.currentSlide = n), i.slideCount <= i.options.slidesToShow && (i.currentSlide = 0), t = i.currentSlide, i.destroy(!0), d.extend(i, i.initials, {
        currentSlide: t
      ...
      var e, t, i, n, o, s = this,
        r = !1;
      if ("object" === d.type(arguments[0]) ? (i = arguments[0], r = arguments[1], o = "multiple") : "string" === d.type(arguments[0]) && (n = arguments[1], r = arguments[2], "responsive" === (i = arguments[0]) && "array" === d.type(arguments[1]) ? o = "responsive" : void 0 !== arguments[1] && (o = "single")), "single" === o) s.options[i] = n;
      ...
      s.$slides.eq(e).addClass("slick-current"), !0 === s.options.centerMode ? (n = s.options.slidesToShow % 2 == 0 ? 1 : 0, o = Math.floor(s.options.slidesToShow / 2), !0 === s.options.infinite && (o <= e && e <= s.slideCount - 1 - o ? s.$slides.slice(e - o + n, e + o + 1).addClass("slick-active").attr("aria-hidden", "false") : (t = s.options.slidesToShow + e, r.slice(t - o + 1 + n, t + o + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === e ? r.eq(r.length - 1 - s.options.slidesToShow).addClass("slick-center") : e === s.slideCount - 1 && r.eq(s.options.slidesToShow).addClass("slick-center")), s.$slides.eq(e).addClass("slick-center")) : 0 <= e && e <= s.slideCount - s.options.slidesToShow ? s.$slides.slice(e, e + s.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : r.length <= s.options.slidesToShow ? r.addClass("slick-active").attr("aria-hidden", "false") : (i = s.slideCount % s.options.slidesToShow, t = !0 === s.options.infinite ? s.options.slidesToShow + e : e, s.options.slidesToShow == s.options.slidesToScroll && s.slideCount - e < s.options.slidesToShow ? r.slice(t - (s.options.slidesToShow - i), t + i).addClass("slick-active").attr("aria-hidden", "false") : r.slice(t, t + s.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false")), "ondemand" !== s.options.lazyLoad && "anticipated" !== s.options.lazyLoad || s.lazyLoad()
      ...
      var e, t = this.touchObject.startX - this.touchObject.curX,
        i = this.touchObject.startY - this.touchObject.curY,
        n = Math.atan2(i, t);
      return (e = Math.round(180 * n / Math.PI)) < 0 && (e = 360 - Math.abs(e)), e <= 45 && 0 <= e || e <= 360 && 315 <= e ? !1 === this.options.rtl ? "left" : "right" : 135 <= e && e <= 225 ? !1 === this.options.rtl ? "right" : "left" : !0 === this.options.verticalSwiping ? 35 <= e && e <= 135 ? "down" : "up" : "vertical"
  ...
  function () {
    var t, i, b = [].indexOf || function (e) {
        for (var t = 0, i = this.length; t < i; t++)
          if (t in this && this[t] === e) return t;
        return -1
      },
      w = [].slice;
    t = this, i = function (l, s) {
      var t, r, a, d, i, c, u, o, h, n, f, p, m, g, y, v;
      ...
      function e(e) {
        ...
        this.$element = e, this.element = e[0], this.didResize = !1, this.didScroll = !1, this.id = "context" + i++, this.oldScroll = {
          ...
          horizontal: {},
          vertical: {}
        }, e.data(c, this.id), u[this.id] = this, e.bind(p, function () {
          var e;
          if (!t.didScroll && !o) return t.didScroll = !0, e = function () {
            return t.doScroll(), t.didScroll = !1
          }, s.setTimeout(e, l[v].settings.scrollThrottle)
        }), e.bind(f, function () {
          var e;
          if (!t.didResize) return t.didResize = !0, e = function () {
            return l[v]("refresh"), t.didResize = !1
          }, s.setTimeout(e, l[v].settings.resizeThrottle)
        })
      }

      function _(e, t, i) {
        var n, o;
        "bottom-in-view" === (i = l.extend({}, l.fn[y].defaults, i)).offset && (i.offset = function () {
          var e = l[v]("viewportHeight");
          return l.isWindow(t.element) || (e = t.$element.height()), e - l(this).outerHeight()
        }), this.$element = e, this.element = e[0], this.axis = i.horizontal ? "horizontal" : "vertical", this.callback = i.handler, this.context = t, this.enabled = i.enabled, this.id = "waypoints" + m++, this.offset = null, this.options = i, t.waypoints[this.axis][this.id] = this, d[this.axis][this.id] = this, (n = null != (o = e.data(g)) ? o : []).push(this.id), e.data(g, n)
      }
      return t = l(s), o = 0 <= b.call(s, "ontouchstart"), d = {
        horizontal: {},
        vertical: {}
      }, u = {}, c = "waypoints-context-id", f = "resize.waypoints", p = "scroll.waypoints", m = i = 1, g = "waypoints-waypoint-ids", y = "waypoint", v = "waypoints", e.prototype.doScroll = function () {
        var n = this,
          e = {
            horizontal: {
        ...
        return !o || e.vertical.oldScroll && e.vertical.newScroll || l[v]("refresh"), l.each(e, function (e, o) {
          var s = [],
            t = o.newScroll > o.oldScroll,
            i = t ? o.forward : o.backward;
          return l.each(n.waypoints[e], function (e, t) {
            var i, n;
            return o.oldScroll < (i = t.offset) && i <= o.newScroll || o.newScroll < (n = t.offset) && n <= o.oldScroll ? s.push(t) : void 0
          }), s.sort(function (e, t) {
        ...
        return this.doScroll(), e = {
          ...
          vertical: {
            ...
            contextDimension: i ? l[v]("viewportHeight") : this.$element.height(),
            oldScroll: this.oldScroll.y,
            forward: "down",
            backward: "up",
            offsetProp: "top"
          ...
          return l.each(t.waypoints[e], function (e, t) {
            var i, n, o = t.options.offset,
              s = t.offset,
              r = l.isWindow(t.element) ? 0 : t.$element.offset()[a.offsetProp];
            if (l.isFunction(o) ? o = o.apply(t.element) : "string" == typeof o && (o = parseFloat(o), -1 < t.options.offset.indexOf("%") && (o = Math.ceil(a.contextDimension * o / 100))), t.offset = r - a.contextOffset + a.contextScroll - o, (!t.options.onlyOnScroll || null == s) && t.enabled) return null !== s && s < (i = a.oldScroll) && i <= t.offset ? t.trigger([a.backward]) : null !== s && s > (n = a.oldScroll) && n >= t.offset || null === s && a.oldScroll >= t.offset ? t.trigger([a.forward]) : void 0
          })
        })
      }, e.prototype.checkEmpty = function () {
        if (l.isEmptyObject(this.waypoints.horizontal) && l.isEmptyObject(this.waypoints.vertical)) return this.$element.unbind([f, p].join(" ")), delete u[this.id]
      }, r = e, _.prototype.trigger = function (e) {
        ...
        return delete d[this.axis][this.id], delete this.context.waypoints[this.axis][this.id], this.context.checkEmpty()
      }, _.getWaypointsByElement = function (e) {
        var t, i = l(e).data(g);
        return i ? (t = l.extend({}, d.horizontal, d.vertical), l.map(i, function (e) {
          return t[e]
        })) : []
      }, a = _, n = {
        init: function (e, o) {
          return null == o && (o = {}), null == o.handler && (o.handler = e), this.each(function () {
            var e, t, i = l(this),
              n = null != (t = o.context) ? t : l.fn[y].defaults.context;
            return l.isWindow(n) || (n = i.closest(n)), n = l(n), e = (e = u[n.data(c)]) || new r(n), new a(i, e, o)
          }), l[v]("refresh"), this
        },
        disable: function () {
        ...
        _traverse: function (t, e, i) {
          ...
          return null == t && (t = "vertical"), null == e && (e = s), o = h.aggregate(e), n = [], this.each(function () {
            var e = l.inArray(this, o[t]);
            return i(n, e, o[t])
          }), this.pushStack(n)
        },
        _invoke: function (e, i) {
          return e.each(function () {
            var e = a.getWaypointsByElement(this);
        ...
        return n[e] ? n[e].apply(this, t) : l.isFunction(e) ? n.init.apply(this, arguments) : l.isPlainObject(e) ? n.init.apply(this, [null, e]) : e ? l.error("The " + e + " method does not exist in jQuery Waypoints.") : l.error("jQuery Waypoints needs a callback function or handler option.")
      }, l.fn[y].defaults = {
        context: s,
        continuous: !0,
        enabled: !0,
        ...
        aggregate: function (e) {
          var t, i, n = d;
          return e && (n = null != (i = u[l(e).data(c)]) ? i.waypoints : void 0), n ? (t = {
            horizontal: [],
            vertical: []
          }, l.each(t, function (e, i) {
            return l.each(n[e], function (e, t) {
              return i.push(t)
            }), i.sort(function (e, t) {
              return e.offset - t.offset
            }), t[e] = l.map(i, function (e) {
              return e.element
            }), t[e] = l.unique(t[e])
          }), t) : []
        },
        ...
        _invoke: function (i) {
          var e = l.extend({}, d.vertical, d.horizontal);
          return l.each(e, function (e, t) {
            return t[i](), !0
          })
        },
        _filter: function (e, t, i) {
          var n, o = u[l(e).data(c)];
          return o ? (n = [], l.each(o.waypoints[t], function (e, t) {
            if (i(o, t)) return n.push(t)
          }), n.sort(function (e, t) {
            return e.offset - t.offset
          }), l.map(n, function (e) {
            return e.element
        ...
        var e = arguments[0],
          t = 2 <= arguments.length ? w.call(arguments, 1) : [];
        return h[e] ? h[e].apply(null, t) : h.aggregate.call(null, e)
      }, l[v].settings = {
        resizeThrottle: 100,
        scrollThrottle: 30
      }, t.load(function () {
